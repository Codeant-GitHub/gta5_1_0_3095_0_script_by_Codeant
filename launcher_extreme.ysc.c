...
void main() // Position - 0x0
{
	...
	while (true)
	{
		...
		func_215(num);
		func_208(&iLocal_92, &(num.f_9), unk61);
	
		if (num == 18)
		{
			func_207(&num);
			func_202(&num, unk61, "EXT2AU", "EXT2_AMB", 3, "DOM", 5000, 1101004800);
		}
		else if (num == 19)
		{
			func_207(&num);
			...
			if (unk_0x9F0C06CFBACDD6A1(uLocal_94))
				func_202(&num, unk61, "EXT3AUD", "EXT_AMB", 3, "DOM", 8000, 1101004800);
...
eCharacter func_32(int iParam0) // Position - 0x2C0E
{
	int i;
...
int func_33(int iParam0, eCharacter echParam1, int iParam2) // Position - 0x2C71
{
	int i;
...
void func_48(int iParam0, var uParam1, int iParam2, Hash hParam3) // Position - 0x38AF
{
...
int func_49(int iParam0, Hash hParam1) // Position - 0x3A49
{
	var unk;
	int num;
...
Hash func_51(Hash hParam0) // Position - 0x3A8D
{
	Hash hash;
	Hash hash2;
...
Hash func_52() // Position - 0x3AC1
{
	return Global_1574925;
}

BOOL func_53(int iParam0, Hash hParam1) // Position - 0x3ACD
{
	var unk;
	BOOL num;
...
var func_54(int iParam0, Hash hParam1) // Position - 0x3AF1
{
...
BOOL func_69(var uParam0, var uParam1, var uParam2, char* sParam3, float fParam4, float fParam5, float fParam6) // Position - 0x5F18
{
	var unk;
	var unk2;
...
BOOL func_71(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0x66DB
{
	if (bParam6)
...
BOOL func_72(var uParam0) // Position - 0x6722
{
...
BOOL func_74(int iParam0, int iParam1, BOOL bParam2) // Position - 0x678D
{
	if (iParam0 == -1)
		return false;
...
BOOL func_77(int iParam0) // Position - 0x6BA0
{
	return func_74(iParam0, 5, true);
}

int func_78(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x6BB0
{
	int i;
	float num;
	float num2;
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x76C7
{
...
Vector3 func_83(float fParam0, float fParam1, float fParam2) // Position - 0x76F1
{
...
BOOL func_85(Player plParam0) // Position - 0x771D
{
...
BOOL func_87(int iParam0, int iParam1, var uParam2, int iParam3, BOOL bParam4) // Position - 0x781F
{
	var unk;
	var unk7;
	var unk13;
...
Vector3 func_88(float fParam0, var uParam1, var uParam2, float fParam3) // Position - 0x78B4
{
	float num;
	float num2;
	float num3;
...
BOOL func_92(int iParam0, var uParam1) // Position - 0x8552
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_93(Player plParam0) // Position - 0x85D4
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
...
Player _INVALID_PLAYER_INDEX() // Position - 0x862C
{
	return -1;
}
...
BOOL func_98(int iParam0) // Position - 0x88CE
{
...
int func_106(int iParam0) // Position - 0x8E17
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * IS_BIT_SET(iParam0, 31) ? -1 : 1) + 2011;
}

var func_107(BOOL bParam0, var uParam1, var uParam2) // Position - 0x8E39
{
	if (bParam0)
		return uParam1;
...
int func_108(int iParam0) // Position - 0x8E50
{
	return iParam0 & 15;
}
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER_0() // Position - 0x8F0E
{
	func_58();
	return Global_114370.f_2366.f_539.f_4321;
}
...
void func_116(char* sParam0, var uParam1, int iParam2) // Position - 0x8FAC
{
...
BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0x8FEE
{
...
BOOL func_122(Any* panParam0) // Position - 0xAA81
{
	int num;
...
void func_126(Vehicle veParam0) // Position - 0xAC1F
{
	int num;
	int num2;
	int num3;
...
int func_128(Vehicle veParam0) // Position - 0xACFB
{
	int i;
...
BOOL func_132(int iParam0, int iParam1, int iParam2) // Position - 0xADF4
{
...
int func_134(Vehicle veParam0) // Position - 0xAE5B
{
	int i;
...
BOOL func_135(var uParam0) // Position - 0xAEA4
{
...
BOOL func_136(int iParam0) // Position - 0xAEC4
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_138(int iParam0) // Position - 0xAF94
{
	switch (iParam0)
	{
		case 5:
...
void func_139(Any* panParam0, int iParam1, BOOL bParam2) // Position - 0xAFE7
{
	int i;
...
BOOL func_140(int iParam0) // Position - 0xB0DC
{
	switch (iParam0)
	{
		case 5:
...
void func_142(BOOL bParam0, BOOL bParam1, BOOL bParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB186
{
	if (bParam0)
	{
...
Player func_145(Hash hParam0, BOOL bParam1) // Position - 0xB346
{
	Player player;
	Hash hash;
...
BOOL func_146(int iParam0) // Position - 0xB387
{
	int num;
...
BOOL func_147(int iParam0) // Position - 0xB3A9
{
...
int func_149(int iParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0xB3F6
{
	int num;
...
BOOL func_152(var uParam0) // Position - 0xB473
{
...
BOOL func_157(var uParam0, float fParam1, int iParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB584
{
...
void func_158(var uParam0) // Position - 0xB5DB
{
	if (!unk_0x1C2F771CDC87A3A5(uParam0, 0))
...
BOOL func_165(int iParam0) // Position - 0xB8E8
{
	if (iParam0 == 1)
...
BOOL func_167(int iParam0) // Position - 0xB94E
{
...
int func_170(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4) // Position - 0xBA06
{
	int i;
...
void func_171(int iParam0, int iParam1) // Position - 0xBB3D
{
	int i;
...
BOOL func_173(int iParam0, int iParam1) // Position - 0xBB9D
{
	if (iParam1 == 15)
		return 1;
...
BOOL func_174(int iParam0) // Position - 0xBD7E
{
	if (Global_43922 == 15)
		return false;
...
void func_178(int iParam0, var uParam1) // Position - 0xBE1E
{
	switch (iParam0)
	{
		case 0:
...
var func_179(float fParam0, float fParam1, float fParam2, int iParam3) // Position - 0xC28E
{
	var unk;
...
var func_180(BOOL bParam0, var uParam1, var uParam2) // Position - 0xC2BA
{
	if (bParam0)
		return uParam1;
...
BOOL func_181(int iParam0) // Position - 0xC2D1
{
	switch (iParam0)
	{
		case 0:
...
int func_182(var uParam0) // Position - 0xC360
{
	if (*uParam0 == 18)
	{
		if (unk_0x5105BE70DEF1F5FB(unk_0x4A8C381C258A124D(), -954.5357f, -2760.5532f, 11.916363f, -947.6847f, -2749.719f, 15.631608f, 26f, 0, 1, 0))
		{
			...
			else if (!func_183(unk_0x4A8C381C258A124D(), joaat("SCRIPT_TASK_LEAVE_ANY_VEHICLE")) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(unk_0x6EF03BE64E058E2F(unk_0x4A8C381C258A124D(), 0)) && func_157(unk_0x6EF03BE64E058E2F(unk_0x4A8C381C258A124D(), 0), 3f, 1, 1056964608, 0, true, false))
			{
				unk_0x092B9247AF00F5CF(unk_0x4A8C381C258A124D(), 0, 0);
			}
		}
...
BOOL func_183(var uParam0, int iParam1) // Position - 0xC407
{
	if (func_135(uParam0))
...
BOOL func_186(var uParam0) // Position - 0xCC38
{
	float num;
...
void func_187(int iParam0, var uParam1) // Position - 0xCCC6
{
	if (iParam0 == 1)
	{
		if (!func_138(uParam1))
...
BOOL func_188(BOOL bParam0) // Position - 0xCD2A
{
	var unk;
...
BOOL func_189(var uParam0) // Position - 0xCDC1
{
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0))
		if (unk_0xD9F5E1FEFD1329E4(uParam0, 0))
...
BOOL func_190(int iParam0) // Position - 0xCDEB
{
	eCharacter character;
...
BOOL func_191() // Position - 0xD508
{
	return Global_101431.f_1;
}

BOOL func_192() // Position - 0xD516
{
	if (Global_98294 != -1)
...
BOOL func_196(int iParam0, int iParam1) // Position - 0xD58E
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_197() // Position - 0xD5C6
{
	return Global_1575079;
}

BOOL func_198() // Position - 0xD5D2
{
	if (!unk_0x76CD105BCAC6EB9F())
...
void _DISPLAY_HELP_TEXT(char* text, int iParam1) // Position - 0xD5EE
{
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(int iParam0) // Position - 0xD605
{
	if (unk_0xFC8BFE4B41177C22(iParam0))
...
BOOL _CONVERSATION_IS_DIALOGUE_IN_PROGRESS() // Position - 0xD626
{
...
int func_202(var uParam0, var uParam1, var uParam2, var uParam3, char* sParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, int iParam9) // Position - 0xD648
{
	var unk;
...
void _CONVERSATION_ADD_LINE_NO_SUBTITLE(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xD6D0
{
...
void func_204(var uParam0, eCharacter echParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xD70B
{
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, var uParam2, char* sParam3, int iParam4, int iParam5) // Position - 0xD761
{
...
float func_206(var uParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0xD7FC
{
	var unk;
...
void func_207(var uParam0) // Position - 0xD836
{
...
void func_208(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) // Position - 0xD863
{
	if (unk_0x75EAB09F5E974116(unk_0x259BE71D8A81D4FA()))
	{
...
void func_211(var uParam0, int iParam1) // Position - 0xD9C9
{
	BOOL flag;
	int i;
...
void func_213(var uParam0) // Position - 0xDA73
{
	unk_0xB479965CBAA3EAE1(0);
	unk_0xDD291722ADDCBD60();
	func_214(uParam0);
...
void func_214(var uParam0) // Position - 0xDA8A
{
	BOOL flag;
	int num;
	int i;
...
BOOL IS_RC_FINE_AND_IN_RANGE(Any* panParam0, BOOL bParam1) // Position - 0xDB9A
{
	var unk;
...
void func_217(int iParam0, var uParam1, int iParam2) // Position - 0xDE0A
{
	...
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(iParam0))
	{
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_219(uParam1) || !unk_0x13CCB1AD131C1082(iParam0, *uParam1, uParam1->f_2, 3))
				{
					if (func_218(iParam2) && !unk_0x3644984C9D7B57EF(iParam0, unk_0x4A8C381C258A124D(), 25f))
					{
						unk_0x0E95B96CFEFE7B61(iParam0, unk_0x4A8C381C258A124D(), 0);
						uParam1->f_3 = 5;
					}
					else if (func_219(uParam1) && uParam1->f_4 == 0 && unk_0xED977E2AE2CB16EE(unk_0xD1A6A821F5AC81DB(unk_0x4A8C381C258A124D(), 1), unk_0xD1A6A821F5AC81DB(iParam0, 1), 1) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
			...
			case 5:
				if (!func_218(iParam2) || unk_0x3644984C9D7B57EF(iParam0, unk_0x4A8C381C258A124D(), 10f))
				{
					if (func_71(uParam1->f_5, 0f, 0f, 0f, false))
						unk_0x10425721983AE158(iParam0, *uParam1, uParam1->f_1, 8f, -8f, -1, 262153, 0, 0, 0, 0);
					else
...
BOOL func_218(int iParam0) // Position - 0xE162
{
...
BOOL func_219(var uParam0) // Position - 0xE182
{
...
BOOL func_220(var uParam0) // Position - 0xE19A
{
...
void func_222(var uParam0) // Position - 0xE4C3
{
...
BOOL CHECK_VEHICLES_OK(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0xE56E
{
	int i;
	int num;
	var unk;
			...
			if (unk_0xFC8BFE4B41177C22(uParam0->f_35[i]))
			{
				...
				if (bParam2)
				{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_225(unk_0x4A8C381C258A124D(), uParam0->f_35[i]))
							{
...
BOOL func_225(var uParam0, var uParam1) // Position - 0xE72C
{
	var unk;
...
BOOL func_226(var uParam0, BOOL bParam1, int iParam2) // Position - 0xE75C
{
	int i;
	int num;
...
BOOL func_227(int iParam0) // Position - 0xEA18
{
...
BOOL func_228(var uParam0, int iParam1) // Position - 0xEA4C
{
	float num;

	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(unk_0x4A8C381C258A124D()) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0))
	{
		if (func_239(uParam0) || unk_0x41754DC6001F6313(unk_0x259BE71D8A81D4FA(), uParam0))
		{
...
BOOL func_229(var uParam0, int iParam1) // Position - 0xEAC2
{
	return func_230(uParam0, unk_0x4A8C381C258A124D(), iParam1, 1, 250, 7);
}

BOOL func_230(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xEADA
{
	BOOL flag;
	var unk;
	int num;

	num = func_238(uParam0, uParam1);
	...
	flag = func_231(&iLocal_35[num /*4*/], unk, uParam1, &(iLocal_35[num /*4*/].f_3), uParam0, iParam5);
	return flag || unk_0x1DD05E817C89C737() - iLocal_35[num /*4*/].f_3 < iParam4;
}

BOOL func_231(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, int iParam7) // Position - 0xEB9B
{
	var unk;
	var unk2;
	var unk5;
...
Vector3 func_232(var uParam0, int iParam1) // Position - 0xECC7
{
	int num;
...
BOOL func_234(var uParam0, var uParam1, int iParam2, int iParam3) // Position - 0xEDD6
{
	var unk;
	var unk4;
	float num;

	unk = { func_236(unk_0xD1A6A821F5AC81DB(uParam1, 1) - unk_0xD1A6A821F5AC81DB(uParam0, 1)) };
	...
	if (iParam3 == 0)
		...
		unk4 = { func_236(unk_0x83FDC027F0BEA202(uParam0, 31086, 0f, 5f, 0f) - unk_0x83FDC027F0BEA202(uParam0, 31086, 0f, 0f, 0f)) };

	num = func_235(unk4, unk);
...
float func_235(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0xEE67
{
	return (fParam0 * uParam3) + (fParam0.f_1 * uParam3.f_1) + (fParam0.f_2 * uParam3.f_2);
}

Vector3 func_236(float fParam0, var uParam1, var uParam2) // Position - 0xEE88
{
	float num;
	float num2;
...
int func_238(var uParam0, var uParam1) // Position - 0xEEE2
{
	int i;
...
int func_239(var uParam0) // Position - 0xEF21
{
...
BOOL func_240(var uParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xEF49
{
	float num;
	float num2;
	int num3;
	...
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(unk_0x4A8C381C258A124D()) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0))
	{
		...
		if (!bParam2)
		{
			if (func_244(uParam0, bParam1, num, num2))
				return true;
		
			if (func_241(uParam0, num2, bParam3, bParam4))
				return true;
		}
		else
		{
...
BOOL func_241(var uParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0xF044
{
	float num;
	float num2;
...
BOOL func_242(var uParam0, float fParam1) // Position - 0xF150
{
	var unk;
	var unk2;
	...
	if (unk_0xF67924A428A734EC(uParam0, joaat("WEAPON_GRENADE"), fParam1, &unk2, &unk, 0) || unk_0xF67924A428A734EC(uParam0, joaat("WEAPON_SMOKEGRENADE"), fParam1, &unk2, &unk, 0) || unk_0xF67924A428A734EC(uParam0, joaat("WEAPON_BZGAS"), fParam1, &unk2, &unk, 0) || unk_0xF67924A428A734EC(uParam0, joaat("WEAPON_STICKYBOMB"), fParam1, &unk2, &unk, 0) || unk_0xF67924A428A734EC(uParam0, joaat("WEAPON_MOLOTOV"), fParam1, &unk2, &unk, 0))
		if (func_243(uParam0, unk2, 90f, 0))
			return true;

	return false;
}

BOOL func_243(var uParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xF1E5
{
	var unk;
	var unk4;
	float num;

	unk = { func_236(uParam1 - unk_0xD1A6A821F5AC81DB(uParam0, 1)) };
...
BOOL func_244(var uParam0, BOOL bParam1, float fParam2, float fParam3) // Position - 0xF273
{
	if (bParam1)
		if (unk_0x65F146FF416F109F(unk_0x4A8C381C258A124D()))
...
BOOL func_245(int iParam0) // Position - 0xF2BB
{
...
void func_246(var uParam0) // Position - 0xF305
{
	var unk;
...
BOOL func_247(int iParam0) // Position - 0xF3A2
{
	if (iParam0 == -1)
		iParam0 = func_175();
...
BOOL func_248(int iParam0) // Position - 0xF437
{
...
BOOL func_251(int iParam0) // Position - 0xF4B6
{
...
BOOL func_253(int iParam0) // Position - 0xF528
{
...
BOOL func_254(var uParam0) // Position - 0xF550
{
	switch (*uParam0)
	{
		case 17:
...
BOOL func_255(var uParam0) // Position - 0xF5C5
{
	int num;
	int i;
...
void func_256(var uParam0, float fParam1, float fParam2, float fParam3, float fParam4) // Position - 0xF6C9
{
	func_257(uParam0, iLocal_91, fParam1, fParam4, 26);
...
void func_257(var uParam0, int iParam1, var uParam2, var uParam3, var uParam4, float fParam5, int iParam6) // Position - 0xF6FB
{
	func_258(uParam0);
...
void func_258(var uParam0) // Position - 0xF71C
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (!unk_0x1C2F771CDC87A3A5(*uParam0, 0))
...
BOOL func_259(var uParam0) // Position - 0xF75D
{
	if (func_220(uParam0))
	{
...
BOOL func_260(var uParam0) // Position - 0xF787
{
	int i;
...
BOOL func_262(var uParam0) // Position - 0xF7F4
{
	int num;
	int i;
	BOOL flag;
...
BOOL func_263(var uParam0, eCharacter echParam1, float fParam2, float fParam3, float fParam4, float fParam5, char* sParam6, int iParam7) // Position - 0xF987
{
	if (func_264(uParam0, echParam1, fParam2, fParam5, true))
	{
		if (unk_0xFC8BFE4B41177C22(*uParam0))
		{
			if (!unk_0x1C2F771CDC87A3A5(*uParam0, 0))
...
BOOL func_264(var uParam0, eCharacter echParam1, var uParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0xF9E3
{
	int num;
...
int func_265(int iParam0, eCharacter echParam1) // Position - 0xFA71
{
	int num;
...
BOOL func_266(var uParam0) // Position - 0xFAB7
{
	int num;
	int i;
	BOOL flag;
...
void func_267(var uParam0, var uParam1, float fParam2, float fParam3, float fParam4, float fParam5) // Position - 0xFDBB
{
	func_268(uParam0);
...
void func_268(var uParam0) // Position - 0xFDFE
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (!unk_0x110821AE6C63DD4F(*uParam0))
...
BOOL func_269(var uParam0) // Position - 0xFE9A
{
	int num;
	int i;
...
BOOL func_270(int iParam0) // Position - 0xFF86
{
	var unk;
	eCharacter character;
...
BOOL func_271(int iParam0) // Position - 0xFFD7
{
	var unk;
...
BOOL func_272(int iParam0) // Position - 0x10090
{
	var unk;
...
BOOL func_273(int iParam0) // Position - 0x10151
{
	int i;
	var unk;
	int num;
...
BOOL func_275(int iParam0) // Position - 0x102B8
{
...
BOOL func_276(int iParam0) // Position - 0x102E3
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_277(int iParam0) // Position - 0x1030E
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_278(int iParam0) // Position - 0x10339
{
	if (func_248(iParam0))
		return false;
	else if (!unk_0x4FAFF4BCB7633475(unk_0x4A8C381C258A124D()))
...
BOOL func_280(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, float fParam5) // Position - 0x10388
{
	int i;
...
BOOL func_281(int iParam0, var uParam1, var uParam2, var uParam3, float fParam4, var uParam5) // Position - 0x103ED
{
	int num;
	char* str;
...
BOOL func_282(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7) // Position - 0x10465
{
	if (fParam6 < 0f)
		fParam6 = 0f;
...
void func_283(var uParam0, BOOL bParam1) // Position - 0x104E0
{
	if (*uParam0 == 18)
	{
		if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_35[0]))
...
void func_288(var uParam0, BOOL bParam1) // Position - 0x10667
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (unk_0x5B9219522937741D(*uParam0))
...
void func_291(var uParam0) // Position - 0x106F1
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
void func_293(var uParam0, int iParam1) // Position - 0x1073B
{
	...
	for (i = 0; i <= *uParam0 - 1; i = i + 1)
	{
		if (iParam1 == 1)
			...
			func_294(&uParam0->[i], 0, 1, 0);
	}

	return;
}

void func_294(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x1077C
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (!unk_0x4FAFF4BCB7633475(*uParam0))
...
void func_295(int iParam0) // Position - 0x107CC
{
	if (*iParam0 == -1)
		return;
...
int func_299(eCharacter echParam0) // Position - 0x10868
{
	if (!func_36(echParam0))

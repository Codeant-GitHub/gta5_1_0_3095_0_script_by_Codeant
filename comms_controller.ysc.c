...
void main() // Position - 0x0
{
	...
	Global_44473 = unk_0x1DD05E817C89C737() + 20000;
	num = 0;
	...
	while (true)
	{
		...
		{
			func_55(&num2, &Global_114370.f_7691.f_867[i /*14*/]);
		}
...
int func_71(var uParam0) // Position - 0x23A2
{
	...
	while (num < 35)
	{
		if (!unk_0xFF692AB7350A74D7(&Global_114370.f_14144[num /*104*/]))
		{
			if (unk_0x1B79E937E91F40C3(&Global_114370.f_14144[num /*104*/], uParam0))
			{
...
void func_74(int iParam0) // Position - 0x368D
{
	...
	if (IS_BIT_SET(Global_114370.f_7691[Global_44469 /*15*/].f_1, 3))
	{
		...
		if (num != -1)
		{
			if (func_75(unk_0x4A8C381C258A124D(), num, Global_43923[num /*5*/].f_3 * 0.35f))
			{
...
int func_90() // Position - 0x54E7
{
	...
	if (num >= 0 && num < 3)
		if (unk_0xFC8BFE4B41177C22(Global_97206[num]))
			return 0;
...
{
	if (unk_0xFC8BFE4B41177C22(Global_98850[2]))
		return 0;
...
{
	if (unk_0xFC8BFE4B41177C22(Global_98850[1]))
		return 0;
...
{
	if (unk_0xFC8BFE4B41177C22(Global_98850[0]))
		return 0;
...
int func_96() // Position - 0x55CB
{
	...
	if (unk_0xF40767E41852FB72(Global_114370.f_18106.f_395))
		return 0;
	...
	{
		if (Global_97228[num5 /*2*/] != 0)
			return 0;
	
		if (Global_114370.f_18106.f_175[num5 /*19*/].f_2 != 0)
			return 0;
	
		if (func_99(&(Global_114370.f_18106.f_175[num5 /*19*/].f_5)) && func_97(&(Global_114370.f_18106.f_175[num5 /*19*/].f_5)) < 5f * 60f)
			return 0;
	}
...
int func_107() // Position - 0x59AB
{
	...
	if (Global_96374 == -1)
		Global_96374 = unk_0x1DD05E817C89C737();

	if (unk_0x1DD05E817C89C737() - Global_96374 > 240000)
	{
		Global_96374 = -1;
		return 1;
	}
...
int func_118() // Position - 0x5B8B
{
	...
	if (unk_0x1DD05E817C89C737() - Global_96374 > 30000)
	{
		Global_96374 = -1;
		return 1;
	}
	...
	if (Global_44469 != -1)
	{
		...
		else
		{
			...
			if (IS_BIT_SET(Global_114370.f_7691[Global_44469 /*15*/].f_1, 15))
			{
				...
				unk_0x8744D2E3FC95740E(&(Global_114370.f_7691[Global_44469 /*15*/].f_1), 15);
			}
...
{
	if (iParam0 == 1)
		unk_0x0B0C9A0F9AAEB7F0(&Global_8683, 20);
	else
...
void func_150(var uParam0, BOOL bParam1) // Position - 0x64BB
{
	...
	if (IS_BIT_SET(Global_114370.f_7691[Global_44469 /*15*/].f_1, 1))
	{
		if (!Global_114370.f_7691.f_913)
		{
			unk_0x0B0C9A0F9AAEB7F0(&(Global_114370.f_7691[Global_44469 /*15*/].f_1), 10);
...
void func_156(eCharacter echParam0, eCharacter echParam1, BOOL bParam2) // Position - 0x6A58
{
	if (Global_118[echParam0 /*10*/].f_8 != 178)
	{
		...
		if (bParam2)
		{
			Global_9293[1 /*6*/] = { _GET_CHARACTER_NAME(echParam0) };
			Global_9293[1 /*6*/].f_5 = echParam1;
			unk_0x0B0C9A0F9AAEB7F0(&Global_8683, 0);
		}
	}
...
void func_222(var uParam0) // Position - 0xB421
{
	...
	switch (iLocal_49)
	{
		case 0:
			if (!unk_0x4FAFF4BCB7633475(unk_0x4A8C381C258A124D()))
			{
				if (func_245(CHAR_BLIMP))
				{
					...
					{
						if (!unk_0xFC8BFE4B41177C22(func_239(60)) && !unk_0xFC8BFE4B41177C22(func_239(61)) && Global_79244 == -1 && !func_238() && !func_237())
						{
		...
		case 2:
			if (unk_0x1DD05E817C89C737() > Global_44473)
				iLocal_49 = iLocal_49 + 1;
			break;
...
void func_249(int iParam0) // Position - 0xDB0E
{
	if (IS_BIT_SET(iParam0->f_2, _GET_CURRENT_PLAYER_CHARACTER_0()))
	{
		...
		{
			case CHAR_MICHAEL:
				_CONVERSATION_INITIALIZE_ACTOR(&Global_44304, 0, unk_0x4A8C381C258A124D(), "MICHAEL", 0, 1);
				break;
		
			case CHAR_FRANKLIN:
				_CONVERSATION_INITIALIZE_ACTOR(&Global_44304, 1, unk_0x4A8C381C258A124D(), "FRANKLIN", 0, 1);
				break;
		
			case CHAR_TREVOR:
				_CONVERSATION_INITIALIZE_ACTOR(&Global_44304, 2, unk_0x4A8C381C258A124D(), "TREVOR", 0, 1);
				break;
		}
	}
...
int func_269(int iParam0) // Position - 0xF2FD
{
						...
						if (Global_9252[i] == false)
						{
							...
							else if (num == 7)
							{
								if (Global_79248)
								{
									...
									func_271(Global_20794, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(i), SYSTEM::TO_FLOAT(Global_8690[num /*15*/].f_10), SYSTEM::TO_FLOAT(value), -1f, &Global_8690[num /*15*/], 0, 0, 0, 0);
								}
								else
								{
									switch (Global_20813)
...
BOOL func_287(var uParam0, eCharacter echParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7) // Position - 0x10AB7
{
...
BOOL func_288(var uParam0, eCharacter echParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7) // Position - 0x10B05
{
	func_176(uParam0, echParam1, sParam2, iParam5, iParam6, 0);
	Global_22214 = false;
	Global_22173 = true;
...
BOOL func_289(var uParam0, eCharacter echParam1, char* sParam2, char* sParam3, int iParam4, char* sParam5, char* sParam6, char* sParam7, int iParam8, int iParam9, BOOL bParam10) // Position - 0x10B53
{

...
void main() // Position - 0x0
{
	...
	if (!func_267(&unk64, &num, unk61, 1f))
	{
		func_266();
	...
	while (true)
	{
		...
		{
			if (!func_210(-72.323f, -1258.643f, 28.648f, unk_0xD1A6A821F5AC81DB(num.f_35[0], 1), 1056964608))
			{
		...
		func_206(num);
		func_199(&iLocal_91, &(num.f_9), unk61);
		func_194(&num, unk61, "HAO1AU", "HAO1_HCO", 3, "HAO", 5000, 1101004800);
...
eCharacter func_32(int iParam0) // Position - 0x2AEC
{
	int i;
...
int func_33(int iParam0, eCharacter echParam1, int iParam2) // Position - 0x2B4F
{
	int i;
...
void func_48(int iParam0, var uParam1, int iParam2, Hash hParam3) // Position - 0x378D
{
...
int func_49(int iParam0, Hash hParam1) // Position - 0x3927
{
	var unk;
	int num;
...
Hash func_51(Hash hParam0) // Position - 0x396B
{
	Hash hash;
	Hash hash2;
...
Hash func_52() // Position - 0x399F
{
	return Global_1574925;
}

BOOL func_53(int iParam0, Hash hParam1) // Position - 0x39AB
{
	var unk;
	BOOL num;
...
var func_54(int iParam0, Hash hParam1) // Position - 0x39CF
{
...
BOOL func_69(var uParam0, var uParam1, var uParam2, char* sParam3, float fParam4, float fParam5, float fParam6) // Position - 0x5DF6
{
	var unk;
	var unk2;
...
BOOL func_71(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0x65B9
{
	if (bParam6)
...
BOOL func_72(var uParam0) // Position - 0x6600
{
...
BOOL func_74(int iParam0, int iParam1, BOOL bParam2) // Position - 0x666B
{
	if (iParam0 == -1)
		return false;
...
BOOL func_77(int iParam0) // Position - 0x6A7E
{
	return func_74(iParam0, 5, true);
}

int func_78(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x6A8E
{
	int i;
	float num;
	float num2;
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x75A5
{
...
Vector3 func_83(float fParam0, float fParam1, float fParam2) // Position - 0x75CF
{
...
BOOL func_85(Player plParam0) // Position - 0x75FB
{
...
BOOL func_87(int iParam0, int iParam1, var uParam2, int iParam3, BOOL bParam4) // Position - 0x76FD
{
	var unk;
	var unk7;
	var unk13;
...
Vector3 func_88(float fParam0, var uParam1, var uParam2, float fParam3) // Position - 0x7792
{
	float num;
	float num2;
	float num3;
...
BOOL func_92(int iParam0, var uParam1) // Position - 0x8430
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_93(Player plParam0) // Position - 0x84B2
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
...
Player _INVALID_PLAYER_INDEX() // Position - 0x850A
{
	return -1;
}
...
BOOL func_98(int iParam0) // Position - 0x87AC
{
...
int func_106(int iParam0) // Position - 0x8CF5
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * IS_BIT_SET(iParam0, 31) ? -1 : 1) + 2011;
}

var func_107(BOOL bParam0, var uParam1, var uParam2) // Position - 0x8D17
{
	if (bParam0)
		return uParam1;
...
int func_108(int iParam0) // Position - 0x8D2E
{
	return iParam0 & 15;
}
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER_0() // Position - 0x8DEC
{
	func_58();
	return Global_114370.f_2366.f_539.f_4321;
}
...
void func_116(char* sParam0, var uParam1, int iParam2) // Position - 0x8E8A
{
...
BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0x8ECC
{
...
BOOL func_122(Any* panParam0) // Position - 0xA95F
{
	int num;
...
void func_126(Vehicle veParam0) // Position - 0xAAFD
{
	int num;
	int num2;
	int num3;
...
int func_128(Vehicle veParam0) // Position - 0xABD9
{
	int i;
...
BOOL func_132(int iParam0, int iParam1, int iParam2) // Position - 0xACD2
{
...
int func_134(Vehicle veParam0) // Position - 0xAD39
{
	int i;
...
BOOL func_135(var uParam0) // Position - 0xAD82
{
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(int iParam0) // Position - 0xADA2
{
	if (unk_0xFC8BFE4B41177C22(iParam0))
...
BOOL func_137(int iParam0) // Position - 0xADC3
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_139(int iParam0) // Position - 0xAE93
{
	switch (iParam0)
	{
		case 5:
...
void func_140(Any* panParam0, int iParam1, BOOL bParam2) // Position - 0xAEE6
{
	int i;
...
BOOL func_141(int iParam0) // Position - 0xAFDB
{
	switch (iParam0)
	{
		case 5:
...
void func_143(BOOL bParam0, BOOL bParam1, BOOL bParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB085
{
	if (bParam0)
	{
...
Player func_146(Hash hParam0, BOOL bParam1) // Position - 0xB245
{
	Player player;
	Hash hash;
...
BOOL func_147(int iParam0) // Position - 0xB286
{
	int num;
...
BOOL func_148(int iParam0) // Position - 0xB2A8
{
...
int func_150(int iParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0xB2F5
{
	int num;
...
BOOL func_153(var uParam0) // Position - 0xB372
{
...
BOOL _CONVERSATION_IS_DIALOGUE_IN_PROGRESS() // Position - 0xB416
{
...
BOOL func_159(var uParam0, float fParam1, int iParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB4A5
{
...
void func_160(var uParam0) // Position - 0xB4FC
{
	if (!unk_0x1C2F771CDC87A3A5(uParam0, 0))
...
BOOL func_167(int iParam0) // Position - 0xB809
{
	if (iParam0 == 1)
...
BOOL func_169(int iParam0) // Position - 0xB86F
{
...
BOOL func_170(int iParam0) // Position - 0xB8B0
{
	int num;
...
int func_172(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4) // Position - 0xB927
{
	int i;
...
void func_173(int iParam0, int iParam1) // Position - 0xBA5E
{
	int i;
...
BOOL _CAN_ENTER_FREEROAM_STATE(int iParam0) // Position - 0xBAAD
{
	return func_175(iParam0, Global_43922);
}

BOOL func_175(int iParam0, int iParam1) // Position - 0xBABE
{
	if (iParam1 == 15)
		return 1;
...
BOOL func_176(int iParam0) // Position - 0xBC9F
{
	if (Global_43922 == 15)
		return false;
...
BOOL _IS_MISSION_REPLAY_IN_PROGRESS() // Position - 0xBD1B
{
	if (Global_101392 == 10 || Global_101392 == 9)
		return true;
...
BOOL func_180(var uParam0, int iParam1) // Position - 0xBD3F
{
	switch (uParam0->f_16)
	{
		case 0:
...
BOOL func_182(var uParam0) // Position - 0xC53F
{
	float num;
...
void func_183(int iParam0, var uParam1) // Position - 0xC5CD
{
	if (iParam0 == 1)
	{
		if (!func_139(uParam1))
...
BOOL func_184(BOOL bParam0) // Position - 0xC631
{
	var unk;
...
BOOL func_185(int iParam0) // Position - 0xC6C8
{
	eCharacter character;
		...
		if (unk_0xFC8BFE4B41177C22(unk_0x4A8C381C258A124D()))
		{
			if (!unk_0x4FAFF4BCB7633475(unk_0x4A8C381C258A124D()))
			{
				...
				switch (iParam0)
				{
					...
					case 3:
						if (unk_0x8BF5256C439DF778(unk_0x4A8C381C258A124D()) || unk_0x9857C978BD3CBEDA(unk_0x4A8C381C258A124D()) || unk_0x6652E84A43F51B8B(unk_0x259BE71D8A81D4FA(), 1) || unk_0x1B32E388988DD296(unk_0x4A8C381C258A124D(), 0) || func_193() || Global_113417 || Global_32831 || func_192() || func_191(8, -1) || func_100() || func_190() || func_188() || Global_114370.f_7691.f_919[character] == 5)
							return false;
						break;
				
					case 4:
						if (func_193() || unk_0xE7B45027762DEFE7(unk_0x259BE71D8A81D4FA()) > 0 || func_191(8, -1) || func_188() || func_187() || Global_114370.f_7691.f_919[character] == 5)
							return false;
						break;
...
BOOL func_186() // Position - 0xCDE5
{
	return Global_101431.f_1;
}

BOOL func_187() // Position - 0xCDF3
{
	if (Global_98294 != -1)
...
BOOL func_191(int iParam0, int iParam1) // Position - 0xCE6B
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_192() // Position - 0xCEA3
{
	return Global_1575079;
}

BOOL func_193() // Position - 0xCEAF
{
	if (!unk_0x76CD105BCAC6EB9F())
...
int func_194(var uParam0, var uParam1, var uParam2, var uParam3, char* sParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, int iParam9) // Position - 0xCECB
{
	var unk;

	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(unk_0x4A8C381C258A124D()) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_28[0]) && !_CONVERSATION_IS_DIALOGUE_IN_PROGRESS() && unk_0x1DD05E817C89C737() - uParam0->f_60 > iParam8 && func_198(unk_0x4A8C381C258A124D(), uParam1, 1) < iParam9)
	{
		unk = 16;
...
void _CONVERSATION_ADD_LINE_NO_SUBTITLE(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xCF53
{
...
void func_196(var uParam0, eCharacter echParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xCF8E
{
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, var uParam2, char* sParam3, int iParam4, int iParam5) // Position - 0xCFE4
{
...
float func_198(var uParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0xD07F
{
	var unk;
...
void func_199(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) // Position - 0xD0B9
{
	if (unk_0x75EAB09F5E974116(unk_0x259BE71D8A81D4FA()))
	{
...
void func_202(var uParam0, int iParam1) // Position - 0xD21F
{
	BOOL flag;
	int i;
...
void func_204(var uParam0) // Position - 0xD2C9
{
	unk_0xB479965CBAA3EAE1(0);
	unk_0xDD291722ADDCBD60();
	func_205(uParam0);
...
void func_205(var uParam0) // Position - 0xD2E0
{
	BOOL flag;
	int num;
	int i;
...
void func_209(var uParam0) // Position - 0xD791
{
...
BOOL func_210(float fParam0, float fParam1, float fParam2, var uParam3, var uParam4, var uParam5, int iParam6) // Position - 0xD7BC
{
	if (iParam6 < 0f)
		iParam6 = 0f;
...
BOOL func_211(var uParam0) // Position - 0xD7F5
{
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0))
		if (unk_0xD9F5E1FEFD1329E4(uParam0, 0))
...
BOOL IS_RC_FINE_AND_IN_RANGE(Any* panParam0, BOOL bParam1) // Position - 0xD81F
{
	var unk;
...
BOOL func_214(int iParam0) // Position - 0xDDE7
{
...
BOOL func_215(var uParam0) // Position - 0xDE07
{
...
BOOL func_216(var uParam0) // Position - 0xDE1F
{
...
BOOL CHECK_VEHICLES_OK(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0xDEC4
{
	int i;
	int num;
	var unk;
...
BOOL func_219(var uParam0, var uParam1) // Position - 0xE082
{
	var unk;
...
BOOL func_220(var uParam0, BOOL bParam1, int iParam2) // Position - 0xE0B2
{
	int i;
	int num;
...
BOOL func_221(int iParam0) // Position - 0xE36E
{
...
BOOL func_222(var uParam0, int iParam1) // Position - 0xE3A2
{
	float num;
...
BOOL func_223(var uParam0, int iParam1) // Position - 0xE418
{
	return func_224(uParam0, unk_0x4A8C381C258A124D(), iParam1, 1, 250, 7);
}

BOOL func_224(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xE430
{
	BOOL flag;
	var unk;
	int num;
	...
	flag = func_225(&iLocal_35[num /*4*/], unk, uParam1, &(iLocal_35[num /*4*/].f_3), uParam0, iParam5);
	return flag || unk_0x1DD05E817C89C737() - iLocal_35[num /*4*/].f_3 < iParam4;
}

BOOL func_225(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, int iParam7) // Position - 0xE4F1
{
	var unk;
	var unk2;
	var unk5;
...
Vector3 func_226(var uParam0, int iParam1) // Position - 0xE61D
{
	int num;
...
BOOL func_228(var uParam0, var uParam1, int iParam2, int iParam3) // Position - 0xE72C
{
	var unk;
	var unk4;
	float num;
...
float func_229(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0xE7BD
{
	return (fParam0 * uParam3) + (fParam0.f_1 * uParam3.f_1) + (fParam0.f_2 * uParam3.f_2);
}

Vector3 func_230(float fParam0, var uParam1, var uParam2) // Position - 0xE7DE
{
	float num;
	float num2;
...
int func_232(var uParam0, var uParam1) // Position - 0xE838
{
	int i;
...
int func_233(var uParam0) // Position - 0xE877
{
...
BOOL func_234(var uParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xE89F
{
	float num;
	float num2;
	int num3;
...
BOOL func_235(var uParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0xE99A
{
	float num;
	float num2;
...
BOOL func_236(var uParam0, float fParam1) // Position - 0xEAA6
{
	var unk;
	var unk2;
...
BOOL func_237(var uParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xEB3B
{
	var unk;
	var unk4;
	float num;
...
BOOL func_238(var uParam0, BOOL bParam1, float fParam2, float fParam3) // Position - 0xEBC9
{
	if (bParam1)
		if (unk_0x65F146FF416F109F(unk_0x4A8C381C258A124D()))
...
BOOL func_239(int iParam0) // Position - 0xEC11
{
...
BOOL func_240(int iParam0) // Position - 0xEC5B
{
	if (iParam0 == -1)
		iParam0 = func_177();
...
BOOL func_241(int iParam0) // Position - 0xECF0
{
...
BOOL func_244(int iParam0) // Position - 0xED6F
{
...
BOOL func_246(int iParam0) // Position - 0xEDE1
{
...
BOOL func_247(var uParam0) // Position - 0xEE09
{
	if (!func_248(uParam0))
		return false;
...
BOOL func_248(var uParam0) // Position - 0xEE28
{
	int num;
	int i;
	var unk5;
...
void func_249(var uParam0, var uParam1, float fParam2, float fParam3, float fParam4, float fParam5) // Position - 0xF292
{
	func_209(uParam0);
...
void func_250(var uParam0, var uParam1, float fParam2, float fParam3, float fParam4, float fParam5) // Position - 0xF2B9
{
	func_251(uParam0);
...
void func_251(var uParam0) // Position - 0xF2FC
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
BOOL func_252(var uParam0, eCharacter echParam1, float fParam2, float fParam3, float fParam4, float fParam5, char* sParam6, int iParam7) // Position - 0xF398
{
...
BOOL func_253(var uParam0, eCharacter echParam1, var uParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0xF3F4
{
	int num;

	if (!func_36(echParam1))
	{
		num = func_286(echParam1);
...
int func_254(int iParam0, eCharacter echParam1) // Position - 0xF482
{
	int num;
...
BOOL func_255(var uParam0) // Position - 0xF4C8
{
	int i;
...
BOOL func_256(eCharacter echParam0) // Position - 0xF4F9
{
	int i;
...
BOOL func_257(int iParam0) // Position - 0xF561
{
	var unk;
	eCharacter character;
...
BOOL func_258(int iParam0) // Position - 0xF5B2
{
	var unk;
...
BOOL func_259(int iParam0) // Position - 0xF66B
{
	var unk;
...
BOOL func_260(int iParam0) // Position - 0xF72C
{
	int i;
	var unk;
	int num;
...
BOOL func_262(int iParam0) // Position - 0xF893
{
...
BOOL func_263(int iParam0) // Position - 0xF8BE
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_264(int iParam0) // Position - 0xF8E9
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_265(int iParam0) // Position - 0xF914
{
	if (func_241(iParam0))
		return false;
	else if (!unk_0x4FAFF4BCB7633475(unk_0x4A8C381C258A124D()))
...
BOOL func_267(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, float fParam5) // Position - 0xF963
{
	int i;
...
BOOL func_268(int iParam0, var uParam1, var uParam2, var uParam3, float fParam4, var uParam5) // Position - 0xF9C8
{
	int num;
	char* str;
...
BOOL func_269(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7) // Position - 0xFA40
{
	if (fParam6 < 0f)
		fParam6 = 0f;
...
void func_270(var uParam0, BOOL bParam1) // Position - 0xFABB
{
	if (bParam1)
	{
...
void func_274(var uParam0, BOOL bParam1) // Position - 0xFB7F
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (unk_0x5B9219522937741D(*uParam0))
...
void func_277(var uParam0) // Position - 0xFC09
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
void func_280(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0xFC94
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (!unk_0x4FAFF4BCB7633475(*uParam0))
...
void func_281(var uParam0) // Position - 0xFCE4
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (!unk_0x1C2F771CDC87A3A5(*uParam0, 0))
...
void func_282(int iParam0) // Position - 0xFD25
{
	if (*iParam0 == -1)
		return;
...
int func_286(eCharacter echParam0) // Position - 0xFDC1
{
	if (!func_36(echParam0))

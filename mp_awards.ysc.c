...
void main() // Position - 0x0
{
	...
	if (unk_0x96CFB880BAC634CE(4))
	{
		...
		Global_1574599 = 0;
		unk_0xA6B31A9A2BC308B5(Global_1666907.f_471, Global_1666907.f_472, Global_1666907.f_499, Global_1666907.f_500);
...
void func_2(var uParam0, var uParam1, var uParam2) // Position - 0x552
{
	...
	if (unk_0x6D05C5731A838CB3(2, 187) || func_12(187, &(Global_1668317.f_1060), 1) && flag)
	{
	...
	if (unk_0x6D05C5731A838CB3(2, 188) || func_12(188, &(Global_1668317.f_1060), 1) && flag)
	{
		_STOPWATCH_DESTROY(uParam2);
		_STOPWATCH_INITIALIZE(uParam2, false, false);
	...
	if (unk_0x6D05C5731A838CB3(2, 189) || unk_0x6D05C5731A838CB3(2, 241) || func_12(189, &(Global_1668317.f_1060), 1) && flag)
	{
		_STOPWATCH_DESTROY(uParam2);
		_STOPWATCH_INITIALIZE(uParam2, false, false);
	...
	if (unk_0x6D05C5731A838CB3(2, 190) || unk_0x6D05C5731A838CB3(2, 242) || func_12(190, &(Global_1668317.f_1060), 1) && flag)
	{
		_STOPWATCH_DESTROY(uParam2);
		_STOPWATCH_INITIALIZE(uParam2, false, false);
		...
		switch (uParam1->f_7)
		{
			case 0:
				if (num3 == 0 || num3 == 1)
				{
					...
					{
						Global_1666323.f_1 = num4 % 4;
						Global_1666323.f_3 = num4 / 4;
					}
				}
				break;
		}
...
Player func_6(Hash hParam0, BOOL bParam1) // Position - 0xC54
{
	Player player;
	Hash hash;
					...
					switch (uParam0->f_6)
					{
						...
						case 18:
							if (!Global_1666907.f_1[0])
							{
								...
								func_65("CLO_LTS_T_0", "CLO_LTS_TD_0", "Elitas_Tshirt", "MPTshirtAwardLTS", 1, player, -1, 1, &Global_1666907, 183, 157);
								func_62(0);
								func_62(1);
								func_62(2);
								player = 0;
								...
								func_65("CLO_HST_A_4", "CLO_HST_AD_5", "CantTouchThis", "MPTShirtAwards2", 1, player, -1, 1, &Global_1666907, 183, 157);
								func_62(5);
								func_62(7);
								func_62(6);
							}
				...
				case 3:
					switch (uParam0->f_6)
					{
						...
						case 18:
							...
							func_65("CLO_HST_A_9", "CLO_HST_AD_9", "Showroom", "MPTShirtAwards2", 1, player, -1, 1, &Global_1666907, 183, 157);
							...
							func_62(34);
							func_65("CLO_S1M_DEC_25", "CLO_S1M_D_24_25" /*Complete all the Lowriders Lamar missions.*/, "BennyTshirt01", "MPTShirtAwards4", 8, player, -1, 1, &Global_1666907, 183, 157);
							break;
					}
					break;
					...
					switch (uParam0->f_6)
					{
						...
						case 18:
							if (!Global_1666907.f_1[0])
							{
								...
								func_65("CLO_S1M_DEC_24", "CLO_S1M_D_24_25" /*Complete all the Lowriders Lamar missions.*/, "BennyTshirt02", "MPTShirtAwards4", 8, player, -1, 1, &Global_1666907, 183, 157);
							}
							break;
					}
					break;
	...
	if (*uParam0 == 0)
	{
		...
		for (i = 0; i <= 18; i = i + 1)
		{
			if (uParam0->f_1[i] == 1)
			{
				...
				unk_0x330108B080A2132F(uParam0->f_346[i]);
				unk_0x330108B080A2132F(uParam0->f_406[i]);
				unk_0x330108B080A2132F(uParam0->f_426[i]);
				unk_0x330108B080A2132F(-1);
				unk_0x330108B080A2132F(-1);
				unk_0x330108B080A2132F(-1);
				unk_0x330108B080A2132F(uParam0->f_386[i]);
				unk_0xE6B753D52F4CA222();
			}
...
void func_17(var uParam0, int iParam1) // Position - 0x4929
{
	...
	if (uParam0->f_450 == 0)
	{
		if (uParam0->f_449 != -1)
		{
			...
			unk_0x330108B080A2132F(0);
			unk_0x330108B080A2132F(uParam0->f_449);
			unk_0xE6B753D52F4CA222();
			uParam0->f_449 = -1;
			uParam0->f_450 = 1;
		}
...
void func_21(var uParam0) // Position - 0x49B4
{
...
void func_34(var uParam0, var uParam1) // Position - 0x4D33
{
...
BOOL func_37(var uParam0) // Position - 0x4D66
{
...
BOOL func_39(var uParam0) // Position - 0x4DF3
{
	int i;
...
Player func_42(int iParam0) // Position - 0x4E6A
{
	Player player;

	if (Global_1937718[iParam0 /*8*/] == -1)
	{
		player = func_49(func_48(iParam0), -1);
		...
		Global_1937718[iParam0 /*8*/] = player;
	}

	return Global_1937718[iParam0 /*8*/];
}

void func_43(int iParam0, Player plParam1) // Position - 0x4EAD
{
	Global_1937718[iParam0 /*8*/] = plParam1;
	func_44(func_48(iParam0), plParam1, -1);
	return;
}

void func_44(int iParam0, Player plParam1, Hash hParam2) // Position - 0x4ECC
{
	func_45(iParam0, plParam1, hParam2, 1);
	return;
}

void func_45(int iParam0, Player plParam1, Hash hParam2, int iParam3) // Position - 0x4EDF
{
	int num;

	if (iParam0 != 14626)
	{
		num = func_46(iParam0, hParam2);
...
int func_46(int iParam0, Hash hParam1) // Position - 0x4F0D
{
	return unk_0xD69CE161FE614531(0, iParam0, func_47(hParam1));
}

Hash func_47(Hash hParam0) // Position - 0x4F22
{
	Hash hash;
	Hash hash2;
...
int func_49(int iParam0, Hash hParam1) // Position - 0x4F74
{
	var unk;
	int num;
...
Hash func_50(int iParam0, Hash hParam1) // Position - 0x4FA3
{
	var unk;
	Hash num;

	unk = func_51(iParam0, hParam1);
...
var func_51(int iParam0, Hash hParam1) // Position - 0x4FC7
{
	return unk_0xD69CE161FE614531(8, iParam0, func_47(hParam1));
}

Hash func_52(int iParam0, int iParam1, int iParam2) // Position - 0x4FDD
{
	iParam2 == 0;
...
BOOL func_53(int iParam0) // Position - 0x7EBD
{
	BOOL flag;
...
BOOL func_54(int iParam0, Hash hParam1) // Position - 0x7F16
{
	int num;
	int num2;
...
int func_56(int iParam0, Hash hParam1) // Position - 0x7F52
{
	int num;

	num = func_49(func_57(iParam0), hParam1);
	return num;
}

int func_57(int iParam0) // Position - 0x7F6A
{
	int num;
	int num2;
...
int func_61(int iParam0, Hash hParam1) // Position - 0x881A
{
	if (hParam1 == -1)
		hParam1 = func_7();

	return unk_0x03CFFD51CE515454(iParam0, hParam1);
}
...
void func_62(int iParam0) // Position - 0x8836
{
	...
	func_65(str, str2, str3, str4, hash, hash2, -1, num2, &Global_1666907, 183, 157);
	return;
}

Hash func_63() // Position - 0x89B5
{
	int num;
...
void func_65(char* sParam0, char* sParam1, char* sParam2, char* sParam3, Hash hParam4, Player plParam5, int iParam6, int iParam7, var uParam8, int iParam9, int iParam10) // Position - 0x8F4A
{
	int i;
	...
	for (i = 0; i <= 11; i = i + 1)
	{
		if (uParam8->f_1[i] == 0)
		{
			...
			func_66(i, sParam0, sParam1, hParam4, plParam5, uParam8);
			uParam8->f_1[i] = 1;
...
void func_66(int iParam0, char* sParam1, char* sParam2, Hash hParam3, Hash hParam4, var uParam5) // Position - 0x8FB4
{
	TEXT_LABEL_ASSIGN_STRING(&uParam5->f_14[iParam0 /*8*/], sParam1, 32);
	TEXT_LABEL_ASSIGN_STRING(&uParam5->f_111[iParam0 /*8*/], sParam2, 32);
	uParam5->f_208[iParam0] = hParam3;
	uParam5->f_221[iParam0] = hParam4;
	return;
}

void func_67(int iParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, var uParam5) // Position - 0x8FE8
{
...
BOOL func_69(int iParam0, Hash hParam1) // Position - 0x9072
{
	if (hParam1 == -1)
		hParam1 = func_7();

	return unk_0xA6D3C21763E25496(iParam0, hParam1);
}
...
void func_70(int iParam0, int iParam1, int iParam2, var uParam3) // Position - 0x908E
{
	...
	hash = func_73(iParam0, num, iParam2);
	hash2 = func_72(iParam0);
	num2 = func_71(iParam1);
	hash3 = func_73(iParam0, num2, iParam2);
	value = hash - hash3;
	value2 = hash2 - hash3;
	num3 = SYSTEM::FLOOR((SYSTEM::TO_FLOAT(value2) / SYSTEM::TO_FLOAT(value)) * 100f);
	func_65(str, str2, str3, str4, hash, hash2, num3, iParam1, uParam3, 183, 157);
	return;
}
...
Hash func_72(int iParam0) // Position - 0x9223
{
	int num;
	int num2;
	Hash num3;

	num = Global_1679796[iParam0];
	num2 = num;

	if (unk_0xDF7F16323520B858(num2, &num3, -1))
		return num3;

	return 0;
}

Hash func_73(int iParam0, int iParam1, int iParam2) // Position - 0x924B
{
	iParam2 == 0;
...
BOOL func_80(Hash hParam0, Hash hParam1) // Position - 0x95A1
{
	if (hParam1 <= hParam0)
		return true;
...
void func_82(int iParam0, int iParam1, int iParam2, var uParam3) // Position - 0x962A
{
	...
	hash = func_52(num2, iParam1, 0);
	hash2 = func_50(num2, -1);
	...
	if (func_54(iParam0, -1))
	{
		hash2 = func_52(func_87(iParam0), iParam1, 0);
...
void func_88(int iParam0, int iParam1, int iParam2, var uParam3) // Position - 0xA738
{
	...
	hash = func_94(iParam0, num, iParam2);
	hash2 = func_91(iParam0, num, iParam2);
	num2 = func_71(iParam1);
	...
	else
	{
		switch (iParam0)
		{
			case 17:
				value2 = 0;
				num5 = func_89(joaat("MPPLY_HEISTFLOWORDERPROGRESS"));
			...
			case 18:
				value2 = 0;
				num5 = func_89(joaat("MPPLY_HEISTTEAMPROGRESSBITSET"));
			...
			case 19:
				value2 = 0;
				num5 = func_89(joaat("MPPLY_HEISTNODEATHPROGREITSET"));
			...
			case 20:
				value2 = 0;
				num5 = func_89(joaat("MPPLY_HEIST_1STPERSON_PROG"));
			...
			case 21:
				value2 = 0;
				num5 = func_89(joaat("MPPLY_HEISTMEMBERPROGRESSBITSET"));
	...
	func_65(str, str2, str3, str4, hash, hash2, num4, iParam1, uParam3, 183, 157);
	return;
}
...
BOOL func_90(int iParam0) // Position - 0xABA4
{
	int num;
	int num2;
	BOOL num3;

	num = Global_1679804[iParam0];
	num2 = num;
...
Hash func_91(int iParam0, int iParam1, int iParam2) // Position - 0xABCC
{
	iParam1 == 5;
	iParam2 == 0;
	func_90(iParam0);
...
char* AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM(int iParam0) // Position - 0xB24C
{
	switch (iParam0)
	{
		case 1:
...
void func_104(int iParam0, int iParam1, int iParam2, var uParam3) // Position - 0xB3F5
{
	...
	hash = func_110(iParam0, num, iParam2);
	...
	func_65(str, str2, str3, str4, hash, hash2, num5, iParam1, uParam3, iParam0, 157);
	return;
}

Hash func_105() // Position - 0xB74B
{
	int num;
...
BOOL func_108(int iParam0, int iParam1) // Position - 0xBB42
{
	var unk;
	int num;
...
var func_109(int iParam0, int iParam1) // Position - 0xBB66
{
...
void func_118(int iParam0, int iParam1, int iParam2, var uParam3) // Position - 0xE8CE
{
	...
	hash = func_52(iParam0, num, iParam2);
	hash2 = func_50(iParam0, -1);
	num2 = func_71(iParam1);
	hash3 = func_52(iParam0, num2, iParam2);
	value = hash - hash3;
	value2 = hash2 - hash3;
	num3 = SYSTEM::FLOOR((SYSTEM::TO_FLOAT(value2) / SYSTEM::TO_FLOAT(value)) * 100f);
	func_65(str, str2, str3, str4, hash, hash2, num3, iParam1, uParam3, 183, iParam0);
	return;
}
...
void func_129(int iParam0, int iParam1, int iParam2, char* sParam3, int iParam4) // Position - 0x11343
{
...
void func_130(int iParam0) // Position - 0x113A0
{
	...
	if (func_137(iParam0))
	{
		...
		if (!IS_BIT_SET(Global_1666907.f_471, num))
			unk_0x0B0C9A0F9AAEB7F0(&(Global_1666907.f_471), num);
	
		if (flag)
			if (!IS_BIT_SET(Global_1666907.f_472, num))
				unk_0x0B0C9A0F9AAEB7F0(&(Global_1666907.f_472), num);
	}
	...
	if (func_132(iParam0))
	{
		...
		if (!IS_BIT_SET(Global_1666907.f_499, num2))
			unk_0x0B0C9A0F9AAEB7F0(&(Global_1666907.f_499), num2);
	
		if (flag2)
			if (!IS_BIT_SET(Global_1666907.f_500, num2))
				unk_0x0B0C9A0F9AAEB7F0(&(Global_1666907.f_500), num2);
	}
...
BOOL func_132(int iParam0) // Position - 0x114F6
{
	switch (iParam0)
	{
		case 120:
...
int func_134(int iParam0) // Position - 0x1155A
{
...
int func_135(int iParam0) // Position - 0x115C3
{
	int num;
	int num2;
...
BOOL func_137(int iParam0) // Position - 0x11666
{
	switch (iParam0)
	{
		case 117:
...
BOOL func_140(int iParam0) // Position - 0x11847
{
	switch (iParam0)
	{
		case 143:
...
BOOL func_142(int iParam0) // Position - 0x119A6
{
	switch (iParam0)
	{
		case 127:
...
int func_143(var uParam0, var uParam1, var uParam2, int iParam3) // Position - 0x11A1D
{
	int num;
	int i;
...
void func_149(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0x11BFF
{

...
void main() // Position - 0x0
{
	...
	while (true)
	{
		...
		if (num == 32)
		{
			...
			{
				if (!func_218(329.513f, 3402.691f, 36.258f, unk_0xD1A6A821F5AC81DB(num.f_35[1], 1), 1056964608))
				{
		...
		func_214(num);
		func_207(&iLocal_94, &(num.f_9), unk61);
	
		if (num == 32)
			func_203(&num, unk61, "MIN1AUD", "MIN1_AMB", 3, "JOE", 4, "JOSEF", &uLocal_97);
		else if (num == 34)
			func_198(&num, unk61, "MIN3AUD", "MIN3_AMB", 3, "MANUEL", 5000, 1101004800);
...
int func_49(int iParam0, Hash hParam1) // Position - 0x39D6
{
	var unk;
	int num;
...
Hash func_51(Hash hParam0) // Position - 0x3A1A
{
	Hash hash;
	Hash hash2;
...
Hash func_52() // Position - 0x3A4E
{
	return Global_1574925;
}

BOOL func_53(int iParam0, Hash hParam1) // Position - 0x3A5A
{
	var unk;
	BOOL num;
...
var func_54(int iParam0, Hash hParam1) // Position - 0x3A7E
{
...
BOOL func_69(var uParam0, var uParam1, var uParam2, char* sParam3, float fParam4, float fParam5, float fParam6) // Position - 0x5EA6
{
	var unk;
	var unk2;
...
BOOL func_71(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0x6669
{
	if (bParam6)
...
BOOL func_72(var uParam0) // Position - 0x66B0
{
...
BOOL func_74(int iParam0, int iParam1, BOOL bParam2) // Position - 0x671B
{
	if (iParam0 == -1)
		return false;
...
BOOL func_77(int iParam0) // Position - 0x6B2E
{
	return func_74(iParam0, 5, true);
}

int func_78(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x6B3E
{
	int i;
	float num;
	float num2;
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x7655
{
...
Vector3 func_83(float fParam0, float fParam1, float fParam2) // Position - 0x767F
{
...
BOOL func_85(Player plParam0) // Position - 0x76AB
{
...
BOOL func_87(int iParam0, int iParam1, var uParam2, int iParam3, BOOL bParam4) // Position - 0x77AD
{
	var unk;
	var unk7;
	var unk13;
...
Vector3 func_88(float fParam0, var uParam1, var uParam2, float fParam3) // Position - 0x7842
{
	float num;
	float num2;
	float num3;
...
BOOL func_92(int iParam0, var uParam1) // Position - 0x84E0
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_93(Player plParam0) // Position - 0x8562
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
...
Player _INVALID_PLAYER_INDEX() // Position - 0x85BA
{
	return -1;
}
...
BOOL func_98(int iParam0) // Position - 0x885C
{
...
int func_106(int iParam0) // Position - 0x8DA5
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * IS_BIT_SET(iParam0, 31) ? -1 : 1) + 2011;
}

var func_107(BOOL bParam0, var uParam1, var uParam2) // Position - 0x8DC7
{
	if (bParam0)
		return uParam1;
...
int func_108(int iParam0) // Position - 0x8DDE
{
	return iParam0 & 15;
}
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER_0() // Position - 0x8E9C
{
	func_58();
	return Global_114370.f_2366.f_539.f_4321;
}
...
void func_116(char* sParam0, var uParam1, int iParam2) // Position - 0x8F3A
{
...
BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0x8F7C
{
...
BOOL func_122(Any* panParam0) // Position - 0xAA0F
{
	int num;
...
void func_126(Vehicle veParam0) // Position - 0xABAD
{
	int num;
	int num2;
	int num3;
...
int func_128(Vehicle veParam0) // Position - 0xAC89
{
	int i;
...
BOOL func_132(int iParam0, int iParam1, int iParam2) // Position - 0xAD82
{
...
int func_134(Vehicle veParam0) // Position - 0xADE9
{
	int i;
...
BOOL func_135(var uParam0) // Position - 0xAE32
{
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(int iParam0) // Position - 0xAE52
{
	if (unk_0xFC8BFE4B41177C22(iParam0))
...
BOOL func_137(int iParam0) // Position - 0xAE73
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_139(int iParam0) // Position - 0xAF43
{
	switch (iParam0)
	{
		case 5:
...
void func_140(Any* panParam0, int iParam1, BOOL bParam2) // Position - 0xAF96
{
	int i;
...
BOOL func_141(int iParam0) // Position - 0xB08B
{
	switch (iParam0)
	{
		case 5:
...
void func_143(BOOL bParam0, BOOL bParam1, BOOL bParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB135
{
	if (bParam0)
	{
...
Player func_146(Hash hParam0, BOOL bParam1) // Position - 0xB2F5
{
	Player player;
	Hash hash;
...
BOOL func_147(int iParam0) // Position - 0xB336
{
	int num;
...
BOOL func_148(int iParam0) // Position - 0xB358
{
...
int func_150(int iParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0xB3A5
{
	int num;
...
BOOL func_153(var uParam0) // Position - 0xB422
{
...
BOOL _CONVERSATION_IS_DIALOGUE_IN_PROGRESS() // Position - 0xB4C6
{
...
BOOL func_159(var uParam0, float fParam1, int iParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB555
{
...
void func_160(var uParam0) // Position - 0xB5AC
{
	if (!unk_0x1C2F771CDC87A3A5(uParam0, 0))
...
BOOL func_167(int iParam0) // Position - 0xB8B9
{
	if (iParam0 == 1)
...
BOOL func_169(int iParam0) // Position - 0xB91F
{
...
BOOL func_170(int iParam0) // Position - 0xB960
{
	int num;
...
int func_172(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4) // Position - 0xB9D7
{
	int i;
...
void func_173(int iParam0, int iParam1) // Position - 0xBB0E
{
	int i;
...
BOOL _CAN_ENTER_FREEROAM_STATE(int iParam0) // Position - 0xBB5D
{
	return func_175(iParam0, Global_43922);
}

BOOL func_175(int iParam0, int iParam1) // Position - 0xBB6E
{
	if (iParam1 == 15)
		return 1;
...
BOOL func_176(int iParam0) // Position - 0xBD4F
{
	if (Global_43922 == 15)
		return false;
...
BOOL _IS_MISSION_REPLAY_IN_PROGRESS() // Position - 0xBDCB
{
	if (Global_101392 == 10 || Global_101392 == 9)
		return true;
...
void func_180(int iParam0, var uParam1) // Position - 0xBDEF
{
	switch (iParam0)
	{
		case 0:
...
var func_181(float fParam0, float fParam1, float fParam2, int iParam3) // Position - 0xC261
{
	var unk;
...
var func_182(BOOL bParam0, var uParam1, var uParam2) // Position - 0xC28D
{
	if (bParam0)
		return uParam1;
...
BOOL func_183(int iParam0) // Position - 0xC2A4
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_184(var uParam0, int iParam1) // Position - 0xC333
{
	switch (uParam0->f_16)
	{
		case 0:
...
BOOL func_186(var uParam0) // Position - 0xCB31
{
	float num;
...
void func_187(int iParam0, var uParam1) // Position - 0xCBBF
{
	if (iParam0 == 1)
	{
		if (!func_139(uParam1))
...
BOOL func_188(BOOL bParam0) // Position - 0xCC23
{
	var unk;
...
BOOL func_189(int iParam0) // Position - 0xCCBA
{
	eCharacter character;
...
BOOL func_190() // Position - 0xD3D7
{
	return Global_101431.f_1;
}

BOOL func_191() // Position - 0xD3E5
{
	if (Global_98294 != -1)
...
BOOL func_195(int iParam0, int iParam1) // Position - 0xD45D
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_196() // Position - 0xD495
{
	return Global_1575079;
}

BOOL func_197() // Position - 0xD4A1
{
	if (!unk_0x76CD105BCAC6EB9F())
...
int func_198(var uParam0, var uParam1, var uParam2, var uParam3, char* sParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, int iParam9) // Position - 0xD4BD
{
	var unk;

	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(unk_0x4A8C381C258A124D()) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_28[0]) && !_CONVERSATION_IS_DIALOGUE_IN_PROGRESS() && unk_0x1DD05E817C89C737() - uParam0->f_60 > iParam8 && func_202(unk_0x4A8C381C258A124D(), uParam1, 1) < iParam9)
	{
		unk = 16;
...
void _CONVERSATION_ADD_LINE_NO_SUBTITLE(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xD545
{
...
void func_200(var uParam0, eCharacter echParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xD580
{
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, var uParam2, char* sParam3, int iParam4, int iParam5) // Position - 0xD5D6
{
...
float func_202(var uParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0xD671
{
	var unk;
...
int func_203(var uParam0, var uParam1, var uParam2, var uParam3, char* sParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, char* sParam9, var uParam10) // Position - 0xD6AB
{
	var unk;
...
BOOL func_205(char* sParam0) // Position - 0xD803
{
	var unk;
...
void func_207(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) // Position - 0xD847
{
	if (unk_0x75EAB09F5E974116(unk_0x259BE71D8A81D4FA()))
	{
...
void func_210(var uParam0, int iParam1) // Position - 0xD9AD
{
	BOOL flag;
	int i;
...
void func_212(var uParam0) // Position - 0xDA57
{
	unk_0xB479965CBAA3EAE1(0);
	unk_0xDD291722ADDCBD60();
	func_213(uParam0);
...
void func_213(var uParam0) // Position - 0xDA6E
{
	BOOL flag;
	int num;
	int i;
...
void func_216(var uParam0) // Position - 0xDE82
{
	var unk;
...
void func_217(var uParam0) // Position - 0xDF1F
{
...
BOOL func_218(float fParam0, float fParam1, float fParam2, var uParam3, var uParam4, var uParam5, int iParam6) // Position - 0xDF4A
{
	if (iParam6 < 0f)
		iParam6 = 0f;
...
BOOL func_219(var uParam0) // Position - 0xDF83
{
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0))
		if (unk_0xD9F5E1FEFD1329E4(uParam0, 0))
...
BOOL IS_RC_FINE_AND_IN_RANGE(Any* panParam0, BOOL bParam1) // Position - 0xDFE0
{
	var unk;
...
void func_222(int iParam0, var uParam1, int iParam2) // Position - 0xE250
{
	...
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(iParam0))
	{
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_224(uParam1) || !unk_0x13CCB1AD131C1082(iParam0, *uParam1, uParam1->f_2, 3))
				{
					if (func_223(iParam2) && !unk_0x3644984C9D7B57EF(iParam0, unk_0x4A8C381C258A124D(), 25f))
					{
						unk_0x0E95B96CFEFE7B61(iParam0, unk_0x4A8C381C258A124D(), 0);
						uParam1->f_3 = 5;
					}
					else if (func_224(uParam1) && uParam1->f_4 == 0 && unk_0xED977E2AE2CB16EE(unk_0xD1A6A821F5AC81DB(unk_0x4A8C381C258A124D(), 1), unk_0xD1A6A821F5AC81DB(iParam0, 1), 1) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
			...
			case 5:
				if (!func_223(iParam2) || unk_0x3644984C9D7B57EF(iParam0, unk_0x4A8C381C258A124D(), 10f))
				{
					if (func_71(uParam1->f_5, 0f, 0f, 0f, false))
						unk_0x10425721983AE158(iParam0, *uParam1, uParam1->f_1, 8f, -8f, -1, 262153, 0, 0, 0, 0);
					else
...
BOOL func_223(int iParam0) // Position - 0xE5A8
{
...
BOOL func_224(var uParam0) // Position - 0xE5C8
{
...
BOOL func_225(var uParam0) // Position - 0xE5E0
{
...
BOOL CHECK_VEHICLES_OK(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0xE685
{
	int i;
	int num;
	var unk;
...
BOOL func_228(var uParam0, var uParam1) // Position - 0xE843
{
	var unk;
...
BOOL func_229(var uParam0, BOOL bParam1, int iParam2) // Position - 0xE873
{
	int i;
	int num;
...
BOOL func_230(int iParam0) // Position - 0xEB2F
{
...
BOOL func_231(var uParam0, int iParam1) // Position - 0xEB63
{
	float num;
...
BOOL func_232(var uParam0, int iParam1) // Position - 0xEBD9
{
	return func_233(uParam0, unk_0x4A8C381C258A124D(), iParam1, 1, 250, 7);
}

BOOL func_233(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xEBF1
{
	BOOL flag;
	var unk;
	int num;
...
BOOL func_234(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, int iParam7) // Position - 0xECB2
{
	var unk;
	var unk2;
	var unk5;
...
Vector3 func_235(var uParam0, int iParam1) // Position - 0xEDDE
{
	int num;
...
BOOL func_237(var uParam0, var uParam1, int iParam2, int iParam3) // Position - 0xEEED
{
	var unk;
	var unk4;
	float num;
...
float func_238(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0xEF7E
{
	return (fParam0 * uParam3) + (fParam0.f_1 * uParam3.f_1) + (fParam0.f_2 * uParam3.f_2);
}

Vector3 func_239(float fParam0, var uParam1, var uParam2) // Position - 0xEF9F
{
	float num;
	float num2;
...
int func_241(var uParam0, var uParam1) // Position - 0xEFF9
{
	int i;
...
int func_242(var uParam0) // Position - 0xF038
{
...
BOOL func_243(var uParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xF060
{
	float num;
	float num2;
	int num3;
...
BOOL func_244(var uParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0xF15B
{
	float num;
	float num2;
...
BOOL func_245(var uParam0, float fParam1) // Position - 0xF267
{
	var unk;
	var unk2;
...
BOOL func_246(var uParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xF2FC
{
	var unk;
	var unk4;
	float num;
...
BOOL func_247(var uParam0, BOOL bParam1, float fParam2, float fParam3) // Position - 0xF38A
{
	if (bParam1)
		if (unk_0x65F146FF416F109F(unk_0x4A8C381C258A124D()))
...
BOOL func_248(int iParam0) // Position - 0xF3D2
{
...
BOOL func_249(int iParam0) // Position - 0xF41C
{
	if (iParam0 == -1)
		iParam0 = func_177();
...
BOOL func_250(int iParam0) // Position - 0xF4B1
{
...
BOOL func_253(int iParam0) // Position - 0xF530
{
...
BOOL func_255(int iParam0) // Position - 0xF5A2
{
...
BOOL func_258(var uParam0) // Position - 0xF657
{
	int num;
	int i;
	BOOL flag;
...
void func_259(var uParam0, var uParam1, float fParam2, float fParam3, float fParam4, float fParam5) // Position - 0xF97A
{
	func_260(uParam0);
...
void func_260(var uParam0) // Position - 0xF9BD
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
BOOL func_261(var uParam0, eCharacter echParam1, float fParam2, float fParam3, float fParam4, float fParam5, char* sParam6, int iParam7) // Position - 0xFA59
{
...
BOOL func_262(var uParam0, eCharacter echParam1, var uParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0xFAB5
{
	int num;
...
int func_263(int iParam0, eCharacter echParam1) // Position - 0xFB43
{
	int num;
...
void func_264(var uParam0, var uParam1, float fParam2, float fParam3, float fParam4, float fParam5) // Position - 0xFB89
{
	func_217(uParam0);
...
BOOL func_265(var uParam0) // Position - 0xFBB0
{
	if (func_225(uParam0))
	{
...
BOOL func_266(var uParam0) // Position - 0xFBDA
{
	int i;
...
BOOL func_268(var uParam0) // Position - 0xFC47
{
	int num;
	int i;
...
BOOL func_269(var uParam0) // Position - 0xFD5A
{
	int num;
	int i;
	BOOL flag;
	...
	switch (iLocal_89)
	{
		...
		case 1:
			...
			if (!func_266(&num) || !unk_0xE100DD4F82A51BDE("rcmminute1"))
				return false;
...
void func_270(var uParam0, var uParam1) // Position - 0x1007F
{
	if (unk_0xFC8BFE4B41177C22(uParam0))
	{
...
BOOL func_271(int iParam0) // Position - 0x100B5
{
	var unk;
	eCharacter character;
...
BOOL func_272(int iParam0) // Position - 0x10106
{
	var unk;
...
BOOL func_273(int iParam0) // Position - 0x101BF
{
	var unk;
...
BOOL func_274(int iParam0) // Position - 0x10280
{
	int i;
	var unk;
	int num;
...
BOOL func_276(int iParam0) // Position - 0x103E7
{
...
BOOL func_277(int iParam0) // Position - 0x10412
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_278(int iParam0) // Position - 0x1043D
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_279(int iParam0) // Position - 0x10468
{
	if (func_250(iParam0))
		return false;
	else if (!unk_0x4FAFF4BCB7633475(unk_0x4A8C381C258A124D()))
...
BOOL func_281(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, float fParam5) // Position - 0x104B7
{
	int i;
...
BOOL func_282(int iParam0, var uParam1, var uParam2, var uParam3, float fParam4, var uParam5) // Position - 0x1051C
{
	int num;
	char* str;
...
BOOL func_283(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7) // Position - 0x10594
{
	if (fParam6 < 0f)
		fParam6 = 0f;
...
void func_284(var uParam0, BOOL bParam1) // Position - 0x1060F
{
	char* str;
...
void func_292(var uParam0, BOOL bParam1) // Position - 0x107F2
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (unk_0x5B9219522937741D(*uParam0))
...
void func_295(var uParam0) // Position - 0x1087C
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
void func_298(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x10907
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (!unk_0x4FAFF4BCB7633475(*uParam0))
...
void func_299(var uParam0) // Position - 0x10957
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (!unk_0x1C2F771CDC87A3A5(*uParam0, 0))
...
void func_300(int iParam0) // Position - 0x10998
{
	if (*iParam0 == -1)
		return;
...
int func_304(eCharacter echParam0) // Position - 0x10A34
{
	if (!func_36(echParam0))

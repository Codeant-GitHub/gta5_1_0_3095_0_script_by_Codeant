...
void main() // Position - 0x0
{
	...
	while (true)
	{
		...
		func_224(num);
		func_217(&iLocal_91, &(num.f_9), unk61);
	
		if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(num.f_28[0]))
			if (num == 2)
				if (func_214(&num, unk_0xD1A6A821F5AC81DB(num.f_28[0], 1), "BARY1AU", "BARY1_PRELEA", 5, "BARRY", 10000, 23f))
					func_213(&num, uLocal_95, true, 0);
			else if (num == 3)
				func_214(&num, unk_0xD1A6A821F5AC81DB(num.f_28[0], 1), "BARY2AU", "BARY2_AMB", 3, "BARRY", 10000, 23f);
			else if (num == 4)
				func_199(&uLocal_103, unk_0xD1A6A821F5AC81DB(num.f_28[0], 1), "BARR3AU", "BARRY3_AMB");
...
int func_49(int iParam0, Hash hParam1) // Position - 0x3989
{
	var unk;
	int num;
...
Hash func_51(Hash hParam0) // Position - 0x39CD
{
	Hash hash;
	Hash hash2;
...
Hash func_52() // Position - 0x3A01
{
	return Global_1574925;
}

BOOL func_53(int iParam0, Hash hParam1) // Position - 0x3A0D
{
	var unk;
	BOOL num;
...
var func_54(int iParam0, Hash hParam1) // Position - 0x3A31
{
...
BOOL func_69(var uParam0, var uParam1, var uParam2, char* sParam3, float fParam4, float fParam5, float fParam6) // Position - 0x5E59
{
	var unk;
	var unk2;
...
BOOL func_71(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0x661C
{
	if (bParam6)
...
BOOL func_72(var uParam0) // Position - 0x6663
{
...
BOOL func_74(int iParam0, int iParam1, BOOL bParam2) // Position - 0x66CE
{
	if (iParam0 == -1)
		return false;
...
BOOL func_77(int iParam0) // Position - 0x6AE1
{
	return func_74(iParam0, 5, true);
}

int func_78(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x6AF1
{
	int i;
	float num;
	float num2;
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x7608
{
...
Vector3 func_83(float fParam0, float fParam1, float fParam2) // Position - 0x7632
{
...
BOOL func_85(Player plParam0) // Position - 0x765E
{
...
BOOL func_87(int iParam0, int iParam1, var uParam2, int iParam3, BOOL bParam4) // Position - 0x7760
{
	var unk;
	var unk7;
	var unk13;
...
Vector3 func_88(float fParam0, var uParam1, var uParam2, float fParam3) // Position - 0x77F5
{
	float num;
	float num2;
	float num3;
...
BOOL func_92(int iParam0, var uParam1) // Position - 0x8494
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_93(Player plParam0) // Position - 0x8516
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
...
Player _INVALID_PLAYER_INDEX() // Position - 0x856E
{
	return -1;
}
...
BOOL func_98(int iParam0) // Position - 0x8810
{
...
int func_106(int iParam0) // Position - 0x8D59
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * IS_BIT_SET(iParam0, 31) ? -1 : 1) + 2011;
}

var func_107(BOOL bParam0, var uParam1, var uParam2) // Position - 0x8D7B
{
	if (bParam0)
		return uParam1;
...
int func_108(int iParam0) // Position - 0x8D92
{
	return iParam0 & 15;
}
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER_0() // Position - 0x8E50
{
	func_58();
	return Global_114370.f_2366.f_539.f_4321;
}
...
void func_116(char* sParam0, var uParam1, int iParam2) // Position - 0x8EEE
{
...
BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0x8F30
{
...
BOOL func_122(Any* panParam0) // Position - 0xA9C3
{
	int num;
...
void func_126(Vehicle veParam0) // Position - 0xAB61
{
	int num;
	int num2;
	int num3;
...
int func_128(Vehicle veParam0) // Position - 0xAC3D
{
	int i;
...
BOOL func_132(int iParam0, int iParam1, int iParam2) // Position - 0xAD36
{
...
int func_134(Vehicle veParam0) // Position - 0xAD9D
{
	int i;
...
BOOL func_135(var uParam0) // Position - 0xADE6
{
...
BOOL func_136(int iParam0) // Position - 0xAE06
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_138(int iParam0) // Position - 0xAED6
{
	switch (iParam0)
	{
		case 5:
...
void func_139(Any* panParam0, int iParam1, BOOL bParam2) // Position - 0xAF29
{
	int i;
...
BOOL func_140(int iParam0) // Position - 0xB01E
{
	switch (iParam0)
	{
		case 5:
...
void func_142(BOOL bParam0, BOOL bParam1, BOOL bParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB0C8
{
	if (bParam0)
	{
...
Player func_145(Hash hParam0, BOOL bParam1) // Position - 0xB288
{
	Player player;
	Hash hash;
...
BOOL func_146(int iParam0) // Position - 0xB2C9
{
	int num;
...
BOOL func_147(int iParam0) // Position - 0xB2EB
{
...
int func_149(int iParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0xB338
{
	int num;
...
BOOL func_152(var uParam0) // Position - 0xB3B5
{
...
BOOL _CONVERSATION_IS_DIALOGUE_IN_PROGRESS() // Position - 0xB459
{
...
BOOL func_158(var uParam0, float fParam1, int iParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB4E8
{
...
void func_159(var uParam0) // Position - 0xB53F
{
	if (!unk_0x1C2F771CDC87A3A5(uParam0, 0))
...
BOOL func_166(int iParam0) // Position - 0xB84C
{
	if (iParam0 == 1)
...
BOOL func_169(int iParam0) // Position - 0xB8F3
{
	int num;
...
int func_171(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4) // Position - 0xB96A
{
	int i;
...
void func_172(int iParam0, int iParam1) // Position - 0xBAA1
{
	int i;
...
BOOL _CAN_ENTER_FREEROAM_STATE(int iParam0) // Position - 0xBAF0
{
	return func_174(iParam0, Global_43922);
}

BOOL func_174(int iParam0, int iParam1) // Position - 0xBB01
{
	if (iParam1 == 15)
		return 1;
...
BOOL func_175(int iParam0) // Position - 0xBCE2
{
	if (Global_43922 == 15)
		return false;
...
BOOL _IS_MISSION_REPLAY_IN_PROGRESS() // Position - 0xBD5E
{
	if (Global_101392 == 10 || Global_101392 == 9)
		return true;
...
void func_179(int iParam0, var uParam1) // Position - 0xBD82
{
	switch (iParam0)
	{
		case 0:
...
var func_180(float fParam0, float fParam1, float fParam2, int iParam3) // Position - 0xC1F5
{
	var unk;
...
var func_181(BOOL bParam0, var uParam1, var uParam2) // Position - 0xC221
{
	if (bParam0)
		return uParam1;
...
BOOL func_182(int iParam0) // Position - 0xC238
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_183(var uParam0, int iParam1) // Position - 0xC2C7
{
	switch (uParam0->f_16)
	{
		case 0:
...
BOOL func_185(var uParam0) // Position - 0xCAC5
{
	float num;
...
void func_186(int iParam0, var uParam1) // Position - 0xCB53
{
	if (iParam0 == 1)
	{
		if (!func_138(uParam1))
...
BOOL func_187(BOOL bParam0) // Position - 0xCBB7
{
	var unk;
...
BOOL func_188(var uParam0) // Position - 0xCC4E
{
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0))
		if (unk_0xD9F5E1FEFD1329E4(uParam0, 0))
...
BOOL func_189(int iParam0) // Position - 0xCC78
{
	eCharacter character;
		...
		if (unk_0xFC8BFE4B41177C22(unk_0x4A8C381C258A124D()))
		{
			if (!unk_0x4FAFF4BCB7633475(unk_0x4A8C381C258A124D()))
			{
				...
				switch (iParam0)
				{
					...
					case 3:
						if (unk_0x8BF5256C439DF778(unk_0x4A8C381C258A124D()) || unk_0x9857C978BD3CBEDA(unk_0x4A8C381C258A124D()) || unk_0x6652E84A43F51B8B(unk_0x259BE71D8A81D4FA(), 1) || unk_0x1B32E388988DD296(unk_0x4A8C381C258A124D(), 0) || func_197() || Global_113417 || Global_32831 || func_196() || func_195(8, -1) || func_100() || func_194() || func_192() || Global_114370.f_7691.f_919[character] == 5)
							return false;
						break;
				
					case 4:
						if (func_197() || unk_0xE7B45027762DEFE7(unk_0x259BE71D8A81D4FA()) > 0 || func_195(8, -1) || func_192() || func_191() || Global_114370.f_7691.f_919[character] == 5)
							return false;
						break;
...
BOOL func_190() // Position - 0xD395
{
	return Global_101431.f_1;
}

BOOL func_191() // Position - 0xD3A3
{
	if (Global_98294 != -1)
...
BOOL func_196() // Position - 0xD453
{
	return Global_1575079;
}

BOOL func_197() // Position - 0xD45F
{
	if (!unk_0x76CD105BCAC6EB9F())
...
BOOL func_198(int iParam0) // Position - 0xD47B
{
	switch (iParam0)
	{
		case 5:
...
void func_199(var uParam0, var uParam1, var uParam2, var uParam3, char* sParam4, char* sParam5) // Position - 0xD49E
{
	switch (*uParam0)
	{
		case 0:
		...
		case 1:
			if (func_212(unk_0x4A8C381C258A124D(), uParam1, 1) <= 20f)
		...
		case 2:
			...
			else if (func_212(unk_0x4A8C381C258A124D(), uParam1, 1) >= 25f)
			{
				func_153();
				*uParam0 = 0;
			}
...
BOOL _CONVERSATION_ADD_LINE(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0xD53B
{
...
BOOL func_201(char* sParam0, int iParam1, BOOL bParam2) // Position - 0xD589
{
	Global_22167 = 0;
...
BOOL func_205(int iParam0, int iParam1) // Position - 0xD901
{
...
void _UPDATE_CURRENT_PLAYER_CHARACTER() // Position - 0xDA79
{
	if (func_59(14))
	{
		if (!unk_0x1C2F771CDC87A3A5(unk_0x4A8C381C258A124D(), 0))
...
void func_211(var uParam0, eCharacter echParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xDB73
{
...
float func_212(var uParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0xDBC9
{
	var unk;
...
void func_213(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, BOOL bParam9, int iParam10) // Position - 0xDC03
{
	var unk;
	int num;
...
BOOL func_214(var uParam0, var uParam1, var uParam2, var uParam3, char* sParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9) // Position - 0xDCA0
{
	var unk;

	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(unk_0x4A8C381C258A124D()) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_28[0]) && !_CONVERSATION_IS_DIALOGUE_IN_PROGRESS() && unk_0x1DD05E817C89C737() - uParam0->f_60 > iParam8 && func_212(unk_0x4A8C381C258A124D(), uParam1, 1) < fParam9)
	{
		unk = 16;
...
void _CONVERSATION_ADD_LINE_NO_SUBTITLE(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xDD28
{
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(int iParam0) // Position - 0xDD63
{
	if (unk_0xFC8BFE4B41177C22(iParam0))
...
void func_217(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) // Position - 0xDD84
{
	if (unk_0x75EAB09F5E974116(unk_0x259BE71D8A81D4FA()))
	{
		if (!unk_0xD6F9DEE4765092A9(uParam1))
		{
			...
			{
				if (func_212(unk_0x4A8C381C258A124D(), uParam2, 1) <= 100f)
					func_220(uParam0, 1);
			}
			else
			{
				...
				if (func_212(unk_0x4A8C381C258A124D(), uParam2, 1) > 120f)
					func_222(uParam0);
			}
		}
	}
...
void func_220(var uParam0, int iParam1) // Position - 0xDEEA
{
	BOOL flag;
	int i;
...
void func_222(var uParam0) // Position - 0xDF94
{
	unk_0xB479965CBAA3EAE1(0);
	unk_0xDD291722ADDCBD60();
	func_223(uParam0);
...
void func_223(var uParam0) // Position - 0xDFAB
{
	BOOL flag;
	int num;
	int i;
...
BOOL IS_RC_FINE_AND_IN_RANGE(Any* panParam0, BOOL bParam1) // Position - 0xE0BB
{
	var unk;
...
BOOL func_227(int iParam0) // Position - 0xE683
{
...
BOOL func_228(var uParam0) // Position - 0xE6A3
{
...
BOOL func_229(var uParam0) // Position - 0xE6BB
{
...
void func_231(var uParam0) // Position - 0xE9E4
{
...
BOOL CHECK_VEHICLES_OK(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0xEA8F
{
	int i;
	int num;
	var unk;
...
BOOL func_234(var uParam0, var uParam1) // Position - 0xEC4D
{
	var unk;
...
BOOL func_235(var uParam0, BOOL bParam1, int iParam2) // Position - 0xEC7D
{
	int i;
	int num;
...
BOOL func_236(int iParam0) // Position - 0xEF39
{
...
BOOL func_237(var uParam0, int iParam1) // Position - 0xEF6D
{
	float num;
...
BOOL func_238(var uParam0, int iParam1) // Position - 0xEFE3
{
	return func_239(uParam0, unk_0x4A8C381C258A124D(), iParam1, 1, 250, 7);
}

BOOL func_239(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xEFFB
{
	BOOL flag;
	var unk;
	int num;
...
BOOL func_240(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, int iParam7) // Position - 0xF0BC
{
	var unk;
	var unk2;
	var unk5;
...
Vector3 func_241(var uParam0, int iParam1) // Position - 0xF1E8
{
	int num;
...
BOOL func_243(var uParam0, var uParam1, int iParam2, int iParam3) // Position - 0xF2F7
{
	var unk;
	var unk4;
	float num;
...
float func_244(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0xF388
{
	return (fParam0 * uParam3) + (fParam0.f_1 * uParam3.f_1) + (fParam0.f_2 * uParam3.f_2);
}

Vector3 func_245(float fParam0, var uParam1, var uParam2) // Position - 0xF3A9
{
	float num;
	float num2;
...
int func_247(var uParam0, var uParam1) // Position - 0xF403
{
	int i;
...
int func_248(var uParam0) // Position - 0xF442
{
...
BOOL func_249(var uParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xF46A
{
	float num;
	float num2;
	int num3;
...
BOOL func_250(var uParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0xF565
{
	float num;
	float num2;
...
BOOL func_251(var uParam0, float fParam1) // Position - 0xF671
{
	var unk;
	var unk2;
...
BOOL func_252(var uParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xF706
{
	var unk;
	var unk4;
	float num;
...
BOOL func_253(var uParam0, BOOL bParam1, float fParam2, float fParam3) // Position - 0xF794
{
	if (bParam1)
		if (unk_0x65F146FF416F109F(unk_0x4A8C381C258A124D()))
...
BOOL func_254(int iParam0) // Position - 0xF7DC
{
...
void func_255(var uParam0) // Position - 0xF826
{
	var unk;
...
BOOL func_256(int iParam0) // Position - 0xF8C3
{
	if (iParam0 == -1)
		iParam0 = func_176();
...
BOOL func_257(int iParam0) // Position - 0xF958
{
...
BOOL func_260(int iParam0) // Position - 0xF9D7
{
...
BOOL func_262(int iParam0) // Position - 0xFA49
{
...
void func_263() // Position - 0xFA71
{
	...
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(unk_0x4A8C381C258A124D()))
		if (func_264(unk_0x4A8C381C258A124D(), unk, num, 1))
			func_161();

	return;
}

BOOL func_264(var uParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xFAB4
{
	return SYSTEM::VDIST2(unk_0xD1A6A821F5AC81DB(uParam0, iParam5), vParam1) <= fParam4 * fParam4;
}

void func_265(var uParam0) // Position - 0xFAD2
{
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_28[0]))
	{
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, var uParam2, char* sParam3, int iParam4, int iParam5) // Position - 0xFBDC
{
...
BOOL func_272(var uParam0) // Position - 0xFDDE
{
	uParam0->f_16 = 3;
...
BOOL func_273(var uParam0) // Position - 0xFE09
{
	int num;
	var unk4;
	var unk7;
	...
	switch (iLocal_89)
	{
		...
		case 2:
			...
			{
				func_274(&uParam0->f_41[0], num[1], unk4 + unk10, 0f);
...
void func_274(var uParam0, var uParam1, float fParam2, float fParam3, float fParam4, float fParam5) // Position - 0x10090
{
	func_231(uParam0);
...
void func_275(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, float fParam5) // Position - 0x100B7
{
	func_276(uParam0);
...
void func_276(var uParam0) // Position - 0x100FA
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
BOOL func_277(var uParam0) // Position - 0x10196
{
	int i;
...
BOOL func_278(var uParam0) // Position - 0x101C7
{
	int num;
	var unk5;
	var unk8;
	...
	switch (iLocal_89)
	{
		...
		case 2:
			...
			if (!unk_0xFC8BFE4B41177C22(uParam0->f_41[0]))
			{
				func_274(&uParam0->f_41[0], num[1], unk5 + unk8, 0f);
			...
			if (!unk_0xFC8BFE4B41177C22(uParam0->f_35[1]))
				func_275(&uParam0->f_35[1], num[2], unk11, num3);
		
			if (!unk_0xFC8BFE4B41177C22(uParam0->f_28[0]))
				func_279(&uParam0->f_28[0], num[3], unk11, num3, 6);
		
			if (!unk_0xFC8BFE4B41177C22(uParam0->f_28[1]))
				func_279(&uParam0->f_28[1], num[3], unk11, num3, 6);
...
void func_279(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, float fParam5, int iParam6) // Position - 0x10517
{
	func_280(uParam0);
...
void func_280(var uParam0) // Position - 0x10538
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (!unk_0x1C2F771CDC87A3A5(*uParam0, 0))
...
BOOL func_281(var uParam0) // Position - 0x10579
{
	int num;
	var unk3;
	float num2;
...
BOOL func_282(var uParam0, eCharacter echParam1, var uParam2, var uParam3, var uParam4, float fParam5, char* sParam6, int iParam7) // Position - 0x10771
{
	if (func_283(uParam0, echParam1, uParam2, fParam5, true))
	{
		if (unk_0xFC8BFE4B41177C22(*uParam0))
		{
			if (!unk_0x1C2F771CDC87A3A5(*uParam0, 0))
...
BOOL func_283(var uParam0, eCharacter echParam1, var uParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0x107CD
{
	int num;

	if (!func_36(echParam1))
	{
		num = func_325(echParam1);
...
int func_284(int iParam0, eCharacter echParam1) // Position - 0x1085B
{
	int num;
...
BOOL func_285(var uParam0) // Position - 0x108A1
{
	if (func_229(uParam0))
	{
...
BOOL func_287(var uParam0) // Position - 0x10907
{
	int num;
	var unk6;
	float num2;
	...
	switch (iLocal_89)
	{
		...
		case 2:
			...
			if (!unk_0xFC8BFE4B41177C22(uParam0->f_28[0]))
				if (func_282(&uParam0->f_28[0], CHAR_BARRY, unk6, num2, "RC LAUNCHER: BARRY 2", 1))
					unk_0x7F08C4791E6D6969(uParam0->f_28[0], 1, 0, 0, 0, 1);
				else
					flag = false;
...
void func_288(var uParam0, var uParam1) // Position - 0x10CA6
{
	var unk;
	float num;
	...
	num = 23.45f;
	func_274(uParam0, uParam1, unk, num);
	return;
}
...
BOOL func_290(var uParam0) // Position - 0x10CE6
{
	int num;
	var unk8;
	float num2;
	...
	switch (iLocal_89)
	{
		...
		case 2:
			...
			if (!unk_0xFC8BFE4B41177C22(uParam0->f_28[0]))
				if (func_282(&uParam0->f_28[0], CHAR_BARRY, unk8, num2, "RC LAUNCHER: BARRY 1", 1))
					unk_0x7F08C4791E6D6969(uParam0->f_28[0], 1, 0, 0, 0, 1);
				else
					flag = false;
...
BOOL func_291(int iParam0) // Position - 0x11145
{
	var unk;
	eCharacter character;
...
BOOL func_292(int iParam0) // Position - 0x11196
{
	var unk;
...
BOOL func_293(int iParam0) // Position - 0x1124F
{
	var unk;
...
BOOL func_294(int iParam0) // Position - 0x11310
{
	int i;
	var unk;
	int num;
...
BOOL func_296(int iParam0) // Position - 0x11477
{
...
BOOL func_297(int iParam0) // Position - 0x114A2
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_298(int iParam0) // Position - 0x114CD
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_299(int iParam0) // Position - 0x114F8
{
	if (func_257(iParam0))
		return false;
	else if (!unk_0x4FAFF4BCB7633475(unk_0x4A8C381C258A124D()))
...
BOOL func_301(var uParam0, var uParam1, var uParam2, var uParam3, float fParam4) // Position - 0x11547
{
	int num;
	int i;
...
BOOL func_302(int iParam0, var uParam1, var uParam2, var uParam3, float fParam4, var uParam5) // Position - 0x115D8
{
	int num;
	char* str;
...
BOOL func_303(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7) // Position - 0x11650
{
	if (fParam6 < 0f)
		fParam6 = 0f;
...
void func_304(var uParam0, BOOL bParam1) // Position - 0x116CB
{
	char* str;
...
BOOL func_308(char* sParam0) // Position - 0x117B0
{
	var unk;
...
void func_314(var uParam0, BOOL bParam1) // Position - 0x1189A
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (unk_0x5B9219522937741D(*uParam0))
...
void func_317(var uParam0) // Position - 0x11924
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
void func_319(var uParam0, int iParam1) // Position - 0x1196E
{
	...
	for (i = 0; i <= *uParam0 - 1; i = i + 1)
	{
		if (iParam1 == 1)
			...
			func_320(&uParam0->[i], 0, 1, 0);
	}

	return;
}

void func_320(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x119AF
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (!unk_0x4FAFF4BCB7633475(*uParam0))
...
void func_321(int iParam0) // Position - 0x119FF
{
	if (*iParam0 == -1)
		return;
...
int func_325(eCharacter echParam0) // Position - 0x11A9B
{
	if (!func_36(echParam0))

...
void func_50(int iParam0, int iParam1, BOOL bParam2) // Position - 0x1518
{
	...
	if (iParam0 == 1)
	{
		...
		{
			if (bParam2)
				unk_0x0B0C9A0F9AAEB7F0(&(Global_114370.f_10052.f_122), iParam1);
			else
				unk_0x8744D2E3FC95740E(&(Global_114370.f_10052.f_122), iParam1);
		
			return;
		}
	
		if (bParam2)
			unk_0x0B0C9A0F9AAEB7F0(&(Global_114370.f_10052.f_122.f_1), iParam1 - 32);
		else
			unk_0x8744D2E3FC95740E(&(Global_114370.f_10052.f_122.f_1), iParam1 - 32);
	}
	else if (iParam0 == 0)
	{
		if (iParam1 <= 31)
		{
			if (bParam2)
				unk_0x0B0C9A0F9AAEB7F0(&(Global_114370.f_10052.f_125), iParam1);
			else
				unk_0x8744D2E3FC95740E(&(Global_114370.f_10052.f_125), iParam1);
		
			return;
		}
	
		if (bParam2)
			unk_0x0B0C9A0F9AAEB7F0(&(Global_114370.f_10052.f_125.f_1), iParam1 - 32);
		else
			unk_0x8744D2E3FC95740E(&(Global_114370.f_10052.f_125.f_1), iParam1 - 32);
	}

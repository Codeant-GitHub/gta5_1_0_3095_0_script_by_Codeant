...
void main() // Position - 0x0
{
	...
	iLocal_96 = func_307(CHAR_ABIGAIL);
	...
	if (!func_283(&unk230, &num, unk61, 1f))
	{
		func_282();
	...
	while (true)
	{
		...
		func_224(num);
		func_217(&iLocal_98, &(num.f_9), unk61);
		...
		switch (num)
		{
			...
			case 1:
				func_199(&num, unk61, "SONARAU", "SONAR_CALL", 3, "ABIGAIL", 10000, 1101004800);
				break;
		}
...
int func_49(int iParam0, Hash hParam1) // Position - 0x38F8
{
	var unk;
	int num;
...
Hash func_51(Hash hParam0) // Position - 0x393C
{
	Hash hash;
	Hash hash2;
...
Hash func_52() // Position - 0x3970
{
	return Global_1574925;
}

BOOL func_53(int iParam0, Hash hParam1) // Position - 0x397C
{
	var unk;
	BOOL num;
...
var func_54(int iParam0, Hash hParam1) // Position - 0x39A0
{
...
BOOL func_69(var uParam0, var uParam1, var uParam2, char* sParam3, float fParam4, float fParam5, float fParam6) // Position - 0x5DC8
{
	var unk;
	var unk2;
...
BOOL func_71(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0x658B
{
	if (bParam6)
...
BOOL func_72(var uParam0) // Position - 0x65D2
{
...
BOOL func_74(int iParam0, int iParam1, BOOL bParam2) // Position - 0x663D
{
	if (iParam0 == -1)
		return false;
...
BOOL func_77(int iParam0) // Position - 0x6A50
{
	return func_74(iParam0, 5, true);
}

int func_78(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x6A60
{
	int i;
	float num;
	float num2;
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x7577
{
...
Vector3 func_83(float fParam0, float fParam1, float fParam2) // Position - 0x75A1
{
...
BOOL func_85(Player plParam0) // Position - 0x75CD
{
...
BOOL func_87(int iParam0, int iParam1, var uParam2, int iParam3, BOOL bParam4) // Position - 0x76CF
{
	var unk;
	var unk7;
	var unk13;
...
Vector3 func_88(float fParam0, var uParam1, var uParam2, float fParam3) // Position - 0x7764
{
	float num;
	float num2;
	float num3;
...
int func_199(var uParam0, var uParam1, var uParam2, var uParam3, char* sParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, int iParam9) // Position - 0xD408
{
	var unk;
...
void _CONVERSATION_ADD_LINE_NO_SUBTITLE(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xD490
{
...
void func_201(var uParam0, eCharacter echParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xD4CB
{
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, var uParam2, char* sParam3, int iParam4, int iParam5) // Position - 0xD521
{
...
float func_203(var uParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0xD5BC
{
	var unk;
...
void func_204(var uParam0, var uParam1, char* sParam2) // Position - 0xD5F6
{
		...
		switch (*uParam0)
		{
			...
			case 1:
				if (unk_0x1DD05E817C89C737() > uParam0->f_166)
				{
					...
					else if (func_216(unk_0x4A8C381C258A124D(), *uParam1, 1) < 15f)
					{
						*uParam0 = 4;
					}
				}
...
BOOL _CONVERSATION_ADD_LINE(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0xD8F2
{
...
BOOL func_206(char* sParam0, int iParam1, BOOL bParam2) // Position - 0xD940
{
	Global_22167 = 0;
...
BOOL func_210(int iParam0, int iParam1) // Position - 0xDCB8
{
...
void _UPDATE_CURRENT_PLAYER_CHARACTER() // Position - 0xDE30
{
	if (func_59(14))
	{
		if (!unk_0x1C2F771CDC87A3A5(unk_0x4A8C381C258A124D(), 0))
...
float func_216(var uParam0, var uParam1, int iParam2) // Position - 0xDF2A
{
	var unk;
	var unk4;
...
void func_217(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) // Position - 0xDF88
{
	if (unk_0x75EAB09F5E974116(unk_0x259BE71D8A81D4FA()))
	{
...
void func_220(var uParam0, int iParam1) // Position - 0xE0EE
{
	BOOL flag;
	int i;
...
void func_223(var uParam0) // Position - 0xE1AF
{
	BOOL flag;
	int num;
	int i;
...
BOOL IS_RC_FINE_AND_IN_RANGE(Any* panParam0, BOOL bParam1) // Position - 0xE2BF
{
	var unk;
...
BOOL func_227(int iParam0) // Position - 0xE887
{
...
BOOL func_228(var uParam0) // Position - 0xE8A7
{
...
BOOL func_229(var uParam0) // Position - 0xE8BF
{
...
void func_231(var uParam0) // Position - 0xEBE2
{
...
BOOL CHECK_VEHICLES_OK(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0xEC8D
{
	int i;
	int num;
	var unk;
...
BOOL func_234(var uParam0, var uParam1) // Position - 0xEE4B
{
	var unk;
...
BOOL func_235(var uParam0, BOOL bParam1, int iParam2) // Position - 0xEE7B
{
	int i;
	int num;
...
BOOL func_236(int iParam0) // Position - 0xF137
{
...
BOOL func_237(var uParam0, int iParam1) // Position - 0xF16B
{
	float num;
...
BOOL func_238(var uParam0, int iParam1) // Position - 0xF1E1
{
	return func_239(uParam0, unk_0x4A8C381C258A124D(), iParam1, 1, 250, 7);
}

BOOL func_239(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xF1F9
{
	BOOL flag;
	var unk;
	int num;
...
BOOL func_240(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, int iParam7) // Position - 0xF2BA
{
	var unk;
	var unk2;
	var unk5;
...
Vector3 func_241(var uParam0, int iParam1) // Position - 0xF3E6
{
	int num;
...
BOOL func_243(var uParam0, var uParam1, int iParam2, int iParam3) // Position - 0xF4F5
{
	var unk;
	var unk4;
	float num;
...
float func_244(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0xF586
{
	return (fParam0 * uParam3) + (fParam0.f_1 * uParam3.f_1) + (fParam0.f_2 * uParam3.f_2);
}

Vector3 func_245(float fParam0, var uParam1, var uParam2) // Position - 0xF5A7
{
	float num;
	float num2;
...
int func_247(var uParam0, var uParam1) // Position - 0xF601
{
	int i;
...
int func_248(var uParam0) // Position - 0xF640
{
...
BOOL func_249(var uParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xF668
{
	float num;
	float num2;
	int num3;
...
BOOL func_250(var uParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0xF763
{
	float num;
	float num2;
...
BOOL func_251(var uParam0, float fParam1) // Position - 0xF86F
{
	var unk;
	var unk2;
...
BOOL func_252(var uParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xF904
{
	var unk;
	var unk4;
	float num;
...
BOOL func_253(var uParam0, BOOL bParam1, float fParam2, float fParam3) // Position - 0xF992
{
	if (bParam1)
		if (unk_0x65F146FF416F109F(unk_0x4A8C381C258A124D()))
...
BOOL func_254(int iParam0) // Position - 0xF9DA
{
...
void func_255(var uParam0) // Position - 0xFA24
{
	var unk;
...
BOOL func_256(int iParam0) // Position - 0xFAC1
{
	if (iParam0 == -1)
		iParam0 = func_177();
...
BOOL func_257(int iParam0) // Position - 0xFB56
{
...
BOOL func_260(int iParam0) // Position - 0xFBD5
{
...
BOOL func_262(int iParam0) // Position - 0xFC47
{
...
BOOL func_263(var uParam0) // Position - 0xFC6F
{
	switch (*uParam0)
	{
		case 0:
...
BOOL func_264(var uParam0) // Position - 0xFCB6
{
	int num;
	int i;
	BOOL flag;
	...
	switch (iLocal_89)
	{
		...
		case 1:
			if (!func_270(&num) || !unk_0xE100DD4F82A51BDE(sLocal_97))
				return false;
...
void func_265(var uParam0, var uParam1, float fParam2, float fParam3, float fParam4, float fParam5) // Position - 0xFE68
{
	func_266(uParam0);
...
void func_266(var uParam0) // Position - 0xFEAB
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
BOOL func_267(var uParam0, eCharacter echParam1, float fParam2, float fParam3, float fParam4, float fParam5, char* sParam6, int iParam7) // Position - 0xFF47
{
...
BOOL func_268(var uParam0, eCharacter echParam1, var uParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0xFFA3
{
	int num;

	if (!func_36(echParam1))
	{
		num = func_307(echParam1);
...
int func_269(int iParam0, eCharacter echParam1) // Position - 0x10032
{
	int num;
...
BOOL func_270(var uParam0) // Position - 0x10078
{
	int i;
...
BOOL func_272(var uParam0) // Position - 0x100E5
{
	int num;
	BOOL flag;
...
BOOL func_273(int iParam0) // Position - 0x101F0
{
	var unk;
	eCharacter character;
...
BOOL func_274(int iParam0) // Position - 0x10241
{
	var unk;
...
BOOL func_275(int iParam0) // Position - 0x102FA
{
	var unk;
...
BOOL func_276(int iParam0) // Position - 0x103BB
{
	int i;
	var unk;
	int num;
...
BOOL func_278(int iParam0) // Position - 0x10522
{
...
BOOL func_279(int iParam0) // Position - 0x1054D
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_280(int iParam0) // Position - 0x10578
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_281(int iParam0) // Position - 0x105A3
{
	if (func_257(iParam0))
		return false;
	else if (!unk_0x4FAFF4BCB7633475(unk_0x4A8C381C258A124D()))
...
BOOL func_283(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, float fParam5) // Position - 0x105F2
{
	int i;
...
BOOL func_284(int iParam0, var uParam1, var uParam2, var uParam3, float fParam4, var uParam5) // Position - 0x10657
{
	int num;
	char* str;
...
BOOL func_285(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7) // Position - 0x106CF
{
	if (fParam6 < 0f)
		fParam6 = 0f;
...
void func_286(var uParam0, BOOL bParam1) // Position - 0x1074A
{
	char* str;
...
BOOL func_290(char* sParam0) // Position - 0x10821
{
	var unk;
...
void func_295(var uParam0, BOOL bParam1) // Position - 0x108D5
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (unk_0x5B9219522937741D(*uParam0))
...
void func_298(var uParam0) // Position - 0x1095F
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
void func_300(var uParam0, int iParam1) // Position - 0x109A9
{
	...
	for (i = 0; i <= *uParam0 - 1; i = i + 1)
	{
		if (iParam1 == 1)
			...
			func_301(&uParam0->[i], 0, 1, 0);
	}

	return;
}

void func_301(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x109EA
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (!unk_0x4FAFF4BCB7633475(*uParam0))
...
void func_302(var uParam0) // Position - 0x10A3A
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (!unk_0x1C2F771CDC87A3A5(*uParam0, 0))
...
void func_303(int iParam0) // Position - 0x10A7B
{
	if (*iParam0 == -1)
		return;
...
int func_307(eCharacter echParam0) // Position - 0x10B17
{
	if (!func_36(echParam0))

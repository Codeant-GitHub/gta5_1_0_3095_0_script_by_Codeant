...
void func_17(int iParam0) // Position - 0x1B5D
{
	...
	else if (IS_BIT_SET(Global_114370.f_20567.f_471, iParam0) || IS_BIT_SET(Global_2359296[func_19() /*5569*/].f_681.f_10, iParam0))
	{
		flag = true;
		unk_0x8744D2E3FC95740E(&(Global_114370.f_20567.f_471), iParam0);
		unk_0x8744D2E3FC95740E(&(Global_2359296[func_19() /*5569*/].f_681.f_10), iParam0);
	}
...
{
	if (iParam0 == 1)
		unk_0x0B0C9A0F9AAEB7F0(&Global_8683, 24);
	else
		unk_0x8744D2E3FC95740E(&Global_8683, 24);
...
int func_75(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0x2A9A
{
	...
	unk_0x0B0C9A0F9AAEB7F0(&Global_8684, 9);
...
struct<4> func_105(int iParam0, BOOL bParam1, BOOL bParam2, var uParam3) // Position - 0x3DEE
{
	...
	if (!func_110(&(Global_114370.f_19964), 8) && bParam1 && iParam0 != 4 && func_108(3) > 0 && unk_0xD2AA6F822D3A55D2(0, 1065353216) < 0.75f)
	{
		num = 8;
		*uParam3 = 4;
	}
...
{
	if (Global_97833 != 0 && unk_0x1DD05E817C89C737() - Global_97833 < 1800000)
		return false;
	...
	_CONVERSATION_INITIALIZE_ACTOR(uParam0, 0, unk_0x4A8C381C258A124D(), "MICHAEL", 0, 1);
	_CONVERSATION_INITIALIZE_ACTOR(uParam0, 1, 0, "FRIEDLANDER", 0, 1);
	Global_97833 = unk_0x1DD05E817C89C737();
	return true;
}

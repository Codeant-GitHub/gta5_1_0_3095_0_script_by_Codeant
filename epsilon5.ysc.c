...
BOOL func_31(int iParam0, int iParam1, Hash hParam2) // Position - 0x1562
{
	int num;
	int i;
	var unk;
...
int func_34(int iParam0, int iParam1, Hash hParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x17FB
{
	int i;
	int j;
	int k;
...
void func_35(int iParam0, int iParam1, Hash hParam2) // Position - 0x200C
{
	Hash hash;
	int num;
...
BOOL func_36(int iParam0, int iParam1, Hash hParam2) // Position - 0x2096
{
	if (iParam0 == joaat("Player_Zero"))
		if (iParam1 == 4)
...
BOOL func_37(int iParam0, int iParam1, Hash hParam2) // Position - 0x2174
{
	Global_79031[1 /*14*/] = { func_84(iParam0, iParam1, hParam2, -1) };
	return IS_BIT_SET(Global_79031[1 /*14*/].f_6, 2);
}

BOOL func_38(int iParam0, Hash hParam1, int iParam2, Hash hParam3, var uParam4, int iParam5) // Position - 0x219C
{
	var unk;
	int i;
...
BOOL func_39(int iParam0, int iParam1, Hash hParam2) // Position - 0x27A0
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
Hash func_40(var uParam0, int iParam1, int iParam2) // Position - 0x2839
{
	Hash i;
	Hash j;
...
int func_41(int iParam0, int iParam1, Hash hParam2, var uParam3) // Position - 0x28DA
{
	int num;
...
Hash func_42(var uParam0, int iParam1, int iParam2, Hash hParam3, int iParam4, int iParam5) // Position - 0x2BE1
{
	Hash hash;
	Hash hash2;
	Hash hash3;
	...
	if (iParam4 == 0)
	{
		...
		{
			case 2:
				hash2 = func_64(uParam0, 1);
				hash = func_49(iParam1, hParam3, hash2);
				break;
		
			case 1:
				hash3 = func_64(uParam0, 2);
				...
				switch (iParam4)
				{
					...
					case 8:
						if (iParam2 == 11 || iParam2 == 3)
						{
							...
							{
								hash6 = hParam3;
								hash5 = func_64(uParam0, 3);
							}
							else if (iParam2 == 3)
							{
								hash5 = hParam3;
								hash6 = func_64(uParam0, 11);
								hash6 = func_44(iParam1, hash5, hash6, 0);
							}
						
							hash4 = func_64(uParam0, 8);
					...
					case 11:
						if (iParam2 == 3)
						{
							...
							{
								hash8 = func_64(uParam0, 8);
								hash9 = func_64(uParam0, 11);
...
BOOL func_43(int iParam0, Hash hParam1, Hash hParam2, Hash hParam3, var uParam4) // Position - 0x3794
{
	int num;
...
Hash func_44(int iParam0, Hash hParam1, Hash hParam2, int iParam3) // Position - 0x3A78
{
	int num;
...
Hash func_45(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x3D3F
{
	Hash i;
	Hash hash;
...
BOOL func_46(var uParam0, int iParam1, Hash hParam2, Hash hParam3) // Position - 0x3D76
{
	Hash hash;

	hash = func_64(uParam0, iParam1);
...
BOOL func_47(int iParam0, Hash hParam1, var uParam2) // Position - 0x3D9F
{
	*uParam2 = -99;
...
int func_48(int iParam0, int iParam1, Hash hParam2, var uParam3) // Position - 0x406A
{
	int num;
...
Hash func_49(int iParam0, Hash hParam1, Hash hParam2) // Position - 0x42F4
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
void func_50(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x444B
{
	...
	else
	{
		...
		if (iParam1 == 0)
		{
			hash = func_55(uParam0, iParam2, iParam3, iParam1);
		
			if (func_51(unk_0x4B423FAA24E8ABF0(uParam0), 14, hash, unk_0x6B7AEB5F3D578298(uParam0, 0, iParam2, iParam3)))
			{
...
BOOL func_51(int iParam0, int iParam1, Hash hParam2, int iParam3) // Position - 0x44E5
{
	switch (iParam0)
	{
...
int func_52(int iParam0, Hash hParam1, int iParam2, int iParam3) // Position - 0x45B3
{
	var unk;
	int num;
	int num2;
...
Hash func_55(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x4AD5
{
	int num;
	int num2;
	int num3;
...
BOOL func_60(int iParam0, int iParam1, Hash hParam2, int iParam3) // Position - 0x4EAF
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
BOOL func_61(int iParam0, int iParam1, Hash hParam2, int iParam3) // Position - 0x512C
{
	if (iParam0 == joaat("Player_Zero"))
	{
		if (iParam1 == 6)
...
BOOL func_62(int iParam0, int iParam1, Hash hParam2, int iParam3) // Position - 0x5551
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
Hash func_63(var uParam0, int iParam1) // Position - 0x5844
{
	int num;
	var unk;
...
Hash func_64(var uParam0, int iParam1) // Position - 0x588B
{
	int num;
	var unk;
	var unk2;
...
BOOL func_73(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x85CD
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
BOOL func_74(int iParam0) // Position - 0x9470
{
	if (!IS_BIT_SET(Global_79031[1 /*14*/].f_6, 0))
		return false;
...
BOOL func_75(int iParam0, int iParam1, var uParam2, int iParam3) // Position - 0x94B8
{
	int num;
...
struct<10> func_77(int iParam0, Hash hParam1) // Position - 0x9613
{
	int i;
	var unk;
...
void func_78(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x9F42
{
	int num;
	var unk;
	int num2;
...
void func_79(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9) // Position - 0xA06C
{
	uParam0->[0] = iParam1;
	uParam0->[1] = iParam2;
	uParam0->[2] = iParam3;
...
struct<17> func_80(int iParam0, Hash hParam1) // Position - 0xA0B4
{
	int i;
	var unk;
...
void func_83(var uParam0, int iParam1, int iParam2, Hash hParam3, Hash hParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0xC198
{
	uParam0->[0] = iParam1;
	uParam0->[2] = iParam2;
	uParam0->[3] = hParam3;
...
struct<14> func_84(int iParam0, int iParam1, Hash hParam2, int iParam3) // Position - 0xC209
{
	func_148();
...
void func_87(int iParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7, int iParam8, int iParam9, BOOL bParam10) // Position - 0xD57B
{
	int num;
	int num2;
...
BOOL func_91(int iParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0xE517
{
	int num;
	int num2;
	int num3;
...
BOOL func_149(int iParam0, int iParam1, Hash hParam2) // Position - 0x1F975
{
	int num;
	Hash hash;
	int i;
...
int func_152(eCharacter echParam0) // Position - 0x1FC30
{
...
void func_154(var uParam0, int iParam1) // Position - 0x1FC4B
{
...
void func_160(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x202AD
{
...
void func_161(int iParam0, int iParam1, int iParam2) // Position - 0x2034A
{
	var unk;
	var unk33;
...
void func_162(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4) // Position - 0x20389
{
...
BOOL func_195(int iParam0) // Position - 0x26874
{
	int num;
	int i;
...
BOOL func_198(int iParam0) // Position - 0x26AAB
{
...
BOOL func_200(const char* sParam0) // Position - 0x26B12
{
...
int func_202(var uParam0, int iParam1) // Position - 0x26B83
{
	int num;
	var unk;
	var unk33;
...
void func_206(eCharacter echParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x271EE
{
	eCharacter character;
	BOOL flag;
	var unk;
...
char* AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM(int iParam0) // Position - 0x27404
{
	switch (iParam0)
	{
		case 0:
...
char* func_209(int iParam0, var uParam1) // Position - 0x2776F
{
	*uParam1 = 1;
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER() // Position - 0x27B3A
{
	func_156();
...
void func_215(char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9) // Position - 0x27E21
{
	int i;
...
void func_218(var uParam0, int iParam1, BOOL bParam2) // Position - 0x2811E
{
	int i;
...
void func_219(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x28213
{
	var unk;
...
BOOL func_220(var uParam0) // Position - 0x282BD
{
...
void func_221(BOOL bParam0, BOOL bParam1, BOOL bParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0x282DD
{
	if (bParam0)
	{
...
BOOL func_225(int iParam0) // Position - 0x284DE
{
	int num;
...
BOOL func_226(int iParam0) // Position - 0x28500
{
...
int func_228(int iParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0x2854D
{
	int num;
...
BOOL func_229() // Position - 0x28580
{
...
void func_232(var uParam0) // Position - 0x285F5
{
...
BOOL func_233() // Position - 0x28636
{
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(unk_0x4A8C381C258A124D()))
	{
...
void func_234(float fParam0, float fParam1, float fParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, BOOL bParam8, BOOL bParam9, BOOL bParam10, int iParam11, BOOL bParam12) // Position - 0x2866A
{
	var unk;
...
Vector3 _GET_PLAYER_COORDS(var uParam0) // Position - 0x28864
{
...
void func_238(float fParam0, float fParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, float fParam7, float fParam8, float fParam9, float fParam10, var uParam11, var uParam12, var uParam13, BOOL bParam14, BOOL bParam15, BOOL bParam16, BOOL bParam17, BOOL bParam18) // Position - 0x288B6
{
	func_239(fParam0, fParam3, fParam6, fParam7, fParam10, uParam11, bParam14, bParam15, bParam16, bParam17, bParam18);
	return;
}

void func_239(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, var uParam7, var uParam8, var uParam9, float fParam10, float fParam11, var uParam12, var uParam13, BOOL bParam14, BOOL bParam15, BOOL bParam16, BOOL bParam17, BOOL bParam18) // Position - 0x288E0
{
	var unk;
	BOOL flag;
	BOOL flag2;
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x28CD6
{
...
BOOL func_241(var uParam0, eCharacter echParam1, BOOL bParam2) // Position - 0x28D00
{
	int i;
	var unk;
	int num;
...
BOOL func_242(eCharacter echParam0, int iParam1, char* sParam2, var uParam3) // Position - 0x28D6E
{
...
BOOL func_243(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, float fParam7) // Position - 0x28E46
{
	float num;
	var unk3;
	var unk6;
...
BOOL func_244(float fParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, float fParam9, var uParam10, var uParam11) // Position - 0x2913C
{
	float num;
	float num2;
	float num3;
...
Vector3 func_245(float fParam0, var uParam1, var uParam2) // Position - 0x291F0
{
	float num;
	float num2;
...
void func_246(var uParam0) // Position - 0x2922F
{
	if (unk_0xFC8BFE4B41177C22(uParam0))
	{
		if (unk_0xD9F5E1FEFD1329E4(uParam0, 0))
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(var uParam0) // Position - 0x292CB
{
	if (unk_0xFC8BFE4B41177C22(uParam0))
		if (!unk_0x1C2F771CDC87A3A5(uParam0, 0))
			return true;
...
BOOL func_250(int iParam0, int iParam1, int iParam2) // Position - 0x292EC
{
	int num;
...
BOOL _CONVERSATION_IS_DIALOGUE_IN_PROGRESS() // Position - 0x2944A
{
...
BOOL func_256(var uParam0, int iParam1) // Position - 0x294BD
{
	if (func_220(uParam0))
...
BOOL func_257(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6) // Position - 0x294F0
{
...
void func_258(var uParam0) // Position - 0x29547
{
	if (!unk_0x1C2F771CDC87A3A5(uParam0, 0))
...
BOOL _CONVERSATION_ADD_LINE(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x29964
{
...
BOOL func_263(char* sParam0, int iParam1, BOOL bParam2) // Position - 0x299B2
{
	Global_22167 = 0;
...
BOOL func_265() // Position - 0x29CB7
{
...
BOOL func_267(int iParam0, int iParam1) // Position - 0x29D2A
{
	return IS_BIT_SET(Global_1886967[iParam0 /*609*/].f_10.f_4, iParam1);
}

Player _INVALID_PLAYER_INDEX() // Position - 0x29D42
{
	return -1;
}
...
BOOL func_271() // Position - 0x29E11
{
	int num;
	int num2;
...
void _UPDATE_CURRENT_PLAYER_CHARACTER() // Position - 0x29EAA
{
	if (func_92(14))
	{
		if (!unk_0x1C2F771CDC87A3A5(unk_0x4A8C381C258A124D(), 0))
...
void func_275(var uParam0, eCharacter echParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0x29FDB
{
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, var uParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x2A031
{
...
BOOL func_277() // Position - 0x2A0CC
{
...
float func_278(var uParam0, var uParam1, int iParam2) // Position - 0x2A0E5
{
	var unk;
	var unk4;
...
BOOL func_285(int iParam0) // Position - 0x2A2EF
{
	if (iParam0 == 1)
		if (Global_20813.f_1 > 3)
...
void func_287(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10) // Position - 0x2A355
{
	float num;
	int value;
	int num2;
	...
	if (Global_79503 != 6)
	{
		...
		else
		{
			...
			if (value < 9000 && !unk_0x15CCE8886267624F())
			{
				...
				unk = { func_289(Global_79504, Global_79506, iParam10) };
				num4 == -0.014f;
...
float func_288(var uParam0) // Position - 0x2A63A
{
...
BOOL func_298(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) // Position - 0x2AA1B
{
	if (!func_300(0) || Global_79519 || Global_79507 == 1 || !unk_0x9390801B06EE998F())
		return false;
...
BOOL func_300(int iParam0) // Position - 0x2AB5C
{
	if (Global_43922 == 15)
		return false;
...
BOOL _CAN_ENTER_FREEROAM_STATE(int iParam0) // Position - 0x2AB7E
{
	return func_302(iParam0, Global_43922);
}

BOOL func_302(int iParam0, int iParam1) // Position - 0x2AB8F
{
	if (iParam1 == 15)
		return 1;
...
void func_303(eCharacter echParam0, eCharacter echParam1, BOOL bParam2) // Position - 0x2AD70
{
	int num;
...
struct<4> _GET_CHARACTER_NAME(eCharacter character) // Position - 0x2AF69
{
	return Global_2139[character /*29*/].f_3;
}

int func_306(eCharacter echParam0, int iParam1) // Position - 0x2AF7C
{
...
int func_307(eCharacter echParam0, int iParam1) // Position - 0x2AFA6
{
	if (iParam1 < 0 || iParam1 > 4)
		return 0;
...
void func_308(eCharacter echParam0, int iParam1, int iParam2) // Position - 0x2AFD0
{
	if (iParam1 < 0 || iParam1 > 4)
		return;
...
void func_309(eCharacter echParam0, int iParam1, int iParam2) // Position - 0x2B015
{
	if (iParam1 < 0 || iParam1 > 4)
		return;
...
BOOL func_310(var uParam0) // Position - 0x2B05A
{
	int num;
	int i;
	BOOL flag;
...
BOOL func_311(var uParam0, eCharacter echParam1, float fParam2, float fParam3, float fParam4, float fParam5, char* sParam6, int iParam7) // Position - 0x2B1DD
{
...
BOOL func_312(var uParam0, eCharacter echParam1, var uParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0x2B239
{
	int num;
...
int func_313(var uParam0, eCharacter echParam1) // Position - 0x2B2C7
{
	int num;
...
BOOL func_314(var uParam0) // Position - 0x2B30D
{
	if (func_315(uParam0))
	{
...
BOOL func_315(var uParam0) // Position - 0x2B337
{
...
BOOL func_316(var uParam0) // Position - 0x2B35C
{
	int i;
...
BOOL _IS_MISSION_REPLAY_IN_PROGRESS() // Position - 0x2B3C9
{
...
void func_323(var uParam0, BOOL bParam1) // Position - 0x2B4A7
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
void func_324(var uParam0) // Position - 0x2B4E2
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (unk_0x5B9219522937741D(*uParam0))
...
void func_327(var uParam0) // Position - 0x2B55C
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
void func_328(var uParam0) // Position - 0x2B594
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (!unk_0x110821AE6C63DD4F(*uParam0))
...
BOOL func_329(var uParam0) // Position - 0x2B630
{
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0))
		if (unk_0xD9F5E1FEFD1329E4(uParam0, 0))
...
void func_332(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x2B6AD
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (!unk_0x4FAFF4BCB7633475(*uParam0))
...
BOOL func_333() // Position - 0x2B6FD
{
	int num;
...
BOOL func_336(char* sParam0, int iParam1, int iParam2) // Position - 0x2B896
{
	var unk;
	var unk2;
	int num;
...
int func_340(var uParam0, BOOL bParam1) // Position - 0x2BAC9
{
	int i;
...
BOOL func_341() // Position - 0x2BAFF
{
...
BOOL func_342() // Position - 0x2BB4F
{
...
void func_343(int iParam0) // Position - 0x2BBBB
{
...
BOOL func_351() // Position - 0x2BCFD
{
...
int func_356(eCharacter echParam0) // Position - 0x2BE94
{

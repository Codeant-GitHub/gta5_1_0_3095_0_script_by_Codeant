...
void main() // Position - 0x0
{
	...
	if (!func_263(&unk64, &num, unk61, 1f))
	{
		func_262();
	...
	while (true)
	{
		...
		func_209(num);
		func_202(&iLocal_91, &uLocal_92, &(num.f_9), unk61, -1295.84f, 4641.98f, 105.33f, -1301.43f, 4641.21f, 105.62f);
		func_195(&num, unk61, "SAS1AUD", "SAS1_AMB", 4, "HUNTER", 10000);
...
int func_49(int iParam0, Hash hParam1) // Position - 0x3889
{
	var unk;
	int num;
...
Hash func_51(Hash hParam0) // Position - 0x38CD
{
	Hash hash;
	Hash hash2;
...
Hash func_52() // Position - 0x3901
{
	return Global_1574925;
}

BOOL func_53(int iParam0, Hash hParam1) // Position - 0x390D
{
	var unk;
	BOOL num;
...
var func_54(int iParam0, Hash hParam1) // Position - 0x3931
{
...
BOOL func_69(var uParam0, var uParam1, var uParam2, char* sParam3, float fParam4, float fParam5, float fParam6) // Position - 0x5D58
{
	var unk;
	var unk2;
...
BOOL func_71(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0x651B
{
	if (bParam6)
...
BOOL func_72(var uParam0) // Position - 0x6562
{
...
BOOL func_74(int iParam0, int iParam1, BOOL bParam2) // Position - 0x65CD
{
	if (iParam0 == -1)
		return false;
...
BOOL func_77(int iParam0) // Position - 0x69E0
{
	return func_74(iParam0, 5, true);
}

int func_78(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x69F0
{
	int i;
	float num;
	float num2;
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x7507
{
...
Vector3 func_83(float fParam0, float fParam1, float fParam2) // Position - 0x7531
{
...
BOOL func_85(Player plParam0) // Position - 0x755D
{
...
BOOL func_87(int iParam0, int iParam1, var uParam2, int iParam3, BOOL bParam4) // Position - 0x765F
{
	var unk;
	var unk7;
	var unk13;
...
Vector3 func_88(float fParam0, var uParam1, var uParam2, float fParam3) // Position - 0x76F4
{
	float num;
	float num2;
	float num3;
...
BOOL func_92(int iParam0, var uParam1) // Position - 0x8395
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_93(Player plParam0) // Position - 0x8417
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
...
Player _INVALID_PLAYER_INDEX() // Position - 0x846F
{
	return -1;
}
...
BOOL func_98(int iParam0) // Position - 0x8711
{
...
int func_106(int iParam0) // Position - 0x8C5A
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * IS_BIT_SET(iParam0, 31) ? -1 : 1) + 2011;
}

var func_107(BOOL bParam0, var uParam1, var uParam2) // Position - 0x8C7C
{
	if (bParam0)
		return uParam1;
...
int func_108(int iParam0) // Position - 0x8C93
{
	return iParam0 & 15;
}
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER_0() // Position - 0x8D51
{
	func_58();
	return Global_114370.f_2366.f_539.f_4321;
}
...
void func_116(char* sParam0, var uParam1, int iParam2) // Position - 0x8DEF
{
...
BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0x8E31
{
...
BOOL func_122(Any* panParam0) // Position - 0xA8C4
{
	int num;
...
void func_126(Vehicle veParam0) // Position - 0xAA62
{
	int num;
	int num2;
	int num3;
...
int func_128(Vehicle veParam0) // Position - 0xAB3E
{
	int i;
...
BOOL func_132(int iParam0, int iParam1, int iParam2) // Position - 0xAC37
{
...
int func_134(Vehicle veParam0) // Position - 0xAC9E
{
	int i;
...
BOOL func_135(var uParam0) // Position - 0xACE7
{
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(int iParam0) // Position - 0xAD07
{
	if (unk_0xFC8BFE4B41177C22(iParam0))
...
BOOL func_137(int iParam0) // Position - 0xAD28
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_139(int iParam0) // Position - 0xADF8
{
	switch (iParam0)
	{
		case 5:
...
void func_140(Any* panParam0, int iParam1, BOOL bParam2) // Position - 0xAE4B
{
	int i;
...
BOOL func_141(int iParam0) // Position - 0xAF40
{
	switch (iParam0)
	{
		case 5:
...
void func_143(BOOL bParam0, BOOL bParam1, BOOL bParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xAFEA
{
	if (bParam0)
	{
...
Player func_146(Hash hParam0, BOOL bParam1) // Position - 0xB1AA
{
	Player player;
	Hash hash;
...
BOOL func_147(int iParam0) // Position - 0xB1EB
{
	int num;
...
BOOL func_148(int iParam0) // Position - 0xB20D
{
...
int func_150(int iParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0xB25A
{
	int num;
...
BOOL func_153(var uParam0) // Position - 0xB2D7
{
...
BOOL func_159(var uParam0, float fParam1, int iParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB40A
{
...
void func_160(var uParam0) // Position - 0xB461
{
	if (!unk_0x1C2F771CDC87A3A5(uParam0, 0))
...
BOOL func_167(int iParam0) // Position - 0xB76E
{
	if (iParam0 == 1)
...
BOOL func_169(int iParam0) // Position - 0xB7D4
{
...
BOOL func_170(int iParam0) // Position - 0xB815
{
	int num;
...
int func_172(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4) // Position - 0xB88C
{
	int i;
...
void func_173(int iParam0, int iParam1) // Position - 0xB9C3
{
	int i;
...
BOOL _CAN_ENTER_FREEROAM_STATE(int iParam0) // Position - 0xBA12
{
	return func_175(iParam0, Global_43922);
}

BOOL func_175(int iParam0, int iParam1) // Position - 0xBA23
{
	if (iParam1 == 15)
		return 1;
...
BOOL func_176(int iParam0) // Position - 0xBC04
{
	if (Global_43922 == 15)
		return false;
...
BOOL _IS_MISSION_REPLAY_IN_PROGRESS() // Position - 0xBC80
{
	if (Global_101392 == 10 || Global_101392 == 9)
		return true;
...
BOOL func_180(var uParam0, int iParam1) // Position - 0xBCA4
{
	switch (uParam0->f_16)
	{
		case 0:
...
BOOL func_182(var uParam0) // Position - 0xC4A3
{
	float num;
...
void func_183(int iParam0, var uParam1) // Position - 0xC531
{
	if (iParam0 == 1)
	{
		if (!func_139(uParam1))
...
BOOL func_184(BOOL bParam0) // Position - 0xC595
{
	var unk;
...
BOOL func_185(var uParam0) // Position - 0xC62C
{
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0))
		if (unk_0xD9F5E1FEFD1329E4(uParam0, 0))
...
BOOL func_186(int iParam0) // Position - 0xC656
{
	eCharacter character;
		...
		if (unk_0xFC8BFE4B41177C22(unk_0x4A8C381C258A124D()))
		{
			if (!unk_0x4FAFF4BCB7633475(unk_0x4A8C381C258A124D()))
			{
				...
				switch (iParam0)
				{
					...
					case 3:
						if (unk_0x8BF5256C439DF778(unk_0x4A8C381C258A124D()) || unk_0x9857C978BD3CBEDA(unk_0x4A8C381C258A124D()) || unk_0x6652E84A43F51B8B(unk_0x259BE71D8A81D4FA(), 1) || unk_0x1B32E388988DD296(unk_0x4A8C381C258A124D(), 0) || func_194() || Global_113417 || Global_32831 || func_193() || func_192(8, -1) || func_100() || func_191() || func_189() || Global_114370.f_7691.f_919[character] == 5)
							return false;
						break;
				
					case 4:
						if (func_194() || unk_0xE7B45027762DEFE7(unk_0x259BE71D8A81D4FA()) > 0 || func_192(8, -1) || func_189() || func_188() || Global_114370.f_7691.f_919[character] == 5)
							return false;
						break;
...
BOOL func_187() // Position - 0xCD73
{
	return Global_101431.f_1;
}

BOOL func_188() // Position - 0xCD81
{
	if (Global_98294 != -1)
...
BOOL func_192(int iParam0, int iParam1) // Position - 0xCDF9
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_193() // Position - 0xCE31
{
	return Global_1575079;
}

BOOL func_194() // Position - 0xCE3D
{
	if (!unk_0x76CD105BCAC6EB9F())
...
int func_195(var uParam0, var uParam1, var uParam2, var uParam3, char* sParam4, char* sParam5, int iParam6, char* sParam7, int iParam8) // Position - 0xCE59
{
	var unk;
	...
	if (func_186(2))
	{
		if (!_CONVERSATION_IS_DIALOGUE_IN_PROGRESS())
		{
			if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(unk_0x4A8C381C258A124D()) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_28[0]) && unk_0x1DD05E817C89C737() - uParam0->f_60 > iParam8 && func_201(unk_0x4A8C381C258A124D(), uParam1, 1) < 20f)
			{
				unk = 16;
		...
		else if (func_196(sParam5))
		{
			if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(unk_0x4A8C381C258A124D()))
				if (func_201(unk_0x4A8C381C258A124D(), uParam1, 1) >= 20f)
					func_154();
		}
	}
...
BOOL func_196(char* sParam0) // Position - 0xCF1B
{
	var unk;
...
void _CONVERSATION_ADD_LINE_NO_SUBTITLE(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xCF5F
{
...
void func_199(var uParam0, eCharacter echParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xCF9A
{
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, var uParam2, char* sParam3, int iParam4, int iParam5) // Position - 0xCFF0
{
...
float func_201(var uParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0xD08B
{
	var unk;
...
void func_202(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, float fParam7, float fParam8, float fParam9, float fParam10, float fParam11) // Position - 0xD0C5
{
	float num;
	float num2;
	float num3;
	...
	if (unk_0x75EAB09F5E974116(unk_0x259BE71D8A81D4FA()))
	{
		if (!unk_0xD6F9DEE4765092A9(uParam2))
		{
			...
			{
				if (func_201(unk_0x4A8C381C258A124D(), uParam3, 1) <= 100f)
					func_205(uParam0, 1);
			}
			else
			{
				...
				{
					num = func_201(unk_0x4A8C381C258A124D(), fParam6, 1);
					num2 = func_201(unk_0x4A8C381C258A124D(), fParam9, 1);
					num3 = num - num2;
				...
				if (func_201(unk_0x4A8C381C258A124D(), uParam3, 1) > 120f)
					func_206(uParam0);
			}
		}
	}
...
void func_205(var uParam0, int iParam1) // Position - 0xD258
{
	BOOL flag;
	int i;
...
void func_206(var uParam0) // Position - 0xD2F6
{
	unk_0xB479965CBAA3EAE1(0);
	unk_0xDD291722ADDCBD60();
	func_207(uParam0);
...
void func_207(var uParam0) // Position - 0xD30D
{
	BOOL flag;
	int num;
	int i;
...
BOOL IS_RC_FINE_AND_IN_RANGE(Any* panParam0, BOOL bParam1) // Position - 0xD429
{
	var unk;
...
BOOL func_212(int iParam0) // Position - 0xD9F1
{
...
BOOL func_213(var uParam0) // Position - 0xDA11
{
...
BOOL func_214(var uParam0) // Position - 0xDA29
{
...
void func_216(var uParam0) // Position - 0xDD52
{
...
BOOL CHECK_VEHICLES_OK(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0xDDFD
{
	int i;
	int num;
	var unk;
...
BOOL func_219(var uParam0, var uParam1) // Position - 0xDFBB
{
	var unk;
...
BOOL func_220(var uParam0, BOOL bParam1, int iParam2) // Position - 0xDFEB
{
	int i;
	int num;
...
BOOL func_221(int iParam0) // Position - 0xE2A7
{
...
BOOL func_222(var uParam0, int iParam1) // Position - 0xE2DB
{
	float num;
...
BOOL func_223(var uParam0, int iParam1) // Position - 0xE351
{
	return func_224(uParam0, unk_0x4A8C381C258A124D(), iParam1, 1, 250, 7);
}

BOOL func_224(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xE369
{
	BOOL flag;
	var unk;
	int num;
...
BOOL func_225(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, int iParam7) // Position - 0xE42A
{
	var unk;
	var unk2;
	var unk5;
...
Vector3 func_226(var uParam0, int iParam1) // Position - 0xE556
{
	int num;
...
BOOL func_228(var uParam0, var uParam1, int iParam2, int iParam3) // Position - 0xE665
{
	var unk;
	var unk4;
	float num;
...
float func_229(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0xE6F6
{
	return (fParam0 * uParam3) + (fParam0.f_1 * uParam3.f_1) + (fParam0.f_2 * uParam3.f_2);
}

Vector3 func_230(float fParam0, var uParam1, var uParam2) // Position - 0xE717
{
	float num;
	float num2;
...
int func_232(var uParam0, var uParam1) // Position - 0xE771
{
	int i;
...
int func_233(var uParam0) // Position - 0xE7B0
{
...
BOOL func_234(var uParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xE7D8
{
	float num;
	float num2;
	int num3;
...
BOOL func_235(var uParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0xE8D3
{
	float num;
	float num2;
...
BOOL func_236(var uParam0, float fParam1) // Position - 0xE9DF
{
	var unk;
	var unk2;
...
BOOL func_237(var uParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xEA74
{
	var unk;
	var unk4;
	float num;
...
BOOL func_238(var uParam0, BOOL bParam1, float fParam2, float fParam3) // Position - 0xEB02
{
	if (bParam1)
		if (unk_0x65F146FF416F109F(unk_0x4A8C381C258A124D()))
...
BOOL func_239(int iParam0) // Position - 0xEB4A
{
...
void func_240(var uParam0) // Position - 0xEB94
{
	var unk;
...
BOOL func_241(int iParam0) // Position - 0xEC31
{
	if (iParam0 == -1)
		iParam0 = func_177();
...
BOOL func_242(int iParam0) // Position - 0xECC6
{
...
BOOL func_245(int iParam0) // Position - 0xED45
{
...
BOOL func_247(int iParam0) // Position - 0xEDB7
{
...
BOOL func_248(var uParam0) // Position - 0xEDDF
{
	if (!func_249(uParam0))
		return false;
...
BOOL func_249(var uParam0) // Position - 0xEDFE
{
	int num;
	int i;
	BOOL flag;
	...
	switch (iLocal_89)
	{
		...
		case 1:
			if (!func_252(&num) || !unk_0xE100DD4F82A51BDE("rcmlastone1") || !unk_0x92A65766A892EFC6(joaat("WEAPON_PUMPSHOTGUN")) || !unk_0x92A65766A892EFC6(joaat("WEAPON_SNIPERRIFLE")))
				return false;
...
void func_250(var uParam0, var uParam1, float fParam2, float fParam3, float fParam4, float fParam5) // Position - 0xEFEA
{
	func_251(uParam0);
...
void func_251(var uParam0) // Position - 0xF02D
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
BOOL func_252(var uParam0) // Position - 0xF0C9
{
	int i;
...
BOOL func_253(int iParam0) // Position - 0xF0FA
{
	var unk;
	eCharacter character;
...
BOOL func_254(int iParam0) // Position - 0xF14B
{
	var unk;
...
BOOL func_255(int iParam0) // Position - 0xF204
{
	var unk;
...
BOOL func_256(int iParam0) // Position - 0xF2C5
{
	int i;
	var unk;
	int num;
...
BOOL func_258(int iParam0) // Position - 0xF42C
{
...
BOOL func_259(int iParam0) // Position - 0xF457
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_260(int iParam0) // Position - 0xF482
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_261(int iParam0) // Position - 0xF4AD
{
	if (func_242(iParam0))
		return false;
	else if (!unk_0x4FAFF4BCB7633475(unk_0x4A8C381C258A124D()))
...
BOOL func_263(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, float fParam5) // Position - 0xF4FC
{
	int i;
...
BOOL func_264(int iParam0, var uParam1, var uParam2, var uParam3, float fParam4, var uParam5) // Position - 0xF561
{
	int num;
	char* str;
...
BOOL func_265(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7) // Position - 0xF5D9
{
	if (fParam6 < 0f)
		fParam6 = 0f;
...
void func_266(var uParam0, BOOL bParam1) // Position - 0xF654
{
	if (bParam1)
	{
...
void func_271(var uParam0, BOOL bParam1) // Position - 0xF750
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (unk_0x5B9219522937741D(*uParam0))
...
void func_274(var uParam0) // Position - 0xF7DA
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
void func_277(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0xF865
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (!unk_0x4FAFF4BCB7633475(*uParam0))
...
void func_278(var uParam0) // Position - 0xF8B5
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (!unk_0x1C2F771CDC87A3A5(*uParam0, 0))
...
void func_279(int iParam0) // Position - 0xF8F6
{
	if (*iParam0 == -1)
		return;

...
void main() // Position - 0x0
{
	...
	while (!Global_64032)
	{
		if (Global_76133 > 0)
		{
			...
			else if (unk_0x1DD05E817C89C737() - Global_64066 > 1000)
				func_106();
		}
					...
					if (Global_64041)
					{
						...
						for (j = 0; j < Global_97401[num2 /*19*/]; j = j + 1)
						{
							if (!func_92(Global_114370.f_1.f_12[num2 /*6*/][j]))
								...
								num4 = num4 + Global_114370.f_1.f_126[Global_64042 /*23*/].f_17[j];
						}
...
void func_42(Player plParam0, char* sParam1, int iParam2, int iParam3, Player plParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13, int iParam14, int iParam15, int iParam16, int iParam17) // Position - 0x3262
{
	int num;
	int i;
		...
		if (Global_76283 == false)
		{
			...
			if (num6 == 90)
			{
				if (Global_114370.f_9088.f_99.f_205[func_75(0)] == 2)
				{
					...
					unk_0x3573EC2255786C32(131, Global_76279, 0f);
					unk_0x3573EC2255786C32(162, Global_76280, 0f);
					unk_0x3573EC2255786C32(126, 1, 0f);
					unk_0x3573EC2255786C32(161, Global_76282, 0f);
...
void func_77(var uParam0) // Position - 0xBAA3
{
	...
	if (_IS_MISSION_REPEAT_ACTIVE(false))
	{
		unk_0x9012CD429E55212A(Global_76284);
...
void func_90(int iParam0, int iParam1) // Position - 0xD60D
{
	...
	num = Global_64263[iParam1 /*13*/].f_4;
...
void func_98(int iParam0) // Position - 0xD824
{
	...
	{
		case 0:
			unk_0x1164A75E490C27B6(joaat("JEWEL_HEIST_RAW_TAKE"), Global_114370.f_1.f_126[iParam0 /*23*/], 1);
			break;
	}
...
void func_107() // Position - 0xE5B1
{
	...
	if (Global_64044 && unk_0x75EAB09F5E974116(unk_0xB6B621402486C3E4()) && !unk_0x0CB7695268A7F50F() && !unk_0x4D9174D8796EA622())
		Global_64044 = false;
	...
	for (i = 0; i < Global_76133; i = i + 1)
	{
		if (Global_76134[i /*9*/] >= 0)
		{
			num2 = Global_64263[Global_76134[i /*9*/] /*13*/];
			...
			switch (num2)
			{
				case 6:
					if (Global_76134[i /*9*/].f_6 != 0)
					{
						...
						else if (unk_0xFC8BFE4B41177C22(Global_76134[i /*9*/].f_6))
						{
							if (!unk_0x1C2F771CDC87A3A5(Global_76134[i /*9*/].f_6, 0))
							{
								iLocal_628 = Global_76134[i /*9*/].f_8;
								uLocal_627 = unk_0x8D91ADE44AC79BC9(Global_76134[i /*9*/].f_6);
								...
								Global_76134[i /*9*/].f_8 = uLocal_627;
							}
						}
						else
						{
					...
					if (Global_64046)
						if (Global_64048 == -1 || Global_76134[i /*9*/] == Global_64048)
							if (Global_76134[i /*9*/] == 339 || Global_76134[i /*9*/] == 179 || Global_76134[i /*9*/] == 342 || Global_76134[i /*9*/] == 234)
								Global_76134[i /*9*/].f_1 = Global_76134[i /*9*/].f_1 + SYSTEM::ROUND(unk_0x0B852B0BF94A8DC1() * 1000f);
							else
								Global_76134[i /*9*/].f_1 = Global_76134[i /*9*/].f_1 + iLocal_624;
					break;
				...
				case 5:
					if (flag2)
					{
						if (Global_64050 == -1 || Global_64050 == Global_76134[i /*9*/])
						{
							if (!(Global_64049 == 0))
							{
								if (unk_0xFC8BFE4B41177C22(Global_64049))
								{
									if (!unk_0x1C2F771CDC87A3A5(Global_64049, 0))
									{
										if (unk_0x55B80B6E7AB61270(Global_64049))
										{
											num = unk_0xDF93B3CFAC96698F(Global_64049);
										
											if (num > Global_76134[i /*9*/].f_2)
												Global_76134[i /*9*/].f_2 = num;
										}
									}
								}
							}
...
void func_108() // Position - 0xE98C
{
	...
	if (Global_64067 > 0)
	{
		...
		for (i = 0; i < 64; i = i + 1)
		{
			...
			{
				if (!unk_0xFC8BFE4B41177C22(Global_64068[i /*2*/]))
				{
					Global_64068[i /*2*/] = 0;
		...
		switch (num2)
		{
			case 142:
				...
				if (unk_0xFC8BFE4B41177C22(num3))
				{
					...
					if (Global_64197 > 0)
					{
						num5 = unk_0x4B423FAA24E8ABF0(num3);
						j = 0;
					
						for (j = 0; j < Global_64197; j = j + 1)
						{
							if (Global_64198[j /*2*/] == num5)
								num7 = num7 + Global_64198[j /*2*/].f_1;
						}
					}
					...
					if (unk_0x0101C509A6E67F99(num3) && unk_0xBD545F8729E9F413(num3) != unk_0x4A8C381C258A124D())
					{
						...
						if (unk_0xFC8BFE4B41177C22(unk))
						{
							if (unk_0x55B80B6E7AB61270(unk))
							{
								...
								if (unk_0xFC8BFE4B41177C22(unk3) && unk_0xE93EDE86BBB66532(unk) == unk3)
									flag2 = true;
							}
						}
						...
						if (unk_0x0101C509A6E67F99(unk) && unk_0x56E414973C2A8C0E(unk_0xB6B621402486C3E4()) == unk_0xBD545F8729E9F413(unk) || flag2)
						{
							if (unk_0x0101C509A6E67F99(unk))
							{
								...
								if (Global_64067 > 0)
								{
									...
									if (num8 != -1)
									{
										unk_0xB76C3F86B744BBA5(unk_0xBD545F8729E9F413(Global_64068[num8 /*2*/]), &iLocal_631);
							...
							if (Global_76285)
							{
								unk2 = unk_0xBD545F8729E9F413(num3);
								num9 = unk_0x0DFE7358172FC006(unk2);
							
								if (!unk_0x110821AE6C63DD4F(num3) && !(num9 == 22) && !(num9 == 19) && !(num9 == 17) && !(num9 == 18) && !(num9 == 27) && !(num9 == 29) && !(num9 == 28))
								{
									num6 = unk_0x1E37AEC038A241A3(unk_0x56E414973C2A8C0E(unk_0xB6B621402486C3E4()), unk_0xBD545F8729E9F413(num3));
							...
							if (Global_76319 > 0)
							{
								...
								while (!flag)
								{
									...
									{
										if (unk_0xFC8BFE4B41177C22(Global_76286[j /*2*/]))
										{
											if (unk_0x1C2F771CDC87A3A5(Global_76286[j /*2*/], 0))
											{
												if (Global_76286[j /*2*/] == num3)
												{
...
void func_113() // Position - 0xEEC7
{
	...
	if (unk_0x90168A0DE18A7F1A())
	{
		if (unk_0x81D4D874CB1DFBE4() == 33)
		{
			if (unk_0x16C990F0AEBBC7A3() == 33)
			{
				...
				if ((num - 4) % 3 == 0)
				{
					...
					num5 = unk_0x8BDAC9E7F4C1D9E5(num2);
		...
		if (unk_0x81D4D874CB1DFBE4() == 13)
		{
			...
			{
				num6 = unk_0x536257A79D7C865A();
			
				if (num6 == 3)
				{
					num7 = unk_0x8BDAC9E7F4C1D9E5(0);
					num8 = unk_0x8BDAC9E7F4C1D9E5(1);
					unk = unk_0x8BDAC9E7F4C1D9E5(2);
					Global_114370.f_2355[num7 /*2*/] = num8;
					Global_114370.f_2355[num7 /*2*/].f_1 = unk;
					func_114();
				}
			}
		}

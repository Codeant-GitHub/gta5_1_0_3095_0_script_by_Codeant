...
void _STAT_SET_PACKED_BOOL(int iParam0, int iParam1, Hash hParam2) // Position - 0xA69
{
	if (hParam2 == -1)
		hParam2 = func_11();
...
void func_22(int iParam0) // Position - 0xC48
{
	int i;
	int j;
...
BOOL func_32(int iParam0, int iParam1, Player plParam2) // Position - 0x1535
{
	int num;
	int i;
	var unk;
...
BOOL func_33(int iParam0, int iParam1, var uParam2) // Position - 0x16F2
{
	int num;
...
int func_35(int iParam0, int iParam1, Player plParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x17CE
{
	int i;
	int j;
	int k;
...
void func_36(int iParam0, int iParam1, Player plParam2) // Position - 0x1FDF
{
	Player player;
	int num;
...
BOOL func_37(int iParam0, int iParam1, Player plParam2) // Position - 0x2069
{
	if (iParam0 == joaat("Player_Zero"))
		if (iParam1 == 4)
...
BOOL func_38(int iParam0, int iParam1, Player plParam2) // Position - 0x2147
{
	Global_79031[1 /*14*/] = { func_85(iParam0, iParam1, plParam2, -1) };
	return IS_BIT_SET(Global_79031[1 /*14*/].f_6, 2);
}

BOOL func_39(int iParam0, Player plParam1, int iParam2, Player plParam3, var uParam4, int iParam5) // Position - 0x216F
{
	var unk;
	int i;
...
BOOL func_40(int iParam0, int iParam1, Player plParam2) // Position - 0x2773
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
Player func_41(var uParam0, int iParam1, int iParam2) // Position - 0x280C
{
	Player i;
	Player j;
...
int func_42(int iParam0, int iParam1, Player plParam2, var uParam3) // Position - 0x28AD
{
	int num;
...
Player func_43(var uParam0, int iParam1, int iParam2, Player plParam3, int iParam4, int iParam5) // Position - 0x2BB4
{
	Player player;
	Player player2;
	Player player3;
...
BOOL func_44(int iParam0, Player plParam1, Player plParam2, Player plParam3, var uParam4) // Position - 0x3767
{
	int num;
...
Player func_45(int iParam0, Player plParam1, Player plParam2, int iParam3) // Position - 0x3A4B
{
	int num;
...
Player func_46(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x3D12
{
	Player i;
	Player player;
...
BOOL func_47(var uParam0, int iParam1, Player plParam2, Player plParam3) // Position - 0x3D49
{
	Player player;
...
BOOL func_48(int iParam0, Player plParam1, var uParam2) // Position - 0x3D72
{
	*uParam2 = -99;
...
int func_49(int iParam0, int iParam1, Player plParam2, var uParam3) // Position - 0x403D
{
	int num;
...
Player func_50(int iParam0, Player plParam1, Player plParam2) // Position - 0x42C7
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
void func_51(var uParam0, int iParam1, Player plParam2, Player plParam3) // Position - 0x441E
{
	Player player;
...
BOOL func_52(int iParam0, int iParam1, Player plParam2, int iParam3) // Position - 0x44B8
{
	switch (iParam0)
	{
...
int func_53(int iParam0, Player plParam1, int iParam2, int iParam3) // Position - 0x4586
{
	var unk;
	int num;
	int num2;
...
Player func_56(var uParam0, Player plParam1, Player plParam2, int iParam3) // Position - 0x4AA8
{
	int num;
	int num2;
	int num3;
...
int func_57(var uParam0, int iParam1) // Position - 0x4BA4
{
	int num;
...
BOOL func_61(int iParam0, int iParam1, Player plParam2, int iParam3) // Position - 0x4E82
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
BOOL func_62(int iParam0, int iParam1, Player plParam2, int iParam3) // Position - 0x50FF
{
	if (iParam0 == joaat("Player_Zero"))
	{
		if (iParam1 == 6)
...
BOOL func_63(int iParam0, int iParam1, Player plParam2, int iParam3) // Position - 0x5524
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
Player func_64(var uParam0, int iParam1) // Position - 0x5817
{
	int num;
	var unk;
...
Player func_65(var uParam0, int iParam1) // Position - 0x585E
{
	int num;
	var unk;
	var unk2;
...
int func_66(var uParam0, int iParam1, var uParam2, int iParam3) // Position - 0x58BE
{
	int num;
	int num2;
	int num3;
...
void func_68(Player plParam0, int iParam1, BOOL bParam2, BOOL bParam3, Hash hParam4) // Position - 0x59C1
{
	Hash hash;
	var unk;
	int num;
...
void func_69(int iParam0, int iParam1, Hash hParam2, int iParam3) // Position - 0x5A09
{
	int num;
...
int func_70(int iParam0, Hash hParam1) // Position - 0x5A37
{
	return unk_0xD69CE161FE614531(0, iParam0, func_71(hParam1));
}

Hash func_71(Hash hParam0) // Position - 0x5A4C
{
	Hash hash;
	Hash hash2;
...
int func_72(int iParam0, Hash hParam1) // Position - 0x5A80
{
	var unk;
	int num;
...
BOOL func_73(Player plParam0, int iParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5) // Position - 0x5AAF
{
	int value;
...
BOOL func_74(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x85A0
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
BOOL func_75(int iParam0) // Position - 0x9443
{
	if (!IS_BIT_SET(Global_79031[1 /*14*/].f_6, 0))
		return false;
...
BOOL func_76(int iParam0, int iParam1, var uParam2, int iParam3) // Position - 0x948B
{
	int num;
...
struct<10> func_78(int iParam0, Player plParam1) // Position - 0x95E6
{
	int i;
	var unk;
...
void func_79(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x9F15
{
	int num;
	var unk;
	int num2;
...
void func_80(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9) // Position - 0xA03F
{
	uParam0->[0] = iParam1;
	uParam0->[1] = iParam2;
	uParam0->[2] = iParam3;
...
struct<17> func_81(int iParam0, Player plParam1) // Position - 0xA087
{
	int i;
	var unk;
...
void func_84(var uParam0, int iParam1, int iParam2, Player plParam3, Player plParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0xC16B
{
	uParam0->[0] = iParam1;
	uParam0->[2] = iParam2;
	uParam0->[3] = plParam3;
...
struct<14> func_85(int iParam0, int iParam1, Player plParam2, int iParam3) // Position - 0xC1DC
{
	func_149();
...
void func_88(int iParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7, int iParam8, int iParam9, BOOL bParam10) // Position - 0xD54B
{
	int num;
	int num2;
...
BOOL func_92(Player plParam0, int iParam1, BOOL bParam2, BOOL bParam3, Hash hParam4) // Position - 0xE4E7
{
	Hash hash;
	int num;
	int num2;
...
BOOL func_150(int iParam0, int iParam1, Player plParam2) // Position - 0x1F975
{
	int num;
	Player player;
	int i;
...
void func_207(var uParam0, int iParam1, BOOL bParam2) // Position - 0x26ED7
{
	int i;
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(var uParam0) // Position - 0x26FCC
{
...
void func_209(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x26FED
{
	var unk;
...
BOOL func_210(var uParam0) // Position - 0x27097
{
...
void func_211(BOOL bParam0, BOOL bParam1, BOOL bParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0x270B7
{
	if (bParam0)
	{
...
Player func_214(Hash hParam0, BOOL bParam1) // Position - 0x27277
{
	Player player;
	Hash hash;
...
BOOL func_215(int iParam0) // Position - 0x272B8
{
	int num;
...
BOOL func_216(int iParam0) // Position - 0x272DA
{
...
int func_218(int iParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0x27327
{
	int num;
...
BOOL func_221(var uParam0, float fParam1, float fParam2, float fParam3, float fParam4, BOOL bParam5, int iParam6) // Position - 0x273A4
{
	BOOL flag;
	float num;
...
Vector3 _GET_PLAYER_COORDS(var uParam0) // Position - 0x275BE
{
...
BOOL func_234(var uParam0, int iParam1) // Position - 0x27856
{
	if (func_210(uParam0))
...
BOOL func_235(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6) // Position - 0x27889
{
...
void func_236(var uParam0) // Position - 0x278E0
{
	if (!unk_0x1C2F771CDC87A3A5(uParam0, 0))
	...
	if (Global_79503 != 6)
	{
		...
		else
		{
			...
			if (value < 9000 && !unk_0x15CCE8886267624F())
			{
				...
				unk = { func_241(Global_79504, Global_79506, iParam10) };
				num4 == -0.014f;
...
float func_240(var uParam0) // Position - 0x27D58
{
...
{
	if (!func_253(0) || Global_79519 || Global_79507 == 1 || !unk_0x9390801B06EE998F())
		return false;
...
void func_260(var uParam0, BOOL bParam1) // Position - 0x28576
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
void func_261(var uParam0) // Position - 0x285B1
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (unk_0x5B9219522937741D(*uParam0))
...
void func_264(var uParam0) // Position - 0x2862B
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
void func_265(var uParam0) // Position - 0x28663
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
BOOL func_266(var uParam0) // Position - 0x286FF
{
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0))
...
void func_269(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x2877C
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (!unk_0x4FAFF4BCB7633475(*uParam0))
...
void func_270(var uParam0) // Position - 0x287CC
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (!unk_0x1C2F771CDC87A3A5(*uParam0, 0))
...
BOOL func_274(char* sParam0, int iParam1, int iParam2) // Position - 0x289A6
{
	var unk;
	var unk2;
	int num;
...
void func_281(int iParam0) // Position - 0x28CCB
{

...
void main() // Position - 0x0
{
	...
	while (true)
	{
		...
		if (func_180(&num, 0) && unk_0x1D5CD3EAAA7422B0(vector.f_2 - vector2.f_2) < 2.5f)
		{
			if (!func_2(&num))
				func_271(&num, true);
...
int func_49(int iParam0, Hash hParam1) // Position - 0x392B
{
	var unk;
	int num;
...
Hash func_51(Hash hParam0) // Position - 0x396F
{
	Hash hash;
	Hash hash2;
...
Hash func_52() // Position - 0x39A3
{
	return Global_1574925;
}

BOOL func_53(int iParam0, Hash hParam1) // Position - 0x39AF
{
	var unk;
	BOOL num;
...
var func_54(int iParam0, Hash hParam1) // Position - 0x39D3
{
...
BOOL func_69(var uParam0, var uParam1, var uParam2, char* sParam3, float fParam4, float fParam5, float fParam6) // Position - 0x5DFB
{
	var unk;
	var unk2;
...
BOOL func_71(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0x65BE
{
	if (bParam6)
...
BOOL func_72(var uParam0) // Position - 0x6605
{
...
BOOL func_74(int iParam0, int iParam1, BOOL bParam2) // Position - 0x6670
{
	if (iParam0 == -1)
		return false;
...
BOOL func_77(int iParam0) // Position - 0x6A83
{
	return func_74(iParam0, 5, true);
}

int func_78(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x6A93
{
	int i;
	float num;
	float num2;
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x75AA
{
...
Vector3 func_83(float fParam0, float fParam1, float fParam2) // Position - 0x75D4
{
...
BOOL func_85(Player plParam0) // Position - 0x7600
{
...
BOOL func_87(int iParam0, int iParam1, var uParam2, int iParam3, BOOL bParam4) // Position - 0x7702
{
	var unk;
	var unk7;
	var unk13;
...
Vector3 func_88(float fParam0, var uParam1, var uParam2, float fParam3) // Position - 0x7797
{
	float num;
	float num2;
	float num3;
...
BOOL func_92(int iParam0, var uParam1) // Position - 0x8439
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_93(Player plParam0) // Position - 0x84BB
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
...
Player _INVALID_PLAYER_INDEX() // Position - 0x8513
{
	return -1;
}
...
BOOL func_98(int iParam0) // Position - 0x87B5
{
...
int func_106(int iParam0) // Position - 0x8CFE
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * IS_BIT_SET(iParam0, 31) ? -1 : 1) + 2011;
}

var func_107(BOOL bParam0, var uParam1, var uParam2) // Position - 0x8D20
{
	if (bParam0)
		return uParam1;
...
int func_108(int iParam0) // Position - 0x8D37
{
	return iParam0 & 15;
}
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER_0() // Position - 0x8DF5
{
	func_58();
	return Global_114370.f_2366.f_539.f_4321;
}
...
void func_116(char* sParam0, var uParam1, int iParam2) // Position - 0x8E93
{
...
BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0x8ED5
{
...
BOOL func_122(Any* panParam0) // Position - 0xA968
{
	int num;
...
void func_126(Vehicle veParam0) // Position - 0xAB06
{
	int num;
	int num2;
	int num3;
...
int func_128(Vehicle veParam0) // Position - 0xABE2
{
	int i;
...
BOOL func_132(int iParam0, int iParam1, int iParam2) // Position - 0xACDB
{
...
int func_134(Vehicle veParam0) // Position - 0xAD42
{
	int i;
...
BOOL func_135(var uParam0) // Position - 0xAD8B
{
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(int iParam0) // Position - 0xADAB
{
	if (unk_0xFC8BFE4B41177C22(iParam0))
...
BOOL func_137(int iParam0) // Position - 0xADCC
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_139(int iParam0) // Position - 0xAE9C
{
	switch (iParam0)
	{
		case 5:
...
void func_140(Any* panParam0, int iParam1, BOOL bParam2) // Position - 0xAEEF
{
	int i;
...
BOOL func_141(int iParam0) // Position - 0xAFE4
{
	switch (iParam0)
	{
		case 5:
...
void func_143(BOOL bParam0, BOOL bParam1, BOOL bParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB08E
{
	if (bParam0)
	{
...
Player func_146(Hash hParam0, BOOL bParam1) // Position - 0xB24E
{
	Player player;
	Hash hash;
...
BOOL func_147(int iParam0) // Position - 0xB28F
{
	int num;
...
BOOL func_148(int iParam0) // Position - 0xB2B1
{
...
int func_150(int iParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0xB2FE
{
	int num;
...
BOOL func_153(var uParam0) // Position - 0xB37B
{
...
BOOL func_159(var uParam0, float fParam1, int iParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB4AE
{
...
void func_160(var uParam0) // Position - 0xB505
{
	if (!unk_0x1C2F771CDC87A3A5(uParam0, 0))
...
BOOL func_167(int iParam0) // Position - 0xB812
{
	if (iParam0 == 1)
...
BOOL func_169(int iParam0) // Position - 0xB878
{
...
BOOL func_170(int iParam0) // Position - 0xB8B9
{
	int num;
...
int func_172(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4) // Position - 0xB930
{
	int i;
...
void func_173(int iParam0, int iParam1) // Position - 0xBA67
{
	int i;
...
BOOL _CAN_ENTER_FREEROAM_STATE(int iParam0) // Position - 0xBAB6
{
	return func_175(iParam0, Global_43922);
}

BOOL func_175(int iParam0, int iParam1) // Position - 0xBAC7
{
	if (iParam1 == 15)
		return 1;
...
BOOL func_176(int iParam0) // Position - 0xBCA8
{
	if (Global_43922 == 15)
		return false;
...
BOOL _IS_MISSION_REPLAY_IN_PROGRESS() // Position - 0xBD24
{
	if (Global_101392 == 10 || Global_101392 == 9)
		return true;
...
BOOL func_180(var uParam0, int iParam1) // Position - 0xBD48
{
	switch (uParam0->f_16)
	{
		case 0:
...
BOOL func_182(var uParam0) // Position - 0xC547
{
	float num;
...
void func_183(int iParam0, var uParam1) // Position - 0xC5D5
{
	if (iParam0 == 1)
	{
		if (!func_139(uParam1))
...
BOOL func_184(BOOL bParam0) // Position - 0xC639
{
	var unk;
...
BOOL func_185(var uParam0) // Position - 0xC6D0
{
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0))
		if (unk_0xD9F5E1FEFD1329E4(uParam0, 0))
...
BOOL func_186(int iParam0) // Position - 0xC6FA
{
	eCharacter character;
...
BOOL func_187() // Position - 0xCE17
{
	return Global_101431.f_1;
}

BOOL func_188() // Position - 0xCE25
{
	if (Global_98294 != -1)
...
BOOL func_192(int iParam0, int iParam1) // Position - 0xCE9D
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_193() // Position - 0xCED5
{
	return Global_1575079;
}

BOOL func_194() // Position - 0xCEE1
{
	if (!unk_0x76CD105BCAC6EB9F())
...
int func_195(var uParam0, var uParam1, var uParam2, var uParam3, char* sParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, int iParam9) // Position - 0xCEFD
{
	var unk;
...
void _CONVERSATION_ADD_LINE_NO_SUBTITLE(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xCF85
{
...
void func_197(var uParam0, eCharacter echParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xCFC0
{
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, var uParam2, char* sParam3, int iParam4, int iParam5) // Position - 0xD016
{
...
float func_199(var uParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0xD0B1
{
	var unk;
...
void func_200(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) // Position - 0xD0EB
{
	if (unk_0x75EAB09F5E974116(unk_0x259BE71D8A81D4FA()))
	{
...
void func_203(var uParam0, int iParam1) // Position - 0xD251
{
	BOOL flag;
	int i;
...
void func_205(var uParam0) // Position - 0xD2FB
{
	unk_0xB479965CBAA3EAE1(0);
	unk_0xDD291722ADDCBD60();
	func_206(uParam0);
...
void func_206(var uParam0) // Position - 0xD312
{
	BOOL flag;
	int num;
	int i;
...
BOOL IS_RC_FINE_AND_IN_RANGE(Any* panParam0, BOOL bParam1) // Position - 0xD422
{
	var unk;
...
BOOL func_210(int iParam0) // Position - 0xD9EA
{
...
BOOL func_211(var uParam0) // Position - 0xDA0A
{
...
BOOL func_212(var uParam0) // Position - 0xDA22
{
...
void func_214(var uParam0) // Position - 0xDD4B
{
...
BOOL CHECK_VEHICLES_OK(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0xDDF6
{
	int i;
	int num;
	var unk;
...
BOOL func_217(var uParam0, var uParam1) // Position - 0xDFB4
{
	var unk;
...
BOOL func_218(var uParam0, BOOL bParam1, int iParam2) // Position - 0xDFE4
{
	int i;
	int num;
...
BOOL func_219(int iParam0) // Position - 0xE2A0
{
...
BOOL func_220(var uParam0, int iParam1) // Position - 0xE2D4
{
	float num;
...
BOOL func_221(var uParam0, int iParam1) // Position - 0xE34A
{
	return func_222(uParam0, unk_0x4A8C381C258A124D(), iParam1, 1, 250, 7);
}

BOOL func_222(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xE362
{
	BOOL flag;
	var unk;
	int num;
	...
	flag = func_223(&iLocal_35[num /*4*/], unk, uParam1, &(iLocal_35[num /*4*/].f_3), uParam0, iParam5);
	return flag || unk_0x1DD05E817C89C737() - iLocal_35[num /*4*/].f_3 < iParam4;
}

BOOL func_223(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, int iParam7) // Position - 0xE423
{
	var unk;
	var unk2;
	var unk5;
...
Vector3 func_224(var uParam0, int iParam1) // Position - 0xE54F
{
	int num;
...
BOOL func_226(var uParam0, var uParam1, int iParam2, int iParam3) // Position - 0xE65E
{
	var unk;
	var unk4;
	float num;
...
float func_227(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0xE6EF
{
	return (fParam0 * uParam3) + (fParam0.f_1 * uParam3.f_1) + (fParam0.f_2 * uParam3.f_2);
}

Vector3 func_228(float fParam0, var uParam1, var uParam2) // Position - 0xE710
{
	float num;
	float num2;
...
int func_230(var uParam0, var uParam1) // Position - 0xE76A
{
	int i;
...
int func_231(var uParam0) // Position - 0xE7A9
{
...
BOOL func_232(var uParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xE7D1
{
	float num;
	float num2;
	int num3;
...
BOOL func_233(var uParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0xE8CC
{
	float num;
	float num2;
...
BOOL func_234(var uParam0, float fParam1) // Position - 0xE9D8
{
	var unk;
	var unk2;
...
BOOL func_235(var uParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xEA6D
{
	var unk;
	var unk4;
	float num;
...
BOOL func_236(var uParam0, BOOL bParam1, float fParam2, float fParam3) // Position - 0xEAFB
{
	if (bParam1)
		if (unk_0x65F146FF416F109F(unk_0x4A8C381C258A124D()))
...
BOOL func_237(int iParam0) // Position - 0xEB43
{
...
void func_238(var uParam0) // Position - 0xEB8D
{
	var unk;
...
BOOL func_239(int iParam0) // Position - 0xEC2A
{
	if (iParam0 == -1)
		iParam0 = func_177();
...
BOOL func_240(int iParam0) // Position - 0xECBF
{
...
BOOL func_243(int iParam0) // Position - 0xED3E
{
...
BOOL func_245(int iParam0) // Position - 0xEDB0
{
...
BOOL func_246(var uParam0) // Position - 0xEDD8
{
	switch (*uParam0)
	{
		case 25:
...
BOOL func_247(var uParam0) // Position - 0xEE1F
{
	int num;
	int i;
	BOOL flag;
	...
	switch (iLocal_89)
	{
		...
		case 1:
			if (!func_254(&num) || !unk_0xE100DD4F82A51BDE("rcmhunting2"))
				return false;
...
void func_248(var uParam0, float fParam1, float fParam2, float fParam3, float fParam4, int iParam5) // Position - 0xF054
{
	func_249(uParam0, iLocal_91, fParam1, fParam4);
...
void func_249(var uParam0, int iParam1, var uParam2, var uParam3, var uParam4, float fParam5) // Position - 0xF0BA
{
	func_250(uParam0);
...
void func_250(var uParam0) // Position - 0xF0FD
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
BOOL func_251(var uParam0, eCharacter echParam1, float fParam2, float fParam3, float fParam4, float fParam5, char* sParam6, int iParam7) // Position - 0xF199
{
	if (func_252(uParam0, echParam1, fParam2, fParam5, true))
	{
		if (unk_0xFC8BFE4B41177C22(*uParam0))
		{
			if (!unk_0x1C2F771CDC87A3A5(*uParam0, 0))
...
BOOL func_252(var uParam0, eCharacter echParam1, var uParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0xF1F5
{
	int num;
...
int func_253(int iParam0, eCharacter echParam1) // Position - 0xF283
{
	int num;
...
BOOL func_254(var uParam0) // Position - 0xF2C9
{
	int i;
...
BOOL func_255(var uParam0) // Position - 0xF2FA
{
	int num;
	int i;
	BOOL flag;
	...
	switch (iLocal_89)
	{
		...
		case 1:
			if (!func_254(&num) || !func_256(&(uParam0->f_48)) || !unk_0xE100DD4F82A51BDE("special_ped@cletus@base"))
				return false;
...
BOOL func_256(var uParam0) // Position - 0xF5B0
{
	if (func_212(uParam0))
	{
...
BOOL func_258(int iParam0) // Position - 0xF616
{
	var unk;
	eCharacter character;
...
BOOL func_259(int iParam0) // Position - 0xF667
{
	var unk;
...
BOOL func_260(int iParam0) // Position - 0xF720
{
	var unk;
...
BOOL func_261(int iParam0) // Position - 0xF7E1
{
	int i;
	var unk;
	int num;
...
BOOL func_263(int iParam0) // Position - 0xF948
{
...
BOOL func_264(int iParam0) // Position - 0xF973
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_265(int iParam0) // Position - 0xF99E
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_266(int iParam0) // Position - 0xF9C9
{
	if (func_240(iParam0))
		return false;
	else if (!unk_0x4FAFF4BCB7633475(unk_0x4A8C381C258A124D()))
...
BOOL func_268(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, float fParam5) // Position - 0xFA18
{
	int i;
...
BOOL func_269(int iParam0, var uParam1, var uParam2, var uParam3, float fParam4, var uParam5) // Position - 0xFA7D
{
	int num;
	char* str;
...
BOOL func_270(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7) // Position - 0xFAF5
{
	if (fParam6 < 0f)
		fParam6 = 0f;
...
void func_271(var uParam0, BOOL bParam1) // Position - 0xFB70
{
	if (bParam1)
	{
...
void func_275(var uParam0, BOOL bParam1) // Position - 0xFC2D
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (unk_0x5B9219522937741D(*uParam0))
...
void func_278(var uParam0) // Position - 0xFCB7
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
void func_281(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0xFD42
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (!unk_0x4FAFF4BCB7633475(*uParam0))
...
void func_282(var uParam0) // Position - 0xFD92
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (!unk_0x1C2F771CDC87A3A5(*uParam0, 0))
...
void func_283(int iParam0) // Position - 0xFDD3
{
	if (*iParam0 == -1)
		return;
...
int func_287(eCharacter echParam0) // Position - 0xFE6F
{
	if (!func_36(echParam0))

	...
	else if (unk_0xA0C7B98BCF1EEF9E(Global_20794) == 1)
	{
		if (func_11())
		{
			if (func_10())
			{
				...
				while (!unk_0xA6F779AA284EB20E(unk) && num3 == 0 && unk_0xA0C7B98BCF1EEF9E(Global_20794) == 1)
				{
					SYSTEM::WAIT(0);
...
BOOL func_27(int iParam0) // Position - 0x11F8
{
	int num;
	var unk;
	var unk2;
...
BOOL _NETSHOPPING_SHOULD_USE_TRANSACTION_SYSTEM() // Position - 0x12BD
{
	if (unk_0x761778199FE1211C())
...
BOOL func_29(int iParam0, int iParam1) // Position - 0x12D4
{
	BOOL num;
	var unk;
...
BOOL func_33() // Position - 0x6853
{
	return false;
}

BOOL func_34() // Position - 0x685C
{
	return true;
}

BOOL func_35() // Position - 0x6865
{
	return true;
}

BOOL func_36() // Position - 0x686E
{
...
BOOL _IS_EXCLUSIVE_CONTENT_UNLOCKED() // Position - 0x6887
{
	var unk;
...
BOOL func_38(int iParam0) // Position - 0x693F
{
	int num;
	var unk;
...
BOOL func_39(int iParam0) // Position - 0x6986
{
	int i;
...
BOOL func_40(int iParam0) // Position - 0x69C1
{
	int i;
...
BOOL func_41(int iParam0) // Position - 0x6A3D
{
	int i;
...
BOOL func_42(int iParam0, int iParam1, BOOL bParam2) // Position - 0x6B25
{
	int i;
	var unk;
	int num;
...
BOOL func_43(int iParam0, int iParam1, char* sParam2, var uParam3) // Position - 0x6B93
{
...
int func_49(int iParam0) // Position - 0x6E5C
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * IS_BIT_SET(iParam0, 31) ? -1 : 1) + 2011;
}

var func_50(BOOL bParam0, var uParam1, var uParam2) // Position - 0x6E7E
{
	if (bParam0)
		return uParam1;
...
int func_51(int iParam0) // Position - 0x6E95
{
	return iParam0 & 15;
}
...
BOOL func_55(var uParam0, int iParam1) // Position - 0x6F53
{
	BOOL num;
	int num2;
...
BOOL func_58(eCharacter echParam0) // Position - 0x88DF
{
	return echParam0 < CHAR_MULTIPLAYER;
}

void func_59(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, float fParam5, eCharacter echParam6) // Position - 0x88EB
{
	if (func_55(&Global_78038.f_555[0 /*21*/], iParam0))
	{
...
eCharacter func_64(int iParam0) // Position - 0x8BBF
{
	int i;
...
int func_67(var uParam0, var uParam1, var uParam2) // Position - 0x8F7D
{
	int i;
	int num;
...
BOOL func_68(int iParam0) // Position - 0x9170
{
	switch (iParam0)
	{
		case joaat("granger"):
...
eCharacter _GET_PLAYER_CHARACTER_FROM_PED(var uParam0) // Position - 0x936A
{
	eCharacter i;
	int num;
...
int _GET_CHARACTER_MODEL(eCharacter character) // Position - 0x93A7
{
...
int func_75(eCharacter echParam0) // Position - 0x93CC
{
	return Global_2139[echParam0 /*29*/];
}

BOOL func_76(int iParam0, int iParam1) // Position - 0x93DB
{
	if (iParam0 == -1)
		return false;
...
BOOL func_79(var uParam0, Vector3 vParam1, var uParam2, var uParam3, int iParam4, int iParam5) // Position - 0x9433
{
	return SYSTEM::VDIST2(unk_0xD1A6A821F5AC81DB(uParam0, iParam5), vParam1) <= iParam4 * iParam4;
}

BOOL func_80(float fParam0, float fParam1, float fParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0x9451
{
	if (bParam6)
...
BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0x9507
{
...
void func_84(char* sParam0, int iParam1) // Position - 0x952F
{
...
BOOL func_88(int iParam0) // Position - 0x96D1
{
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(var uParam0) // Position - 0x96FB
{
	if (unk_0xFC8BFE4B41177C22(uParam0))
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER() // Position - 0x97CC
{
	func_86();
...
void func_94(int iParam0, BOOL bParam1) // Position - 0x97F7
{
...
void _STAT_SET_PACKED_BOOL(int iParam0, int iParam1, int iParam2) // Position - 0x9ED2
{
	if (iParam2 == -1)
		iParam2 = func_102();
...
BOOL func_106(int iParam0) // Position - 0x9F8B
{
	if (iParam0 == 146 || iParam0 == -1)
		return false;
...
void func_111(BOOL bParam0) // Position - 0xA057
{
...
int func_114(int iParam0, int iParam1, eCharacter echParam2, eCharacter echParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10) // Position - 0xA24F
{
	int num;
	int num2;
...
void func_115(eCharacter echParam0) // Position - 0xA3A0
{
	eCharacter i;
	int num;
	eCharacter j;
...
void func_118(eCharacter echParam0, int iParam1, int iParam2) // Position - 0xA50E
{
...
void func_119(eCharacter echParam0, int iParam1, int iParam2) // Position - 0xA553
{
	if (iParam1 < 0 || iParam1 > 4)
		return;
...
void func_121(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0xA5BD
{
	if (iLocal_40 == 0)
		func_126(uParam0);
	else if (iLocal_40 == 1)
...
void func_122(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0xA5E4
{
	if (func_104())
...
void func_126(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0xA74C
{
	if (func_104())
		if (func_127())
			if (_GET_CURRENT_PLAYER_CHARACTER() != CHAR_MICHAEL)
...
BOOL _IS_MISSION_REPLAY_IN_PROGRESS() // Position - 0xA962
{
...
BOOL func_143(var uParam0) // Position - 0xAAB9
{
	var unk;
...
void func_145(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0xAB33
{
	int i;
...
BOOL func_147(char* sParam0, int iParam1, BOOL bParam2) // Position - 0xABE1
{
	Global_22167 = 0;
...
BOOL func_151(int iParam0, int iParam1) // Position - 0xAF59
{
	return IS_BIT_SET(Global_1886967[iParam0 /*609*/].f_10.f_4, iParam1);
}

Player _INVALID_PLAYER_INDEX() // Position - 0xAF71
{
	return -1;
}
...
void _UPDATE_CURRENT_PLAYER_CHARACTER() // Position - 0xB0FF
{
	if (func_87(14))
	{
...
void func_161(var uParam0, eCharacter echParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xB286
{
...
void func_163(eCharacter echParam0, char* sParam1) // Position - 0xB2F6
{
	int num;
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5) // Position - 0xB46C
{
...
void func_165(eCharacter echParam0, eCharacter echParam1, BOOL bParam2) // Position - 0xB507
{
	int num;
...
struct<4> _GET_CHARACTER_NAME(eCharacter character) // Position - 0xB6FE
{
	return Global_2139[character /*29*/].f_3;
}

int func_168(eCharacter echParam0, int iParam1) // Position - 0xB711
{
	if (iParam1 < 0 || iParam1 > 4)
		return 0;
...
int func_169(eCharacter echParam0, int iParam1) // Position - 0xB73B
{
	if (iParam1 < 0 || iParam1 > 4)
		return 0;
...
void func_170(eCharacter echParam0) // Position - 0xB765
{
...
void func_171(eCharacter echParam0) // Position - 0xB784
{
...
char* func_172(eCharacter echParam0) // Position - 0xD015
{
	char* str;
...
BOOL func_176(eCharacter echParam0) // Position - 0xD1FC
{
...
BOOL func_184(int iParam0) // Position - 0xD67B
{
	float num;
...
BOOL func_185(int iParam0) // Position - 0xD730
{
	int num;
	var unk;
	var unk4;
...
BOOL func_186(var uParam0, var uParam1, var uParam2) // Position - 0xD7E5
{
	float num;
	var unk;
	var unk2;
...
BOOL func_188(var uParam0, var uParam1, var uParam2) // Position - 0xD8AA
{
...
BOOL func_189(var uParam0, var uParam1, var uParam2) // Position - 0xD903
{
...
int func_190(Vector3 vParam0, var uParam1, var uParam2) // Position - 0xD936
{
	float num;
...
int func_191(var uParam0, var uParam1, var uParam2, BOOL bParam3) // Position - 0xD96B
{
	int i;
	float num;
	float num2;
...
int func_192(Vector3 vParam0, var uParam1, var uParam2) // Position - 0xD9E5
{
	float num;
...
int func_193(var uParam0, var uParam1, var uParam2, BOOL bParam3) // Position - 0xDA1A
{
	int i;
	float num;
	float num2;
...
BOOL func_194(Vector3 vParam0, var uParam1, var uParam2) // Position - 0xDA94
{
	Vector3 vector;
	float num;
...
BOOL func_195(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0xDB1D
{
	float num;
...
BOOL func_196(var uParam0, var uParam1, var uParam2) // Position - 0xDB40
{
	if (!func_199(1))
		if (!func_199(0))
...
BOOL func_197(Vector3 vParam0, var uParam1, var uParam2, int iParam3) // Position - 0xE1B3
{
	float num;
...
BOOL func_199(int iParam0) // Position - 0xE8B8
{
...
BOOL func_201(var uParam0) // Position - 0xEA3B
{
...
BOOL func_202(char* sParam0) // Position - 0xEA66
{
	int i;
...
BOOL func_203(Vector3 vParam0, var uParam1, var uParam2) // Position - 0xEAB2
{
	if (vParam0.f_2 < -90f)
		return true;
...
int func_206(var uParam0, var uParam1, var uParam2, eCharacter echParam3, int iParam4) // Position - 0xEBEB
{
	int i;
	float num;
	float num2;
...
BOOL func_207(int iParam0) // Position - 0xEC7A
{
	return IS_BIT_SET(Global_114370.f_7232[iParam0], 0);
}

BOOL func_208() // Position - 0xEC8F
{
...
void func_209(int iParam0, int iParam1) // Position - 0xED07
{
	func_4(iParam0);
...
BOOL func_212(int iParam0) // Position - 0xF053
{
...
BOOL func_213(int iParam0) // Position - 0xF084
{
...
BOOL func_215(int iParam0) // Position - 0xF10C
{
...
BOOL func_217(int iParam0) // Position - 0xF158
{
	eCharacter character;
...
BOOL func_218(int iParam0) // Position - 0xF1AC
{
	var unk;
...
BOOL func_219(var uParam0) // Position - 0xF1F1
{
	int i;
...
BOOL func_221(int iParam0) // Position - 0xF2B3
{
	if (unk_0xD130E7CDEE903624(iParam0, "GetawayVehicleValid"))
		return true;
...
BOOL func_223(var uParam0) // Position - 0xF316
{
	int num;
	int num2;
	var unk;
...
void func_226(int iParam0, BOOL bParam1) // Position - 0xF65D
{
	switch (iLocal_37)
	{
		case 1:
			if (!unk_0x4C705AAF75363287() && !func_229(_GET_CURRENT_PLAYER_CHARACTER()) && !func_228())
			{
...
void _DISPLAY_HELP_TEXT(var text, int iParam1) // Position - 0xF767
{
...
BOOL func_229(eCharacter echParam0) // Position - 0xF798
{
	eCharacter i;
...
BOOL func_230(eCharacter echParam0) // Position - 0xF7E2
{
	eCharacter i;
...
void func_231(int iParam0, var uParam1) // Position - 0xF890
{
	int num;
...
BOOL func_233(var uParam0, int iParam1, int iParam2) // Position - 0xFA51
{
...
BOOL func_244(int iParam0) // Position - 0xFE1F
{
	if (iLocal_40 == 1)
...
BOOL func_247(int iParam0) // Position - 0xFF2B
{
	return func_248(iParam0, 6, true);
}

BOOL func_248(int iParam0, int iParam1, BOOL bParam2) // Position - 0xFF3B
{
	if (iParam0 == -1)
		return false;
...
var func_250(int iParam0, int iParam1) // Position - 0xFFCA
{
	return unk_0xD69CE161FE614531(0, iParam0, func_251(iParam1));
}

int func_251(int iParam0) // Position - 0xFFDF
{
	int num;
	int num2;
...
BOOL func_253(var uParam0) // Position - 0x103BC
{
...
BOOL func_254(int iParam0) // Position - 0x103DC
{
...
struct<8> func_259(char* sParam0, float fParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, float fParam7) // Position - 0x11BAB
{
	char* str;
...
BOOL func_271(var uParam0, int iParam1) // Position - 0x11DC7
{
	if (iParam1 == -1)
		return false;
...
BOOL func_274(int iParam0) // Position - 0x11E82
{
	int num;
	int num2;

...
void main() // Position - 0x0
{
	...
	while (true)
	{
		...
		func_217(num);
		func_210(&iLocal_92, &(num.f_9), unk61);
		...
		if (num == 21)
			func_206(&num, unk61, "FAN1AU", "FAN1_AMB", 3, "MARYANN", 1500);
		else if (num == 22)
			func_201(&num, unk61, "FAN2AU", "FAN2_AMB", 3, "MARYANN", 5000, 1101004800);
		else if (num == 23)
			if (iLocal_94 == 0)
				if (func_206(&num, unk61, "FAN3AUD", "FAN3_AMB", 3, "MARYANN", 50))
					iLocal_94 = 1;
			else
				func_198(&num);
...
int func_49(int iParam0, Hash hParam1) // Position - 0x3936
{
	var unk;
	int num;
...
Hash func_51(Hash hParam0) // Position - 0x397A
{
	Hash hash;
	Hash hash2;
...
Hash func_52() // Position - 0x39AE
{
	return Global_1574925;
}

BOOL func_53(int iParam0, Hash hParam1) // Position - 0x39BA
{
	var unk;
	BOOL num;
...
var func_54(int iParam0, Hash hParam1) // Position - 0x39DE
{
...
BOOL func_69(var uParam0, var uParam1, var uParam2, char* sParam3, float fParam4, float fParam5, float fParam6) // Position - 0x5E05
{
	var unk;
	var unk2;
...
BOOL func_71(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0x65C8
{
	if (bParam6)
...
BOOL func_72(var uParam0) // Position - 0x660F
{
...
BOOL func_74(int iParam0, int iParam1, BOOL bParam2) // Position - 0x667A
{
	if (iParam0 == -1)
		return false;
...
BOOL func_77(int iParam0) // Position - 0x6A8D
{
	return func_74(iParam0, 5, true);
}

int func_78(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x6A9D
{
	int i;
	float num;
	float num2;
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x75B4
{
...
Vector3 func_83(float fParam0, float fParam1, float fParam2) // Position - 0x75DE
{
...
BOOL func_85(Player plParam0) // Position - 0x760A
{
...
BOOL func_87(int iParam0, int iParam1, var uParam2, int iParam3, BOOL bParam4) // Position - 0x770C
{
	var unk;
	var unk7;
	var unk13;
...
Vector3 func_88(float fParam0, var uParam1, var uParam2, float fParam3) // Position - 0x77A1
{
	float num;
	float num2;
	float num3;
...
BOOL func_92(int iParam0, var uParam1) // Position - 0x843F
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_93(Player plParam0) // Position - 0x84C1
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
...
Player _INVALID_PLAYER_INDEX() // Position - 0x8519
{
	return -1;
}
...
BOOL func_98(int iParam0) // Position - 0x87BB
{
...
int func_106(int iParam0) // Position - 0x8D04
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * IS_BIT_SET(iParam0, 31) ? -1 : 1) + 2011;
}

var func_107(BOOL bParam0, var uParam1, var uParam2) // Position - 0x8D26
{
	if (bParam0)
		return uParam1;
...
int func_108(int iParam0) // Position - 0x8D3D
{
	return iParam0 & 15;
}
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER_0() // Position - 0x8DFB
{
	func_58();
	return Global_114370.f_2366.f_539.f_4321;
}
...
void func_116(char* sParam0, var uParam1, int iParam2) // Position - 0x8E99
{
...
BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0x8EDB
{
...
BOOL func_122(Any* panParam0) // Position - 0xA96E
{
	int num;
...
void func_126(Vehicle veParam0) // Position - 0xAB0C
{
	int num;
	int num2;
	int num3;
...
int func_128(Vehicle veParam0) // Position - 0xABE8
{
	int i;
...
BOOL func_132(int iParam0, int iParam1, int iParam2) // Position - 0xACE1
{
...
int func_134(Vehicle veParam0) // Position - 0xAD48
{
	int i;
...
BOOL func_135(var uParam0) // Position - 0xAD91
{
...
BOOL func_136(int iParam0) // Position - 0xADB1
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_138(int iParam0) // Position - 0xAE81
{
	switch (iParam0)
	{
		case 5:
...
void func_139(Any* panParam0, int iParam1, BOOL bParam2) // Position - 0xAED4
{
	int i;
...
BOOL func_140(int iParam0) // Position - 0xAFC9
{
	switch (iParam0)
	{
		case 5:
...
void func_142(BOOL bParam0, BOOL bParam1, BOOL bParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB073
{
	if (bParam0)
	{
...
Player func_145(Hash hParam0, BOOL bParam1) // Position - 0xB233
{
	Player player;
	Hash hash;
...
BOOL func_146(int iParam0) // Position - 0xB274
{
	int num;
...
BOOL func_147(int iParam0) // Position - 0xB296
{
...
int func_149(int iParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0xB2E3
{
	int num;
...
BOOL func_152(var uParam0) // Position - 0xB360
{
...
BOOL _CONVERSATION_IS_DIALOGUE_IN_PROGRESS() // Position - 0xB404
{
...
BOOL func_158(var uParam0, float fParam1, int iParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB493
{
...
void func_159(var uParam0) // Position - 0xB4EA
{
	if (!unk_0x1C2F771CDC87A3A5(uParam0, 0))
...
BOOL func_166(int iParam0) // Position - 0xB7F7
{
	if (iParam0 == 1)
...
BOOL func_168(int iParam0) // Position - 0xB85D
{
...
BOOL func_169(int iParam0) // Position - 0xB89E
{
	int num;
...
int func_171(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4) // Position - 0xB915
{
	int i;
...
void func_172(int iParam0, int iParam1) // Position - 0xBA4C
{
	int i;
...
BOOL _CAN_ENTER_FREEROAM_STATE(int iParam0) // Position - 0xBA9B
{
	return func_174(iParam0, Global_43922);
}

BOOL func_174(int iParam0, int iParam1) // Position - 0xBAAC
{
	if (iParam1 == 15)
		return 1;
...
BOOL func_175(int iParam0) // Position - 0xBC8D
{
	if (Global_43922 == 15)
		return false;
...
BOOL _IS_MISSION_REPLAY_IN_PROGRESS() // Position - 0xBD09
{
	if (Global_101392 == 10 || Global_101392 == 9)
		return true;
...
void func_179(int iParam0, var uParam1) // Position - 0xBD2D
{
	switch (iParam0)
	{
		case 0:
...
var func_180(float fParam0, float fParam1, float fParam2, int iParam3) // Position - 0xC19D
{
	var unk;
...
var func_181(BOOL bParam0, var uParam1, var uParam2) // Position - 0xC1C9
{
	if (bParam0)
		return uParam1;
...
BOOL func_182(int iParam0) // Position - 0xC1E0
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_183(var uParam0, int iParam1) // Position - 0xC26F
{
	switch (uParam0->f_16)
	{
		case 0:
...
BOOL func_185(var uParam0) // Position - 0xCA6D
{
	float num;
...
void func_186(int iParam0, var uParam1) // Position - 0xCAFB
{
	if (iParam0 == 1)
	{
		if (!func_138(uParam1))
...
BOOL func_187(BOOL bParam0) // Position - 0xCB5F
{
	var unk;
...
BOOL func_188(var uParam0) // Position - 0xCBF6
{
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0))
		if (unk_0xD9F5E1FEFD1329E4(uParam0, 0))
...
BOOL func_189(int iParam0) // Position - 0xCC20
{
	eCharacter character;
...
BOOL func_190() // Position - 0xD33D
{
	return Global_101431.f_1;
}

BOOL func_191() // Position - 0xD34B
{
	if (Global_98294 != -1)
...
BOOL func_195(int iParam0, int iParam1) // Position - 0xD3C3
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_196() // Position - 0xD3FB
{
	return Global_1575079;
}

BOOL func_197() // Position - 0xD407
{
	if (!unk_0x76CD105BCAC6EB9F())
...
void func_198(var uParam0) // Position - 0xD423
{
	if (iLocal_95 == -1)
...
void func_199(var uParam0, char* sParam1, char* sParam2, int iParam3) // Position - 0xD473
{
	unk_0x4CAD907F190E6F10(uParam0, sParam1, sParam2, AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM(iParam3), 0);
	return;
}

char* AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM(int iParam0) // Position - 0xD48C
{
	char* str;
...
int func_201(var uParam0, var uParam1, var uParam2, var uParam3, char* sParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, int iParam9) // Position - 0xD681
{
	var unk;

	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(unk_0x4A8C381C258A124D()) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_28[0]) && !_CONVERSATION_IS_DIALOGUE_IN_PROGRESS() && unk_0x1DD05E817C89C737() - uParam0->f_60 > iParam8 && func_205(unk_0x4A8C381C258A124D(), uParam1, 1) < iParam9)
	{
		unk = 16;
...
void _CONVERSATION_ADD_LINE_NO_SUBTITLE(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xD709
{
...
void func_203(var uParam0, eCharacter echParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xD744
{
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, var uParam2, char* sParam3, int iParam4, int iParam5) // Position - 0xD79A
{
...
float func_205(var uParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0xD835
{
	var unk;
...
BOOL func_206(var uParam0, var uParam1, var uParam2, var uParam3, char* sParam4, char* sParam5, int iParam6, char* sParam7, int iParam8) // Position - 0xD86F
{
	var unk;
	...
	if (func_189(2))
	{
		if (!_CONVERSATION_IS_DIALOGUE_IN_PROGRESS())
		{
			if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(unk_0x4A8C381C258A124D()) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_28[0]) && unk_0x1DD05E817C89C737() - uParam0->f_60 > iParam8 && func_205(unk_0x4A8C381C258A124D(), uParam1, 1) < 20f)
			{
				unk = 16;
				_CONVERSATION_INITIALIZE_ACTOR(&unk, iParam6, uParam0->f_28[0], sParam7, 0, 1);
				_CONVERSATION_ADD_LINE_NO_SUBTITLE(&unk, sParam4, sParam5, 7, 0, 0);
		...
		else if (func_207(sParam5))
		{
			if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(unk_0x4A8C381C258A124D()))
				if (func_205(unk_0x4A8C381C258A124D(), uParam1, 1) >= 20f)
					func_153();
		}
	}
...
BOOL func_207(char* sParam0) // Position - 0xD931
{
	var unk;
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(int iParam0) // Position - 0xD975
{
	if (unk_0xFC8BFE4B41177C22(iParam0))
...
void func_210(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) // Position - 0xD996
{
	if (unk_0x75EAB09F5E974116(unk_0x259BE71D8A81D4FA()))
	{
...
void func_213(var uParam0, int iParam1) // Position - 0xDAFC
{
	BOOL flag;
	int i;
...
void func_215(var uParam0) // Position - 0xDBA6
{
	unk_0xB479965CBAA3EAE1(0);
	unk_0xDD291722ADDCBD60();
	func_216(uParam0);
...
void func_216(var uParam0) // Position - 0xDBBD
{
	BOOL flag;
	int num;
	int i;
...
BOOL IS_RC_FINE_AND_IN_RANGE(Any* panParam0, BOOL bParam1) // Position - 0xDCCD
{
	var unk;
...
void func_219(int iParam0, var uParam1, int iParam2) // Position - 0xDF3D
{
	...
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(iParam0))
	{
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_221(uParam1) || !unk_0x13CCB1AD131C1082(iParam0, *uParam1, uParam1->f_2, 3))
				{
					if (func_220(iParam2) && !unk_0x3644984C9D7B57EF(iParam0, unk_0x4A8C381C258A124D(), 25f))
					{
						unk_0x0E95B96CFEFE7B61(iParam0, unk_0x4A8C381C258A124D(), 0);
						uParam1->f_3 = 5;
					}
					else if (func_221(uParam1) && uParam1->f_4 == 0 && unk_0xED977E2AE2CB16EE(unk_0xD1A6A821F5AC81DB(unk_0x4A8C381C258A124D(), 1), unk_0xD1A6A821F5AC81DB(iParam0, 1), 1) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
			...
			case 5:
				if (!func_220(iParam2) || unk_0x3644984C9D7B57EF(iParam0, unk_0x4A8C381C258A124D(), 10f))
				{
					if (func_71(uParam1->f_5, 0f, 0f, 0f, false))
						unk_0x10425721983AE158(iParam0, *uParam1, uParam1->f_1, 8f, -8f, -1, 262153, 0, 0, 0, 0);
					else
...
BOOL func_220(int iParam0) // Position - 0xE295
{
...
BOOL func_221(var uParam0) // Position - 0xE2B5
{
...
BOOL func_222(var uParam0) // Position - 0xE2CD
{
...
void func_224(var uParam0) // Position - 0xE5F6
{
...
BOOL CHECK_VEHICLES_OK(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0xE6A1
{
	int i;
	int num;
	var unk;
...
BOOL func_227(var uParam0, var uParam1) // Position - 0xE85F
{
	var unk;
...
BOOL func_228(var uParam0, BOOL bParam1, int iParam2) // Position - 0xE88F
{
	int i;
	int num;
...
BOOL func_229(int iParam0) // Position - 0xEB4B
{
...
BOOL func_230(var uParam0, int iParam1) // Position - 0xEB7F
{
	float num;
...
BOOL func_231(var uParam0, int iParam1) // Position - 0xEBF5
{
	return func_232(uParam0, unk_0x4A8C381C258A124D(), iParam1, 1, 250, 7);
}

BOOL func_232(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xEC0D
{
	BOOL flag;
	var unk;
	int num;
...
BOOL func_233(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, int iParam7) // Position - 0xECCE
{
	var unk;
	var unk2;
	var unk5;
...
Vector3 func_234(var uParam0, int iParam1) // Position - 0xEDFA
{
	int num;
...
BOOL func_236(var uParam0, var uParam1, int iParam2, int iParam3) // Position - 0xEF09
{
	var unk;
	var unk4;
	float num;
...
float func_237(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0xEF9A
{
	return (fParam0 * uParam3) + (fParam0.f_1 * uParam3.f_1) + (fParam0.f_2 * uParam3.f_2);
}

Vector3 func_238(float fParam0, var uParam1, var uParam2) // Position - 0xEFBB
{
	float num;
	float num2;
...
int func_240(var uParam0, var uParam1) // Position - 0xF015
{
	int i;
...
int func_241(var uParam0) // Position - 0xF054
{
...
BOOL func_242(var uParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xF07C
{
	float num;
	float num2;
	int num3;
...
BOOL func_243(var uParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0xF177
{
	float num;
	float num2;
...
BOOL func_244(var uParam0, float fParam1) // Position - 0xF283
{
	var unk;
	var unk2;
...
BOOL func_245(var uParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xF318
{
	var unk;
	var unk4;
	float num;
...
BOOL func_246(var uParam0, BOOL bParam1, float fParam2, float fParam3) // Position - 0xF3A6
{
	if (bParam1)
		if (unk_0x65F146FF416F109F(unk_0x4A8C381C258A124D()))
...
BOOL func_247(int iParam0) // Position - 0xF3EE
{
...
void func_248(var uParam0) // Position - 0xF438
{
	var unk;
...
BOOL func_249(int iParam0) // Position - 0xF4D5
{
	if (iParam0 == -1)
		iParam0 = func_176();
...
BOOL func_250(int iParam0) // Position - 0xF56A
{
...
BOOL func_253(int iParam0) // Position - 0xF5E9
{
...
BOOL func_255(int iParam0) // Position - 0xF65B
{
...
BOOL func_256(var uParam0) // Position - 0xF683
{
	switch (*uParam0)
	{
		case 21:
...
BOOL func_259(var uParam0, eCharacter echParam1, float fParam2, float fParam3, float fParam4, float fParam5, char* sParam6, int iParam7) // Position - 0xFAF7
{
...
BOOL func_260(var uParam0, eCharacter echParam1, var uParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0xFB53
{
	int num;

	if (!func_36(echParam1))
	{
		num = func_304(echParam1);
...
int func_261(int iParam0, eCharacter echParam1) // Position - 0xFBE1
{
	int num;
...
BOOL func_262(var uParam0) // Position - 0xFC27
{
	if (func_222(uParam0))
	{
...
BOOL func_263(var uParam0) // Position - 0xFC51
{
	int i;
...
BOOL func_265(var uParam0) // Position - 0xFCBE
{
	int num;
	int i;
	BOOL flag;
	...
	switch (iLocal_89)
	{
		...
		case 2:
			...
			{
				func_269(&uParam0->f_28[1], num[1], 808.43f, 1279.16f, 360.47f, -79.11f, 26);
...
void func_267(var uParam0, var uParam1, float fParam2, float fParam3, float fParam4, float fParam5) // Position - 0x10004
{
	func_268(uParam0);
...
void func_268(var uParam0) // Position - 0x10047
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
void func_269(var uParam0, var uParam1, float fParam2, float fParam3, float fParam4, float fParam5, int iParam6) // Position - 0x100E3
{
	func_270(uParam0);
...
void func_270(var uParam0) // Position - 0x10104
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (!unk_0x1C2F771CDC87A3A5(*uParam0, 0))
...
BOOL func_271(var uParam0) // Position - 0x10145
{
	int num;
	int i;
	BOOL flag;
...
BOOL func_272(int iParam0) // Position - 0x102A0
{
	var unk;
	eCharacter character;
...
BOOL func_273(int iParam0) // Position - 0x102F1
{
	var unk;
...
BOOL func_274(int iParam0) // Position - 0x103AA
{
	var unk;
...
BOOL func_275(int iParam0) // Position - 0x1046B
{
	int i;
	var unk;
	int num;
...
BOOL func_277(int iParam0) // Position - 0x105D2
{
...
BOOL func_278(int iParam0) // Position - 0x105FD
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_279(int iParam0) // Position - 0x10628
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_280(int iParam0) // Position - 0x10653
{
	if (func_250(iParam0))
		return false;
	else if (!unk_0x4FAFF4BCB7633475(unk_0x4A8C381C258A124D()))
...
BOOL func_282(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, float fParam5) // Position - 0x106A2
{
	int i;
...
BOOL func_283(int iParam0, var uParam1, var uParam2, var uParam3, float fParam4, var uParam5) // Position - 0x10707
{
	int num;
	char* str;
...
BOOL func_284(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7) // Position - 0x1077F
{
	if (fParam6 < 0f)
		fParam6 = 0f;
...
void func_285(var uParam0, BOOL bParam1) // Position - 0x107FA
{
	char* str;
...
void func_293(var uParam0, BOOL bParam1) // Position - 0x10994
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (unk_0x5B9219522937741D(*uParam0))
...
void func_296(var uParam0) // Position - 0x10A1E
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
void func_299(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x10AA9
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (!unk_0x4FAFF4BCB7633475(*uParam0))
...
void func_300(int iParam0) // Position - 0x10AF9
{
	if (*iParam0 == -1)
		return;
...
int func_304(eCharacter echParam0) // Position - 0x10B95
{
	if (!func_36(echParam0))

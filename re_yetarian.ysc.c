...
void _STAT_SET_PACKED_BOOL(int iParam0, int iParam1, Player plParam2) // Position - 0xD95
{
	if (plParam2 == -1)
		plParam2 = func_15();
...
{
	switch (func_72(&Global_32888, 0, 5, false, unk_0x8F76B2250AC806FA()))
	{
		case 1:
			return true;
...
int func_82(int iParam0, eCharacter echParam1) // Position - 0x36A6
{
	int num;
...
void func_101(int iParam0) // Position - 0x5B9A
{
	...
	if (func_129())
	{
		...
		func_104(30000);
		TEXT_LABEL_ASSIGN_STRING(&unk, func_103(Global_114359, true), 64);
...
{
	if (Global_114359 == func_32() && unk_0x9FA91AA1AC724CD0() && Global_114360)
		return true;
...
void func_133(eCharacter echParam0) // Position - 0x6B0D
{
	...
	unk = { func_140(echParam0) };

	if (IS_BIT_SET(unk.f_4, 2))
		func_138(echParam0, &unk);
...
BOOL func_136(eCharacter echParam0) // Position - 0x7279
{
	int num;
...
var func_137(var uParam0) // Position - 0x72E5
{
	return uParam0;
}
...
void func_138(int iParam0, var uParam1) // Position - 0x72EF
{
	...
	switch (iParam0)
	{
		...
		case 71:
		case 72:
			if (!func_139(iParam0) && unk_0x486FF5D06E9659F1(Global_92160[26 /*34*/].f_6) == 0)
			{
				Global_114370.f_7264[iParam0] = 1;
				unk_0xEBB2809684978887(uParam1->f_5, Global_114370.f_7264[iParam0], 1, 1);
			}
		...
		if (unk_0xFC8BFE4B41177C22(unk_0x4A8C381C258A124D()))
		{
			if (!unk_0x4FAFF4BCB7633475(unk_0x4A8C381C258A124D()))
			{
				...
				switch (iParam0)
				{
					...
					case 1:
						if (unk_0x6652E84A43F51B8B(unk_0x259BE71D8A81D4FA(), 1) || func_164() || Global_32831 || func_163() || func_52(8, -1) || func_160() || func_162() || func_161() || func_159() || Global_114370.f_7691.f_919[character] == 5)
							return false;
						break;
					...
					case 4:
						if (func_164() || unk_0xE7B45027762DEFE7(unk_0x259BE71D8A81D4FA()) > 0 || func_52(8, -1) || func_159() || func_158() || Global_114370.f_7691.f_919[character] == 5)
							return false;
						break;

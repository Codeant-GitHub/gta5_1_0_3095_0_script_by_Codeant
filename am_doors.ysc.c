...
void func_1() // Position - 0x24B
{
	...
	{
		if (_NETWORK_IS_PLAYER_VALID(unk_0xB23E0F9B63D009A8(iLocal_229), false, true))
		{
			if (IS_BIT_SET(uLocal_282[iLocal_229 /*4*/].f_2, iLocal_230))
				unk_0x0B0C9A0F9AAEB7F0(&iLocal_232.f_2[iLocal_230], iLocal_229);
			else
				unk_0x8744D2E3FC95740E(&iLocal_232.f_2[iLocal_230], iLocal_229);
		}
		else
		{
			unk_0x8744D2E3FC95740E(&iLocal_232.f_9[iLocal_230], iLocal_229);
			unk_0x8744D2E3FC95740E(&iLocal_232.f_9[iLocal_230], iLocal_229);
		}
	...
	if (uLocal_262[iParam0] == 0)
	{
		if (unk_0xE2A2194077783E19(uParam1) == -1)
		{
			if (unk_0x117BCCA03F7A311A(uParam1) != iParam2)
			{
				...
				{
					unk_0x0B0C9A0F9AAEB7F0(&uLocal_262[iParam0], num);
...
void func_9() // Position - 0x5AB
{
	...
	if (IS_BIT_SET(Global_2748465, iLocal_231) || IS_BIT_SET(Global_2748465.f_1, iLocal_231) || IS_BIT_SET(Global_2748465.f_2, iLocal_231))
	{
		if (IS_BIT_SET(Global_2748465, iLocal_231))
			unk_0x0B0C9A0F9AAEB7F0(&(uLocal_282[unk_0x259BE71D8A81D4FA() /*4*/].f_2), iLocal_231);
	
		if (IS_BIT_SET(Global_2748465.f_1, iLocal_231))
			unk_0x8744D2E3FC95740E(&(uLocal_282[unk_0x259BE71D8A81D4FA() /*4*/].f_2), iLocal_231);
	
		if (IS_BIT_SET(Global_2748465.f_2, iLocal_231))
			unk_0x0B0C9A0F9AAEB7F0(&(uLocal_282[unk_0x259BE71D8A81D4FA() /*4*/].f_3), iLocal_231);
	}
	else if (num <= 20f)
	{
		if (unk_0x26715B0ED6702C87(vector, uLocal_126[iLocal_231 /*17*/].f_3, uLocal_126[iLocal_231 /*17*/].f_6, uLocal_126[iLocal_231 /*17*/].f_9, 0, 1))
			if (!IS_BIT_SET(uLocal_282[unk_0x259BE71D8A81D4FA() /*4*/].f_2, iLocal_231))
				unk_0x0B0C9A0F9AAEB7F0(&(uLocal_282[unk_0x259BE71D8A81D4FA() /*4*/].f_2), iLocal_231);
	
		if (iLocal_231 == 0 || iLocal_231 == 1 || iLocal_231 == 5)
			if (Global_2697675 || !func_13())
				if (unk_0x26715B0ED6702C87(vector, uLocal_126[iLocal_231 /*17*/].f_10, uLocal_126[iLocal_231 /*17*/].f_13, uLocal_126[iLocal_231 /*17*/].f_16, 0, 1))
					if (!IS_BIT_SET(uLocal_282[unk_0x259BE71D8A81D4FA() /*4*/].f_2, iLocal_231))
						unk_0x0B0C9A0F9AAEB7F0(&(uLocal_282[unk_0x259BE71D8A81D4FA() /*4*/].f_2), iLocal_231);
		...
		if (iLocal_231 == 2 || iLocal_231 == 3 || iLocal_231 == 4)
			if (_GET_ACTIVE_PV_SLOT() >= 0)
				if (func_10(29))
					if (!IS_BIT_SET(uLocal_282[unk_0x259BE71D8A81D4FA() /*4*/].f_2, iLocal_231))
						unk_0x0B0C9A0F9AAEB7F0(&(uLocal_282[unk_0x259BE71D8A81D4FA() /*4*/].f_2), iLocal_231);
				else if (IS_BIT_SET(uLocal_282[unk_0x259BE71D8A81D4FA() /*4*/].f_2, iLocal_231) && !unk_0x26715B0ED6702C87(vector, uLocal_126[iLocal_231 /*17*/].f_3, uLocal_126[iLocal_231 /*17*/].f_6, uLocal_126[iLocal_231 /*17*/].f_9, 0, 1))
					unk_0x8744D2E3FC95740E(&(uLocal_282[unk_0x259BE71D8A81D4FA() /*4*/].f_2), iLocal_231);
	}
	else if (IS_BIT_SET(uLocal_282[unk_0x259BE71D8A81D4FA() /*4*/].f_2, iLocal_231))
	{
		unk_0x8744D2E3FC95740E(&(uLocal_282[unk_0x259BE71D8A81D4FA() /*4*/].f_2), iLocal_231);
	}
...
BOOL func_13() // Position - 0x875
{
	...
	if (func_29(unk_0x259BE71D8A81D4FA(), true) && !Global_1970582)
		return true;
...
Vector3 _GET_PLAYER_COORDS(var uParam0) // Position - 0xB6D
{
	...
	for (i = 0; i < 4; i = i + 1)
	{
		...
		if (unk_0xED977E2AE2CB16EE(_GET_PLAYER_COORDS(unk_0x259BE71D8A81D4FA()), unk.f_1, 1) < 150f)
		{
			...
			for (j = 0; j < 32; j = j + 1)
			{
				...
				{
					if (func_36(player) && unk_0x5105BE70DEF1F5FB(unk_0x56E414973C2A8C0E(player), unk.f_4[0 /*3*/], unk.f_4[1 /*3*/], unk.f_11, 0, 1, 0))
					{
						flag = true;
						j = 32;
					}
			...
			if (flag)
			{
				if (uLocal_411[i] != 1f)
				{
					uLocal_411[i] = uLocal_411[i] + (unk.f_12 * SYSTEM::TIMESTEP());
				
					if (uLocal_411[i] > 1f)
						uLocal_411[i] = 1f;
				
					unk_0x60F1DCFB89B4F353(unk, 1);
					unk_0x3A15B21067339E98(unk, uLocal_411[i], 0, 0);
...
int func_36(Player plParam0) // Position - 0xCDE
{
	int num;
	Player player;
	int num2;
...
{
	uLocal_282[unk_0xAE032CEDCF23C6D5() /*4*/] = iParam0;
	return;
}
...
BOOL func_60(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19, var uParam20) // Position - 0x5F0B
{
	...
	unk_0x6F4A865F87C7A3AD(&iLocal_232, 30, 0);
...
BOOL _SHOULD_NETWORK_SCRIPT_TERMINATE() // Position - 0x7254
{
...
int _GET_CURRENT_SESSION_TYPE_SCRIPT_HASH() // Position - 0x72D8
{
	switch (func_53())
	{
		case 0:

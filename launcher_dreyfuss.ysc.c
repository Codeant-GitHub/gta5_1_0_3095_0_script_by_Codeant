...
void main() // Position - 0x0
{
	...
	if (!func_277(&unk64, &num, unk61, 1f))
	{
		func_276();
	...
	while (true)
	{
		...
		func_209(num);
		func_202(&iLocal_96, &(num.f_9), unk61);
	
		if (num == 8)
			func_198(&num, unk61, "DREY1AU", "DREY1_IDLE", 3, "DREYFUSS", 5000, 1101004800);
...
int func_49(int iParam0, Hash hParam1) // Position - 0x38AE
{
	var unk;
	int num;
...
Hash func_51(Hash hParam0) // Position - 0x38F2
{
	Hash hash;
	Hash hash2;
...
Hash func_52() // Position - 0x3926
{
	return Global_1574925;
}

BOOL func_53(int iParam0, Hash hParam1) // Position - 0x3932
{
	var unk;
	BOOL num;
...
var func_54(int iParam0, Hash hParam1) // Position - 0x3956
{
...
BOOL func_69(var uParam0, var uParam1, var uParam2, char* sParam3, float fParam4, float fParam5, float fParam6) // Position - 0x5D7D
{
	var unk;
	var unk2;
...
BOOL func_71(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0x6540
{
	if (bParam6)
...
BOOL func_72(var uParam0) // Position - 0x6587
{
...
BOOL func_74(int iParam0, int iParam1, BOOL bParam2) // Position - 0x65F2
{
	if (iParam0 == -1)
		return false;
...
BOOL func_77(int iParam0) // Position - 0x6A05
{
	return func_74(iParam0, 5, true);
}

int func_78(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x6A15
{
	int i;
	float num;
	float num2;
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x752C
{
...
Vector3 func_83(float fParam0, float fParam1, float fParam2) // Position - 0x7556
{
...
BOOL func_85(Player plParam0) // Position - 0x7582
{
...
BOOL func_87(int iParam0, int iParam1, var uParam2, int iParam3, BOOL bParam4) // Position - 0x7684
{
	var unk;
	var unk7;
	var unk13;
...
Vector3 func_88(float fParam0, var uParam1, var uParam2, float fParam3) // Position - 0x7719
{
	float num;
	float num2;
	float num3;
...
void func_126(Vehicle veParam0) // Position - 0xAA85
{
	int num;
	int num2;
	int num3;
...
int func_128(Vehicle veParam0) // Position - 0xAB61
{
	int i;
...
int func_134(Vehicle veParam0) // Position - 0xACC1
{
	int i;
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(int iParam0) // Position - 0xAD2A
{
	if (unk_0xFC8BFE4B41177C22(iParam0))
...
Player func_146(Hash hParam0, BOOL bParam1) // Position - 0xB1CD
{
	Player player;
	Hash hash;
...
void func_160(var uParam0) // Position - 0xB484
{
	if (!unk_0x1C2F771CDC87A3A5(uParam0, 0))
...
BOOL func_167(int iParam0) // Position - 0xB791
{
	if (iParam0 == 1)
...
BOOL func_169(int iParam0) // Position - 0xB7F7
{
...
BOOL func_170(int iParam0) // Position - 0xB838
{
	int num;
...
int func_172(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4) // Position - 0xB8AF
{
	int i;
...
void func_173(int iParam0, int iParam1) // Position - 0xB9E6
{
	int i;
...
BOOL _CAN_ENTER_FREEROAM_STATE(int iParam0) // Position - 0xBA35
{
	return func_175(iParam0, Global_43922);
}

BOOL func_175(int iParam0, int iParam1) // Position - 0xBA46
{
	if (iParam1 == 15)
		return 1;
...
BOOL func_176(int iParam0) // Position - 0xBC27
{
	if (Global_43922 == 15)
		return false;
...
BOOL _IS_MISSION_REPLAY_IN_PROGRESS() // Position - 0xBCA3
{
	if (Global_101392 == 10 || Global_101392 == 9)
		return true;
...
int func_180() // Position - 0xBCC7
{
	if (func_183(2))
	{
		if (func_182(unk_0x4A8C381C258A124D(), -1459.68f, 485.26f, 116.22f, 1) < 6f && !unk_0x8BF5256C439DF778(unk_0x4A8C381C258A124D()))
		{
			if (!unk_0x7F420695E3F776FB(unk_0x4A8C381C258A124D(), 0))
			{
			...
			else if (!func_181(unk_0x4A8C381C258A124D(), joaat("SCRIPT_TASK_LEAVE_ANY_VEHICLE")) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(unk_0x6EF03BE64E058E2F(unk_0x4A8C381C258A124D(), 0)) && func_159(unk_0x6EF03BE64E058E2F(unk_0x4A8C381C258A124D(), 0), 1f, 1, 1056964608, 0, true, false))
			{
				unk_0x092B9247AF00F5CF(unk_0x4A8C381C258A124D(), 0, 0);
			}
		}
...
BOOL func_181(var uParam0, int iParam1) // Position - 0xBD68
{
	if (func_135(uParam0))
...
float func_182(var uParam0, float fParam1, float fParam2, float fParam3, int iParam4) // Position - 0xBD9B
{
	var unk;
...
BOOL func_183(int iParam0) // Position - 0xBDD5
{
	eCharacter character;
		...
		if (unk_0xFC8BFE4B41177C22(unk_0x4A8C381C258A124D()))
		{
			if (!unk_0x4FAFF4BCB7633475(unk_0x4A8C381C258A124D()))
			{
				...
				switch (iParam0)
				{
					...
					case 3:
						if (unk_0x8BF5256C439DF778(unk_0x4A8C381C258A124D()) || unk_0x9857C978BD3CBEDA(unk_0x4A8C381C258A124D()) || unk_0x6652E84A43F51B8B(unk_0x259BE71D8A81D4FA(), 1) || unk_0x1B32E388988DD296(unk_0x4A8C381C258A124D(), 0) || func_191() || Global_113417 || Global_32831 || func_190() || func_189(8, -1) || func_100() || func_188() || func_186() || Global_114370.f_7691.f_919[character] == 5)
							return false;
						break;
				
					case 4:
						if (func_191() || unk_0xE7B45027762DEFE7(unk_0x259BE71D8A81D4FA()) > 0 || func_189(8, -1) || func_186() || func_185() || Global_114370.f_7691.f_919[character] == 5)
							return false;
						break;
...
BOOL func_184() // Position - 0xC4F5
{
	return Global_101431.f_1;
}

BOOL func_185() // Position - 0xC503
{
	if (Global_98294 != -1)
...
BOOL func_189(int iParam0, int iParam1) // Position - 0xC57B
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_190() // Position - 0xC5B3
{
	return Global_1575079;
}

BOOL func_191() // Position - 0xC5BF
{
	if (!unk_0x76CD105BCAC6EB9F())
...
int func_192(var uParam0, int iParam1) // Position - 0xC5DB
{
	switch (uParam0->f_16)
	{
		case 0:
...
BOOL func_194(var uParam0) // Position - 0xCDD9
{
	float num;
...
void func_195(int iParam0, var uParam1) // Position - 0xCE67
{
	if (iParam0 == 1)
	{
		if (!func_139(uParam1))
...
BOOL func_196(BOOL bParam0) // Position - 0xCECB
{
	var unk;
...
BOOL func_197(var uParam0) // Position - 0xCF62
{
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0))
		if (unk_0xD9F5E1FEFD1329E4(uParam0, 0))
...
int func_198(var uParam0, var uParam1, var uParam2, var uParam3, char* sParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, int iParam9) // Position - 0xCF8C
{
	var unk;

	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(unk_0x4A8C381C258A124D()) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_28[0]) && !_CONVERSATION_IS_DIALOGUE_IN_PROGRESS() && unk_0x1DD05E817C89C737() - uParam0->f_60 > iParam8 && func_182(unk_0x4A8C381C258A124D(), uParam1, 1) < iParam9)
	{
		unk = 16;
...
void _CONVERSATION_ADD_LINE_NO_SUBTITLE(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xD014
{
...
void func_200(var uParam0, eCharacter echParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xD04F
{
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, var uParam2, char* sParam3, int iParam4, int iParam5) // Position - 0xD0A5
{
...
void func_202(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) // Position - 0xD140
{
	if (unk_0x75EAB09F5E974116(unk_0x259BE71D8A81D4FA()))
	{
		if (!unk_0xD6F9DEE4765092A9(uParam1))
		{
			...
			{
				if (func_182(unk_0x4A8C381C258A124D(), uParam2, 1) <= 100f)
					func_205(uParam0, 1);
			}
			else
			{
				...
				if (func_182(unk_0x4A8C381C258A124D(), uParam2, 1) > 120f)
					func_207(uParam0);
			}
		}
	}
...
void func_205(var uParam0, int iParam1) // Position - 0xD2A6
{
	BOOL flag;
	int i;
...
void func_207(var uParam0) // Position - 0xD350
{
	unk_0xB479965CBAA3EAE1(0);
	unk_0xDD291722ADDCBD60();
	func_208(uParam0);
...
void func_208(var uParam0) // Position - 0xD367
{
	BOOL flag;
	int num;
	int i;
...
BOOL IS_RC_FINE_AND_IN_RANGE(Any* panParam0, BOOL bParam1) // Position - 0xD477
{
	var unk;
...
BOOL func_212(int iParam0) // Position - 0xDA3F
{
...
BOOL func_213(var uParam0) // Position - 0xDA5F
{
...
BOOL func_214(var uParam0) // Position - 0xDA77
{
...
void func_216(var uParam0) // Position - 0xDDA0
{
...
BOOL CHECK_VEHICLES_OK(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0xDE4B
{
	int i;
	int num;
	var unk;
...
BOOL func_219(var uParam0, var uParam1) // Position - 0xE009
{
	var unk;
...
BOOL func_220(var uParam0, BOOL bParam1, int iParam2) // Position - 0xE039
{
	int i;
	int num;
...
BOOL func_221(int iParam0) // Position - 0xE2F5
{
...
BOOL func_222(var uParam0, int iParam1) // Position - 0xE329
{
	float num;
...
BOOL func_223(var uParam0, int iParam1) // Position - 0xE39F
{
	return func_224(uParam0, unk_0x4A8C381C258A124D(), iParam1, 1, 250, 7);
}

BOOL func_224(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xE3B7
{
	BOOL flag;
	var unk;
	int num;
...
BOOL func_225(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, int iParam7) // Position - 0xE478
{
	var unk;
	var unk2;
	var unk5;
...
Vector3 func_226(var uParam0, int iParam1) // Position - 0xE5A4
{
	int num;
...
BOOL func_228(var uParam0, var uParam1, int iParam2, int iParam3) // Position - 0xE6B3
{
	var unk;
	var unk4;
	float num;
...
float func_229(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0xE744
{
	return (fParam0 * uParam3) + (fParam0.f_1 * uParam3.f_1) + (fParam0.f_2 * uParam3.f_2);
}

Vector3 func_230(float fParam0, var uParam1, var uParam2) // Position - 0xE765
{
	float num;
	float num2;
...
int func_232(var uParam0, var uParam1) // Position - 0xE7BF
{
	int i;
...
int func_233(var uParam0) // Position - 0xE7FE
{
...
BOOL func_234(var uParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xE826
{
	float num;
	float num2;
	int num3;
...
BOOL func_235(var uParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0xE921
{
	float num;
	float num2;
...
BOOL func_236(var uParam0, float fParam1) // Position - 0xEA2D
{
	var unk;
	var unk2;
...
BOOL func_237(var uParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xEAC2
{
	var unk;
	var unk4;
	float num;
...
BOOL func_238(var uParam0, BOOL bParam1, float fParam2, float fParam3) // Position - 0xEB50
{
	if (bParam1)
		if (unk_0x65F146FF416F109F(unk_0x4A8C381C258A124D()))
...
BOOL func_239(int iParam0) // Position - 0xEB98
{
...
void func_240(var uParam0) // Position - 0xEBE2
{
	var unk;
...
BOOL func_241(int iParam0) // Position - 0xEC7F
{
	if (iParam0 == -1)
		iParam0 = func_177();
...
BOOL func_242(int iParam0) // Position - 0xED14
{
...
BOOL func_245(int iParam0) // Position - 0xED93
{
...
BOOL func_247(int iParam0) // Position - 0xEE05
{
...
BOOL func_250(var uParam0) // Position - 0xEE7B
{
	int num;
	int i;
	BOOL flag;
...
void func_251(int iParam0) // Position - 0xF096
{
...
void func_252(int iParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0xF0E8
{
	if (iParam0 != 198)
	{
		if (Global_79248)
...
void func_259(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, float fParam5) // Position - 0x13777
{
	func_260(uParam0);
...
void func_260(var uParam0) // Position - 0x137BA
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
BOOL func_261(var uParam0, eCharacter echParam1, float fParam2, float fParam3, float fParam4, float fParam5, char* sParam6, int iParam7) // Position - 0x13856
{
...
BOOL func_262(var uParam0, eCharacter echParam1, var uParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0x138B2
{
	int num;

	if (!func_36(echParam1))
	{
		num = func_302(echParam1);
...
int func_263(int iParam0, eCharacter echParam1) // Position - 0x13940
{
	int num;
...
BOOL func_264(var uParam0) // Position - 0x13986
{
	if (func_214(uParam0))
	{
...
BOOL func_265(var uParam0) // Position - 0x139B0
{
	int i;
...
BOOL func_267(int iParam0) // Position - 0x13A1D
{
	var unk;
	eCharacter character;
...
BOOL func_268(int iParam0) // Position - 0x13A6E
{
	var unk;
...
BOOL func_269(int iParam0) // Position - 0x13B27
{
	var unk;
...
BOOL func_270(int iParam0) // Position - 0x13BE8
{
	int i;
	var unk;
	int num;
...
BOOL func_272(int iParam0) // Position - 0x13D4F
{
...
BOOL func_273(int iParam0) // Position - 0x13D7A
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_274(int iParam0) // Position - 0x13DA5
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_275(int iParam0) // Position - 0x13DD0
{
	if (func_242(iParam0))
		return false;
	else if (!unk_0x4FAFF4BCB7633475(unk_0x4A8C381C258A124D()))
...
BOOL func_277(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, float fParam5) // Position - 0x13E1F
{
	int i;
...
BOOL func_278(int iParam0, var uParam1, var uParam2, var uParam3, float fParam4, var uParam5) // Position - 0x13E84
{
	int num;
	char* str;
...
BOOL func_279(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7) // Position - 0x13EFC
{
	if (fParam6 < 0f)
		fParam6 = 0f;
...
void func_280(var uParam0, BOOL bParam1) // Position - 0x13F77
{
	char* str;
...
BOOL func_284(char* sParam0) // Position - 0x14050
{
	var unk;
...
void func_290(var uParam0, BOOL bParam1) // Position - 0x1413A
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (unk_0x5B9219522937741D(*uParam0))
...
void func_293(var uParam0) // Position - 0x141C4
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
void func_295(var uParam0, int iParam1) // Position - 0x1420E
{
	...
	for (i = 0; i <= *uParam0 - 1; i = i + 1)
	{
		if (iParam1 == 1)
			...
			func_296(&uParam0->[i], 0, 1, 0);
	}

	return;
}

void func_296(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x1424F
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (!unk_0x4FAFF4BCB7633475(*uParam0))
...
void func_297(var uParam0) // Position - 0x1429F
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (!unk_0x1C2F771CDC87A3A5(*uParam0, 0))
...
void func_298(int iParam0) // Position - 0x142E0
{
	if (*iParam0 == -1)
		return;
...
int func_302(eCharacter echParam0) // Position - 0x1437C
{
	if (!func_36(echParam0))

...
void main() // Position - 0x0
{
	...
	if (unk_0x96CFB880BAC634CE(67))
	{
		...
		func_257(&iLocal_397, &uLocal_400, uLocal_402, iLocal_58);
	}
...
void func_6(int iParam0) // Position - 0x1A36
{
	...
	else if (IS_BIT_SET(Global_114370.f_20567.f_471, iParam0) || IS_BIT_SET(Global_2359296[func_8() /*5569*/].f_681.f_10, iParam0))
	{
		flag = true;
		unk_0x8744D2E3FC95740E(&(Global_114370.f_20567.f_471), iParam0);
		unk_0x8744D2E3FC95740E(&(Global_2359296[func_8() /*5569*/].f_681.f_10), iParam0);
	}
...
void func_9(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x1CB3
{
	int num;
...
int func_10(int iParam0, int iParam1) // Position - 0x1CE1
{
...
void _STAT_SET_PACKED_BOOL(int iParam0, int iParam1, int iParam2) // Position - 0x1D36
{
	if (iParam2 == -1)
		iParam2 = func_12();
...
eCharacter _GET_PLAYER_CHARACTER_FROM_PED(int iParam0) // Position - 0x25F7
{
	eCharacter i;
	int num;
...
int _GET_CHARACTER_MODEL(eCharacter character) // Position - 0x2634
{
...
int func_44(eCharacter echParam0) // Position - 0x2659
{
	return Global_2139[echParam0 /*29*/];
}

BOOL func_45(var uParam0) // Position - 0x2668
{
	var unk;
	int num;
...
BOOL func_46(var uParam0) // Position - 0x26EB
{
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(var uParam0) // Position - 0x2715
{
...
int func_48(var uParam0) // Position - 0x2736
{
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0))
...
BOOL func_49(var uParam0) // Position - 0x2756
{
	var unk;
	int num;
...
void func_50(var uParam0, float fParam1) // Position - 0x27C2
{
...
BOOL func_53(var uParam0, float fParam1) // Position - 0x285E
{
...
BOOL func_54(var uParam0, float fParam1) // Position - 0x287C
{
	if (func_76(uParam0))
...
BOOL func_62(int iParam0, int iParam1) // Position - 0x2F4C
{
...
float func_73(int iParam0, var uParam1, int iParam2) // Position - 0x32D1
{
	var unk;
	var unk4;
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x332F
{
...
BOOL func_76(var uParam0) // Position - 0x3404
{
...
Vector3 func_78(var uParam0) // Position - 0x3450
{
	var unk;
	var unk4;
	var unk7;
...
void func_79(BOOL bParam0, BOOL bParam1, BOOL bParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0x34B5
{
	if (bParam0)
	{
...
BOOL func_83(int iParam0) // Position - 0x36B6
{
	int num;
...
BOOL func_84(int iParam0) // Position - 0x36D8
{
...
int func_86(int iParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0x3725
{
	int num;
...
Vector3 func_88(var uParam0, float fParam1, float fParam2, float fParam3) // Position - 0x377B
{
	var unk;
...
BOOL func_89(var uParam0) // Position - 0x37C1
{
	if (!unk_0xFC8BFE4B41177C22(uParam0))
		return false;
...
BOOL func_95(int iParam0, int iParam1, var uParam2) // Position - 0x3C00
{
	int num;
	var unk;
	var unk9;
...
BOOL func_99(var uParam0, var uParam1, var uParam2) // Position - 0x3E39
{
	BOOL flag;
	BOOL flag2;
...
void func_100(var uParam0, int iParam1, int iParam2, BOOL bParam3, BOOL bParam4, int iParam5) // Position - 0x3EB7
{
	var unk;
	var unk2;
	BOOL flag;
...
void func_103(var uParam0) // Position - 0x4199
{
...
void func_104(var uParam0) // Position - 0x41AB
{
...
BOOL func_106(var uParam0) // Position - 0x41C8
{
	if (*uParam0 != 0)
	{
...
void func_107(var uParam0) // Position - 0x41EF
{
	if (*uParam0 != 0)
	{
...
void func_109(var uParam0, var uParam1, int iParam2) // Position - 0x4225
{
	BOOL flag;
...
void func_121(var uParam0) // Position - 0x479D
{
	func_50(uParam0, 0f);
	return;
}
...
void func_133(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, float fParam8, int iParam9) // Position - 0x4B3F
{
	var unk;
	int num;
...
void func_134(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x4CD9
{
	int num;
	var unk;
	var unk9;
...
void func_135(var uParam0) // Position - 0x4E0E
{
	uParam0->f_1 = 0f;
	uParam0->f_2 = 0f;
	*uParam0 = 0;
...
float func_137(var uParam0) // Position - 0x4E47
{
	if (func_76(uParam0))
		if (func_138(uParam0))
			return uParam0->f_2;
...
void func_139(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x4E90
{
	var unk;
	int i;
...
int func_144(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x5551
{
	var unk;
	int i;
	int num;
...
BOOL func_150(int iParam0, int iParam1, int iParam2, var uParam3) // Position - 0x5BA9
{
	int num;
...
BOOL func_160(int iParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x9069
{
	int num;
	int num2;
	int num3;
	...
	if (func_161(iParam0, iParam1, &num3, &num2, bParam2, bParam3))
	{
...
void func_163(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0xBC69
{
	...
	if (iParam0 == 12)
	{
		...
		if (num4 >= 0)
		{
			...
			if (num5 > num4)
			{
				...
				Global_2883589 = num3;
				func_155(&Global_79031[0 /*14*/], iParam0, iParam1, &(num3.f_7), 0, 0, num3.f_2, false, -1, 2, true);
				return;
			}
		}
	}
	...
	else if (iParam0 == 14)
	{
		...
		if (num8 >= 0)
		{
			...
			if (num9 > num8)
			{
				...
				Global_2883589 = num6;
				func_155(&Global_79031[0 /*14*/], iParam0, iParam1, &(num6.f_9), num6.f_3, num6.f_4, num6.f_5, unk_0x304A39EB177D246B(num6.f_1, joaat("OUTFIT_ONLY"), 0), num7, 2, num6.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_79229)
		{
			...
			func_155(&Global_79031[0 /*14*/], iParam0, iParam1, &(num10.f_9), num10.f_3, num10.f_4, num10.f_5, unk_0x304A39EB177D246B(num10.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, num10.f_1 != 0);
			return;
		}
		...
		if (num11 >= 0)
		{
			num12 = unk_0x7B6C0A0D604E68FA(num2, 10, -1, 0, -1, func_146(iParam0));
...
BOOL func_218(int iParam0, int iParam1, int iParam2, var uParam3) // Position - 0x1D109
{
	int num;
...
int func_219(int iParam0, int iParam1, var uParam2, int iParam3) // Position - 0x1D410
{
	int num;
	int num2;
	int num3;
...
BOOL func_222(int iParam0, int iParam1) // Position - 0x1D6B1
{
	var unk;
	BOOL num;
...
var func_223(int iParam0, int iParam1) // Position - 0x1D6D5
{
	return unk_0xD69CE161FE614531(2, iParam0, func_11(iParam1));
}

void func_224(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, eCharacter echParam5) // Position - 0x1D6EA
{
	eCharacter character;
...
void func_225(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, eCharacter echParam6) // Position - 0x1DC33
{
	eCharacter character;
...
void func_226(var uParam0, int iParam1) // Position - 0x1DE74
{
	int bitShift;
	BOOL flag;
...
struct<4> func_228(int iParam0, BOOL bParam1, BOOL bParam2, var uParam3) // Position - 0x1DFD4
{
	var unk;
	int num;
	int num2;
	...
	if (!func_233(&(Global_114370.f_19964), 8) && bParam1 && iParam0 != 4 && func_231(3) > 0 && unk_0xD2AA6F822D3A55D2(0, 1065353216) < 0.75f)
	{
		num = 8;
		*uParam3 = 4;
	}
...
void func_229(var uParam0, int iParam1, BOOL bParam2) // Position - 0x1E334
{
...
BOOL func_233(var uParam0, int iParam1) // Position - 0x1E647
{
	if (iParam1 < 0 || iParam1 > 11)
		return false;
...
BOOL func_234(int iParam0, BOOL bParam1) // Position - 0x1E66C
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_235(int iParam0) // Position - 0x1E786
{
...
void func_236(var uParam0, int iParam1, var uParam2, var uParam3, var uParam4, float fParam5, int iParam6, int iParam7, int iParam8) // Position - 0x1E7B2
{
	if (!unk_0x1C2F771CDC87A3A5(unk_0x4A8C381C258A124D(), 0))
...
BOOL func_238(int iParam0) // Position - 0x1E8D7
{
	int num;
...
char* func_241(int iParam0, var uParam1) // Position - 0x1E978
{
	var unk;
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x214B5
{
...
BOOL func_245(var uParam0) // Position - 0x22095
{
...
BOOL func_246(var uParam0) // Position - 0x220C7
{
	int i;
...
void func_247(var uParam0) // Position - 0x2210E
{
	if (!func_76(uParam0))
		func_121(uParam0);
...
BOOL func_254() // Position - 0x22285
{
	int num;
...
void func_257(var uParam0, var uParam1, var uParam2, int iParam3) // Position - 0x223D8
{
	unk_0x747786364137DC63(1);
	unk_0x37B894853929BF1A(1);
	func_261();
...
BOOL func_264(int iParam0) // Position - 0x2275A
{
	int num;
	int num2;
...
BOOL func_267(int iParam0, var uParam1, var uParam2) // Position - 0x22A3E
{
	switch (iParam0)
	{
		case 11:
...
BOOL func_270() // Position - 0x2341D
{
...
BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0x2345B
{
...
void func_272(BOOL bParam0, BOOL bParam1) // Position - 0x23483
{
	int num;
	int num2;
	int num3;
...
BOOL func_273(int iParam0) // Position - 0x23553
{
	switch (iParam0)
	{
		case 71:
...
void func_274(int iParam0, BOOL bParam1) // Position - 0x23591
{
	if (iParam0 == 146 || iParam0 == -1)
		return;
...
var func_276(BOOL bParam0, var uParam1, var uParam2) // Position - 0x235E4
{
	if (bParam0)
		return uParam1;
...
BOOL _GET_RANDOM_BOOL() // Position - 0x235FB
{

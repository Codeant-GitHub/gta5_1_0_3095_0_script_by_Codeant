...
void func_6() // Position - 0x1F6
{
	...
	if (unk_0xFC8BFE4B41177C22(num))
		if (!func_116(num, CHAR_FRANKLIN, 1))
	...
	while (unk_0xFD216000DC314A92() || !flag)
	{
		...
		if (!unk_0xFC8BFE4B41177C22(uLocal_28))
		{
			...
			if (unk_0xFC8BFE4B41177C22(num))
				if (!func_116(num, CHAR_FRANKLIN, 1) && !func_87(CHAR_FRANKLIN, 1, -1.3389f, 544.1759f, 172.7673f, -1f))
	...
	if (func_86(echParam0) && unk_0xFC8BFE4B41177C22(*uParam1) && unk_0xD9F5E1FEFD1329E4(*uParam1, 0))
	{
		...
		if (unk_0xA9DFDFED12311CA7(*uParam1) >= 0 && func_14(*uParam1, false, &unk))
		{
			...
			if (bParam3)
			{
				...
				func_10(Global_114370.f_2366.f_539.f_2407[iParam2 /*295*/][echParam0 /*98*/].f_5, Global_114370.f_2366.f_539.f_2407[iParam2 /*295*/][echParam0 /*98*/].f_7, num2, true, &(Global_114370.f_20121[echParam0 /*43*/].f_1));
				...
				func_10(Global_114370.f_2366.f_539.f_2407[iParam2 /*295*/][echParam0 /*98*/].f_6, -1, num2, false, &(Global_114370.f_20121[echParam0 /*43*/].f_2));
			}
		}
	}
...
BOOL func_14(int iParam0, BOOL bParam1, var uParam2) // Position - 0x36C6
{
	...
	*uParam2 = 0;
	...
	if (!func_48(hash, bParam1, uParam2) && !func_47(unk_0x259BE71D8A81D4FA()) && !func_28(iParam0))
		return false;
	...
	if (func_24(unk_0x259BE71D8A81D4FA()) && unk_0xBA16CD57E37AC32A(hash) || unk_0x00C6FDED3EB75117(hash))
		flag = true;

	if (unk_0x9E20DC08879FF3FC(iParam0) && !func_21(iParam0) && !flag && !(func_20(unk_0x4B423FAA24E8ABF0(iParam0)) && func_16(unk_0x259BE71D8A81D4FA())))
	{
...
BOOL func_15(int iParam0) // Position - 0x3834
{
	int i;
...
BOOL _NETWORK_IS_PLAYER_VALID(Player player, BOOL bIsPlaying, BOOL bUnk) // Position - 0x3D90
{
	Player player;
...
Player _INVALID_PLAYER_INDEX() // Position - 0x3DF0
{
	return -1;
}

BOOL func_20(int iParam0) // Position - 0x3DF9
{
...
BOOL func_21(int iParam0) // Position - 0x3E3B
{
	switch (unk_0x4B423FAA24E8ABF0(iParam0))
	{
...
BOOL func_22(Player plParam0) // Position - 0x3F03
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2657921[plParam0 /*463*/].f_321.f_7 != -1)
...
BOOL func_23(Player plParam0) // Position - 0x3F4A
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2657921[plParam0 /*463*/].f_321.f_7 != -1)
...
BOOL func_24(Player plParam0) // Position - 0x3F91
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2657921[plParam0 /*463*/].f_321.f_7 != -1)
...
BOOL func_25(Hash hParam0) // Position - 0x3FD7
{
	BOOL flag;
	...
	if (!func_27(unk_0x259BE71D8A81D4FA()) && hParam0 != joaat("thruster") && hParam0 != joaat("avenger") && hParam0 != func_26(true) && !flag)
		return false;

	return true;
}

Hash func_26(BOOL bParam0) // Position - 0x406C
{
	if (bParam0)
		return -426933872;
...
BOOL func_27(Player plParam0) // Position - 0x4086
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
...
BOOL func_28(int iParam0) // Position - 0x40AC
{
...
BOOL func_29(int iParam0) // Position - 0x40DB
{
...
BOOL func_30(int iParam0) // Position - 0x4213
{
	int num;
	...
	if (unk_0xFC8BFE4B41177C22(iParam0) && unk_0xD9F5E1FEFD1329E4(iParam0, 0))
	{
		...
		if (unk_0x9E20DC08879FF3FC(iParam0) && !func_21(iParam0) || func_31(num))
			return true;
...
BOOL func_31(int iParam0) // Position - 0x4290
{
	switch (iParam0)
	{
		case joaat("mule"):
...
BOOL func_32(Player plParam0) // Position - 0x42EC
{
	if (plParam0 == _INVALID_PLAYER_INDEX())
		return false;
...
BOOL func_33(int iParam0, BOOL bParam1) // Position - 0x4325
{
	switch (unk_0x4B423FAA24E8ABF0(iParam0))
	{
...
BOOL func_35(int iParam0, int iParam1) // Position - 0x43B9
{
	if (iParam1 == 0)
...
BOOL func_44(int iParam0, int iParam1) // Position - 0x48C0
{
	switch (iParam0)
	{
		case joaat("faction2"):
...
BOOL func_45(Player plParam0) // Position - 0x4C9F
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
...
BOOL func_46(Player plParam0) // Position - 0x4CFE
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2657921[plParam0 /*463*/].f_321.f_7 != -1 && Global_2657921[plParam0 /*463*/].f_321.f_10 != _INVALID_PLAYER_INDEX())
...
BOOL func_47(Player plParam0) // Position - 0x4D5E
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2657921[plParam0 /*463*/].f_321.f_7 != -1)
...
BOOL func_48(int iParam0, BOOL bParam1, var uParam2) // Position - 0x4DA5
{
	BOOL flag;
...
BOOL func_49(int iParam0) // Position - 0x519C
{
	switch (iParam0)
	{
		case joaat("towtruck"):
...
void func_50(int iParam0, eCharacter echParam1) // Position - 0x51D1
{
	var unk;
	int i;
	int j;
...
BOOL func_53(int iParam0) // Position - 0x572E
{
	switch (iParam0)
	{
		case joaat("granger"):
...
BOOL func_55(int iParam0) // Position - 0x57FF
{
	if (!unk_0xFC8BFE4B41177C22(iParam0) || !unk_0xD9F5E1FEFD1329E4(iParam0, 0) || func_72(iParam0, CHAR_MICHAEL, false) || func_72(iParam0, CHAR_FRANKLIN, false) || func_72(iParam0, CHAR_TREVOR, false) || func_71(iParam0) != _CHAR_NULL || func_70(iParam0) || func_69(iParam0) || func_15(iParam0) || func_68(iParam0) || !func_56(unk_0x4B423FAA24E8ABF0(iParam0)))
	{
		func_69(iParam0);
		func_69(iParam0);
		func_72(iParam0, CHAR_MICHAEL, false);
		func_72(iParam0, CHAR_FRANKLIN, false);
		func_72(iParam0, CHAR_TREVOR, false);
		func_71(iParam0) != _CHAR_NULL;
		return false;
	}
...
BOOL func_56(Hash hParam0) // Position - 0x58DC
{
	if (hParam0 == 0)
		return false;
...
BOOL func_57(Hash hParam0, BOOL bParam1, int iParam2) // Position - 0x5A9A
{
	int i;
	var unk;
...
BOOL func_58(Hash hParam0) // Position - 0x5C1C
{
	int num;
	var unk;
	var unk2;
...
BOOL _NETSHOPPING_SHOULD_USE_TRANSACTION_SYSTEM() // Position - 0x5CE8
{
...
BOOL func_60(Hash hParam0, int iParam1) // Position - 0x5CFF
{
	BOOL num;
	var unk;
...
BOOL func_63() // Position - 0xB265
{
	return false;
}

BOOL func_64() // Position - 0xB26E
{
	return true;
}

BOOL func_65() // Position - 0xB277
{
	return true;
}

BOOL func_66() // Position - 0xB280
{
...
BOOL _IS_EXCLUSIVE_CONTENT_UNLOCKED() // Position - 0xB299
{
	var unk;
...
BOOL func_68(int iParam0) // Position - 0xB351
{
	Hash hash;
	var unk;
	...
	if (!func_57(hash, false, -1))
		return true;

	return false;
}

BOOL func_69(int iParam0) // Position - 0xB398
{
	int i;
...
BOOL func_70(int iParam0) // Position - 0xB414
{
	int i;
...
eCharacter func_71(int iParam0) // Position - 0xB4FC
{
	int i;
...
BOOL func_72(int iParam0, eCharacter echParam1, BOOL bParam2) // Position - 0xB55F
{
	int i;
	var unk;
	int num;
...
BOOL func_73(eCharacter echParam0, int iParam1, char* sParam2, var uParam3) // Position - 0xB5CD
{
...
void func_74(int iParam0, eCharacter echParam1) // Position - 0xB6A6
{
	int i;
...
BOOL func_76(var uParam0) // Position - 0xB753
{
...
BOOL func_78(var uParam0) // Position - 0xB93C
{
	int i;
	int num;
	int num2;
...
int func_80(var uParam0, int iParam1) // Position - 0xBA6F
{
	int value;
	int value2;
	float num;
...
int func_81(var uParam0, int iParam1) // Position - 0xBB58
{
	int i;
...
BOOL func_82(var uParam0, int iParam1, int iParam2) // Position - 0xBBBA
{
...
BOOL func_83() // Position - 0xBBDE
{
	return false;
}

BOOL func_84(var uParam0, var uParam1) // Position - 0xBBE7
{
	if (unk_0x76CD105BCAC6EB9F())
	{
	}
...
void func_85(eCharacter echParam0, var uParam1, int iParam2) // Position - 0xBC28
{
	int num;
...
BOOL func_86(eCharacter echParam0) // Position - 0xBE84
{
	return echParam0 < CHAR_MULTIPLAYER;
}

BOOL func_87(eCharacter echParam0, int iParam1, float fParam2, float fParam3, float fParam4, float fParam5) // Position - 0xBE90
{
	int i;
	int num;
	int num2;
	...
	if (num2 != 0)
	{
		...
		{
			if (unk_0xFC8BFE4B41177C22(Global_98703[i]) && unk_0xD9F5E1FEFD1329E4(Global_98703[i], 0))
				if (unk_0x4B423FAA24E8ABF0(Global_98703[i]) == num2 && Global_98713[i] == echParam0)
					if (fParam5 == -1f || unk_0xED977E2AE2CB16EE(unk_0xD1A6A821F5AC81DB(Global_98703[i], 0), fParam2, 1) <= fParam5)
						return true;
		}
	}
...
void func_88(float fParam0, float fParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, float fParam7, float fParam8, float fParam9, float fParam10, BOOL bParam11, BOOL bParam12, BOOL bParam13, BOOL bParam14, BOOL bParam15) // Position - 0xBF55
{
	func_89(fParam0, fParam3, fParam6, fParam7, fParam10, 0f, 0f, 0f, bParam11, bParam12, bParam13, bParam14, bParam15);
	return;
}

void func_89(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, var uParam7, var uParam8, var uParam9, float fParam10, float fParam11, float fParam12, float fParam13, BOOL bParam14, BOOL bParam15, BOOL bParam16, BOOL bParam17, BOOL bParam18) // Position - 0xBF7E
{
	var unk;
	BOOL flag;
	BOOL flag2;
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0xC376
{
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER() // Position - 0xC3A0
{
	func_92();
...
eCharacter _GET_PLAYER_CHARACTER_FROM_PED(int iParam0) // Position - 0xC4C4
{
	eCharacter i;
	int num;
...
int _GET_CHARACTER_MODEL(eCharacter character) // Position - 0xC501
{
...
int func_96(eCharacter echParam0) // Position - 0xC526
{
	return Global_2139[echParam0 /*29*/];
}

BOOL func_97(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, float fParam7) // Position - 0xC535
{
	float num;
	var unk3;
	var unk6;
...
BOOL func_98(float fParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, float fParam9, var uParam10, var uParam11) // Position - 0xC82B
{
	float num;
	float num2;
	float num3;
...
Vector3 func_99(float fParam0, var uParam1, var uParam2) // Position - 0xC8DF
{
	float num;
	float num2;
...
void func_100(var uParam0) // Position - 0xC91E
{
	if (unk_0xFC8BFE4B41177C22(uParam0))
	{
		if (unk_0xD9F5E1FEFD1329E4(uParam0, 0))
...
void func_101(float fParam0, float fParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, float fParam7, float fParam8, float fParam9, float fParam10, var uParam11, var uParam12, var uParam13, BOOL bParam14, BOOL bParam15, BOOL bParam16, BOOL bParam17, BOOL bParam18) // Position - 0xC983
{
	func_89(fParam0, fParam3, fParam6, fParam7, fParam10, uParam11, bParam14, bParam15, bParam16, bParam17, bParam18);
	return;
}

BOOL func_102(var uParam0, var uParam1, var uParam2, int iParam3) // Position - 0xC9AD
{
	return func_103(Global_104933.f_2890.f_12.f_66, uParam0, iParam3);
}

BOOL func_103(int iParam0, float fParam1, var uParam2, var uParam3, int iParam4) // Position - 0xC9CA
{
	var unk;
	float num;
...
void func_105(float fParam0, float fParam1, float fParam2, float fParam3, int iParam4) // Position - 0xCA4B
{
	int i;
	...
	for (i = 0; i < 68; i = i + 1)
	{
		if (func_113(&Global_78038.f_555[0 /*21*/], i))
			if (unk_0xED977E2AE2CB16EE(fParam0, Global_78038.f_555[0 /*21*/], iParam4) <= fParam3)
				func_106(i);
	}
...
BOOL func_110(int iParam0, int iParam1) // Position - 0xCD6E
{
	int num;
...
BOOL func_112(int iParam0, int iParam1) // Position - 0xCDEC
{
	if (iParam0 == -1)
		return false;
...
BOOL func_113(var uParam0, int iParam1) // Position - 0xCE0C
{
	BOOL num;
	int num2;
...
BOOL func_114(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0xE4FB
{
	if (bParam6)
...
int func_115(eCharacter echParam0, int iParam1) // Position - 0xE542
{
	int num;
...
BOOL func_116(int iParam0, eCharacter echParam1, int iParam2) // Position - 0xE584
{
	int i;
		...
		if (unk_0xFC8BFE4B41177C22(Global_98703[i]))
			if (Global_98703[i] == iParam0)
				if (echParam1 == _CHAR_NULL || echParam1 == Global_98713[i])
					if (iParam2 == 0 || unk_0x4B423FAA24E8ABF0(iParam0) == func_115(echParam1, iParam2))
						return true;
	}
...
int func_123(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0xED13
{
	var unk;
	int i;
	int num;
...
BOOL func_129(int iParam0, int iParam1, int iParam2, var uParam3) // Position - 0xF36B
{
	int num;
...
void func_134(int iParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7, int iParam8, int iParam9, BOOL bParam10) // Position - 0x109EA
{
	int num;
	int num2;
...
var func_138(int iParam0, int iParam1) // Position - 0x115BB
{
	return unk_0xD69CE161FE614531(0, iParam0, func_139(iParam1));
}

int func_139(int iParam0) // Position - 0x115D0
{
	int num;
	int num2;
...
BOOL func_142(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x11A0B
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
BOOL func_143(int iParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x128AE
{
	int num;
	int num2;
	int num3;
	...
	if (func_144(iParam0, iParam1, &num3, &num2, bParam2, bParam3))
	{
...
void func_146(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x154AE
{
	...
	if (iParam0 == 12)
	{
		...
		if (num4 >= 0)
		{
			...
			if (num5 > num4)
			{
				...
				Global_2883589 = num3;
				func_134(&Global_79031[0 /*14*/], iParam0, iParam1, &(num3.f_7), 0, 0, num3.f_2, false, -1, 2, true);
				return;
			}
		}
	}
	...
	else if (iParam0 == 14)
	{
		...
		if (num8 >= 0)
		{
			...
			if (num9 > num8)
			{
				...
				Global_2883589 = num6;
				func_134(&Global_79031[0 /*14*/], iParam0, iParam1, &(num6.f_9), num6.f_3, num6.f_4, num6.f_5, unk_0x304A39EB177D246B(num6.f_1, joaat("OUTFIT_ONLY"), 0), num7, 2, num6.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_79229)
		{
			...
			func_134(&Global_79031[0 /*14*/], iParam0, iParam1, &(num10.f_9), num10.f_3, num10.f_4, num10.f_5, unk_0x304A39EB177D246B(num10.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, num10.f_1 != 0);
			return;
		}
		...
		if (num11 >= 0)
		{
			num12 = unk_0x7B6C0A0D604E68FA(num2, 10, -1, 0, -1, func_125(iParam0));
...
BOOL func_201(int iParam0, int iParam1, int iParam2, var uParam3) // Position - 0x26BC0
{
	int num;
...
int func_202(int iParam0, int iParam1, var uParam2, int iParam3) // Position - 0x26EC7
{
	int num;
	int num2;
	int num3;
...
BOOL func_205(int iParam0, int iParam1) // Position - 0x27168
{
	var unk;
	BOOL num;
...
var func_206(int iParam0, int iParam1) // Position - 0x2718C
{
	return unk_0xD69CE161FE614531(2, iParam0, func_139(iParam1));
}

void func_207(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, eCharacter echParam5) // Position - 0x271A1
{
	eCharacter character;
...
void func_208(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, eCharacter echParam6) // Position - 0x276EA
{
	eCharacter character;
...
BOOL func_213(int iParam0) // Position - 0x27AFF
{
	int num;
	int num2;
...
BOOL func_216(int iParam0, var uParam1, var uParam2) // Position - 0x27DE3
{
	switch (iParam0)
	{
		case 11:
...
BOOL func_218() // Position - 0x28791
{

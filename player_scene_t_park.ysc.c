			...
			if (func_6(num, &unk31, &unk47, &unk63))
				if (func_4(num, &unk64, &unk80, &unk96, &unk112, &unk113))
					if (!unk_0x13CCB1AD131C1082(*uParam0, &unk64, &unk31, 2))
						unk_0x381D671BCFC294D9(*uParam0, Global_98702, &unk31, &unk64, 1000f, -8f, unk63, 1148846080);
...
void func_17(Vehicle veParam0, int iParam1, int iParam2, int iParam3, int iParam4) // Position - 0x2671
{
	int num;
	int num2;
	int num3;
	...
	if (func_36(veParam0) + iParam2 > 10)
		iParam2 = 10 - func_36(veParam0);
	...
	if (!func_34(veParam0))
	{
		func_32(veParam0, num2, false);
		func_29(num2, num2, 0.3f, func_30(), iParam1, false);
		num3 = func_28(veParam0);
	...
	func_18(1, num7, 4, veParam0, iParam2);
	return;
}

void func_18(int iParam0, int iParam1, int iParam2, Vehicle veParam3, int iParam4) // Position - 0x27E3
{
	func_19(iParam0, iParam1, iParam2, veParam3, 0, iParam4);
	return;
}

void func_19(int iParam0, int iParam1, int iParam2, Vehicle veParam3, int iParam4, int iParam5) // Position - 0x27FA
{
	int num;
...
void func_24(Vehicle veParam0, int iParam1) // Position - 0x2941
{
	int num;
	int num2;
	...
	num = func_28(veParam0);
	num2 = -1;

	if (num == -1)
	{
		num2 = func_26(veParam0);
...
int func_26(Vehicle veParam0) // Position - 0x29D6
{
	int i;
...
int func_28(Vehicle veParam0) // Position - 0x2A37
{
	int i;
...
int func_31(Vehicle veParam0) // Position - 0x2BB2
{
	int num;
	int num2;
...
int func_32(Vehicle veParam0, int iParam1, BOOL bParam2) // Position - 0x2BF5
{
	int num;
	int num2;
	int num3;
...
BOOL func_34(Vehicle veParam0) // Position - 0x2CE0
{
	if (veParam0 == 0)
		return false;

	if (func_35(veParam0) == -1)
		return false;

	return true;
}

int func_35(Vehicle veParam0) // Position - 0x2D01
{
	int i;
...
int func_36(Vehicle veParam0) // Position - 0x2D4A
{
	int num;
	int num2;

...
int func_49(int iParam0, Hash hParam1) // Position - 0x391F
{
	var unk;
	int num;
...
Hash func_51(Hash hParam0) // Position - 0x3963
{
	Hash hash;
	Hash hash2;
...
Hash func_52() // Position - 0x3997
{
	return Global_1574925;
}

BOOL func_53(int iParam0, Hash hParam1) // Position - 0x39A3
{
	var unk;
	BOOL num;
...
var func_54(int iParam0, Hash hParam1) // Position - 0x39C7
{
...
BOOL func_69(var uParam0, var uParam1, var uParam2, char* sParam3, float fParam4, float fParam5, float fParam6) // Position - 0x5DEE
{
	var unk;
	var unk2;
...
int func_78(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x6A86
{
	int i;
	float num;
	float num2;
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x759D
{
...
Vector3 func_83(float fParam0, float fParam1, float fParam2) // Position - 0x75C7
{
...
BOOL func_85(Player plParam0) // Position - 0x75F3
{
...
BOOL func_87(int iParam0, int iParam1, var uParam2, int iParam3, BOOL bParam4) // Position - 0x76F5
{
	var unk;
	var unk7;
	var unk13;
...
Vector3 func_88(float fParam0, var uParam1, var uParam2, float fParam3) // Position - 0x778A
{
	float num;
	float num2;
	float num3;
...
BOOL func_92(int iParam0, var uParam1) // Position - 0x842B
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_93(Player plParam0) // Position - 0x84AD
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
...
Player _INVALID_PLAYER_INDEX() // Position - 0x8505
{
	return -1;
}
...
BOOL func_98(int iParam0) // Position - 0x87A7
{
...
int func_106(int iParam0) // Position - 0x8CF0
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * IS_BIT_SET(iParam0, 31) ? -1 : 1) + 2011;
}

var func_107(BOOL bParam0, var uParam1, var uParam2) // Position - 0x8D12
{
	if (bParam0)
		return uParam1;
...
int func_108(int iParam0) // Position - 0x8D29
{
	return iParam0 & 15;
}
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER_0() // Position - 0x8DE7
{
	func_58();
	return Global_114370.f_2366.f_539.f_4321;
}
...
void func_116(char* sParam0, var uParam1, int iParam2) // Position - 0x8E85
{
...
BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0x8EC7
{
...
BOOL func_122(Any* panParam0) // Position - 0xA95A
{
	int num;
...
void func_126(Vehicle veParam0) // Position - 0xAAF8
{
	int num;
	int num2;
	int num3;
...
int func_128(Vehicle veParam0) // Position - 0xABD4
{
	int i;
...
BOOL func_132(int iParam0, int iParam1, int iParam2) // Position - 0xACCD
{
...
int func_134(Vehicle veParam0) // Position - 0xAD34
{
	int i;
...
BOOL func_135(var uParam0) // Position - 0xAD7D
{
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(int iParam0) // Position - 0xAD9D
{
	if (unk_0xFC8BFE4B41177C22(iParam0))
...
BOOL func_137(int iParam0) // Position - 0xADBE
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_139(int iParam0) // Position - 0xAE8E
{
	switch (iParam0)
	{
		case 5:
...
void func_140(Any* panParam0, int iParam1, BOOL bParam2) // Position - 0xAEE1
{
	int i;
...
BOOL func_141(int iParam0) // Position - 0xAFD6
{
	switch (iParam0)
	{
		case 5:
...
void func_143(BOOL bParam0, BOOL bParam1, BOOL bParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB080
{
	if (bParam0)
	{
...
Player func_146(Hash hParam0, BOOL bParam1) // Position - 0xB240
{
	Player player;
	Hash hash;
...
BOOL func_147(int iParam0) // Position - 0xB281
{
	int num;
...
BOOL func_148(int iParam0) // Position - 0xB2A3
{
...
int func_150(int iParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0xB2F0
{
	int num;
...
BOOL func_153(var uParam0) // Position - 0xB36D
{
...
BOOL _CONVERSATION_IS_DIALOGUE_IN_PROGRESS() // Position - 0xB411
{
...
BOOL func_159(var uParam0, float fParam1, int iParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB4A0
{
...
void func_160(var uParam0) // Position - 0xB4F7
{
	if (!unk_0x1C2F771CDC87A3A5(uParam0, 0))
...
BOOL func_167(int iParam0) // Position - 0xB804
{
	if (iParam0 == 1)
...
BOOL func_169(int iParam0) // Position - 0xB86A
{
...
BOOL func_170(int iParam0) // Position - 0xB8AB
{
	int num;
...
int func_172(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4) // Position - 0xB922
{
	int i;
...
void func_173(int iParam0, int iParam1) // Position - 0xBA59
{
	int i;
...
BOOL _CAN_ENTER_FREEROAM_STATE(int iParam0) // Position - 0xBAA8
{
	return func_175(iParam0, Global_43922);
}

BOOL func_175(int iParam0, int iParam1) // Position - 0xBAB9
{
	if (iParam1 == 15)
		return 1;
...
BOOL func_176(int iParam0) // Position - 0xBC9A
{
	if (Global_43922 == 15)
		return false;
...
BOOL _IS_MISSION_REPLAY_IN_PROGRESS() // Position - 0xBD16
{
	if (Global_101392 == 10 || Global_101392 == 9)
		return true;
...
BOOL func_180(var uParam0, int iParam1) // Position - 0xBD3A
{
	switch (uParam0->f_16)
	{
		case 0:
...
BOOL func_182(var uParam0) // Position - 0xC53A
{
	float num;
...
void func_183(int iParam0, var uParam1) // Position - 0xC5C8
{
	if (iParam0 == 1)
	{
		if (!func_139(uParam1))
...
BOOL func_184(BOOL bParam0) // Position - 0xC62C
{
	var unk;
...
BOOL func_185(var uParam0) // Position - 0xC6C3
{
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0))
		if (unk_0xD9F5E1FEFD1329E4(uParam0, 0))
...
BOOL func_186(int iParam0) // Position - 0xC6ED
{
	eCharacter character;
...
BOOL func_187() // Position - 0xCE0A
{
	return Global_101431.f_1;
}

BOOL func_188() // Position - 0xCE18
{
	if (Global_98294 != -1)
...
BOOL func_193() // Position - 0xCEC8
{
	return Global_1575079;
}

BOOL func_194() // Position - 0xCED4
{
	if (!unk_0x76CD105BCAC6EB9F())
...
void func_195(var uParam0) // Position - 0xCEF0
{
	...
	if (func_189() || unk_0x3555462DB47B7AB1())
	{
		unk_0x0F15249D24BC5ADA(0);
		return;
	}
		...
		if (num < 20f * 20f && bLocal_96)
		{
			switch (iLocal_97)
			{
				...
				case 2:
					if (func_202(&uLocal_263))
					{
						if (func_196(&uLocal_263) > unk_0xD2AA6F822D3A55D2(9f, 15f))
						{
...
float func_196(var uParam0) // Position - 0xDCA1
{
	if (func_202(uParam0))
		if (func_198(uParam0))
			return uParam0->f_2;
		else
			return func_197(IS_BIT_SET(*uParam0, 4)) - uParam0->f_1;
...
BOOL func_198(var uParam0) // Position - 0xDD35
{
	return IS_BIT_SET(*uParam0, 2);
}

void func_199(var uParam0) // Position - 0xDD42
{
	func_200(uParam0, 0f);
	return;
}

void func_200(var uParam0, float fParam1) // Position - 0xDD51
{
	uParam0->f_1 = func_197(IS_BIT_SET(*uParam0, 4)) - fParam1;
...
void func_201(var uParam0) // Position - 0xDD7C
{
	if (!func_202(uParam0))
		func_199(uParam0);
...
BOOL func_202(var uParam0) // Position - 0xDD94
{
...
BOOL func_208(int iParam0, int iParam1) // Position - 0xE16D
{
...
void _UPDATE_CURRENT_PLAYER_CHARACTER() // Position - 0xE2E5
{
	if (func_59(14))
	{
		if (!unk_0x1C2F771CDC87A3A5(unk_0x4A8C381C258A124D(), 0))
...
void func_214(var uParam0, eCharacter echParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xE3DF
{
...
int _CONVERSATION_ADD_LINE(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0xE435
{
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, var uParam2, char* sParam3, int iParam4, int iParam5) // Position - 0xE483
{
...
void func_217(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) // Position - 0xE51E
{
	if (unk_0x75EAB09F5E974116(unk_0x259BE71D8A81D4FA()))
	{
		if (!unk_0xD6F9DEE4765092A9(uParam1))
		{
			...
			{
				if (func_221(unk_0x4A8C381C258A124D(), uParam2, 1) <= 100f)
					func_220(uParam0, 1);
			}
			else
			{
				...
				if (func_221(unk_0x4A8C381C258A124D(), uParam2, 1) > 120f)
					func_223(uParam0);
			}
		}
	}
...
void func_220(var uParam0, int iParam1) // Position - 0xE684
{
	BOOL flag;
	int i;
...
float func_221(var uParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0xE722
{
	var unk;
...
void func_223(var uParam0) // Position - 0xE768
{
	unk_0xB479965CBAA3EAE1(0);
	unk_0xDD291722ADDCBD60();
	func_224(uParam0);
...
void func_224(var uParam0) // Position - 0xE77F
{
	BOOL flag;
	int num;
	int i;
...
BOOL IS_RC_FINE_AND_IN_RANGE(Any* panParam0, BOOL bParam1) // Position - 0xE88F
{
	var unk;
...
BOOL func_228(int iParam0) // Position - 0xEE57
{
...
BOOL func_229(var uParam0) // Position - 0xEE77
{
...
BOOL func_230(var uParam0) // Position - 0xEE8F
{
...
void func_232(var uParam0) // Position - 0xF1B8
{
...
BOOL CHECK_VEHICLES_OK(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0xF263
{
	int i;
	int num;
	var unk;
...
BOOL func_235(var uParam0, var uParam1) // Position - 0xF421
{
	var unk;
...
BOOL func_236(var uParam0, BOOL bParam1, int iParam2) // Position - 0xF451
{
	int i;
	int num;
...
BOOL func_237(int iParam0) // Position - 0xF70D
{
...
BOOL func_238(var uParam0, int iParam1) // Position - 0xF741
{
	float num;
...
BOOL func_239(var uParam0, int iParam1) // Position - 0xF7B7
{
	return func_240(uParam0, unk_0x4A8C381C258A124D(), iParam1, 1, 250, 7);
}

BOOL func_240(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xF7CF
{
	BOOL flag;
	var unk;
	int num;
...
BOOL func_241(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, int iParam7) // Position - 0xF890
{
	var unk;
	var unk2;
	var unk5;
...
Vector3 func_242(var uParam0, int iParam1) // Position - 0xF9BC
{
	int num;
...
BOOL func_244(var uParam0, var uParam1, int iParam2, int iParam3) // Position - 0xFACB
{
	var unk;
	var unk4;
	float num;
...
float func_245(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0xFB5C
{
	return (fParam0 * uParam3) + (fParam0.f_1 * uParam3.f_1) + (fParam0.f_2 * uParam3.f_2);
}

Vector3 func_246(float fParam0, var uParam1, var uParam2) // Position - 0xFB7D
{
	float num;
	float num2;
...
int func_248(var uParam0, var uParam1) // Position - 0xFBD7
{
	int i;
...
int func_249(var uParam0) // Position - 0xFC16
{
...
BOOL func_250(var uParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xFC3E
{
	float num;
	float num2;
	int num3;
...
BOOL func_251(var uParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0xFD39
{
	float num;
	float num2;
...
BOOL func_252(var uParam0, float fParam1) // Position - 0xFE45
{
	var unk;
	var unk2;
...
BOOL func_253(var uParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xFEDA
{
	var unk;
	var unk4;
	float num;
...
BOOL func_254(var uParam0, BOOL bParam1, float fParam2, float fParam3) // Position - 0xFF68
{
	if (bParam1)
		if (unk_0x65F146FF416F109F(unk_0x4A8C381C258A124D()))
...
BOOL func_255(int iParam0) // Position - 0xFFB0
{
...
void func_256(var uParam0) // Position - 0xFFFA
{
	var unk;
...
BOOL func_257(int iParam0) // Position - 0x10098
{
	if (iParam0 == -1)
		iParam0 = func_177();
...
BOOL func_258(int iParam0) // Position - 0x1012D
{
...
BOOL func_259() // Position - 0x1016C
{
	if (unk_0x761778199FE1211C())
...
BOOL func_260() // Position - 0x10189
{
	if (Global_98294 != -1)
...
BOOL func_261(int iParam0) // Position - 0x101AC
{
...
BOOL func_262() // Position - 0x101E0
{
...
BOOL func_263(int iParam0) // Position - 0x1021E
{
...
BOOL func_264(var uParam0) // Position - 0x10246
{
	if (!func_265(uParam0))
		return false;
...
BOOL func_265(var uParam0) // Position - 0x1029B
{
	BOOL flag;
	var unk;
...
BOOL func_266(eCharacter echParam0) // Position - 0x10551
{
	int i;
...
BOOL func_267(int iParam0) // Position - 0x105B9
{
	var unk;
	eCharacter character;
...
BOOL func_268(int iParam0) // Position - 0x1060A
{
	var unk;
...
BOOL func_269(int iParam0) // Position - 0x106C3
{
	var unk;
...
BOOL func_270(int iParam0) // Position - 0x10784
{
	int i;
	var unk;
	int num;
...
BOOL func_272(int iParam0) // Position - 0x108EB
{
...
BOOL func_273(int iParam0) // Position - 0x10916
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_274(int iParam0) // Position - 0x10941
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_275(int iParam0) // Position - 0x1096C
{
	if (func_258(iParam0))
		return false;
	else if (!unk_0x4FAFF4BCB7633475(unk_0x4A8C381C258A124D()))
...
BOOL func_276(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, float fParam5) // Position - 0x109A1
{
	int i;
...
BOOL func_277(int iParam0, var uParam1, var uParam2, var uParam3, float fParam4, var uParam5) // Position - 0x10A06
{
	int num;
	char* str;
...
BOOL func_278(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7) // Position - 0x10A7E
{
	if (fParam6 < 0f)
		fParam6 = 0f;
...
void func_279(var uParam0, BOOL bParam1) // Position - 0x10AF9
{
	func_292();
...
void func_283(var uParam0, BOOL bParam1) // Position - 0x10C3D
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (unk_0x5B9219522937741D(*uParam0))
...
void func_286(var uParam0) // Position - 0x10CC7
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
void func_287(var uParam0) // Position - 0x10CFF
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
void func_290(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x10DEE
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (!unk_0x4FAFF4BCB7633475(*uParam0))
...
void func_291(var uParam0) // Position - 0x10E3E
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (!unk_0x1C2F771CDC87A3A5(*uParam0, 0))
...
void func_294(int iParam0) // Position - 0x10EB0
{
	if (*iParam0 == -1)
		return;

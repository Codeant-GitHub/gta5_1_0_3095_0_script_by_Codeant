...
int func_60(eCharacter echParam0) // Position - 0x2086
{
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x297D
{
...
void func_118(var uParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, eCharacter echParam12, int iParam13) // Position - 0x3BA4
{
	int num;
...
BOOL func_119(var uParam0, eCharacter echParam1, var uParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6, int iParam7) // Position - 0x3D38
{
	var unk;
	var unk2;
	int num;
	...
	if (func_14(echParam1))
	{
		...
		num.f_31 = 49;
		num.f_81 = 2;
		func_195(echParam1, &num, iParam7);
	...
	if (func_14(echParam0) && unk_0xFC8BFE4B41177C22(*uParam1) && unk_0xD9F5E1FEFD1329E4(*uParam1, 0))
	{
		...
		if (unk_0xA9DFDFED12311CA7(*uParam1) >= 0 && func_125(*uParam1, false, &unk))
		{
			...
			if (bParam3)
			{
				...
				func_121(Global_114370.f_2366.f_539.f_2407[iParam2 /*295*/][echParam0 /*98*/].f_5, Global_114370.f_2366.f_539.f_2407[iParam2 /*295*/][echParam0 /*98*/].f_7, num2, true, &(Global_114370.f_20121[echParam0 /*43*/].f_1));
				...
				func_121(Global_114370.f_2366.f_539.f_2407[iParam2 /*295*/][echParam0 /*98*/].f_6, -1, num2, false, &(Global_114370.f_20121[echParam0 /*43*/].f_2));
			}
		}
	}
...
float func_123(var uParam0) // Position - 0x6CD5
{
	int num;
	int num2;
	int num3;
...
BOOL func_125(int iParam0, BOOL bParam1, var uParam2) // Position - 0x6F78
{
	int num;
	BOOL flag;
	...
	*uParam2 = 0;
	...
	if (!func_158(num, bParam1, uParam2) && !func_157(unk_0x259BE71D8A81D4FA()) && !func_138(iParam0))
		return false;
	...
	if (unk_0x9E20DC08879FF3FC(iParam0) && !func_131(iParam0) && !flag && !(func_130(unk_0x4B423FAA24E8ABF0(iParam0)) && func_127(unk_0x259BE71D8A81D4FA())))
	{
...
BOOL func_126(int iParam0) // Position - 0x70E6
{
	int i;
...
BOOL _NETWORK_IS_PLAYER_VALID(Player player, BOOL bIsPlaying, BOOL bUnk) // Position - 0x7642
{
	Player player;
...
BOOL func_130(int iParam0) // Position - 0x76A2
{
...
BOOL func_131(int iParam0) // Position - 0x76E4
{
	switch (unk_0x4B423FAA24E8ABF0(iParam0))
	{
...
BOOL func_132(Player plParam0) // Position - 0x77AC
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2657921[plParam0 /*463*/].f_321.f_7 != -1)
...
BOOL func_133(Player plParam0) // Position - 0x77F3
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2657921[plParam0 /*463*/].f_321.f_7 != -1)
...
BOOL func_134(Player plParam0) // Position - 0x783A
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2657921[plParam0 /*463*/].f_321.f_7 != -1)
...
BOOL func_135(int iParam0) // Position - 0x7880
{
	BOOL flag;
...
BOOL func_137(Player plParam0) // Position - 0x792B
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
...
BOOL func_138(int iParam0) // Position - 0x7951
{
...
BOOL func_139(int iParam0) // Position - 0x7980
{
...
BOOL func_140(int iParam0) // Position - 0x7AB8
{
	int num;
	...
	if (unk_0xFC8BFE4B41177C22(iParam0) && unk_0xD9F5E1FEFD1329E4(iParam0, 0))
	{
		...
		if (unk_0x9E20DC08879FF3FC(iParam0) && !func_131(iParam0) || func_141(num))
			return true;
...
BOOL func_141(int iParam0) // Position - 0x7B35
{
	switch (iParam0)
	{
		case joaat("mule"):
...
BOOL func_142(Player plParam0) // Position - 0x7B91
{
	if (plParam0 == _INVALID_PLAYER_INDEX())
		return false;
...
BOOL func_143(int iParam0, BOOL bParam1) // Position - 0x7BCA
{
	switch (unk_0x4B423FAA24E8ABF0(iParam0))
	{
...
BOOL func_145(int iParam0, int iParam1) // Position - 0x7C5E
{
	if (iParam1 == 0)
...
BOOL func_154(int iParam0, int iParam1) // Position - 0x8167
{
	switch (iParam0)
	{
		case joaat("faction2"):
...
BOOL func_155(Player plParam0) // Position - 0x8546
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
...
BOOL func_156(Player plParam0) // Position - 0x85A5
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2657921[plParam0 /*463*/].f_321.f_7 != -1 && Global_2657921[plParam0 /*463*/].f_321.f_10 != _INVALID_PLAYER_INDEX())
...
BOOL func_157(Player plParam0) // Position - 0x8605
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2657921[plParam0 /*463*/].f_321.f_7 != -1)
...
BOOL func_158(int iParam0, BOOL bParam1, var uParam2) // Position - 0x864C
{
	BOOL flag;
...
BOOL func_159(int iParam0) // Position - 0x8A43
{
	switch (iParam0)
	{
		case joaat("towtruck"):
...
void func_160(int iParam0, eCharacter echParam1) // Position - 0x8A78
{
	var unk;
	int i;
	int j;
...
BOOL func_163(int iParam0) // Position - 0x8FD5
{
	switch (iParam0)
	{
		case joaat("granger"):
...
BOOL func_165(int iParam0) // Position - 0x90A5
{
	if (!unk_0xFC8BFE4B41177C22(iParam0) || !unk_0xD9F5E1FEFD1329E4(iParam0, 0) || func_182(iParam0, 0, false) || func_182(iParam0, 1, false) || func_182(iParam0, 2, false) || func_181(iParam0) != _CHAR_NULL || func_180(iParam0) || func_179(iParam0) || func_126(iParam0) || func_178(iParam0) || !func_166(unk_0x4B423FAA24E8ABF0(iParam0)))
	{
		func_179(iParam0);
		func_179(iParam0);
...
BOOL func_166(Hash hParam0) // Position - 0x9182
{
	if (hParam0 == 0)
		return false;
	...
	if (unk_0xEA4F815FDC353FEF(hParam0) || unk_0x00C6FDED3EB75117(hParam0) || unk_0xBA16CD57E37AC32A(hParam0) || unk_0xAE447CBB33B40CA3(hParam0))
		return false;
...
BOOL func_167(Hash hParam0, BOOL bParam1, int iParam2) // Position - 0x9340
{
	int i;
	var unk;
	...
	if (!unk_0xAD1840C2E6AF7D5E(hParam0))
		return false;

	if (hParam0 == joaat("dominator2") && !unk_0x76CD105BCAC6EB9F() || hParam0 == joaat("buffalo3") && !unk_0x76CD105BCAC6EB9F() || hParam0 == joaat("gauntlet2") && !unk_0x76CD105BCAC6EB9F() || hParam0 == joaat("blimp2") || hParam0 == joaat("stalion2") && !unk_0x76CD105BCAC6EB9F())
	{
...
BOOL func_168(int iParam0) // Position - 0x94C2
{
	int num;
	var unk;
	var unk2;
...
BOOL _NETSHOPPING_SHOULD_USE_TRANSACTION_SYSTEM() // Position - 0x958E
{
	if (unk_0x761778199FE1211C())
...
BOOL func_170(int iParam0, int iParam1) // Position - 0x95A5
{
	BOOL num;
	var unk;
...
BOOL func_173() // Position - 0xEB0A
{
	return false;
}

BOOL func_174() // Position - 0xEB13
{
	return true;
}

BOOL func_175() // Position - 0xEB1C
{
	return true;
}

BOOL func_176() // Position - 0xEB25
{
...
BOOL _IS_EXCLUSIVE_CONTENT_UNLOCKED() // Position - 0xEB3E
{
	var unk;
...
BOOL func_178(int iParam0) // Position - 0xEBF6
{
	Hash hash;
	var unk;

	hash = unk_0x4B423FAA24E8ABF0(iParam0);
	unk = unk_0xCA7159F2C5FF745A(iParam0);

	if (hash == joaat("speedo") && unk_0x1B79E937E91F40C3(unk, "LAMAR G "))
		return true;

	if (!func_167(hash, false, -1))
		return true;

	return false;
}

BOOL func_179(int iParam0) // Position - 0xEC3D
{
	int i;
...
BOOL func_180(int iParam0) // Position - 0xECB9
{
	int i;
...
eCharacter func_181(int iParam0) // Position - 0xEDA1
{
	int i;
...
BOOL func_182(int iParam0, int iParam1, BOOL bParam2) // Position - 0xEE04
{
	int i;
	var unk;
	int num;
...
BOOL func_183(int iParam0, int iParam1, char* sParam2, var uParam3) // Position - 0xEE72
{
...
void func_184(int iParam0, eCharacter echParam1) // Position - 0xEF4A
{
	int i;
...
void func_185(var uParam0) // Position - 0xEFCC
{
	if (!func_186(*uParam0))
...
BOOL func_186(var uParam0) // Position - 0xEFF7
{
	return unk_0x5318DF85BEB6B95F(uParam0, 5);
}

int func_187(var uParam0, var uParam1, var uParam2) // Position - 0xF006
{
	int i;
	int num;
...
BOOL func_188(var uParam0) // Position - 0xF1E0
{
	int i;
	int num;
	int num2;
...
int func_190(var uParam0, int iParam1) // Position - 0xF313
{
	int value;
	int value2;
	float num;
...
int func_191(var uParam0, int iParam1) // Position - 0xF3FC
{
	int i;
...
BOOL func_192(var uParam0, int iParam1, int iParam2) // Position - 0xF45E
{
...
BOOL func_193() // Position - 0xF482
{
	return false;
}

BOOL func_194(var uParam0, var uParam1) // Position - 0xF48B
{
	if (unk_0x76CD105BCAC6EB9F())
	{
	}
...
void func_195(eCharacter echParam0, var uParam1, int iParam2) // Position - 0xF4CC
{
	int num;
...
void func_196(eCharacter echParam0, int iParam1) // Position - 0xF728
{
	int i;
	...
	for (i = 0; i < 9; i = i + 1)
	{
		if (unk_0xFC8BFE4B41177C22(Global_98703[i]))
		{
			...
			{
				if (iParam1 == 0 || unk_0x4B423FAA24E8ABF0(Global_98703[i]) == func_197(echParam0, iParam1))
				{
...
int func_197(eCharacter echParam0, int iParam1) // Position - 0xF7C6
{
	int num;
...
void func_198(var uParam0, var uParam1, var uParam2, float fParam3, int iParam4) // Position - 0xF808
{
	int i;
...
BOOL func_203(int iParam0, int iParam1) // Position - 0xFB2B
{
	int num;
...
BOOL func_205(int iParam0, int iParam1) // Position - 0xFBA9
{
	if (iParam0 == -1)
		return false;
...
BOOL func_206(var uParam0, int iParam1) // Position - 0xFBC9
{
	BOOL num;
	int num2;
...
BOOL func_207(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0x112B8
{
	if (bParam6)
...
int func_208(var uParam0, var uParam1, var uParam2, float fParam3) // Position - 0x112FF
{
	return func_209(&(Global_107917.f_2890), uParam0, fParam3, false);
}

int func_209(var uParam0, var uParam1, var uParam2, var uParam3, float fParam4, BOOL bParam5) // Position - 0x11319
{
	int num;
	Vector3 vector;
	BOOL flag;
	...
	if (func_232(uParam0))
	{
		...
		if (func_231(uParam0))
		{
			...
			if (unk_0xFC8BFE4B41177C22(num))
			{
				...
				func_213(num, &(uParam0->f_12), false, true);
				flag = true;
				...
				if (uParam0->f_7 == 1)
				{
					...
					func_184(num, uParam0->f_11);
				}
				else if (!func_211(num, uParam0->f_3, uParam0->f_8) && uParam0->f_10 && unk_0x1B79E937E91F40C3(unk_0x1AF90EB93E0012D6(), "startup_positioning"))
				{
					num2 = func_210(num);
...
BOOL func_211(int iParam0, var uParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x1168E
{
	int num;
	var unk;
	int num2;
	...
	{
		case joaat("cargobob"):
			if (func_212(iParam0, Global_78038.f_139[38], false))
			{
				func_199(38);
				return true;
			}
		...
		case joaat("firetruk"):
			if (func_212(iParam0, Global_78038.f_139[43], true))
			{
				func_199(43);
				return true;
			}
		...
		case joaat("cuban800"):
			...
			{
				if (func_212(iParam0, unk[i], true) && func_99(unk_0xD1A6A821F5AC81DB(unk[i], 1), 2136.133f, 4780.5635f, 39.9702f, 5f, false))
				{
					if (!bParam4 || func_207(uParam1, 0f, 0f, 0f, false) || unk_0xED977E2AE2CB16EE(unk_0xD1A6A821F5AC81DB(iParam0, 1), unk_0xD1A6A821F5AC81DB(unk[i], 1), 1) < 10f)
					{
...
BOOL func_212(int iParam0, int iParam1, BOOL bParam2) // Position - 0x11896
{
	var unk;
	var unk2;
	var unk3;
...
void func_213(int iParam0, var uParam1, BOOL bParam2, BOOL bParam3) // Position - 0x118F7
{
	...
	if (unk_0xD9F5E1FEFD1329E4(iParam0, 0))
	{
		...
		if (IS_BIT_SET(uParam1->f_77, 15) || func_221(iParam0) || uParam1->f_62 == 0 && uParam1->f_63 == 0 && uParam1->f_64 == 0 && uParam1->f_9[20] > 0 && func_220())
		{
			uParam1->f_62 = 0;
			uParam1->f_63 = 0;
			uParam1->f_64 = 0;
		...
		if (func_214() && unk_0x00C6FDED3EB75117(uParam1->f_66) && unk_0x8EC15ED9ECD1E9D0(iParam0) && !unk_0x2E6A27037F1DC473(iParam0, joaat("avenger")) && !unk_0x2E6A27037F1DC473(iParam0, func_136(true)))
...
BOOL func_215(Player plParam0) // Position - 0x1207E
{
	Player player;
...
BOOL func_216(Player plParam0) // Position - 0x120A2
{
	Player player;
...
BOOL func_218(var uParam0, int iParam1) // Position - 0x120D4
{
	int num;
	int num2;
	int num3;
...
void func_219(int iParam0, var uParam1) // Position - 0x120F7
{
	int num;
	int num2;
...
BOOL func_221(int iParam0) // Position - 0x12180
{
	int num;
...
int func_222(var uParam0) // Position - 0x121C8
{
...
BOOL func_223(int iParam0) // Position - 0x121E8
{
	switch (iParam0)
	{
		case 161:
...
BOOL func_224(int iParam0) // Position - 0x1223B
{
...
BOOL func_228(int iParam0, BOOL bParam1) // Position - 0x12331
{
	if (func_33(iParam0))
...
BOOL _IS_PLAYER_IN_VEHICLE_SEAT(var uParam0, int iParam1) // Position - 0x123A1
{
	var unk;
...
BOOL func_231(var uParam0) // Position - 0x123EE
{
	if (func_232(uParam0))
	{
...
BOOL func_232(var uParam0) // Position - 0x12423
{
...
BOOL func_236(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x124C7
{
...
BOOL func_237() // Position - 0x12555
{
	float num;
...
BOOL func_238(int iParam0) // Position - 0x125CA
{
	switch (iParam0)
	{
		case joaat("police"):
...
BOOL func_240(float fParam0, float fParam1, float fParam2, int iParam3) // Position - 0x1264F
{
	return func_241(Global_107917.f_2890.f_12.f_66, fParam0, iParam3);
}

BOOL func_241(int iParam0, float fParam1, var uParam2, var uParam3, int iParam4) // Position - 0x1266C
{
	var unk;
	float num;
...
void func_244(char* sParam0, var uParam1) // Position - 0x127A6
{
	if (!*uParam1)
	{
		_SHOW_SUBTITLE_CLEAR_EXISTING(sParam0, 7500, 0);
...
BOOL func_245() // Position - 0x127C3
{
	int num;
...
BOOL func_246(BOOL bParam0, int iParam1) // Position - 0x12800
{
	int num;
...
BOOL func_251() // Position - 0x128E1
{
	func_252();
...
void func_253(var uParam0, var uParam1, var uParam2) // Position - 0x12ADF
{
...
BOOL func_256(var uParam0) // Position - 0x12B6C
{
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0))
...
void func_258(eCharacter echParam0, int iParam1, int iParam2, BOOL bParam3, BOOL bParam4) // Position - 0x12BDC
{
	int num;
	int num2;
...
void func_262(int iParam0) // Position - 0x13589
{
	BOOL flag;
	var unk;
	...
	else if (IS_BIT_SET(Global_114370.f_20567.f_471, iParam0) || IS_BIT_SET(Global_2359296[func_264() /*5569*/].f_681.f_10, iParam0))
	{
		flag = true;
		unk_0x8744D2E3FC95740E(&(Global_114370.f_20567.f_471), iParam0);
		unk_0x8744D2E3FC95740E(&(Global_2359296[func_264() /*5569*/].f_681.f_10), iParam0);
	}
...
char* AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM(int iParam0) // Position - 0x13702
{
	switch (iParam0)
	{
		case 0:
...
void func_265(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x13811
{
	int num;
...
void _STAT_SET_PACKED_BOOL(int iParam0, int iParam1, int iParam2) // Position - 0x1383F
{
	if (iParam2 == -1)
		iParam2 = func_32();
...
BOOL func_268(int iParam0) // Position - 0x1387D
{
	int num;
	int num2;
	int num3;
...
BOOL func_273(var uParam0, int iParam1) // Position - 0x13BA8
{
	int i;
	var unk;
...
void func_278(var uParam0, int iParam1) // Position - 0x13D29
{
	if (iParam1 == 0f)
		uParam0->f_80 = 0f;
	else
...
BOOL func_283(int iParam0) // Position - 0x13D9F
{
	switch (iParam0)
	{
		case 60:
...
int func_288(eCharacter echParam0) // Position - 0x13F35
{
...
BOOL func_291(BOOL bParam0) // Position - 0x13FDD
{
...
void func_293(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x14023
{
	if (bParam1)
	{
...
void func_297(float fParam0, float fParam1, float fParam2, float fParam3, int iParam4, int iParam5) // Position - 0x144A2
{
	if (_IS_MISSION_REPLAY_IN_PROGRESS())
	{
...
BOOL _IS_MISSION_REPLAY_IN_PROGRESS() // Position - 0x14537
{
...
BOOL func_301(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x14680
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
void func_305(int iParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7, int iParam8, int iParam9, BOOL bParam10) // Position - 0x168DC
{
	int num;
	int num2;
...
BOOL func_309(int iParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x17879
{
	int num;
	int num2;
	int num3;
	...
	if (func_310(iParam0, iParam1, &num3, &num2, bParam2, bParam3))
	{
...
void func_312(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x1A5E1
{
	...
	if (iParam0 == 12)
	{
		...
		if (num4 >= 0)
		{
			...
			if (num5 > num4)
			{
				...
				Global_2883589 = num3;
				func_305(&Global_79031[0 /*14*/], iParam0, iParam1, &(num3.f_7), 0, 0, num3.f_2, false, -1, 2, true);
				return;
			}
		}
	}
	...
	else if (iParam0 == 14)
	{
		...
		if (num8 >= 0)
		{
			...
			if (num9 > num8)
			{
				...
				Global_2883589 = num6;
				func_305(&Global_79031[0 /*14*/], iParam0, iParam1, &(num6.f_9), num6.f_3, num6.f_4, num6.f_5, unk_0x304A39EB177D246B(num6.f_1, joaat("OUTFIT_ONLY"), 0), num7, 2, num6.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_79229)
		{
			...
			func_305(&Global_79031[0 /*14*/], iParam0, iParam1, &(num10.f_9), num10.f_3, num10.f_4, num10.f_5, unk_0x304A39EB177D246B(num10.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, num10.f_1 != 0);
			return;
		}
		...
		if (num11 >= 0)
		{
			num12 = unk_0x7B6C0A0D604E68FA(num2, 10, -1, 0, -1, func_313(iParam0));
...
BOOL func_372(var uParam0, float fParam1, var uParam2, var uParam3) // Position - 0x2BD00
{
	BOOL flag;
	int num;
	int num2;
...
void func_374(var uParam0, var uParam1, var uParam2, var uParam3) // Position - 0x2BE5C
{
	uParam0->f_51 == 0;
	uParam0->f_46 >= 15;
...
BOOL func_393() // Position - 0x2C13C
{
	if (Global_101392 == 13 || Global_101392 == 10 || Global_101392 == 11 || Global_101392 == 12)
		return false;

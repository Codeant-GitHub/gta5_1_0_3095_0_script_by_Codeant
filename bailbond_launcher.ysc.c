		...
		switch (Global_114370.f_24989.f_2)
		{
					...
					if (!func_252())
					{
						if (func_230(4, CHAR_MAUDE, 2, -1, 0))
						{
							if (func_227(uLocal_41.f_4, uLocal_41.f_5))
							{
								...
								unk_0x8744D2E3FC95740E(&(Global_114370.f_24989), 9);
			...
			case 1:
				if (_GET_CURRENT_PLAYER_CHARACTER_0() == CHAR_TREVOR)
				{
					...
					{
						if (!func_252())
							unk_0x0B0C9A0F9AAEB7F0(&(Global_114370.f_24989), 8);
						else
							SYSTEM::WAIT(2000);
					}
					else if (func_252())
					{
						...
						{
							if (IS_BIT_SET(Global_114370.f_24989, 8))
								unk_0x8744D2E3FC95740E(&(Global_114370.f_24989), 8);
...
void func_28(int iParam0) // Position - 0x1E62
{
	...
	switch (iParam0)
	{
		case 1:
		case 2:
			unk_0x0B0C9A0F9AAEB7F0(&(Global_114370.f_24989), func_73(uLocal_41.f_4));
		
			if (iParam0 == 1)
			{
				func_72(0);
				num = 8;
				unk_0x0B0C9A0F9AAEB7F0(&(Global_114370.f_24989), func_71(uLocal_41.f_4));
			}
			else
			{
				func_72(true);
				num = 4;
				unk_0x8744D2E3FC95740E(&(Global_114370.f_24989), func_71(uLocal_41.f_4));
			...
			if (func_254())
			{
				if (func_230(4, CHAR_MAUDE, 2, -1, 0))
				{
					...
					if (func_14(26, num, false))
						unk_0x0B0C9A0F9AAEB7F0(&(Global_114370.f_24989), 9);
				}
			}
		}
	}
...
void func_77(char* sParam0, int iParam1, int iParam2) // Position - 0x3192
{
	if (Global_101392 != 10 && Global_101392 != 9)
	{
		...
		func_79(&Global_104933, sParam0, 0, "Start", iParam1, iParam2);
		func_78();
		Global_95550 = 0;
	}
...
void func_81(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0x4D1A
{
	...
	if (func_95(iParam2, &num, iParam3, iParam5))
		func_82(uParam0, uParam1, num, iParam4);
...
void func_84(var uParam0, int iParam1, int iParam2) // Position - 0x4E10
{
	...
	uParam0->f_7 = func_87(iParam1, _CHAR_NULL, 0);
...
eCharacter func_86(int iParam0) // Position - 0x4F2E
{
	int i;
...
int func_87(int iParam0, eCharacter echParam1, int iParam2) // Position - 0x4F91
{
	int i;
		...
		if (unk_0xFC8BFE4B41177C22(Global_98703[i]))
			if (Global_98703[i] == iParam0)
				if (echParam1 == _CHAR_NULL || echParam1 == Global_98713[i])
					if (iParam2 == 0 || unk_0x4B423FAA24E8ABF0(iParam0) == func_88(echParam1, iParam2))
						return 1;
	}
...
void func_112(var uParam0, BOOL bParam1) // Position - 0x6613
{
	...
	if (func_90(character) && !unk_0x4FAFF4BCB7633475(uParam0))
	{
		...
		{
			func_113(uParam0, &Global_114370.f_2366.f_539.f_298[character /*477*/]);
...
void func_119(var uParam0) // Position - 0x7BEB
{
	eCharacter character;
...
BOOL func_121(var uParam0, var uParam1, var uParam2, char* sParam3, float fParam4, float fParam5, float fParam6) // Position - 0x8177
{
	var unk;
	var unk2;
...
BOOL func_123(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0x893A
{
	if (bParam6)
...
BOOL func_124(var uParam0) // Position - 0x8981
{
...
BOOL func_126(int iParam0, int iParam1, BOOL bParam2) // Position - 0x89EC
{
	if (iParam0 == -1)
		return false;
...
BOOL func_129(int iParam0) // Position - 0x8DFF
{
	return func_126(iParam0, 5, true);
}

int func_130(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x8E0F
{
	int i;
	float num;
	float num2;
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x9926
{
...
Vector3 func_135(float fParam0, float fParam1, float fParam2) // Position - 0x9950
{
...
BOOL func_137(Player plParam0) // Position - 0x997C
{
...
BOOL func_139(int iParam0, int iParam1, var uParam2, int iParam3, BOOL bParam4) // Position - 0x9A7E
{
	var unk;
	var unk7;
	var unk13;
...
Vector3 func_140(float fParam0, var uParam1, var uParam2, float fParam3) // Position - 0x9B13
{
	float num;
	float num2;
	float num3;
...
BOOL func_144(int iParam0, var uParam1) // Position - 0xA7B0
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_145(Player plParam0) // Position - 0xA832
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
...
Player _INVALID_PLAYER_INDEX() // Position - 0xA88A
{
	return -1;
}
...
BOOL func_150(int iParam0) // Position - 0xAB2C
{
...
BOOL _IS_MISSION_REPLAY_IN_PROGRESS() // Position - 0xAE83
{
	if (Global_101392 == 10 || Global_101392 == 9)
		return true;
...
void func_154(var uParam0) // Position - 0xAEA7
{
	var scriptName;
...
BOOL func_156(var uParam0) // Position - 0xAF47
{
	int num;
...
BOOL _CAN_ENTER_FREEROAM_STATE(int iParam0) // Position - 0xB0EC
{
	return func_160(iParam0, Global_43922);
}

BOOL func_160(int iParam0, int iParam1) // Position - 0xB0FD
{
	if (iParam1 == 15)
		return 1;
...
BOOL func_161(int iParam0) // Position - 0xB2DE
{
	if (Global_43922 == 15)
		return false;
...
BOOL func_162(BOOL bParam0) // Position - 0xB300
{
...
BOOL func_166(int iParam0) // Position - 0xB438
{
	eCharacter character;
		...
		if (unk_0xFC8BFE4B41177C22(unk_0x4A8C381C258A124D()))
		{
			if (!unk_0x4FAFF4BCB7633475(unk_0x4A8C381C258A124D()))
			{
				...
				switch (iParam0)
				{
					...
					case 1:
						if (unk_0x6652E84A43F51B8B(unk_0x259BE71D8A81D4FA(), 1) || func_165() || Global_32831 || func_171() || func_170(8, -1) || func_163() || func_152() || func_169() || func_164() || Global_114370.f_7691.f_919[character] == 5)
							return false;
						break;
					...
					case 4:
						if (func_165() || unk_0xE7B45027762DEFE7(unk_0x259BE71D8A81D4FA()) > 0 || func_170(8, -1) || func_164() || func_168() || Global_114370.f_7691.f_919[character] == 5)
							return false;
						break;
...
BOOL func_167() // Position - 0xBB55
{
	return Global_101431.f_1;
}

BOOL func_168() // Position - 0xBB63
{
	if (Global_98294 != -1)
...
BOOL func_175(char* sParam0) // Position - 0xBCB9
{
	int i;
...
void func_177(char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9) // Position - 0xBD14
{
	int i;
...
BOOL func_179(int iParam0) // Position - 0xBFFD
{
	int num;
	int i;
...
BOOL _CONVERSATION_ADD_LINE(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0xC0D1
{
...
BOOL func_182(char* sParam0, int iParam1, BOOL bParam2) // Position - 0xC11F
{
	Global_22167 = 0;
...
BOOL func_186(int iParam0, int iParam1) // Position - 0xC497
{
...
void _UPDATE_CURRENT_PLAYER_CHARACTER() // Position - 0xC634
{
	if (func_70(14))
	{
...
void func_194(var uParam0, eCharacter echParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xC783
{
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, var uParam2, char* sParam3, int iParam4, int iParam5) // Position - 0xC863
{
...
BOOL _CONVERSATION_IS_DIALOGUE_IN_PROGRESS() // Position - 0xC8FE
{
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER_0() // Position - 0xC920
{
	func_111();
	return Global_114370.f_2366.f_539.f_4321;
}

void func_200(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0xC939
{
	int num;
	int i;
	int num2;
...
void func_213(int iParam0) // Position - 0xD6A1
{
	BOOL flag;
	var unk;
	...
	else if (IS_BIT_SET(Global_114370.f_20567.f_471, iParam0) || IS_BIT_SET(Global_2359296[func_215() /*5569*/].f_681.f_10, iParam0))
	{
		flag = true;
		unk_0x8744D2E3FC95740E(&(Global_114370.f_20567.f_471), iParam0);
		unk_0x8744D2E3FC95740E(&(Global_2359296[func_215() /*5569*/].f_681.f_10), iParam0);
	}
...
char* AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM(int iParam0) // Position - 0xD819
{
	switch (iParam0)
	{
		case 0:
...
void func_216(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0xD927
{
	int num;
...
void _STAT_SET_PACKED_BOOL(int iParam0, int iParam1, int iParam2) // Position - 0xD955
{
	if (iParam2 == -1)
		iParam2 = func_105();
...
BOOL func_219(int iParam0) // Position - 0xD993
{
	int num;
	int num2;
	int num3;
...
BOOL func_227(int iParam0, BOOL bParam1) // Position - 0xDD5D
{
	int num;
	char* str;
	char* str2;
...
BOOL func_230(int iParam0, eCharacter echParam1, int iParam2, int iParam3, int iParam4) // Position - 0xDE79
{
	int num;
	int num2;
	int num3;
...
int func_231(eCharacter echParam0) // Position - 0xE465
{
	if (!func_90(echParam0))
...
BOOL func_232(var uParam0, int iParam1, int iParam2) // Position - 0xE48B
{
	var unk;
	int num;
...
int func_238(eCharacter echParam0) // Position - 0xE729
{
...
int func_239(eCharacter echParam0) // Position - 0xE781
{
	return Global_2139[echParam0 /*29*/].f_11;
}

eCharacter func_240() // Position - 0xE792
{
...
BOOL func_248(int iParam0) // Position - 0x1026E
{
	if (iParam0 == 0)
		return false;
...
BOOL func_250() // Position - 0x102D8
{
	if (Global_43922 == 15)
		return false;
...
BOOL func_251() // Position - 0x102ED
{
...
BOOL func_252() // Position - 0x10306
{
	Vector3 vector;
	float num;
...
Vector3 _GET_PLAYER_COORDS(var uParam0) // Position - 0x1039B
{
	return unk_0xD1A6A821F5AC81DB(unk_0x56E414973C2A8C0E(uParam0), 0);
}

BOOL func_254() // Position - 0x103AE
{
	Vector3 vector;
...
BOOL func_257() // Position - 0x10534
{
	if (!unk_0x75EAB09F5E974116(unk_0x259BE71D8A81D4FA()))
		return false;
...
void func_258() // Position - 0x10583
{
	if (Global_114370.f_24989.f_1 == 0)
	{
		...
		{
			unk_0x8744D2E3FC95740E(&(Global_114370.f_24989), 0);
			unk_0x8744D2E3FC95740E(&(Global_114370.f_24989), 1);
			unk_0x8744D2E3FC95740E(&(Global_114370.f_24989), 2);
			unk_0x8744D2E3FC95740E(&(Global_114370.f_24989), 3);
			unk_0x8744D2E3FC95740E(&(Global_114370.f_24989), 4);
			unk_0x8744D2E3FC95740E(&(Global_114370.f_24989), 5);
			unk_0x8744D2E3FC95740E(&(Global_114370.f_24989), 6);
			unk_0x8744D2E3FC95740E(&(Global_114370.f_24989), 7);
			unk_0x8744D2E3FC95740E(&(Global_114370.f_24989), 8);
			unk_0x8744D2E3FC95740E(&(Global_114370.f_24989), 9);
			iLocal_216 = func_208();
...
void func_259(eCharacter echParam0, eCharacter echParam1, BOOL bParam2) // Position - 0x10687
{
	int num;
...
struct<4> _GET_CHARACTER_NAME(eCharacter character) // Position - 0x1087E
{
	return Global_2139[character /*29*/].f_3;
}

int func_262(eCharacter echParam0, int iParam1) // Position - 0x10891
{
...
int func_263(eCharacter echParam0, int iParam1) // Position - 0x108BB
{
	if (iParam1 < 0 || iParam1 > 4)
		return 0;
...
void func_264(eCharacter echParam0, int iParam1, int iParam2) // Position - 0x108E5
{
	if (iParam1 < 0 || iParam1 > 4)
		return;
...
void func_265(eCharacter echParam0, int iParam1, int iParam2) // Position - 0x1092A
{
	if (iParam1 < 0 || iParam1 > 4)
		return;
...
BOOL _IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(char* message) // Position - 0x109C5
{

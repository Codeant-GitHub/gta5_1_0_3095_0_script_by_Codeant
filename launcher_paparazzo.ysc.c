...
void main() // Position - 0x0
{
	...
	if (!func_278(&unk64, &num, unk61, 5f))
	{
		func_277();
	...
	while (true)
	{
		...
		if (num == 47)
			func_208(&num, unk61, "PAP2AUD", "PAP2_AMB", 3, "BEVERLY", 5000, 1101004800);
		else if (num == 51)
			func_208(&num, unk61, "PAP4AUD", "PAP4_AMB", 3, "BEVERLY", 5000, 1101004800);
	
		func_207(num);
		func_199(&iLocal_93, &(num.f_9), unk61);
	
		if (func_184(&num, 0))
		{
			if (func_183(num))
				func_180(num, &uLocal_95);
...
int func_49(int iParam0, Hash hParam1) // Position - 0x38F7
{
	var unk;
	int num;
...
Hash func_51(Hash hParam0) // Position - 0x393B
{
	Hash hash;
	Hash hash2;
...
Hash func_52() // Position - 0x396F
{
	return Global_1574925;
}

BOOL func_53(int iParam0, Hash hParam1) // Position - 0x397B
{
	var unk;
	BOOL num;
...
var func_54(int iParam0, Hash hParam1) // Position - 0x399F
{
...
BOOL func_69(var uParam0, var uParam1, var uParam2, char* sParam3, float fParam4, float fParam5, float fParam6) // Position - 0x5DC6
{
	var unk;
	var unk2;
...
BOOL func_71(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0x6589
{
	if (bParam6)
...
BOOL func_72(var uParam0) // Position - 0x65D0
{
...
BOOL func_74(int iParam0, int iParam1, BOOL bParam2) // Position - 0x663B
{
	if (iParam0 == -1)
		return false;
...
BOOL func_77(int iParam0) // Position - 0x6A4E
{
	return func_74(iParam0, 5, true);
}

int func_78(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x6A5E
{
	int i;
	float num;
	float num2;
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x7575
{
...
Vector3 func_83(float fParam0, float fParam1, float fParam2) // Position - 0x759F
{
...
BOOL func_85(Player plParam0) // Position - 0x75CB
{
...
BOOL func_87(int iParam0, int iParam1, var uParam2, int iParam3, BOOL bParam4) // Position - 0x76CD
{
	var unk;
	var unk7;
	var unk13;
...
Vector3 func_88(float fParam0, var uParam1, var uParam2, float fParam3) // Position - 0x7762
{
	float num;
	float num2;
	float num3;
...
BOOL func_92(int iParam0, var uParam1) // Position - 0x8403
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_93(Player plParam0) // Position - 0x8485
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
...
Player _INVALID_PLAYER_INDEX() // Position - 0x84DD
{
	return -1;
}
...
BOOL func_98(int iParam0) // Position - 0x877F
{
...
int func_106(int iParam0) // Position - 0x8CC8
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * IS_BIT_SET(iParam0, 31) ? -1 : 1) + 2011;
}

var func_107(BOOL bParam0, var uParam1, var uParam2) // Position - 0x8CEA
{
	if (bParam0)
		return uParam1;
...
int func_108(int iParam0) // Position - 0x8D01
{
	return iParam0 & 15;
}
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER_0() // Position - 0x8DBF
{
	func_58();
	return Global_114370.f_2366.f_539.f_4321;
}
...
void func_116(char* sParam0, var uParam1, int iParam2) // Position - 0x8E5D
{
...
BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0x8E9F
{
...
BOOL func_122(Any* panParam0) // Position - 0xA932
{
	int num;
...
void func_126(Vehicle veParam0) // Position - 0xAAD0
{
	int num;
	int num2;
	int num3;
...
int func_128(Vehicle veParam0) // Position - 0xABAC
{
	int i;
...
BOOL func_132(int iParam0, int iParam1, int iParam2) // Position - 0xACA5
{
...
int func_134(Vehicle veParam0) // Position - 0xAD0C
{
	int i;
...
BOOL func_135(var uParam0) // Position - 0xAD55
{
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(int iParam0) // Position - 0xAD75
{
	if (unk_0xFC8BFE4B41177C22(iParam0))
...
BOOL func_137(int iParam0) // Position - 0xAD96
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_139(int iParam0) // Position - 0xAE66
{
	switch (iParam0)
	{
		case 5:
...
void func_140(Any* panParam0, int iParam1, BOOL bParam2) // Position - 0xAEB9
{
	int i;
...
BOOL func_141(int iParam0) // Position - 0xAFAE
{
	switch (iParam0)
	{
		case 5:
...
void func_143(BOOL bParam0, BOOL bParam1, BOOL bParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB058
{
	if (bParam0)
	{
...
Player func_146(Hash hParam0, BOOL bParam1) // Position - 0xB218
{
	Player player;
	Hash hash;
...
BOOL func_147(int iParam0) // Position - 0xB259
{
	int num;
...
BOOL func_148(int iParam0) // Position - 0xB27B
{
...
int func_150(int iParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0xB2C8
{
	int num;
...
BOOL func_153(var uParam0) // Position - 0xB345
{
...
BOOL _CONVERSATION_IS_DIALOGUE_IN_PROGRESS() // Position - 0xB3E9
{
...
BOOL func_159(var uParam0, float fParam1, int iParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB478
{
...
void func_160(var uParam0) // Position - 0xB4CF
{
	if (!unk_0x1C2F771CDC87A3A5(uParam0, 0))
...
BOOL func_167(int iParam0) // Position - 0xB7DC
{
	if (iParam0 == 1)
...
BOOL func_169(int iParam0) // Position - 0xB842
{
...
BOOL func_170(int iParam0) // Position - 0xB883
{
	int num;
...
int func_172(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4) // Position - 0xB8FA
{
	int i;
...
void func_173(int iParam0, int iParam1) // Position - 0xBA31
{
	int i;
...
BOOL _CAN_ENTER_FREEROAM_STATE(int iParam0) // Position - 0xBA80
{
	return func_175(iParam0, Global_43922);
}

BOOL func_175(int iParam0, int iParam1) // Position - 0xBA91
{
	if (iParam1 == 15)
		return 1;
...
BOOL func_176(int iParam0) // Position - 0xBC72
{
	if (Global_43922 == 15)
		return false;
...
BOOL _IS_MISSION_REPLAY_IN_PROGRESS() // Position - 0xBCEE
{
	if (Global_101392 == 10 || Global_101392 == 9)
		return true;
...
void func_180(int iParam0, var uParam1) // Position - 0xBD12
{
	switch (iParam0)
	{
		case 0:
...
var func_181(float fParam0, float fParam1, float fParam2, int iParam3) // Position - 0xC182
{
	var unk;
...
var func_182(BOOL bParam0, var uParam1, var uParam2) // Position - 0xC1AE
{
	if (bParam0)
		return uParam1;
...
BOOL func_183(int iParam0) // Position - 0xC1C5
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_184(var uParam0, int iParam1) // Position - 0xC254
{
	switch (uParam0->f_16)
	{
		case 0:
...
BOOL func_186(var uParam0) // Position - 0xCA52
{
	float num;
...
void func_187(int iParam0, var uParam1) // Position - 0xCAE0
{
	if (iParam0 == 1)
	{
		if (!func_139(uParam1))
...
BOOL func_188(BOOL bParam0) // Position - 0xCB44
{
	var unk;
...
BOOL func_189(var uParam0) // Position - 0xCBDB
{
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0))
		if (unk_0xD9F5E1FEFD1329E4(uParam0, 0))
...
BOOL func_190(int iParam0) // Position - 0xCC05
{
	eCharacter character;
...
BOOL func_191() // Position - 0xD322
{
	return Global_101431.f_1;
}

BOOL func_192() // Position - 0xD330
{
	if (Global_98294 != -1)
...
BOOL func_197() // Position - 0xD3E0
{
	return Global_1575079;
}

BOOL func_198() // Position - 0xD3EC
{
	if (!unk_0x76CD105BCAC6EB9F())
...
void func_199(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) // Position - 0xD408
{
	if (unk_0x75EAB09F5E974116(unk_0x259BE71D8A81D4FA()))
	{
...
void func_202(var uParam0, int iParam1) // Position - 0xD56E
{
	BOOL flag;
	int i;
...
float func_203(var uParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0xD60C
{
	var unk;
...
void func_205(var uParam0) // Position - 0xD652
{
	unk_0xB479965CBAA3EAE1(0);
	unk_0xDD291722ADDCBD60();
	func_206(uParam0);
...
void func_206(var uParam0) // Position - 0xD669
{
	BOOL flag;
	int num;
	int i;
...
int func_208(var uParam0, var uParam1, var uParam2, var uParam3, char* sParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, int iParam9) // Position - 0xD779
{
	var unk;
...
void _CONVERSATION_ADD_LINE_NO_SUBTITLE(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xD801
{
...
void func_210(var uParam0, eCharacter echParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xD83C
{
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, var uParam2, char* sParam3, int iParam4, int iParam5) // Position - 0xD892
{
...
BOOL IS_RC_FINE_AND_IN_RANGE(Any* panParam0, BOOL bParam1) // Position - 0xD92D
{
	var unk;
...
BOOL func_214(int iParam0) // Position - 0xDEF5
{
...
BOOL func_215(var uParam0) // Position - 0xDF15
{
...
BOOL func_216(var uParam0) // Position - 0xDF2D
{
...
void func_218(var uParam0) // Position - 0xE256
{
...
BOOL CHECK_VEHICLES_OK(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0xE301
{
	int i;
	int num;
	var unk;
...
BOOL func_221(var uParam0, var uParam1) // Position - 0xE4BF
{
	var unk;
...
BOOL func_222(var uParam0, BOOL bParam1, int iParam2) // Position - 0xE4EF
{
	int i;
	int num;
...
BOOL func_223(int iParam0) // Position - 0xE7AB
{
...
BOOL func_224(var uParam0, int iParam1) // Position - 0xE7DF
{
	float num;
...
BOOL func_225(var uParam0, int iParam1) // Position - 0xE855
{
	return func_226(uParam0, unk_0x4A8C381C258A124D(), iParam1, 1, 250, 7);
}

BOOL func_226(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xE86D
{
	BOOL flag;
	var unk;
	int num;
	...
	flag = func_227(&iLocal_35[num /*4*/], unk, uParam1, &(iLocal_35[num /*4*/].f_3), uParam0, iParam5);
	return flag || unk_0x1DD05E817C89C737() - iLocal_35[num /*4*/].f_3 < iParam4;
}

BOOL func_227(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, int iParam7) // Position - 0xE92E
{
	var unk;
	var unk2;
	var unk5;
...
Vector3 func_228(var uParam0, int iParam1) // Position - 0xEA5A
{
	int num;
...
BOOL func_230(var uParam0, var uParam1, int iParam2, int iParam3) // Position - 0xEB69
{
	var unk;
	var unk4;
	float num;
...
float func_231(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0xEBFA
{
	return (fParam0 * uParam3) + (fParam0.f_1 * uParam3.f_1) + (fParam0.f_2 * uParam3.f_2);
}

Vector3 func_232(float fParam0, var uParam1, var uParam2) // Position - 0xEC1B
{
	float num;
	float num2;
...
int func_234(var uParam0, var uParam1) // Position - 0xEC75
{
	int i;
...
int func_235(var uParam0) // Position - 0xECB4
{
...
BOOL func_236(var uParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xECDC
{
	float num;
	float num2;
	int num3;
...
BOOL func_237(var uParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0xEDD7
{
	float num;
	float num2;
...
BOOL func_238(var uParam0, float fParam1) // Position - 0xEEE3
{
	var unk;
	var unk2;
...
BOOL func_239(var uParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xEF78
{
	var unk;
	var unk4;
	float num;
...
BOOL func_240(var uParam0, BOOL bParam1, float fParam2, float fParam3) // Position - 0xF006
{
	if (bParam1)
		if (unk_0x65F146FF416F109F(unk_0x4A8C381C258A124D()))
...
BOOL func_241(int iParam0) // Position - 0xF04E
{
...
void func_242(var uParam0) // Position - 0xF098
{
	var unk;
...
BOOL func_243(int iParam0) // Position - 0xF135
{
	if (iParam0 == -1)
		iParam0 = func_177();
...
BOOL func_244(int iParam0) // Position - 0xF1CA
{
...
BOOL func_247(int iParam0) // Position - 0xF249
{
...
BOOL func_249(int iParam0) // Position - 0xF2BB
{
...
BOOL func_252(var uParam0) // Position - 0xF3B5
{
	int num;
	char* str;
	int i;
	...
	switch (iLocal_89)
	{
		...
		case 1:
			if (!func_261(&num) || !unk_0xE100DD4F82A51BDE(str))
				return false;
		...
		case 2:
			...
			{
				func_256(&uParam0->f_28[1], num[3], -498.16565f, 228.62839f, 82.09948f, 292.9763f, 26);
			...
			{
				func_256(&uParam0->f_28[2], num[4], -498.30902f, 227.91116f, 82.105995f, 296.4216f, 26);
...
void func_253(var uParam0, var uParam1, float fParam2, float fParam3, float fParam4, float fParam5) // Position - 0xF97A
{
	func_218(uParam0);
...
void func_254(var uParam0, var uParam1, float fParam2, float fParam3, float fParam4, float fParam5) // Position - 0xF9A1
{
	func_255(uParam0);
...
void func_255(var uParam0) // Position - 0xF9E4
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
void func_256(var uParam0, var uParam1, float fParam2, float fParam3, float fParam4, float fParam5, int iParam6) // Position - 0xFA80
{
	func_257(uParam0);
...
void func_257(var uParam0) // Position - 0xFAA1
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (!unk_0x1C2F771CDC87A3A5(*uParam0, 0))
...
BOOL func_258(var uParam0, eCharacter echParam1, float fParam2, float fParam3, float fParam4, float fParam5, char* sParam6, int iParam7) // Position - 0xFAE2
{
	if (func_259(uParam0, echParam1, fParam2, fParam5, true))
	{
		if (unk_0xFC8BFE4B41177C22(*uParam0))
		{
			if (!unk_0x1C2F771CDC87A3A5(*uParam0, 0))
...
BOOL func_259(var uParam0, eCharacter echParam1, var uParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0xFB3E
{
	int num;

	if (!func_36(echParam1))
	{
		num = func_297(echParam1);
...
int func_260(int iParam0, eCharacter echParam1) // Position - 0xFBCC
{
	int num;
...
BOOL func_261(var uParam0) // Position - 0xFC12
{
	int i;
...
BOOL func_262(var uParam0) // Position - 0xFC43
{
	uParam0->f_16 = 3;
...
BOOL func_263(var uParam0) // Position - 0xFC77
{
	int num;
	int i;
...
BOOL func_264(var uParam0) // Position - 0xFD62
{
	int num;
	var unk6;
	var unk10;
	...
	switch (iLocal_89)
	{
		...
		case 2:
			...
			if (func_135(uParam0->f_28[0]))
			{
				...
				{
					func_253(&uParam0->f_41[3], num[1], unk_0x0D1381B6E0F3987D(uParam0->f_28[0], 0f, 0f, 2.5f), 0f);
...
BOOL func_265(var uParam0) // Position - 0x102A6
{
	int num;
	int i;
	BOOL flag;
	...
	switch (iLocal_89)
	{
		...
		case 1:
			if (!func_261(&num) || !unk_0xE100DD4F82A51BDE("rcmpaparazzo_2"))
				return false;
		...
		case 2:
			...
			if (func_135(uParam0->f_28[0]))
			{
				if (!unk_0xFC8BFE4B41177C22(uParam0->f_41[0]))
				{
					func_253(&uParam0->f_41[0], num[2], unk_0x0D1381B6E0F3987D(uParam0->f_28[0], 0f, 0f, 2.5f), 0f);
...
BOOL func_266(var uParam0) // Position - 0x105E8
{
	int num;
	int i;
	BOOL flag;
...
BOOL func_268(int iParam0) // Position - 0x10997
{
	var unk;
	eCharacter character;
...
BOOL func_269(int iParam0) // Position - 0x109E8
{
	var unk;
...
BOOL func_270(int iParam0) // Position - 0x10AA1
{
	var unk;
...
BOOL func_271(int iParam0) // Position - 0x10B62
{
	int i;
	var unk;
	int num;
...
BOOL func_273(int iParam0) // Position - 0x10CC9
{
...
BOOL func_274(int iParam0) // Position - 0x10CF4
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_275(int iParam0) // Position - 0x10D1F
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_276(int iParam0) // Position - 0x10D4A
{
	if (func_244(iParam0))
		return false;
	else if (!unk_0x4FAFF4BCB7633475(unk_0x4A8C381C258A124D()))
...
BOOL func_278(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, float fParam5) // Position - 0x10D99
{
	int i;
...
BOOL func_279(int iParam0, var uParam1, var uParam2, var uParam3, float fParam4, var uParam5) // Position - 0x10DFE
{
	int num;
	char* str;
...
BOOL func_280(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7) // Position - 0x10E76
{
	if (fParam6 < 0f)
		fParam6 = 0f;
...
void func_281(var uParam0, BOOL bParam1) // Position - 0x10EF1
{
	if (bParam1)
	{
...
void func_286(var uParam0, BOOL bParam1) // Position - 0x11105
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (unk_0x5B9219522937741D(*uParam0))
...
void func_289(var uParam0) // Position - 0x1118F
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
void func_292(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x1121A
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (!unk_0x4FAFF4BCB7633475(*uParam0))
...
void func_293(int iParam0) // Position - 0x1126A
{
	if (*iParam0 == -1)
		return;
...
int func_297(eCharacter echParam0) // Position - 0x11306
{
	if (!func_36(echParam0))

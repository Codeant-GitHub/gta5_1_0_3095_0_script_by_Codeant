...
int func_58(eCharacter echParam0) // Position - 0x21E0
{
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x2B31
{
	...
	switch (iLocal_79)
	{
		case 0:
			if (func_96(iLocal_78, false))
			{
				...
				if (_IS_MISSION_REPLAY_IN_PROGRESS())
				{
					func_116(&unk2, -1327.1753f, -1290.8113f, 3.8472f, 291.8355f, 0, 0, 0, 0, 0, joaat("asterope"), 0, _CHAR_NULL, 1);
					func_113(0, -1, 1);
...
void func_116(var uParam0, float fParam1, float fParam2, float fParam3, float fParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, eCharacter echParam12, int iParam13) // Position - 0x3987
{
	int num;
...
BOOL func_117(var uParam0, eCharacter echParam1, var uParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6, int iParam7) // Position - 0x3B1B
{
	var unk;
	var unk2;
	int num;
	...
	if (func_14(echParam1))
	{
		...
		num.f_31 = 49;
		num.f_81 = 2;
		func_193(echParam1, &num, iParam7);
	...
	if (func_14(echParam0) && unk_0xFC8BFE4B41177C22(*uParam1) && unk_0xD9F5E1FEFD1329E4(*uParam1, 0))
	{
		...
		if (unk_0xA9DFDFED12311CA7(*uParam1) >= 0 && func_123(*uParam1, false, &unk))
		{
			...
			if (bParam3)
			{
				...
				func_119(Global_114370.f_2366.f_539.f_2407[iParam2 /*295*/][echParam0 /*98*/].f_5, Global_114370.f_2366.f_539.f_2407[iParam2 /*295*/][echParam0 /*98*/].f_7, num2, true, &(Global_114370.f_20121[echParam0 /*43*/].f_1));
				...
				func_119(Global_114370.f_2366.f_539.f_2407[iParam2 /*295*/][echParam0 /*98*/].f_6, -1, num2, false, &(Global_114370.f_20121[echParam0 /*43*/].f_2));
			}
		}
	}
...
float func_121(var uParam0) // Position - 0x6ABA
{
	int num;
	int num2;
	int num3;
...
BOOL func_123(int iParam0, BOOL bParam1, var uParam2) // Position - 0x6D5D
{
	int num;
	BOOL flag;
	...
	*uParam2 = 0;
	...
	if (!func_156(num, bParam1, uParam2) && !func_155(unk_0x259BE71D8A81D4FA()) && !func_136(iParam0))
		return false;
	...
	if (unk_0x9E20DC08879FF3FC(iParam0) && !func_129(iParam0) && !flag && !(func_128(unk_0x4B423FAA24E8ABF0(iParam0)) && func_125(unk_0x259BE71D8A81D4FA())))
	{
...
BOOL func_124(int iParam0) // Position - 0x6ECB
{
	int i;
...
BOOL _NETWORK_IS_PLAYER_VALID(Player player, BOOL bIsPlaying, BOOL bUnk) // Position - 0x7427
{
	Player player;
...
BOOL func_128(int iParam0) // Position - 0x7487
{
...
BOOL func_129(int iParam0) // Position - 0x74C9
{
	switch (unk_0x4B423FAA24E8ABF0(iParam0))
	{
...
BOOL func_130(Player plParam0) // Position - 0x7591
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2657921[plParam0 /*463*/].f_321.f_7 != -1)
...
BOOL func_131(Player plParam0) // Position - 0x75D8
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2657921[plParam0 /*463*/].f_321.f_7 != -1)
...
BOOL func_132(Player plParam0) // Position - 0x761F
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2657921[plParam0 /*463*/].f_321.f_7 != -1)
...
BOOL func_133(int iParam0) // Position - 0x7665
{
	BOOL flag;
...
BOOL func_135(Player plParam0) // Position - 0x7710
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
...
BOOL func_136(int iParam0) // Position - 0x7736
{
...
BOOL func_137(int iParam0) // Position - 0x7765
{
...
BOOL func_138(int iParam0) // Position - 0x789D
{
	int num;
	...
	if (unk_0xFC8BFE4B41177C22(iParam0) && unk_0xD9F5E1FEFD1329E4(iParam0, 0))
	{
		...
		if (unk_0x9E20DC08879FF3FC(iParam0) && !func_129(iParam0) || func_139(num))
			return true;
...
BOOL func_139(int iParam0) // Position - 0x791A
{
	switch (iParam0)
	{
		case joaat("mule"):
...
BOOL func_140(Player plParam0) // Position - 0x7976
{
	if (plParam0 == _INVALID_PLAYER_INDEX())
		return false;
...
BOOL func_141(int iParam0, BOOL bParam1) // Position - 0x79AF
{
	switch (unk_0x4B423FAA24E8ABF0(iParam0))
	{
...
BOOL func_143(int iParam0, int iParam1) // Position - 0x7A43
{
	if (iParam1 == 0)
...
BOOL func_152(int iParam0, int iParam1) // Position - 0x7F4A
{
	switch (iParam0)
	{
		case joaat("faction2"):
...
BOOL func_157(int iParam0) // Position - 0x88D5
{
	switch (iParam0)
	{
		case joaat("towtruck"):
...
void func_158(int iParam0, eCharacter echParam1) // Position - 0x890A
{
	var unk;
	int i;
	int j;
...
BOOL func_161(int iParam0) // Position - 0x8E67
{
	switch (iParam0)
	{
		case joaat("granger"):
...
BOOL func_163(int iParam0) // Position - 0x8F37
{
	if (!unk_0xFC8BFE4B41177C22(iParam0) || !unk_0xD9F5E1FEFD1329E4(iParam0, 0) || func_180(iParam0, 0, false) || func_180(iParam0, 1, false) || func_180(iParam0, 2, false) || func_179(iParam0) != _CHAR_NULL || func_178(iParam0) || func_177(iParam0) || func_124(iParam0) || func_176(iParam0) || !func_164(unk_0x4B423FAA24E8ABF0(iParam0)))
	{
		func_177(iParam0);
		func_177(iParam0);
...
BOOL func_164(Hash hParam0) // Position - 0x9014
{
	if (hParam0 == 0)
		return false;
...
BOOL func_165(Hash hParam0, BOOL bParam1, int iParam2) // Position - 0x91D2
{
	int i;
	var unk;
...
BOOL func_166(int iParam0) // Position - 0x9354
{
	int num;
	var unk;
	var unk2;
...
BOOL _NETSHOPPING_SHOULD_USE_TRANSACTION_SYSTEM() // Position - 0x9420
{
	if (unk_0x761778199FE1211C())
...
BOOL func_168(int iParam0, int iParam1) // Position - 0x9437
{
	BOOL num;
	var unk;
...
BOOL func_171() // Position - 0xE99C
{
	return false;
}

BOOL func_172() // Position - 0xE9A5
{
	return true;
}

BOOL func_173() // Position - 0xE9AE
{
	return true;
}

BOOL func_174() // Position - 0xE9B7
{
...
BOOL _IS_EXCLUSIVE_CONTENT_UNLOCKED() // Position - 0xE9D0
{
	var unk;
...
BOOL func_176(int iParam0) // Position - 0xEA88
{
	Hash hash;
	var unk;
	...
	if (!func_165(hash, false, -1))
		return true;

	return false;
}

BOOL func_177(int iParam0) // Position - 0xEACF
{
	int i;
...
BOOL func_178(int iParam0) // Position - 0xEB4B
{
	int i;
...
eCharacter func_179(int iParam0) // Position - 0xEC33
{
	int i;
...
BOOL func_180(int iParam0, int iParam1, BOOL bParam2) // Position - 0xEC96
{
	int i;
	var unk;
	int num;
...
BOOL func_181(int iParam0, int iParam1, char* sParam2, var uParam3) // Position - 0xED04
{
...
void func_182(int iParam0, eCharacter echParam1) // Position - 0xEDDC
{
	int i;
...
void func_183(var uParam0) // Position - 0xEE5E
{
	if (!func_184(*uParam0))
...
BOOL func_184(var uParam0) // Position - 0xEE89
{
	return unk_0x5318DF85BEB6B95F(uParam0, 5);
}

int func_185(var uParam0, var uParam1, var uParam2) // Position - 0xEE98
{
	int i;
	int num;
...
BOOL func_186(var uParam0) // Position - 0xF072
{
	int i;
	int num;
	int num2;
...
int func_188(var uParam0, int iParam1) // Position - 0xF1A5
{
	int value;
	int value2;
	float num;
...
int func_189(var uParam0, int iParam1) // Position - 0xF28E
{
	int i;
...
BOOL func_190(var uParam0, int iParam1, int iParam2) // Position - 0xF2F0
{
...
BOOL func_191() // Position - 0xF314
{
	return false;
}

BOOL func_192(var uParam0, var uParam1) // Position - 0xF31D
{
	if (unk_0x76CD105BCAC6EB9F())
	{
	}
...
void func_193(eCharacter echParam0, var uParam1, int iParam2) // Position - 0xF35E
{
	int num;
...
void func_194(eCharacter echParam0, int iParam1) // Position - 0xF5BA
{
	int i;
	...
	for (i = 0; i < 9; i = i + 1)
	{
		if (unk_0xFC8BFE4B41177C22(Global_98703[i]))
		{
			...
			{
				if (iParam1 == 0 || unk_0x4B423FAA24E8ABF0(Global_98703[i]) == func_195(echParam0, iParam1))
				{
...
int func_195(eCharacter echParam0, int iParam1) // Position - 0xF658
{
	int num;
...
void func_196(var uParam0, var uParam1, var uParam2, float fParam3, int iParam4) // Position - 0xF69A
{
	int i;
...
BOOL func_201(int iParam0, int iParam1) // Position - 0xF9BD
{
	int num;
...
BOOL func_203(int iParam0, int iParam1) // Position - 0xFA3B
{
	if (iParam0 == -1)
		return false;
...
BOOL func_204(var uParam0, int iParam1) // Position - 0xFA5B
{
	BOOL num;
	int num2;
...
BOOL func_205(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0x1114C
{
	if (bParam6)
...
int func_206(var uParam0, var uParam1, var uParam2, float fParam3) // Position - 0x11193
{
	return func_207(&(Global_107917.f_2890), uParam0, fParam3, false);
}

int func_207(var uParam0, var uParam1, var uParam2, var uParam3, float fParam4, BOOL bParam5) // Position - 0x111AD
{
	int num;
	Vector3 vector;
	BOOL flag;
	...
	if (func_230(uParam0))
	{
		...
		if (func_229(uParam0))
		{
			...
			if (unk_0xFC8BFE4B41177C22(num))
			{
				...
				func_211(num, &(uParam0->f_12), false, true);
				flag = true;
				...
				if (uParam0->f_7 == 1)
				{
					...
					func_182(num, uParam0->f_11);
				}
				else if (!func_209(num, uParam0->f_3, uParam0->f_8) && uParam0->f_10 && unk_0x1B79E937E91F40C3(unk_0x1AF90EB93E0012D6(), "startup_positioning"))
				{
					num2 = func_208(num);
...
BOOL func_209(int iParam0, var uParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x11522
{
	int num;
	var unk;
	int num2;
	...
	{
		case joaat("cargobob"):
			if (func_210(iParam0, Global_78038.f_139[38], false))
			{
				func_197(38);
				return true;
			}
		...
		case joaat("firetruk"):
			if (func_210(iParam0, Global_78038.f_139[43], true))
			{
				func_197(43);
				return true;
			}
		...
		case joaat("cuban800"):
			...
			{
				if (func_210(iParam0, unk[i], true) && func_100(unk_0xD1A6A821F5AC81DB(unk[i], 1), 2136.133f, 4780.5635f, 39.9702f, 5f, false))
				{
					if (!bParam4 || func_205(uParam1, 0f, 0f, 0f, false) || unk_0xED977E2AE2CB16EE(unk_0xD1A6A821F5AC81DB(iParam0, 1), unk_0xD1A6A821F5AC81DB(unk[i], 1), 1) < 10f)
					{
...
BOOL func_210(int iParam0, int iParam1, BOOL bParam2) // Position - 0x1172A
{
	var unk;
	var unk2;
	var unk3;
...
void func_211(int iParam0, var uParam1, BOOL bParam2, BOOL bParam3) // Position - 0x1178B
{
	...
	if (unk_0xD9F5E1FEFD1329E4(iParam0, 0))
	{
		...
		if (IS_BIT_SET(uParam1->f_77, 15) || func_219(iParam0) || uParam1->f_62 == 0 && uParam1->f_63 == 0 && uParam1->f_64 == 0 && uParam1->f_9[20] > 0 && func_218())
		{
			uParam1->f_62 = 0;
			uParam1->f_63 = 0;
			uParam1->f_64 = 0;
		...
		if (func_212() && unk_0x00C6FDED3EB75117(uParam1->f_66) && unk_0x8EC15ED9ECD1E9D0(iParam0) && !unk_0x2E6A27037F1DC473(iParam0, joaat("avenger")) && !unk_0x2E6A27037F1DC473(iParam0, func_134(true)))
...
BOOL func_213(Player plParam0) // Position - 0x11F12
{
	Player player;
...
BOOL func_214(Player plParam0) // Position - 0x11F36
{
	Player player;
...
BOOL func_216(var uParam0, int iParam1) // Position - 0x11F68
{
	int num;
	int num2;
	int num3;
...
void func_217(int iParam0, var uParam1) // Position - 0x11F8B
{
	int num;
	int num2;
...
BOOL func_219(int iParam0) // Position - 0x12014
{
	int num;
...
int func_220(var uParam0) // Position - 0x1205C
{
...
BOOL func_221(int iParam0) // Position - 0x1207C
{
	switch (iParam0)
	{
		case 161:
...
BOOL func_222(int iParam0) // Position - 0x120CF
{
...
BOOL func_226(int iParam0, BOOL bParam1) // Position - 0x121C5
{
	if (func_33(iParam0))
...
BOOL _IS_PLAYER_IN_VEHICLE_SEAT(var uParam0, int iParam1) // Position - 0x12235
{
	var unk;
...
BOOL func_229(var uParam0) // Position - 0x12282
{
	if (func_230(uParam0))
	{
...
BOOL func_230(var uParam0) // Position - 0x122B7
{
...
BOOL func_234(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x1235B
{
...
BOOL func_235() // Position - 0x123E9
{
	float num;
...
BOOL func_236(int iParam0) // Position - 0x1245E
{
	switch (iParam0)
	{
		case joaat("police"):
...
{
	unk_0x0B0C9A0F9AAEB7F0(&Global_97227, iParam0);
	return;
}
...
BOOL func_241() // Position - 0x12640
{
	int num;
...
BOOL func_242(BOOL bParam0, int iParam1) // Position - 0x1267C
{
	int num;
...
BOOL func_248() // Position - 0x1276E
{
	func_249();
...
void func_250(var uParam0, var uParam1, var uParam2) // Position - 0x12969
{
...
BOOL func_253(var uParam0) // Position - 0x129F6
{
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0))
...
void func_255(eCharacter echParam0, int iParam1, int iParam2, BOOL bParam3, BOOL bParam4) // Position - 0x12A66
{
	int num;
	int num2;
...
void func_259(int iParam0) // Position - 0x13413
{
	BOOL flag;
	var unk;
	...
	else if (IS_BIT_SET(Global_114370.f_20567.f_471, iParam0) || IS_BIT_SET(Global_2359296[func_261() /*5569*/].f_681.f_10, iParam0))
	{
		flag = true;
		unk_0x8744D2E3FC95740E(&(Global_114370.f_20567.f_471), iParam0);
		unk_0x8744D2E3FC95740E(&(Global_2359296[func_261() /*5569*/].f_681.f_10), iParam0);
	}
...
char* AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM(int iParam0) // Position - 0x1358C
{
	switch (iParam0)
	{
		case 0:
...
void func_262(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x1369B
{
	int num;
...
void _STAT_SET_PACKED_BOOL(int iParam0, int iParam1, int iParam2) // Position - 0x136C9
{
	if (iParam2 == -1)
		iParam2 = func_32();
...
BOOL func_265(int iParam0) // Position - 0x13707
{
	int num;
	int num2;
	int num3;
...
BOOL func_270(var uParam0, int iParam1) // Position - 0x13A32
{
	int i;
	var unk;
...
void func_275(var uParam0, int iParam1) // Position - 0x13BB3
{
	if (iParam1 == 0f)
		uParam0->f_80 = 0f;
	else
...
BOOL func_280(int iParam0) // Position - 0x13C29
{
	switch (iParam0)
	{
		case 60:
...
int func_285(eCharacter echParam0) // Position - 0x13DBF
{
	return Global_2139[echParam0 /*29*/].f_17;
}

BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0x13DD0
{
...
void func_287(float fParam0, float fParam1, float fParam2, float fParam3, int iParam4, int iParam5) // Position - 0x13DF8
{
	if (_IS_MISSION_REPLAY_IN_PROGRESS())
	{
...
BOOL _IS_MISSION_REPLAY_IN_PROGRESS() // Position - 0x13E8D
{
...
BOOL func_291(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x14299
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
void func_295(int iParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7, int iParam8, int iParam9, BOOL bParam10) // Position - 0x164F5
{
	int num;
	int num2;
...
BOOL func_299(int iParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x17492
{
	int num;
	int num2;
	int num3;
	...
	if (func_300(iParam0, iParam1, &num3, &num2, bParam2, bParam3))
	{
...
void func_302(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x1A093
{
	...
	if (iParam0 == 12)
	{
		...
		if (num4 >= 0)
		{
			...
			if (num5 > num4)
			{
				...
				Global_2883589 = num3;
				func_295(&Global_79031[0 /*14*/], iParam0, iParam1, &(num3.f_7), 0, 0, num3.f_2, false, -1, 2, true);
				return;
			}
		}
	}
	...
	else if (iParam0 == 14)
	{
		...
		if (num8 >= 0)
		{
			...
			if (num9 > num8)
			{
				...
				Global_2883589 = num6;
				func_295(&Global_79031[0 /*14*/], iParam0, iParam1, &(num6.f_9), num6.f_3, num6.f_4, num6.f_5, unk_0x304A39EB177D246B(num6.f_1, joaat("OUTFIT_ONLY"), 0), num7, 2, num6.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_79229)
		{
			...
			func_295(&Global_79031[0 /*14*/], iParam0, iParam1, &(num10.f_9), num10.f_3, num10.f_4, num10.f_5, unk_0x304A39EB177D246B(num10.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, num10.f_1 != 0);
			return;
		}
		...
		if (num11 >= 0)
		{
			num12 = unk_0x7B6C0A0D604E68FA(num2, 10, -1, 0, -1, func_303(iParam0));
...
BOOL func_362(var uParam0, float fParam1, var uParam2, var uParam3) // Position - 0x2B938
{
	BOOL flag;
	int num;
	int num2;
...
void func_364(var uParam0, var uParam1, var uParam2, var uParam3) // Position - 0x2BA94
{
	uParam0->f_51 == 0;
	uParam0->f_46 >= 15;
...
BOOL func_381() // Position - 0x2BD16
{
	if (Global_101392 == 13 || Global_101392 == 10 || Global_101392 == 11 || Global_101392 == 12)
		return false;

...
void func_2(int iParam0, BOOL bParam1) // Position - 0x3AD
{
	...
	{
		if (bParam1)
			unk_0x0B0C9A0F9AAEB7F0(&(Global_114370.f_24998), num);
		else
			unk_0x8744D2E3FC95740E(&(Global_114370.f_24998), num);
	}
	else
	{
		num = num - 31;
		...
		if (bParam1)
			unk_0x0B0C9A0F9AAEB7F0(&(Global_114370.f_24998.f_1), num);
		else
			unk_0x8744D2E3FC95740E(&(Global_114370.f_24998.f_1), num);
	}
...
{
	if (bParam0 == 1)
		unk_0x0B0C9A0F9AAEB7F0(&Global_8684, 28);
	else
		unk_0x8744D2E3FC95740E(&Global_8684, 28);
...
int func_16(int iParam0, Player plParam1) // Position - 0x34E9
{
	var unk;
	int num;
...
var func_17(int iParam0, Player plParam1) // Position - 0x3518
{
	return unk_0xD69CE161FE614531(0, iParam0, func_18(plParam1));
}

Player func_18(Player plParam0) // Position - 0x352D
{
	Player player;
	Player player2;
...
Player func_19() // Position - 0x3561
{
...
BOOL func_21(Player plParam0, int iParam1, BOOL bParam2, BOOL bParam3, Player plParam4) // Position - 0x3968
{
	Player player;
	int num;
	int num2;
	...
	if (func_22(plParam0, iParam1, &num2, &num, bParam2, bParam3))
	{
		num3 = func_16(num2, player);
...
BOOL func_22(Player plParam0, int iParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5) // Position - 0x39A6
{
	int value;
...
void func_24(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x65E1
{
	...
	if (iParam0 == 12)
	{
		...
		if (num4 >= 0)
		{
			...
			if (num5 > num4)
			{
				...
				Global_2883589 = num3;
				func_13(&Global_79031[0 /*14*/], iParam0, iParam1, &(num3.f_7), 0, 0, num3.f_2, false, -1, 2, true);
				return;
			}
		}
	}
	...
	else if (iParam0 == 14)
	{
		...
		if (num8 >= 0)
		{
			...
			if (num9 > num8)
			{
				...
				Global_2883589 = num6;
				func_13(&Global_79031[0 /*14*/], iParam0, iParam1, &(num6.f_9), num6.f_3, num6.f_4, num6.f_5, unk_0x304A39EB177D246B(num6.f_1, joaat("OUTFIT_ONLY"), 0), num7, 2, num6.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_79229)
		{
			...
			func_13(&Global_79031[0 /*14*/], iParam0, iParam1, &(num10.f_9), num10.f_3, num10.f_4, num10.f_5, unk_0x304A39EB177D246B(num10.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, num10.f_1 != 0);
			return;
		}
		...
		if (num11 >= 0)
		{
			num12 = unk_0x7B6C0A0D604E68FA(num2, 10, -1, 0, -1, func_25(iParam0));
	...
	switch (iParam0)
	{
		case joaat("Player_Zero"):
			if (!bParam3 || IS_BIT_SET(Global_114370.f_7232[1], 0))
				unk_0x0B0C9A0F9AAEB7F0(&Global_114370.f_2366.f_539.f_3816[0 /*166*/][iParam1 /*11*/][iParam2 / 32], iParam2 % 32);
			break;
	
		case joaat("Player_Two"):
			if (!bParam3 || IS_BIT_SET(Global_114370.f_7232[3], 0))
				unk_0x0B0C9A0F9AAEB7F0(&Global_114370.f_2366.f_539.f_3816[1 /*166*/][iParam1 /*11*/][iParam2 / 32], iParam2 % 32);
		
			if (!bParam3 || IS_BIT_SET(Global_114370.f_7232[4], 0))
				unk_0x0B0C9A0F9AAEB7F0(&Global_114370.f_2366.f_539.f_3816[2 /*166*/][iParam1 /*11*/][iParam2 / 32], iParam2 % 32);
			break;
	}
...
void func_92(var uParam0, int iParam1, int iParam2, Player plParam3, Player plParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x1ACE7
{
	uParam0->[0] = iParam1;
	uParam0->[2] = iParam2;
	uParam0->[3] = plParam3;
...
void func_97(int iParam0, BOOL bParam1) // Position - 0x1AE57
{
	...
	if (bParam1)
		unk_0x0B0C9A0F9AAEB7F0(&Global_114370.f_10052.f_135[num], unk);
	else
		unk_0x8744D2E3FC95740E(&Global_114370.f_10052.f_135[num], unk);

	return;
}

void func_98(var uParam0, var uParam1, var uParam2, var uParam3, float fParam4) // Position - 0x1AE97
{
...
BOOL func_99(var uParam0, var uParam1, var uParam2, float fParam3, float fParam4) // Position - 0x1AEBD
{
	float num;
	float num2;
...
void func_100(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10) // Position - 0x1AEFD
{
	Vector3 vector;
	Vector3 vector2;
	Vector3 vector3;

...
void func_68(var uParam0) // Position - 0x56F3
{
	eCharacter character;
...
BOOL func_70(var uParam0, var uParam1, var uParam2, char* sParam3, float fParam4, float fParam5, float fParam6) // Position - 0x5C7E
{
	var unk;
	var unk2;
...
BOOL func_72(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0x6441
{
	if (bParam6)
...
BOOL func_73(var uParam0) // Position - 0x6488
{
...
BOOL func_75(int iParam0, int iParam1, BOOL bParam2) // Position - 0x64F3
{
	if (iParam0 == -1)
		return false;
...
BOOL func_78(int iParam0) // Position - 0x6906
{
	return func_75(iParam0, 5, true);
}

int func_79(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x6916
{
	int i;
	float num;
	float num2;
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x742D
{
...
Vector3 func_84(float fParam0, float fParam1, float fParam2) // Position - 0x7457
{
...
BOOL func_86(Player plParam0) // Position - 0x7483
{
...
BOOL func_88(int iParam0, int iParam1, var uParam2, int iParam3, BOOL bParam4) // Position - 0x7585
{
	var unk;
	var unk7;
	var unk13;
...
Vector3 func_89(float fParam0, var uParam1, var uParam2, float fParam3) // Position - 0x761A
{
	float num;
	float num2;
	float num3;
...
BOOL func_93(int iParam0, var uParam1) // Position - 0x82B8
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_94(Player plParam0) // Position - 0x833A
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
...
Player _INVALID_PLAYER_INDEX() // Position - 0x8392
{
	return -1;
}
...
BOOL func_99(int iParam0) // Position - 0x8634
{
...
int func_107(int iParam0) // Position - 0x8B7D
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * IS_BIT_SET(iParam0, 31) ? -1 : 1) + 2011;
}

var func_108(BOOL bParam0, var uParam1, var uParam2) // Position - 0x8B9F
{
	if (bParam0)
		return uParam1;
...
int func_109(int iParam0) // Position - 0x8BB6
{
	return iParam0 & 15;
}
...
BOOL _IS_MISSION_REPLAY_IN_PROGRESS() // Position - 0x8C74
{
	if (Global_101392 == 10 || Global_101392 == 9)
		return true;
...
void func_117(char* sParam0, var uParam1, int iParam2) // Position - 0x8D1D
{
...
BOOL func_132(int iParam0, int iParam1, int iParam2) // Position - 0xAA54
{
...
BOOL func_135(var uParam0) // Position - 0xAB04
{
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(var uParam0) // Position - 0xAB24
{
	if (unk_0xFC8BFE4B41177C22(uParam0))
...
BOOL func_137(int iParam0) // Position - 0xAB45
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_140(int iParam0) // Position - 0xAC27
{
	if (iParam0 == -1)
		iParam0 = func_150();
...
BOOL func_141(int iParam0) // Position - 0xACBC
{
...
BOOL func_144(int iParam0) // Position - 0xAD3B
{
...
int func_145(var uParam0, int iParam1) // Position - 0xAD6F
{
	int num;
	var unk;
	var unk33;
...
BOOL _CAN_ENTER_FREEROAM_STATE(int iParam0) // Position - 0xADF6
{
	return func_148(iParam0, Global_43922);
}

BOOL func_148(int iParam0, int iParam1) // Position - 0xAE07
{
	if (iParam1 == 15)
		return 1;
...
BOOL func_149(int iParam0) // Position - 0xAFE8
{
	if (_IS_MISSION_REPEAT_ACTIVE(false))
...
BOOL func_151(int iParam0) // Position - 0xB021
{
	int num;
...
BOOL func_155(int iParam0) // Position - 0xB21E
{
	if (Global_43922 == 15)
		return false;
...
BOOL func_156(int iParam0) // Position - 0xB240
{
	eCharacter character;
		...
		if (unk_0xFC8BFE4B41177C22(unk_0x4A8C381C258A124D()))
		{
			if (!unk_0x4FAFF4BCB7633475(unk_0x4A8C381C258A124D()))
			{
				...
				switch (iParam0)
				{
					...
					case 3:
						if (unk_0x8BF5256C439DF778(unk_0x4A8C381C258A124D()) || unk_0x9857C978BD3CBEDA(unk_0x4A8C381C258A124D()) || unk_0x6652E84A43F51B8B(unk_0x259BE71D8A81D4FA(), 1) || unk_0x1B32E388988DD296(unk_0x4A8C381C258A124D(), 0) || func_164() || Global_113417 || Global_32831 || func_163() || func_162(8, -1) || func_101() || func_161() || func_159() || Global_114370.f_7691.f_919[character] == 5)
							return false;
						break;
				
					case 4:
						if (func_164() || unk_0xE7B45027762DEFE7(unk_0x259BE71D8A81D4FA()) > 0 || func_162(8, -1) || func_159() || func_158() || Global_114370.f_7691.f_919[character] == 5)
							return false;
						break;
...
BOOL func_157() // Position - 0xB95D
{
	return Global_101431.f_1;
}

BOOL func_158() // Position - 0xB96B
{
	if (Global_98294 != -1)
...
BOOL func_163() // Position - 0xBA1B
{
	return Global_1575079;
}

BOOL func_164() // Position - 0xBA27
{
	if (!unk_0x76CD105BCAC6EB9F())
...
BOOL func_166(int iParam0) // Position - 0xBA5B
{
...
BOOL _CONVERSATION_IS_DIALOGUE_IN_PROGRESS() // Position - 0xBBAB
{
...
BOOL func_175(int iParam0, int iParam1) // Position - 0xBFE2
{
...
void _UPDATE_CURRENT_PLAYER_CHARACTER() // Position - 0xC181
{
	if (func_60(14))
	{
...
void func_183(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xC2D1
{
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5) // Position - 0xC327
{
...
BOOL func_188(int iParam0) // Position - 0xC493
{
...
BOOL func_189(int iParam0) // Position - 0xC4C0
{
	int i;
...
void func_191(eCharacter echParam0, eCharacter echParam1, BOOL bParam2) // Position - 0xC53E
{
	int num;
...
struct<4> _GET_CHARACTER_NAME(eCharacter character) // Position - 0xC737
{
	return Global_2139[character /*29*/].f_3;
}

int func_194(eCharacter echParam0, int iParam1) // Position - 0xC74A
{
...
int func_195(eCharacter echParam0, int iParam1) // Position - 0xC774
{
	if (iParam1 < 0 || iParam1 > 4)
		return 0;
...
void func_196(eCharacter echParam0, int iParam1, int iParam2) // Position - 0xC79E
{
	if (iParam1 < 0 || iParam1 > 4)
		return;
...
void func_197(eCharacter echParam0, int iParam1, int iParam2) // Position - 0xC7E3
{
	if (iParam1 < 0 || iParam1 > 4)
		return;
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER() // Position - 0xC828
{
	func_59();
	return Global_114370.f_2366.f_539.f_4321;
}

BOOL func_199(int iParam0) // Position - 0xC841
{
...
BOOL func_200(int iParam0, int iParam1) // Position - 0xC86C
{
	BOOL flag;
...
BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0xC90D
{

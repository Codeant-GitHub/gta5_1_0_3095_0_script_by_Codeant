...
void func_1(int iParam0, BOOL bParam1) // Position - 0x1D1
{
	...
	if (bParam1)
	{
		...
		else if (unk_0x4C705AAF75363287() && !Global_113009 && !IS_BIT_SET(iLocal_103, 15))
		{
			unk_0x0B0C9A0F9AAEB7F0(&iLocal_103, 15);
			unk_0x428C32CC68809A35(1);
		}
...
int func_8() // Position - 0x35B
{
	...
	else if (unk_0xA0C7B98BCF1EEF9E(Global_20794) == 1)
	{
		if (func_11())
		{
			if (func_10())
			{
				...
				while (!unk_0xA6F779AA284EB20E(unk) && num5 == 0 && unk_0xA0C7B98BCF1EEF9E(Global_20794) == 1)
				{
					SYSTEM::WAIT(0);
				...
				num2 = Global_20819[num];
				num3 = num2;
			
				if (unk_0xA0C7B98BCF1EEF9E(Global_20794) == 0)
					num3 = 145;
...
{
	if (!unk_0xFC8BFE4B41177C22(iParam0) || !unk_0xD9F5E1FEFD1329E4(iParam0, 0) || func_42(iParam0, 0, false) || func_42(iParam0, 1, false) || func_42(iParam0, 2, false) || func_64(iParam0) != _CHAR_NULL || func_41(iParam0) || func_40(iParam0) || func_39(iParam0) || func_38(iParam0) || !func_25(unk_0x4B423FAA24E8ABF0(iParam0)))
	{
		func_40(iParam0);
		func_40(iParam0);
...
BOOL func_27(int iParam0) // Position - 0x1219
{
	int num;
	var unk;
	var unk2;
...
BOOL _NETSHOPPING_SHOULD_USE_TRANSACTION_SYSTEM() // Position - 0x12DF
{
	if (unk_0x761778199FE1211C())
...
BOOL func_29(int iParam0, int iParam1) // Position - 0x12F6
{
	BOOL num;
	var unk;
...
BOOL func_33() // Position - 0x6875
{
	return false;
}

BOOL func_34() // Position - 0x687E
{
	return true;
}

BOOL func_35() // Position - 0x6887
{
	return true;
}

BOOL func_36() // Position - 0x6890
{
...
BOOL _IS_EXCLUSIVE_CONTENT_UNLOCKED() // Position - 0x68A9
{
	var unk;
...
BOOL func_38(int iParam0) // Position - 0x6961
{
	int num;
	var unk;
...
BOOL func_39(int iParam0) // Position - 0x69A8
{
	int i;
...
BOOL func_40(int iParam0) // Position - 0x69E3
{
	int i;
...
BOOL func_41(int iParam0) // Position - 0x6A5F
{
	int i;
...
BOOL func_42(int iParam0, int iParam1, BOOL bParam2) // Position - 0x6B47
{
	int i;
	var unk;
	int num;
...
BOOL func_43(int iParam0, int iParam1, char* sParam2, var uParam3) // Position - 0x6BB5
{
...
int func_49(int iParam0) // Position - 0x6E7E
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * IS_BIT_SET(iParam0, 31) ? -1 : 1) + 2011;
}

var func_50(BOOL bParam0, var uParam1, var uParam2) // Position - 0x6EA0
{
	if (bParam0)
		return uParam1;
...
int func_51(int iParam0) // Position - 0x6EB7
{
	return iParam0 & 15;
}
...
BOOL func_55(var uParam0, int iParam1) // Position - 0x6F75
{
	BOOL num;
	int num2;
...
BOOL func_58(eCharacter echParam0) // Position - 0x8901
{
	return echParam0 < CHAR_MULTIPLAYER;
}

void func_59(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, float fParam5, eCharacter echParam6) // Position - 0x890D
{
	if (func_55(&Global_78038.f_555[0 /*21*/], iParam0))
	{
...
eCharacter func_64(int iParam0) // Position - 0x8BE1
{
	int i;
...
int func_67(var uParam0, var uParam1, var uParam2) // Position - 0x8F9F
{
	int i;
	int num;
...
BOOL func_68(int iParam0) // Position - 0x9192
{
	switch (iParam0)
	{
		case joaat("granger"):
...
eCharacter _GET_PLAYER_CHARACTER_FROM_PED(var uParam0) // Position - 0x938C
{
	eCharacter i;
	int num;
...
int _GET_CHARACTER_MODEL(eCharacter character) // Position - 0x93C9
{
...
int func_75(eCharacter echParam0) // Position - 0x93EE
{
	return Global_2139[echParam0 /*29*/];
}

BOOL func_76(int iParam0, int iParam1) // Position - 0x93FD
{
	if (iParam0 == -1)
		return false;
...
BOOL func_79(var uParam0, Vector3 vParam1, var uParam2, var uParam3, int iParam4, int iParam5) // Position - 0x9455
{
	return SYSTEM::VDIST2(unk_0xD1A6A821F5AC81DB(uParam0, iParam5), vParam1) <= iParam4 * iParam4;
}

BOOL func_80(float fParam0, float fParam1, float fParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0x9473
{
	if (bParam6)
...
BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0x9529
{
...
void func_84(char* sParam0, int iParam1) // Position - 0x9551
{
...
BOOL func_88(int iParam0) // Position - 0x96F3
{
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(var uParam0) // Position - 0x971D
{
	if (unk_0xFC8BFE4B41177C22(uParam0))
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER() // Position - 0x97EE
{
	func_86();
...
void func_94(int iParam0, BOOL bParam1) // Position - 0x9819
{
...
void func_95() // Position - 0x985E
{
	...
	if (iLocal_40 == 0)
	{
		unk_0x1164A75E490C27B6(joaat("FL_CO_FB4P3"), Global_114370.f_10019.f_21, 1);
...
void _STAT_SET_PACKED_BOOL(int iParam0, int iParam1, int iParam2) // Position - 0x9EF4
{
	if (iParam2 == -1)
		iParam2 = func_102();
...
BOOL func_106(int iParam0) // Position - 0x9FAD
{
	if (iParam0 == 146 || iParam0 == -1)
		return false;
...
void func_111(BOOL bParam0) // Position - 0xA079
{
...
int func_114(int iParam0, int iParam1, eCharacter echParam2, eCharacter echParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10) // Position - 0xA271
{
	int num;
	int num2;
...
void func_115(eCharacter echParam0) // Position - 0xA3C2
{
	int i;
	int num;
	int j;
...
void func_118(eCharacter echParam0, int iParam1, int iParam2) // Position - 0xA530
{
...
void func_119(eCharacter echParam0, int iParam1, int iParam2) // Position - 0xA575
{
	if (iParam1 < 0 || iParam1 > 4)
		return;
...
void func_121(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0xA5DF
{
	if (iLocal_40 == 0)
		func_126(uParam0);
	else if (iLocal_40 == 1)
...
void func_122(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0xA606
{
	if (func_104())
...
void func_126(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0xA76E
{
	if (func_104())
		if (func_127())
			if (_GET_CURRENT_PLAYER_CHARACTER() != CHAR_MICHAEL)
...
{
	return unk_0xF40767E41852FB72(Global_114370.f_18106.f_395);
}

BOOL func_136() // Position - 0xA94A
{
	if (func_13())
		if (_GET_CURRENT_PLAYER_CHARACTER() == CHAR_MICHAEL)
...
BOOL _IS_MISSION_REPLAY_IN_PROGRESS() // Position - 0xA991
{
...
BOOL func_143(var uParam0) // Position - 0xAAE8
{
	var unk;
...
void func_145(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0xAB62
{
	int i;

	if (unk_0xC450B06E5AAA0985(Global_33208[iParam0 /*23*/].f_19))
		unk_0xDABC73EF230B6665(Global_33208[iParam0 /*23*/].f_19, uParam1);

	i = 0;

	for (i = 0; i <= 2; i = i + 1)
	{
		Global_33208[iParam0 /*23*/][i /*3*/] = { uParam1 };
	}
...
BOOL func_147(char* sParam0, int iParam1, BOOL bParam2) // Position - 0xAC10
{
	Global_22167 = 0;
...
BOOL func_151(int iParam0, int iParam1) // Position - 0xAF88
{
	return IS_BIT_SET(Global_1886967[iParam0 /*609*/].f_10.f_4, iParam1);
}

Player _INVALID_PLAYER_INDEX() // Position - 0xAFA0
{
	return -1;
}
...
void _UPDATE_CURRENT_PLAYER_CHARACTER() // Position - 0xB12E
{
	if (func_87(14))
	{
...
void func_161(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xB2B5
{
...
void func_163(eCharacter echParam0, char* sParam1) // Position - 0xB325
{
	int num;
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5) // Position - 0xB49B
{
...
void func_165(eCharacter echParam0, eCharacter echParam1, BOOL bParam2) // Position - 0xB536
{
	int num;
...
struct<4> _GET_CHARACTER_NAME(eCharacter character) // Position - 0xB72D
{
	return Global_2139[character /*29*/].f_3;
}

int func_168(eCharacter echParam0, int iParam1) // Position - 0xB740
{
	if (iParam1 < 0 || iParam1 > 4)
		return 0;
...
int func_169(eCharacter echParam0, int iParam1) // Position - 0xB76A
{
	if (iParam1 < 0 || iParam1 > 4)
		return 0;
...
void func_170(eCharacter echParam0) // Position - 0xB794
{
...
void func_171(eCharacter echParam0) // Position - 0xB7B3
{
...
char* func_172(eCharacter echParam0) // Position - 0xD043
{
	char* str;
...
BOOL func_176(int iParam0) // Position - 0xD22B
{
...
BOOL func_184(int iParam0) // Position - 0xD651
{
	float num;
...
BOOL func_185(int iParam0) // Position - 0xD706
{
	int num;
	var unk;
	var unk4;
...
BOOL func_186(var uParam0, var uParam1, var uParam2) // Position - 0xD7BB
{
	float num;
	var unk;
	var unk2;
...
BOOL func_188(var uParam0, var uParam1, var uParam2) // Position - 0xD880
{
...
BOOL func_189(var uParam0, var uParam1, var uParam2) // Position - 0xD8D9
{
...
int func_190(Vector3 vParam0, var uParam1, var uParam2) // Position - 0xD90C
{
	float num;
...
int func_191(var uParam0, var uParam1, var uParam2, BOOL bParam3) // Position - 0xD941
{
	int i;
	float num;
	float num2;
	...
	for (i = 0; i <= 7 - 1; i = i + 1)
	{
		if (Global_96511[i /*9*/].f_7 != 263)
		{
			...
			{
				num = unk_0xED977E2AE2CB16EE(uParam0, Global_96511[i /*9*/].f_3, 1);
...
int func_192(Vector3 vParam0, var uParam1, var uParam2) // Position - 0xD9BB
{
	float num;
...
int func_193(var uParam0, var uParam1, var uParam2, BOOL bParam3) // Position - 0xD9F0
{
	int i;
	float num;
	float num2;
	...
	for (i = 0; i <= 5 - 1; i = i + 1)
	{
		if (Global_96575[i /*9*/].f_7 != 263)
		{
			...
			{
				num = unk_0xED977E2AE2CB16EE(uParam0, Global_96575[i /*9*/].f_3, 1);
...
BOOL func_194(Vector3 vParam0, var uParam1, var uParam2) // Position - 0xDA6A
{
	Vector3 vector;
	float num;
...
BOOL func_195(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0xDAF3
{
	float num;
...
BOOL func_196(var uParam0, var uParam1, var uParam2) // Position - 0xDB16
{
	if (!func_199(1))
		if (!func_199(0))
...
BOOL func_197(Vector3 vParam0, var uParam1, var uParam2, int iParam3) // Position - 0xE189
{
	float num;
...
BOOL func_199(int iParam0) // Position - 0xE88E
{
...
BOOL func_201(var uParam0) // Position - 0xEA11
{
...
BOOL func_202(char* sParam0) // Position - 0xEA3C
{
	int i;
...
BOOL func_203(Vector3 vParam0, var uParam1, var uParam2) // Position - 0xEA88
{
	if (vParam0.f_2 < -90f)
		return true;
...
BOOL func_204() // Position - 0xEB12
{
	int num;
	float num2;

	num = func_206(unk_0xD1A6A821F5AC81DB(unk_0x4A8C381C258A124D(), 1), 145, 1);
	num2 = SYSTEM::VDIST2(unk_0xD1A6A821F5AC81DB(unk_0x4A8C381C258A124D(), 1), Global_96410[num /*10*/].f_3);
...
int func_206(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4) // Position - 0xEBC1
{
	int i;
	float num;
	float num2;
...
BOOL func_207(int iParam0) // Position - 0xEC50
{
	return IS_BIT_SET(Global_114370.f_7232[iParam0], 0);
}

BOOL func_208() // Position - 0xEC65
{
...
BOOL func_209(int iParam0) // Position - 0xECFD
{
	if (iLocal_40 == 1)
		if (func_79(unk_0x4A8C381C258A124D(), Global_97318[1 /*15*/], iParam0, 1))
			return true;
	else if (iLocal_40 == 2)
		if (func_79(unk_0x4A8C381C258A124D(), Global_97318[0 /*15*/], iParam0, 1))
			return true;
	else if (iLocal_40 == 0)
		if (func_79(unk_0x4A8C381C258A124D(), Global_97318[3 /*15*/], iParam0, 1))
			return true;

	return false;
}

void func_210(int iParam0, int iParam1) // Position - 0xED6F
{
	func_4(iParam0);
...
BOOL func_213(int iParam0) // Position - 0xF0BB
{
...
BOOL func_214(int iParam0) // Position - 0xF0EC
{
...
BOOL func_216(int iParam0) // Position - 0xF174
{
...
BOOL func_217(int iParam0) // Position - 0xF19E
{
	int num;
...
BOOL func_219(int iParam0) // Position - 0xF1EC
{
	eCharacter character;

	character = func_64(iParam0);
...
BOOL func_220(int iParam0) // Position - 0xF240
{
	var unk;
...
BOOL func_221(var uParam0) // Position - 0xF285
{
	int i;
...
BOOL func_223(int iParam0) // Position - 0xF347
{
	if (unk_0xD130E7CDEE903624(iParam0, "GetawayVehicleValid"))
		return true;
...
BOOL func_225(var uParam0) // Position - 0xF3AA
{
	int num;
	int num2;
	var unk;
...
void func_228(int iParam0, BOOL bParam1) // Position - 0xF6F1
{
	switch (iLocal_37)
	{
		case 1:
			if (!unk_0x4C705AAF75363287() && !func_231(_GET_CURRENT_PLAYER_CHARACTER()) && !func_230())
			{
...
void _DISPLAY_HELP_TEXT(char* text, int iParam1) // Position - 0xF7FB
{
...
BOOL func_231(eCharacter echParam0) // Position - 0xF82C
{
	int i;
...
BOOL func_232(eCharacter echParam0) // Position - 0xF876
{
	int i;
...
void func_233(int iParam0, var uParam1) // Position - 0xF924
{
	int num;
...
BOOL func_235(char* sParam0, int iParam1, int iParam2) // Position - 0xFAE5
{
...
void func_240() // Position - 0xFC2E
{
	if (iLocal_35 != 4)
	{
		if (iLocal_35 != 2)
		{
			if (unk_0x4C705AAF75363287() && !Global_113009)
			{
				unk_0x0B0C9A0F9AAEB7F0(&iLocal_103, 15);
				unk_0x428C32CC68809A35(1);
			}
...
BOOL func_248(int iParam0) // Position - 0xFF4D
{
	return func_249(iParam0, 6, true);
}

BOOL func_249(int iParam0, int iParam1, BOOL bParam2) // Position - 0xFF5D
{
	if (iParam0 == -1)
		return false;
...
var func_251(int iParam0, int iParam1) // Position - 0xFFEC
{
	return unk_0xD69CE161FE614531(0, iParam0, func_252(iParam1));
}

int func_252(int iParam0) // Position - 0x10003
{
	int num;
	int num2;
...
BOOL func_254(var uParam0) // Position - 0x103DF
{
...
BOOL func_255(BOOL bParam0) // Position - 0x103FF
{
	if (bParam0)
		if (func_256())
			return true;
...
BOOL func_256() // Position - 0x10425
{
	if (Global_113314)
		return true;
...
void func_257(char* sParam0, BOOL bParam1) // Position - 0x10457
{
	int i;
	int j;
...
BOOL func_261(int iParam0) // Position - 0x107C3
{
...
struct<8> func_266(char* sParam0, float fParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, float fParam7) // Position - 0x11F92
{
	char* str;
...
void func_279(char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9) // Position - 0x121CE
{
	int i;
...
BOOL func_280(var uParam0, int iParam1) // Position - 0x123A0
{
	if (iParam1 == -1)
		return false;
...
BOOL func_283(int iParam0) // Position - 0x1245B
{
	int num;
	int num2;

...
void main() // Position - 0x0
{
	...
	if (!func_305(&unk125, &num, unk61, 1f))
	{
		func_304();
	...
	while (true)
	{
		...
		func_226(num);
		func_219(&iLocal_106, &(num.f_9), unk61);
	
		if (num == 42)
		{
			if (unk_0xB3FA103AA6383C28())
			{
				unk_0xFE61105198EA3496(func_218(), 4, 0, 0, func_217());
		...
		if (num == 37)
		{
			func_209(&num, unk61, "NIG1AAU", "NIG1A_AMB", 0, "NIGEL", 1, "MRSTHORNHILL", &uLocal_108);
		}
		else if (num == 42)
		{
			func_204(&num, unk61, "NIG2AUD", "NIG2_AMB", 4, "NIGEL", 5000, 14f);
		}
		else if (num == 43)
		{
		...
		if (num == 41)
			if (func_200(&num, &unk64) || func_199(&num))
				flag = true;
...
int func_49(int iParam0, Hash hParam1) // Position - 0x39DB
{
	var unk;
	int num;
...
Hash func_51(Hash hParam0) // Position - 0x3A1F
{
	Hash hash;
	Hash hash2;
...
Hash func_52() // Position - 0x3A53
{
	return Global_1574925;
}

BOOL func_53(int iParam0, Hash hParam1) // Position - 0x3A5F
{
	var unk;
	BOOL num;
...
var func_54(int iParam0, Hash hParam1) // Position - 0x3A83
{
...
BOOL func_69(var uParam0, var uParam1, var uParam2, char* sParam3, float fParam4, float fParam5, float fParam6) // Position - 0x5EAA
{
	var unk;
	var unk2;
...
BOOL func_71(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0x666D
{
	if (bParam6)
...
BOOL func_72(var uParam0) // Position - 0x66B4
{
...
BOOL func_74(int iParam0, int iParam1, BOOL bParam2) // Position - 0x671F
{
	if (iParam0 == -1)
		return false;
...
BOOL func_77(int iParam0) // Position - 0x6B32
{
	return func_74(iParam0, 5, true);
}

int func_78(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x6B42
{
	int i;
	float num;
	float num2;
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x7659
{
...
Vector3 func_83(float fParam0, float fParam1, float fParam2) // Position - 0x7683
{
...
BOOL func_85(Player plParam0) // Position - 0x76AF
{
...
BOOL func_87(int iParam0, int iParam1, var uParam2, int iParam3, BOOL bParam4) // Position - 0x77B1
{
	var unk;
	var unk7;
	var unk13;
...
Vector3 func_88(float fParam0, var uParam1, var uParam2, float fParam3) // Position - 0x7846
{
	float num;
	float num2;
	float num3;
...
BOOL func_92(int iParam0, var uParam1) // Position - 0x84E8
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_93(Player plParam0) // Position - 0x856A
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
...
Player _INVALID_PLAYER_INDEX() // Position - 0x85C2
{
	return -1;
}
...
BOOL func_98(int iParam0) // Position - 0x8864
{
...
int func_106(int iParam0) // Position - 0x8DAD
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * IS_BIT_SET(iParam0, 31) ? -1 : 1) + 2011;
}

var func_107(BOOL bParam0, var uParam1, var uParam2) // Position - 0x8DCF
{
	if (bParam0)
		return uParam1;
...
int func_108(int iParam0) // Position - 0x8DE6
{
	return iParam0 & 15;
}
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER_0() // Position - 0x8EA4
{
	func_58();
	return Global_114370.f_2366.f_539.f_4321;
}
...
void func_116(char* sParam0, var uParam1, int iParam2) // Position - 0x8F42
{
...
BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0x8F84
{
...
BOOL func_122(Any* panParam0) // Position - 0xAA17
{
	int num;
...
void func_126(Vehicle veParam0) // Position - 0xABB5
{
	int num;
	int num2;
	int num3;
...
int func_128(Vehicle veParam0) // Position - 0xAC91
{
	int i;
...
BOOL func_132(int iParam0, int iParam1, int iParam2) // Position - 0xAD8A
{
...
int func_134(Vehicle veParam0) // Position - 0xADF1
{
	int i;
...
BOOL func_135(var uParam0) // Position - 0xAE3A
{
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(int iParam0) // Position - 0xAE5A
{
	if (unk_0xFC8BFE4B41177C22(iParam0))
...
BOOL func_137(int iParam0) // Position - 0xAE7B
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_139(int iParam0) // Position - 0xAF4B
{
	switch (iParam0)
	{
		case 5:
...
void func_140(Any* panParam0, int iParam1, BOOL bParam2) // Position - 0xAF9E
{
	int i;
...
BOOL func_141(int iParam0) // Position - 0xB093
{
	switch (iParam0)
	{
		case 5:
...
void func_143(BOOL bParam0, BOOL bParam1, BOOL bParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB13D
{
	if (bParam0)
	{
...
Player func_146(Hash hParam0, BOOL bParam1) // Position - 0xB2FD
{
	Player player;
	Hash hash;
...
BOOL func_147(int iParam0) // Position - 0xB33E
{
	int num;
...
BOOL func_152(var uParam0) // Position - 0xB3F7
{
...
BOOL _CONVERSATION_IS_DIALOGUE_IN_PROGRESS() // Position - 0xB49B
{
...
BOOL func_158(var uParam0, float fParam1, int iParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB52A
{
...
void func_159(var uParam0) // Position - 0xB581
{
	if (!unk_0x1C2F771CDC87A3A5(uParam0, 0))
...
BOOL func_166(int iParam0) // Position - 0xB88E
{
	if (iParam0 == 1)
...
BOOL func_168(int iParam0) // Position - 0xB8F4
{
...
int func_171(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4) // Position - 0xB9AC
{
	int i;
...
void func_172(int iParam0, int iParam1) // Position - 0xBAE3
{
	int i;
...
BOOL _CAN_ENTER_FREEROAM_STATE(int iParam0) // Position - 0xBB32
{
	return func_174(iParam0, Global_43922);
}

BOOL func_174(int iParam0, int iParam1) // Position - 0xBB43
{
	if (iParam1 == 15)
		return 1;
...
BOOL func_175(int iParam0) // Position - 0xBD24
{
	if (Global_43922 == 15)
		return false;
...
BOOL _IS_MISSION_REPLAY_IN_PROGRESS() // Position - 0xBDA0
{
	if (Global_101392 == 10 || Global_101392 == 9)
		return true;
...
void func_179(int iParam0, var uParam1) // Position - 0xBDC4
{
	switch (iParam0)
	{
		case 0:
...
var func_180(float fParam0, float fParam1, float fParam2, int iParam3) // Position - 0xC235
{
	var unk;
...
var func_181(BOOL bParam0, var uParam1, var uParam2) // Position - 0xC261
{
	if (bParam0)
		return uParam1;
...
BOOL func_182(int iParam0) // Position - 0xC278
{
	switch (iParam0)
	{
		case 0:
...
int func_183(int iParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0xC307
{
	int num;
...
BOOL func_184(var uParam0, int iParam1) // Position - 0xC33A
{
	switch (uParam0->f_16)
	{
		case 0:
...
BOOL func_186(var uParam0) // Position - 0xCB38
{
	float num;
...
void func_187(int iParam0, var uParam1) // Position - 0xCBC6
{
	if (iParam0 == 1)
	{
		if (!func_139(uParam1))
...
BOOL func_188(BOOL bParam0) // Position - 0xCC2A
{
	var unk;
...
BOOL func_189(var uParam0) // Position - 0xCCC1
{
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0))
		if (unk_0xD9F5E1FEFD1329E4(uParam0, 0))
...
BOOL func_190(int iParam0) // Position - 0xCCEB
{
	eCharacter character;
		...
		if (unk_0xFC8BFE4B41177C22(unk_0x4A8C381C258A124D()))
		{
			if (!unk_0x4FAFF4BCB7633475(unk_0x4A8C381C258A124D()))
			{
				...
				switch (iParam0)
				{
					...
					case 3:
						if (unk_0x8BF5256C439DF778(unk_0x4A8C381C258A124D()) || unk_0x9857C978BD3CBEDA(unk_0x4A8C381C258A124D()) || unk_0x6652E84A43F51B8B(unk_0x259BE71D8A81D4FA(), 1) || unk_0x1B32E388988DD296(unk_0x4A8C381C258A124D(), 0) || func_198() || Global_113417 || Global_32831 || func_197() || func_196(8, -1) || func_100() || func_195() || func_193() || Global_114370.f_7691.f_919[character] == 5)
							return false;
						break;
				
					case 4:
						if (func_198() || unk_0xE7B45027762DEFE7(unk_0x259BE71D8A81D4FA()) > 0 || func_196(8, -1) || func_193() || func_192() || Global_114370.f_7691.f_919[character] == 5)
							return false;
						break;
...
BOOL func_196(int iParam0, int iParam1) // Position - 0xD48E
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_197() // Position - 0xD4C6
{
	return Global_1575079;
}

BOOL func_198() // Position - 0xD4D2
{
	if (!unk_0x76CD105BCAC6EB9F())
...
int func_199(var uParam0) // Position - 0xD4EE
{
	int i;
...
int func_200(var uParam0, var uParam1) // Position - 0xD5B2
{
	if (func_201(uParam1, unk_0xD1A6A821F5AC81DB(unk_0x4A8C381C258A124D(), 1)))
	{
		if (func_190(2))
		{
			if (func_188(uParam0->f_27))
...
BOOL func_201(var uParam0, float fParam1, var uParam2, var uParam3) // Position - 0xD5EF
{
	BOOL flag;
	int num;
	int num2;
...
void func_202(var uParam0, var uParam1, var uParam2) // Position - 0xD6AB
{
...
char* AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM(int iParam0) // Position - 0xD816
{
	char* str;
...
int func_204(var uParam0, float fParam1, float fParam2, float fParam3, char* sParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, int iParam9) // Position - 0xDA0B
{
	var unk;

	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(unk_0x4A8C381C258A124D()) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_28[0]) && !_CONVERSATION_IS_DIALOGUE_IN_PROGRESS() && unk_0x1DD05E817C89C737() - uParam0->f_60 > iParam8 && func_208(unk_0x4A8C381C258A124D(), fParam1, 1) < iParam9)
	{
		unk = 16;
...
void _CONVERSATION_ADD_LINE_NO_SUBTITLE(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xDA93
{
...
void func_206(var uParam0, eCharacter echParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xDACE
{
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, var uParam2, char* sParam3, int iParam4, int iParam5) // Position - 0xDB24
{
...
float func_208(var uParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0xDBBF
{
	var unk;
...
int func_209(var uParam0, var uParam1, var uParam2, var uParam3, char* sParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, char* sParam9, var uParam10) // Position - 0xDBF9
{
	var unk;
	...
	if (!(*uParam10 == 3))
	{
		if (func_190(2))
		{
			if (!_CONVERSATION_IS_DIALOGUE_IN_PROGRESS())
			{
				if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(unk_0x4A8C381C258A124D()) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_28[0]) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_28[1]) && func_208(unk_0x4A8C381C258A124D(), uParam1, 1) < 20f)
				{
			...
			else if (func_211(sParam5) && !(*uParam10 == 1) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(unk_0x4A8C381C258A124D()) && func_208(unk_0x4A8C381C258A124D(), uParam1, 1) >= 20f)
			{
			...
			if (func_208(unk_0x4A8C381C258A124D(), uParam1, 1) < 20f && *uParam10 == 1)
			{
...
BOOL func_211(char* sParam0) // Position - 0xDD51
{
	var unk;
...
BOOL func_214(int iParam0) // Position - 0xE0ED
{
...
BOOL func_215(var uParam0) // Position - 0xE10D
{
...
BOOL func_216(var uParam0) // Position - 0xE125
{
...
void func_219(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) // Position - 0xE163
{
	if (unk_0x75EAB09F5E974116(unk_0x259BE71D8A81D4FA()))
	{
		if (!unk_0xD6F9DEE4765092A9(uParam1))
		{
			...
			{
				if (func_208(unk_0x4A8C381C258A124D(), uParam2, 1) <= 100f)
					func_222(uParam0, 1);
			}
			else
			{
				...
				if (func_208(unk_0x4A8C381C258A124D(), uParam2, 1) > 120f)
					func_224(uParam0);
			}
		}
	}
...
void func_222(var uParam0, int iParam1) // Position - 0xE2C9
{
	BOOL flag;
	int i;
...
void func_224(var uParam0) // Position - 0xE373
{
	unk_0xB479965CBAA3EAE1(0);
	unk_0xDD291722ADDCBD60();
	func_225(uParam0);
...
void func_225(var uParam0) // Position - 0xE38A
{
	BOOL flag;
	int num;
	int i;
...
BOOL IS_RC_FINE_AND_IN_RANGE(Any* panParam0, BOOL bParam1) // Position - 0xE49A
{
	var unk;
...
void func_229(var uParam0) // Position - 0xEA0E
{
...
BOOL CHECK_VEHICLES_OK(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0xEAB9
{
	int i;
	int num;
	var unk;
			...
			if (unk_0xFC8BFE4B41177C22(uParam0->f_35[i]))
			{
				...
				if (bParam2)
				{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_232(unk_0x4A8C381C258A124D(), uParam0->f_35[i]))
							{
...
BOOL func_232(var uParam0, var uParam1) // Position - 0xEC77
{
	var unk;
...
BOOL func_233(var uParam0, BOOL bParam1, int iParam2) // Position - 0xECA7
{
	int i;
	int num;
...
BOOL func_234(int iParam0) // Position - 0xEF63
{
...
BOOL func_235(var uParam0, int iParam1) // Position - 0xEF97
{
	float num;
...
BOOL func_236(var uParam0, int iParam1) // Position - 0xF00D
{
	return func_237(uParam0, unk_0x4A8C381C258A124D(), iParam1, 1, 250, 7);
}

BOOL func_237(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xF025
{
	BOOL flag;
	var unk;
	int num;
	...
	flag = func_238(&iLocal_47[num /*4*/], unk, uParam1, &(iLocal_47[num /*4*/].f_3), uParam0, iParam5);
	return flag || unk_0x1DD05E817C89C737() - iLocal_47[num /*4*/].f_3 < iParam4;
}

BOOL func_238(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, int iParam7) // Position - 0xF0E6
{
	var unk;
	var unk2;
	var unk5;
...
Vector3 func_239(var uParam0, int iParam1) // Position - 0xF212
{
	int num;
...
BOOL func_241(var uParam0, var uParam1, int iParam2, int iParam3) // Position - 0xF321
{
	var unk;
	var unk4;
	float num;
...
float func_242(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0xF3B2
{
	return (fParam0 * uParam3) + (fParam0.f_1 * uParam3.f_1) + (fParam0.f_2 * uParam3.f_2);
}

Vector3 func_243(float fParam0, var uParam1, var uParam2) // Position - 0xF3D3
{
	float num;
	float num2;
...
int func_245(var uParam0, var uParam1) // Position - 0xF42D
{
	int i;
...
int func_246(var uParam0) // Position - 0xF46C
{
...
BOOL func_247(var uParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xF494
{
	float num;
	float num2;
	int num3;
	...
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(unk_0x4A8C381C258A124D()) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0))
	{
		...
		if (!bParam2)
		{
			if (func_251(uParam0, bParam1, num, num2))
				return true;
		
			if (func_248(uParam0, num2, bParam3, bParam4))
				return true;
		}
		else
		{
...
BOOL func_248(var uParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0xF58F
{
	float num;
	float num2;
...
BOOL func_249(var uParam0, float fParam1) // Position - 0xF69B
{
	var unk;
	var unk2;
	...
	if (unk_0xF67924A428A734EC(uParam0, joaat("WEAPON_GRENADE"), fParam1, &unk2, &unk, 0) || unk_0xF67924A428A734EC(uParam0, joaat("WEAPON_SMOKEGRENADE"), fParam1, &unk2, &unk, 0) || unk_0xF67924A428A734EC(uParam0, joaat("WEAPON_BZGAS"), fParam1, &unk2, &unk, 0) || unk_0xF67924A428A734EC(uParam0, joaat("WEAPON_STICKYBOMB"), fParam1, &unk2, &unk, 0) || unk_0xF67924A428A734EC(uParam0, joaat("WEAPON_MOLOTOV"), fParam1, &unk2, &unk, 0))
		if (func_250(uParam0, unk2, 90f, 0))
			return true;

	return false;
}

BOOL func_250(var uParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xF730
{
	var unk;
	var unk4;
	float num;
...
BOOL func_251(var uParam0, BOOL bParam1, float fParam2, float fParam3) // Position - 0xF7BE
{
	if (bParam1)
		if (unk_0x65F146FF416F109F(unk_0x4A8C381C258A124D()))
...
BOOL func_252(int iParam0) // Position - 0xF806
{
...
void func_253(var uParam0) // Position - 0xF850
{
	var unk;
...
BOOL func_254(int iParam0) // Position - 0xF8ED
{
	if (iParam0 == -1)
		iParam0 = func_176();
...
BOOL func_255(int iParam0) // Position - 0xF982
{
...
BOOL func_258(int iParam0) // Position - 0xFA01
{
...
BOOL func_260(int iParam0) // Position - 0xFA73
{
...
BOOL func_261(var uParam0, var uParam1) // Position - 0xFA9B
{
	switch (*uParam0)
	{
		case 37:
...
BOOL func_262(var uParam0) // Position - 0xFB57
{
	int num;
	int i;
	BOOL flag;
...
BOOL func_263(var uParam0, var uParam1) // Position - 0xFD3E
{
	var unk;
	var unk4;
	float num;
...
void func_264(var uParam0, int iParam1, float fParam2, float fParam3, float fParam4, float fParam5) // Position - 0xFE13
{
	func_265(uParam0);
...
void func_265(var uParam0) // Position - 0xFE56
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
BOOL func_266(var uParam0, eCharacter echParam1, float fParam2, float fParam3, float fParam4, float fParam5, char* sParam6, int iParam7) // Position - 0xFEF2
{
	if (func_267(uParam0, echParam1, fParam2, fParam5, true))
	{
		if (unk_0xFC8BFE4B41177C22(*uParam0))
		{
			if (!unk_0x1C2F771CDC87A3A5(*uParam0, 0))
...
BOOL func_267(var uParam0, eCharacter echParam1, var uParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0xFF4E
{
	int num;

	if (!func_36(echParam1))
	{
		num = func_330(echParam1);
...
int func_268(int iParam0, eCharacter echParam1) // Position - 0xFFDC
{
	int num;
...
BOOL func_269(var uParam0) // Position - 0x10024
{
	if (func_216(uParam0))
	{
...
BOOL func_270(var uParam0) // Position - 0x1004E
{
	int i;
...
BOOL func_272(var uParam0) // Position - 0x100BB
{
	int num;
	int i;
	BOOL flag;
...
BOOL func_277(var uParam0, var uParam1) // Position - 0x107DA
{
	...
	switch (iLocal_89)
	{
		...
		case 1:
			if (!func_270(&num) || !unk_0xE100DD4F82A51BDE(uParam0->f_48) || !unk_0xE100DD4F82A51BDE(str))
				return false;
...
void func_279(var uParam0, float fParam1, float fParam2, float fParam3) // Position - 0x10E6E
{
	uParam0->f_51 == 0;
	uParam0->f_46 >= 15;
...
BOOL func_281(var uParam0) // Position - 0x10EC6
{
	int num;
	int i;
	char* str;
	...
	switch (iLocal_89)
	{
		...
		case 1:
			if (!func_270(&num) || !unk_0xE100DD4F82A51BDE(str))
				return false;
...
BOOL func_282(var uParam0) // Position - 0x111F4
{
	int num;
	int i;
	char* str;
	...
	switch (iLocal_89)
	{
		...
		case 3:
			...
			func_284(&uParam0->f_28[0], num[0], -1054.7f, 355.94f, 68.35f, 23.67f, 26);
			...
			func_284(&uParam0->f_28[1], num[1], -1058.43f, 362.78f, 69.86f, 130.45f, 26);
			...
			func_284(&uParam0->f_28[2], num[2], -1012.57f, 357.48f, 70.62f, -28.55f, 26);
...
void func_283(var uParam0, var uParam1, float fParam2, float fParam3, float fParam4, float fParam5) // Position - 0x11757
{
	func_229(uParam0);
...
void func_284(var uParam0, var uParam1, float fParam2, float fParam3, float fParam4, float fParam5, int iParam6) // Position - 0x1177E
{
	func_285(uParam0);
...
void func_285(var uParam0) // Position - 0x1179F
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (!unk_0x1C2F771CDC87A3A5(*uParam0, 0))
...
BOOL func_286(var uParam0) // Position - 0x117E0
{
	int num;
	int i;
	var unk8;
	...
	switch (iLocal_89)
	{
		...
		case 1:
			if (!func_270(&num) || !unk_0xE100DD4F82A51BDE(uParam0->f_48))
				return false;
		...
		case 2:
			func_284(&uParam0->f_28[0], num[0], -552.66f, 287.75f, 82.18f, 123.75f, 26);
			func_284(&uParam0->f_28[1], num[1], -553.46f, 287.34f, 82.18f, -65.86f, 26);
			...
			func_284(&uParam0->f_28[2], num[2], -559.94f, 285.99f, 85.38f, -59.06f, 26);
			func_284(&uParam0->f_28[3], num[3], -558.87f, 289.79f, 85.38f, 162.44f, 26);
			func_284(&uParam0->f_28[4], num[4], -559f, 286.09f, 85.38f, 65.92f, 26);
			func_284(&uParam0->f_28[5], num[5], -558.84f, 288.97f, 85.38f, -7.72f, 26);
...
BOOL func_288(int iParam0) // Position - 0x11DF5
{
	int num;
...
char* func_291(int iParam0, var uParam1) // Position - 0x11E96
{
	var unk;
...
BOOL func_294(var uParam0) // Position - 0x1558D
{
	int num;
	int i;
	var unk4;
...
BOOL func_295(int iParam0) // Position - 0x1582E
{
	var unk;
	eCharacter character;
...
BOOL func_296(int iParam0) // Position - 0x1587F
{
	var unk;
...
BOOL func_297(int iParam0) // Position - 0x15938
{
	var unk;
...
BOOL func_298(int iParam0) // Position - 0x159F9
{
	int i;
	var unk;
	int num;
...
BOOL func_300(int iParam0) // Position - 0x15B60
{
...
BOOL func_301(int iParam0) // Position - 0x15B8B
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_302(int iParam0) // Position - 0x15BB6
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_303(int iParam0) // Position - 0x15BE1
{
	if (func_255(iParam0))
		return false;
	else if (!unk_0x4FAFF4BCB7633475(unk_0x4A8C381C258A124D()))
...
BOOL func_305(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, float fParam5) // Position - 0x15C30
{
	int i;
...
BOOL func_306(int iParam0, var uParam1, var uParam2, var uParam3, float fParam4, var uParam5) // Position - 0x15C95
{
	int num;
	char* str;
...
BOOL func_307(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7) // Position - 0x15D0D
{
	if (fParam6 < 0f)
		fParam6 = 0f;
...
void func_308(var uParam0, var uParam1, BOOL bParam2) // Position - 0x15D88
{
	char* str;
...
void func_316(var uParam0, BOOL bParam1) // Position - 0x15F68
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (unk_0x5B9219522937741D(*uParam0))
...
void func_319(var uParam0) // Position - 0x15FF2
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
void func_321(var uParam0, int iParam1) // Position - 0x1603C
{
	...
	for (i = 0; i <= *uParam0 - 1; i = i + 1)
	{
		if (iParam1 == 1)
			...
			func_322(&uParam0->[i], 0, 1, 0);
	}

	return;
}

void func_322(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x1607D
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (!unk_0x4FAFF4BCB7633475(*uParam0))
...
BOOL func_324(var uParam0, int iParam1) // Position - 0x1611E
{
	if (func_135(uParam0))
...
void func_326(int iParam0) // Position - 0x161E0
{
	if (*iParam0 == -1)
		return;
...
int func_330(eCharacter echParam0) // Position - 0x1627C
{
	if (!func_36(echParam0))

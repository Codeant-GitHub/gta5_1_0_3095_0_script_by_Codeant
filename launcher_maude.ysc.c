...
void main() // Position - 0x0
{
	...
	while (true)
	{
		...
		func_203(num);
		func_195(&iLocal_91, &(num.f_9), unk61);
...
int func_49(int iParam0, Hash hParam1) // Position - 0x3844
{
	var unk;
	int num;
...
Hash func_51(Hash hParam0) // Position - 0x3888
{
	Hash hash;
	Hash hash2;
...
Hash func_52() // Position - 0x38BC
{
	return Global_1574925;
}

BOOL func_53(int iParam0, Hash hParam1) // Position - 0x38C8
{
	var unk;
	BOOL num;
...
var func_54(int iParam0, Hash hParam1) // Position - 0x38EC
{
...
BOOL func_69(var uParam0, var uParam1, var uParam2, char* sParam3, float fParam4, float fParam5, float fParam6) // Position - 0x5D14
{
	var unk;
	var unk2;
...
BOOL func_71(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0x64D7
{
	if (bParam6)
...
BOOL func_72(var uParam0) // Position - 0x651E
{
...
BOOL func_74(int iParam0, int iParam1, BOOL bParam2) // Position - 0x6589
{
	if (iParam0 == -1)
		return false;
...
BOOL func_77(int iParam0) // Position - 0x699C
{
	return func_74(iParam0, 5, true);
}

int func_78(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x69AC
{
	int i;
	float num;
	float num2;
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x74C3
{
...
Vector3 func_83(float fParam0, float fParam1, float fParam2) // Position - 0x74ED
{
...
BOOL func_85(Player plParam0) // Position - 0x7519
{
...
BOOL func_87(int iParam0, int iParam1, var uParam2, int iParam3, BOOL bParam4) // Position - 0x761B
{
	var unk;
	var unk7;
	var unk13;
...
Vector3 func_88(float fParam0, var uParam1, var uParam2, float fParam3) // Position - 0x76B0
{
	float num;
	float num2;
	float num3;
...
BOOL func_92(int iParam0, var uParam1) // Position - 0x834F
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_93(Player plParam0) // Position - 0x83D1
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
...
Player _INVALID_PLAYER_INDEX() // Position - 0x8429
{
	return -1;
}
...
BOOL func_98(int iParam0) // Position - 0x86CB
{
...
int func_106(int iParam0) // Position - 0x8C14
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * IS_BIT_SET(iParam0, 31) ? -1 : 1) + 2011;
}

var func_107(BOOL bParam0, var uParam1, var uParam2) // Position - 0x8C36
{
	if (bParam0)
		return uParam1;
...
int func_108(int iParam0) // Position - 0x8C4D
{
	return iParam0 & 15;
}
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER_0() // Position - 0x8D0B
{
	func_58();
	return Global_114370.f_2366.f_539.f_4321;
}
...
void func_116(char* sParam0, var uParam1, int iParam2) // Position - 0x8DA9
{
...
BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0x8DEB
{
...
BOOL func_122(Any* panParam0) // Position - 0xA87E
{
	int num;
...
void func_126(Vehicle veParam0) // Position - 0xAA1C
{
	int num;
	int num2;
	int num3;
...
int func_128(Vehicle veParam0) // Position - 0xAAF8
{
	int i;
...
BOOL func_132(int iParam0, int iParam1, int iParam2) // Position - 0xABF1
{
...
int func_134(Vehicle veParam0) // Position - 0xAC58
{
	int i;
...
BOOL func_135(var uParam0) // Position - 0xACA1
{
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(int iParam0) // Position - 0xACC1
{
	if (unk_0xFC8BFE4B41177C22(iParam0))
...
BOOL func_137(int iParam0) // Position - 0xACE2
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_139(int iParam0) // Position - 0xADB2
{
	switch (iParam0)
	{
		case 5:
...
void func_140(Any* panParam0, int iParam1, BOOL bParam2) // Position - 0xAE05
{
	int i;
...
BOOL func_141(int iParam0) // Position - 0xAEFA
{
	switch (iParam0)
	{
		case 5:
...
void func_143(BOOL bParam0, BOOL bParam1, BOOL bParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xAFA4
{
	if (bParam0)
	{
...
Player func_146(Hash hParam0, BOOL bParam1) // Position - 0xB164
{
	Player player;
	Hash hash;
...
BOOL func_147(int iParam0) // Position - 0xB1A5
{
	int num;
...
BOOL func_148(int iParam0) // Position - 0xB1C7
{
...
int func_150(int iParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0xB214
{
	int num;
...
BOOL func_153(var uParam0) // Position - 0xB291
{
...
BOOL _CONVERSATION_IS_DIALOGUE_IN_PROGRESS() // Position - 0xB335
{
...
BOOL func_159(var uParam0, float fParam1, int iParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB3C4
{
...
void func_160(var uParam0) // Position - 0xB41B
{
	if (!unk_0x1C2F771CDC87A3A5(uParam0, 0))
...
BOOL func_167(int iParam0) // Position - 0xB728
{
	if (iParam0 == 1)
...
BOOL func_169(int iParam0) // Position - 0xB78E
{
...
BOOL func_170(int iParam0) // Position - 0xB7CF
{
	int num;
...
int func_172(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4) // Position - 0xB846
{
	int i;
...
void func_173(int iParam0, int iParam1) // Position - 0xB97D
{
	int i;
...
BOOL _CAN_ENTER_FREEROAM_STATE(int iParam0) // Position - 0xB9CC
{
	return func_175(iParam0, Global_43922);
}

BOOL func_175(int iParam0, int iParam1) // Position - 0xB9DD
{
	if (iParam1 == 15)
		return 1;
...
BOOL func_176(int iParam0) // Position - 0xBBBE
{
	if (Global_43922 == 15)
		return false;
...
BOOL _IS_MISSION_REPLAY_IN_PROGRESS() // Position - 0xBC3A
{
	if (Global_101392 == 10 || Global_101392 == 9)
		return true;
...
BOOL func_180(var uParam0, int iParam1) // Position - 0xBC5E
{
	switch (uParam0->f_16)
	{
		case 0:
...
BOOL func_182(var uParam0) // Position - 0xC45D
{
	float num;
...
void func_183(int iParam0, var uParam1) // Position - 0xC4EB
{
	if (iParam0 == 1)
	{
		if (!func_139(uParam1))
...
BOOL func_184(BOOL bParam0) // Position - 0xC54F
{
	var unk;
...
BOOL func_185(var uParam0) // Position - 0xC5E6
{
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0))
		if (unk_0xD9F5E1FEFD1329E4(uParam0, 0))
...
BOOL func_186(int iParam0) // Position - 0xC610
{
	eCharacter character;
...
BOOL func_187() // Position - 0xCD2D
{
	return Global_101431.f_1;
}

BOOL func_188() // Position - 0xCD3B
{
	if (Global_98294 != -1)
...
BOOL func_192(int iParam0, int iParam1) // Position - 0xCDB3
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_193() // Position - 0xCDEB
{
	return Global_1575079;
}

BOOL func_194() // Position - 0xCDF7
{
	if (!unk_0x76CD105BCAC6EB9F())
...
void func_195(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) // Position - 0xCE13
{
	if (unk_0x75EAB09F5E974116(unk_0x259BE71D8A81D4FA()))
	{
...
void func_198(var uParam0, int iParam1) // Position - 0xCF79
{
	BOOL flag;
	int i;
...
float func_199(var uParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0xD017
{
	var unk;
...
void func_201(var uParam0) // Position - 0xD05D
{
	unk_0xB479965CBAA3EAE1(0);
	unk_0xDD291722ADDCBD60();
	func_202(uParam0);
...
void func_202(var uParam0) // Position - 0xD074
{
	BOOL flag;
	int num;
	int i;
...
BOOL IS_RC_FINE_AND_IN_RANGE(Any* panParam0, BOOL bParam1) // Position - 0xD184
{
	var unk;
...
BOOL func_206(int iParam0) // Position - 0xD74C
{
...
BOOL func_207(var uParam0) // Position - 0xD76C
{
...
BOOL func_208(var uParam0) // Position - 0xD784
{
...
void func_210(var uParam0) // Position - 0xDAAD
{
...
BOOL CHECK_VEHICLES_OK(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0xDB58
{
	int i;
	int num;
	var unk;
...
BOOL func_213(var uParam0, var uParam1) // Position - 0xDD16
{
	var unk;
...
BOOL func_214(var uParam0, BOOL bParam1, int iParam2) // Position - 0xDD46
{
	int i;
	int num;
...
BOOL func_215(int iParam0) // Position - 0xE002
{
...
BOOL func_216(var uParam0, int iParam1) // Position - 0xE036
{
	float num;
...
BOOL func_217(var uParam0, int iParam1) // Position - 0xE0AC
{
	return func_218(uParam0, unk_0x4A8C381C258A124D(), iParam1, 1, 250, 7);
}

BOOL func_218(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xE0C4
{
	BOOL flag;
	var unk;
	int num;
	...
	flag = func_219(&iLocal_35[num /*4*/], unk, uParam1, &(iLocal_35[num /*4*/].f_3), uParam0, iParam5);
	return flag || unk_0x1DD05E817C89C737() - iLocal_35[num /*4*/].f_3 < iParam4;
}

BOOL func_219(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, int iParam7) // Position - 0xE185
{
	var unk;
	var unk2;
	var unk5;
...
Vector3 func_220(var uParam0, int iParam1) // Position - 0xE2B1
{
	int num;
...
BOOL func_222(var uParam0, var uParam1, int iParam2, int iParam3) // Position - 0xE3C0
{
	var unk;
	var unk4;
	float num;
...
float func_223(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0xE451
{
	return (fParam0 * uParam3) + (fParam0.f_1 * uParam3.f_1) + (fParam0.f_2 * uParam3.f_2);
}

Vector3 func_224(float fParam0, var uParam1, var uParam2) // Position - 0xE472
{
	float num;
	float num2;
...
int func_226(var uParam0, var uParam1) // Position - 0xE4CC
{
	int i;
...
int func_227(var uParam0) // Position - 0xE50B
{
...
BOOL func_228(var uParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xE533
{
	float num;
	float num2;
	int num3;
...
BOOL func_229(var uParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0xE62E
{
	float num;
	float num2;
...
BOOL func_230(var uParam0, float fParam1) // Position - 0xE73A
{
	var unk;
	var unk2;
...
BOOL func_231(var uParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xE7CF
{
	var unk;
	var unk4;
	float num;
...
BOOL func_232(var uParam0, BOOL bParam1, float fParam2, float fParam3) // Position - 0xE85D
{
	if (bParam1)
		if (unk_0x65F146FF416F109F(unk_0x4A8C381C258A124D()))
...
BOOL func_233(int iParam0) // Position - 0xE8A5
{
...
void func_234(var uParam0) // Position - 0xE8EF
{
	var unk;
...
BOOL func_235(int iParam0) // Position - 0xE98C
{
	if (iParam0 == -1)
		iParam0 = func_177();
...
BOOL func_236(int iParam0) // Position - 0xEA21
{
...
BOOL func_239(int iParam0) // Position - 0xEAA0
{
...
BOOL func_241(int iParam0) // Position - 0xEB12
{
...
BOOL func_242(var uParam0) // Position - 0xEB3A
{
	if (!func_243(uParam0))
		return false;
...
BOOL func_243(var uParam0) // Position - 0xEB59
{
	int num;
	int i;
	BOOL flag;
	...
	switch (iLocal_89)
	{
		...
		case 1:
			if (!func_248(&num) || !unk_0xE100DD4F82A51BDE("special_ped@maude@base"))
				return false;
...
BOOL func_244(var uParam0, eCharacter echParam1, float fParam2, float fParam3, float fParam4, float fParam5, char* sParam6, int iParam7) // Position - 0xEDF1
{
	if (func_245(uParam0, echParam1, fParam2, fParam5, true))
	{
		if (unk_0xFC8BFE4B41177C22(*uParam0))
		{
			if (!unk_0x1C2F771CDC87A3A5(*uParam0, 0))
...
BOOL func_245(var uParam0, eCharacter echParam1, var uParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0xEE4D
{
	int num;

	if (!func_36(echParam1))
	{
		num = func_250(echParam1);
...
int func_246(int iParam0, eCharacter echParam1) // Position - 0xEEDB
{
	int num;
...
void func_247(var uParam0, var uParam1, float fParam2, float fParam3, float fParam4, float fParam5) // Position - 0xEF21
{
	func_210(uParam0);
...
BOOL func_248(var uParam0) // Position - 0xEF48
{
	int i;
...
int func_250(eCharacter echParam0) // Position - 0xF07A
{
	if (!func_36(echParam0))
...
BOOL func_251(int iParam0) // Position - 0xF0A0
{
	var unk;
	eCharacter character;
...
BOOL func_252(int iParam0) // Position - 0xF0F1
{
	var unk;
...
BOOL func_253(int iParam0) // Position - 0xF1AA
{
	var unk;
...
BOOL func_254(int iParam0) // Position - 0xF26B
{
	int i;
	var unk;
	int num;
...
BOOL func_256(int iParam0) // Position - 0xF3D2
{
...
BOOL func_257(int iParam0) // Position - 0xF3FD
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_258(int iParam0) // Position - 0xF428
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_259(int iParam0) // Position - 0xF453
{
	if (func_236(iParam0))
		return false;
	else if (!unk_0x4FAFF4BCB7633475(unk_0x4A8C381C258A124D()))
...
BOOL func_261(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, float fParam5) // Position - 0xF4A2
{
	int i;
...
BOOL func_262(int iParam0, var uParam1, var uParam2, var uParam3, float fParam4, var uParam5) // Position - 0xF507
{
	int num;
	char* str;
...
BOOL func_263(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7) // Position - 0xF57F
{
	if (fParam6 < 0f)
		fParam6 = 0f;
...
void func_264(var uParam0, BOOL bParam1) // Position - 0xF5FA
{
	if (bParam1)
	{
...
void func_269(var uParam0, BOOL bParam1) // Position - 0xF705
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (unk_0x5B9219522937741D(*uParam0))
...
void func_272(var uParam0) // Position - 0xF78F
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
void func_273(var uParam0) // Position - 0xF7C7
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
void func_276(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0xF8B6
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (!unk_0x4FAFF4BCB7633475(*uParam0))
...
void func_277(var uParam0) // Position - 0xF906
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (!unk_0x1C2F771CDC87A3A5(*uParam0, 0))
...
BOOL func_279(var uParam0, int iParam1) // Position - 0xF9B8
{
	if (func_135(uParam0))
...
void func_280(int iParam0) // Position - 0xF9EB
{
	if (*iParam0 == -1)
		return;

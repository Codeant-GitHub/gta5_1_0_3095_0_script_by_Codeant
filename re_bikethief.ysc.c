...
void _STAT_SET_PACKED_BOOL(int iParam0, int iParam1, Player plParam2) // Position - 0x18C6
{
	if (plParam2 == -1)
		plParam2 = func_45();
...
Player func_45() // Position - 0x18E4
{
...
Player func_61(Player plParam0) // Position - 0x245A
{
	Player player;
	Player player2;
...
{
	switch (func_148(&Global_32888, 0, 5, false, unk_0x8F76B2250AC806FA()))
	{
		case 1:
			return true;
		...
		if (unk_0xFC8BFE4B41177C22(unk_0x4A8C381C258A124D()))
		{
			if (!unk_0x4FAFF4BCB7633475(unk_0x4A8C381C258A124D()))
			{
				...
				switch (iParam0)
				{
					...
					case 3:
						if (unk_0x8BF5256C439DF778(unk_0x4A8C381C258A124D()) || unk_0x9857C978BD3CBEDA(unk_0x4A8C381C258A124D()) || unk_0x6652E84A43F51B8B(unk_0x259BE71D8A81D4FA(), 1) || unk_0x1B32E388988DD296(unk_0x4A8C381C258A124D(), 0) || func_218() || Global_113417 || Global_32831 || func_217() || func_22(8, -1) || func_216() || func_215() || func_213() || Global_114370.f_7691.f_919[character] == 5)
							return false;
						break;
				
					case 4:
						if (func_218() || unk_0xE7B45027762DEFE7(unk_0x259BE71D8A81D4FA()) > 0 || func_22(8, -1) || func_213() || func_212() || Global_114370.f_7691.f_919[character] == 5)
							return false;
						break;
...
void func_230(int iParam0) // Position - 0x98CE
{
	...
	if (func_241())
	{
		...
		func_233(30000);
		TEXT_LABEL_ASSIGN_STRING(&unk, func_232(Global_114359, true), 64);
...
{
	if (Global_114359 == func_56() && unk_0x9FA91AA1AC724CD0() && Global_114360)
		return true;

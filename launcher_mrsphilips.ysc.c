...
void main() // Position - 0x0
{
	...
	if (!func_254(&unk64, &num, unk61, 1f))
	{
		func_253();
	...
	while (true)
	{
		...
		func_203(num);
		func_195(&iLocal_89, &(num.f_9), unk61);
...
BOOL func_1(var uParam0) // Position - 0x261
{
...
BOOL func_2(Any* panParam0) // Position - 0x27F
{
	var unk;
	var unk33;
...
void func_3(int iParam0, var uParam1) // Position - 0x340
{
	func_21(uParam1);
...
void func_17(BOOL bParam0) // Position - 0xBFA
{
...
void func_21(var uParam0) // Position - 0xCB1
{
	unk_0x1B79E937E91F40C3(uParam0, uParam0);
	return;
}

void func_22(char* sParam0, int iParam1) // Position - 0xCC4
{
...
void func_23(char* sParam0, int iParam1, int iParam2) // Position - 0xCE1
{
...
void func_25(int iParam0, char* sParam1, int iParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x19B9
{
	int i;
	eCharacter j;
...
void func_27(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0x2864
{
	int num;
...
int func_28(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x28EC
{
...
BOOL func_29(int iParam0) // Position - 0x292C
{
	int i;
...
eCharacter func_32(int iParam0) // Position - 0x2A78
{
	int i;
...
int func_33(int iParam0, eCharacter echParam1, int iParam2) // Position - 0x2ADB
{
	int i;
...
int func_34(eCharacter echParam0, int iParam1) // Position - 0x2B69
{
	int num;
...
void func_35(eCharacter echParam0, var uParam1, int iParam2) // Position - 0x2BAB
{
	int num;
...
BOOL func_36(eCharacter echParam0) // Position - 0x2E06
{
...
int func_39(var uParam0, var uParam1, var uParam2) // Position - 0x316D
{
	int i;
	int num;
...
BOOL func_40(int iParam0) // Position - 0x3360
{
	switch (iParam0)
	{
		case joaat("granger"):
...
BOOL func_42(int iParam0, var uParam1, int iParam2, int iParam3) // Position - 0x3430
{
	var unk;
...
BOOL func_43(var uParam0, eCharacter echParam1, BOOL bParam2) // Position - 0x355F
{
	int i;
	var unk;
	int num;
...
BOOL func_44(eCharacter echParam0, int iParam1, char* sParam2, var uParam3) // Position - 0x35CD
{
...
eCharacter _GET_PLAYER_CHARACTER_FROM_PED(int iParam0) // Position - 0x36A5
{
	eCharacter i;
	int num;
...
int _GET_CHARACTER_MODEL(eCharacter character) // Position - 0x36E2
{
...
int func_47(eCharacter echParam0) // Position - 0x3707
{
	return Global_2139[echParam0 /*29*/];
}

void func_48(int iParam0, var uParam1, int iParam2, Hash hParam3) // Position - 0x3716
{
...
int func_49(int iParam0, Hash hParam1) // Position - 0x38B0
{
	var unk;
	int num;
...
var func_50(int iParam0, int iParam1) // Position - 0x38DF
{
	return unk_0xD69CE161FE614531(0, iParam0, func_51(iParam1));
}

Hash func_51(Hash hParam0) // Position - 0x38F4
{
	Hash hash;
	Hash hash2;
...
Hash func_52() // Position - 0x3928
{
	return Global_1574925;
}

BOOL func_53(int iParam0, Hash hParam1) // Position - 0x3934
{
	var unk;
	BOOL num;
...
var func_54(int iParam0, Hash hParam1) // Position - 0x3958
{
	return unk_0xD69CE161FE614531(2, iParam0, func_51(hParam1));
}

void func_55(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, eCharacter echParam5) // Position - 0x396D
{
	eCharacter character;
...
void func_56(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, eCharacter echParam6) // Position - 0x3EB6
{
	eCharacter character;
...
BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0x8E58
{
...
BOOL func_122(Any* panParam0) // Position - 0xA858
{
	int num;
...
void func_126(Vehicle veParam0) // Position - 0xA9F6
{
	int num;
	int num2;
	int num3;
...
int func_128(Vehicle veParam0) // Position - 0xAAD2
{
	int i;
...
BOOL func_132(int iParam0, int iParam1, int iParam2) // Position - 0xABCB
{
...
int func_134(Vehicle veParam0) // Position - 0xAC32
{
	int i;
...
BOOL func_135(var uParam0) // Position - 0xAC7B
{
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(int iParam0) // Position - 0xAC9B
{
	if (unk_0xFC8BFE4B41177C22(iParam0))
...
BOOL func_137(int iParam0) // Position - 0xACBC
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_139(int iParam0) // Position - 0xAD8C
{
	switch (iParam0)
	{
		case 5:
...
void func_140(Any* panParam0, int iParam1, BOOL bParam2) // Position - 0xADDF
{
	int i;
...
BOOL func_141(int iParam0) // Position - 0xAED4
{
	switch (iParam0)
	{
		case 5:
...
void func_143(BOOL bParam0, BOOL bParam1, BOOL bParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xAF7E
{
	if (bParam0)
	{
...
Player func_146(Hash hParam0, BOOL bParam1) // Position - 0xB13E
{
	Player player;
	Hash hash;
...
BOOL func_147(int iParam0) // Position - 0xB17F
{
	int num;
...
BOOL func_148(int iParam0) // Position - 0xB1A1
{
...
int func_150(int iParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0xB1EE
{
	int num;
...
BOOL func_153(var uParam0) // Position - 0xB26B
{
...
BOOL _CONVERSATION_IS_DIALOGUE_IN_PROGRESS() // Position - 0xB30F
{
...
BOOL func_159(var uParam0, float fParam1, int iParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB39E
{
...
void func_160(var uParam0) // Position - 0xB3F5
{
	if (!unk_0x1C2F771CDC87A3A5(uParam0, 0))
...
BOOL func_167(int iParam0) // Position - 0xB702
{
	if (iParam0 == 1)
...
BOOL func_169(int iParam0) // Position - 0xB768
{
...
BOOL func_170(int iParam0) // Position - 0xB7A9
{
	int num;
...
int func_172(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4) // Position - 0xB820
{
	int i;
...
void func_173(int iParam0, int iParam1) // Position - 0xB957
{
	int i;
...
BOOL _CAN_ENTER_FREEROAM_STATE(int iParam0) // Position - 0xB9A6
{
	return func_175(iParam0, Global_43922);
}

BOOL func_175(int iParam0, int iParam1) // Position - 0xB9B7
{
	if (iParam1 == 15)
		return 1;
...
BOOL func_176(int iParam0) // Position - 0xBB98
{
	if (Global_43922 == 15)
		return false;
...
BOOL _IS_MISSION_REPLAY_IN_PROGRESS() // Position - 0xBC14
{
	if (Global_101392 == 10 || Global_101392 == 9)
		return true;
...
BOOL func_180(var uParam0, int iParam1) // Position - 0xBC38
{
	switch (uParam0->f_16)
	{
		case 0:
...
BOOL func_182(var uParam0) // Position - 0xC437
{
	float num;
...
void func_183(int iParam0, var uParam1) // Position - 0xC4C5
{
	if (iParam0 == 1)
	{
		if (!func_139(uParam1))
...
BOOL func_184(BOOL bParam0) // Position - 0xC529
{
	var unk;
...
BOOL func_185(var uParam0) // Position - 0xC5C0
{
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0))
		if (unk_0xD9F5E1FEFD1329E4(uParam0, 0))
...
BOOL func_186(int iParam0) // Position - 0xC5EA
{
	eCharacter character;
...
BOOL func_187() // Position - 0xCD07
{
	return Global_101431.f_1;
}

BOOL func_188() // Position - 0xCD15
{
	if (Global_98294 != -1)
...
BOOL func_192(int iParam0, int iParam1) // Position - 0xCD8D
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_193() // Position - 0xCDC5
{
	return Global_1575079;
}

BOOL func_194() // Position - 0xCDD1
{
	if (!unk_0x76CD105BCAC6EB9F())
...
void func_195(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) // Position - 0xCDED
{
	if (unk_0x75EAB09F5E974116(unk_0x259BE71D8A81D4FA()))
	{
...
void func_198(var uParam0, int iParam1) // Position - 0xCF53
{
	BOOL flag;
	int i;
...
float func_199(var uParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0xCFF1
{
	var unk;
...
void func_201(var uParam0) // Position - 0xD037
{
	unk_0xB479965CBAA3EAE1(0);
	unk_0xDD291722ADDCBD60();
	func_202(uParam0);
...
void func_202(var uParam0) // Position - 0xD04E
{
	BOOL flag;
	int num;
	int i;
...
BOOL IS_RC_FINE_AND_IN_RANGE(Any* panParam0, BOOL bParam1) // Position - 0xD15E
{
	var unk;
...
BOOL func_206(int iParam0) // Position - 0xD726
{
...
BOOL func_207(var uParam0) // Position - 0xD746
{
...
BOOL func_208(var uParam0) // Position - 0xD75E
{
...
void func_210(var uParam0) // Position - 0xDA87
{
...
BOOL CHECK_VEHICLES_OK(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0xDB32
{
	int i;
	int num;
	var unk;
...
BOOL func_213(var uParam0, var uParam1) // Position - 0xDCF0
{
	var unk;
...
BOOL func_214(var uParam0, BOOL bParam1, int iParam2) // Position - 0xDD20
{
	int i;
	int num;
...
BOOL func_215(int iParam0) // Position - 0xDFDC
{
...
BOOL func_216(var uParam0, int iParam1) // Position - 0xE010
{
	float num;
...
BOOL func_217(var uParam0, int iParam1) // Position - 0xE086
{
	return func_218(uParam0, unk_0x4A8C381C258A124D(), iParam1, 1, 250, 7);
}

BOOL func_218(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xE09E
{
	BOOL flag;
	var unk;
	int num;
...
BOOL func_219(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, int iParam7) // Position - 0xE15F
{
	var unk;
	var unk2;
	var unk5;
...
Vector3 func_220(var uParam0, int iParam1) // Position - 0xE28B
{
	int num;
...
BOOL func_222(var uParam0, var uParam1, int iParam2, int iParam3) // Position - 0xE39A
{
	var unk;
	var unk4;
	float num;
...
float func_223(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0xE42B
{
	return (fParam0 * uParam3) + (fParam0.f_1 * uParam3.f_1) + (fParam0.f_2 * uParam3.f_2);
}

Vector3 func_224(float fParam0, var uParam1, var uParam2) // Position - 0xE44C
{
	float num;
	float num2;
...
int func_226(var uParam0, var uParam1) // Position - 0xE4A6
{
	int i;
...
int func_227(var uParam0) // Position - 0xE4E5
{
...
BOOL func_228(var uParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xE50D
{
	float num;
	float num2;
	int num3;
...
BOOL func_229(var uParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0xE608
{
	float num;
	float num2;
...
BOOL func_230(var uParam0, float fParam1) // Position - 0xE714
{
	var unk;
	var unk2;
...
BOOL func_231(var uParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xE7A9
{
	var unk;
	var unk4;
	float num;
...
BOOL func_232(var uParam0, BOOL bParam1, float fParam2, float fParam3) // Position - 0xE837
{
	if (bParam1)
		if (unk_0x65F146FF416F109F(unk_0x4A8C381C258A124D()))
...
BOOL func_233(int iParam0) // Position - 0xE87F
{
...
void func_234(var uParam0) // Position - 0xE8C9
{
	var unk;
...
BOOL func_235(int iParam0) // Position - 0xE966
{
	if (iParam0 == -1)
		iParam0 = func_177();
...
BOOL func_236(int iParam0) // Position - 0xE9FB
{
...
BOOL func_239(int iParam0) // Position - 0xEA7A
{
...
BOOL func_241(int iParam0) // Position - 0xEAEC
{
...
void func_242(var uParam0) // Position - 0xEB14
{
	if (!unk_0x173751E886F8E9AB())
	{
...
void func_243(var uParam0) // Position - 0xEB41
{
	uParam0->f_16 = 5;
...
BOOL func_244(int iParam0) // Position - 0xEB96
{
	var unk;
	eCharacter character;
...
BOOL func_245(int iParam0) // Position - 0xEBE7
{
	var unk;
...
BOOL func_246(int iParam0) // Position - 0xECA0
{
	var unk;
...
BOOL func_247(int iParam0) // Position - 0xED61
{
	int i;
	var unk;
	int num;
...
BOOL func_249(int iParam0) // Position - 0xEEC6
{
...
BOOL func_250(int iParam0) // Position - 0xEEF1
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_251(int iParam0) // Position - 0xEF1C
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_252(int iParam0) // Position - 0xEF47
{
	if (func_236(iParam0))
		return false;
	else if (!unk_0x4FAFF4BCB7633475(unk_0x4A8C381C258A124D()))
...
BOOL func_254(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, float fParam5) // Position - 0xEF96
{
	int i;
...
BOOL func_255(int iParam0, var uParam1, var uParam2, var uParam3, float fParam4, var uParam5) // Position - 0xEFFB
{
	int num;
	char* str;
...
BOOL func_256(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7) // Position - 0xF073
{
	if (fParam6 < 0f)
		fParam6 = 0f;
...
void func_257(var uParam0, BOOL bParam1) // Position - 0xF0EE
{
	if (bParam1)
	{
...
void func_261(var uParam0, BOOL bParam1) // Position - 0xF1B2
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (unk_0x5B9219522937741D(*uParam0))
...
void func_264(var uParam0) // Position - 0xF23C
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
void func_265(var uParam0) // Position - 0xF274
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
void func_268(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0xF363
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (!unk_0x4FAFF4BCB7633475(*uParam0))
...
void func_269(var uParam0) // Position - 0xF3B3
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (!unk_0x1C2F771CDC87A3A5(*uParam0, 0))
...
void func_270(int iParam0) // Position - 0xF3F4
{
	if (*iParam0 == -1)
		return;

...
void _STAT_SET_PACKED_BOOL(int iParam0, int iParam1, Player plParam2) // Position - 0x35E4
{
	if (plParam2 == -1)
		plParam2 = func_54();
...
Player func_54() // Position - 0x3602
{
...
{
	unk_0x0B0C9A0F9AAEB7F0(&(Global_114370.f_24998.f_6), iParam0);
	return;
}
...
{
	switch (func_143(&Global_32888, 0, 5, false, unk_0x8F76B2250AC806FA()))
	{
		case 1:
			return true;
...
{
	if (Global_114359 == func_65() && unk_0x9FA91AA1AC724CD0() && Global_114360)
		return true;
...
void func_184(var uParam0) // Position - 0xBC49
{
	...
	if (uParam0->f_145)
	{
		if (unk_0x8034325BF6D6E41F() >= uParam0->f_146 + uParam0->f_147 || IS_BIT_SET(Global_101392.f_20, 2) || IS_BIT_SET(Global_101392.f_20, 13))
		{
			for (i = 0; i < 8; i = i + 1)
			{
				if (IS_BIT_SET(uParam0->[i /*18*/], 30))
		...
		if (unk_0xFC8BFE4B41177C22(unk_0x4A8C381C258A124D()))
		{
			if (!unk_0x4FAFF4BCB7633475(unk_0x4A8C381C258A124D()))
			{
				...
				switch (iParam0)
				{
					...
					case 3:
						if (unk_0x8BF5256C439DF778(unk_0x4A8C381C258A124D()) || unk_0x9857C978BD3CBEDA(unk_0x4A8C381C258A124D()) || unk_0x6652E84A43F51B8B(unk_0x259BE71D8A81D4FA(), 1) || unk_0x1B32E388988DD296(unk_0x4A8C381C258A124D(), 0) || func_1() || Global_113417 || Global_32831 || func_223() || func_24(8, -1) || func_222() || func_221() || func_219() || Global_114370.f_7691.f_919[character] == 5)
							return false;
						break;
				
					case 4:
						if (func_1() || unk_0xE7B45027762DEFE7(unk_0x259BE71D8A81D4FA()) > 0 || func_24(8, -1) || func_219() || func_218() || Global_114370.f_7691.f_919[character] == 5)
							return false;
						break;
...
void func_237(int iParam0) // Position - 0xD9AD
{
	...
	if (func_183())
	{
		...
		func_240(30000);
		TEXT_LABEL_ASSIGN_STRING(&unk, func_239(Global_114359, true), 64);

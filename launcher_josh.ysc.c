...
void main() // Position - 0x0
{
	...
	if (!func_297(&unk64, &num, unk61, 1f))
	{
		func_296();
	...
	while (true)
	{
		...
		if (!IS_RC_FINE_AND_IN_RANGE(&num, 1))
		{
			if (num == 30)
			{
				if (func_228(unk_0x4A8C381C258A124D(), -1102.7241f, 290.1463f, 63.23002f, 1) < 200f)
				{
		...
		func_226(num);
		func_219(&iLocal_93, &(num.f_9), unk61);
	
		if (num == 27)
		{
			func_217(&num, unk61, "JOSH1AU", "JOSH1_AMB1", 5, "JOSH", 5000, 14f);
		}
		else if (num == 28)
		{
			func_217(&num, unk61, "JOSH2AU", "JOSH2_AMB", 5, "JOSH", 5000, 1101004800);
		}
		else if (num == 29)
		{
			func_217(&num, unk61, "JOSH3AU", "JOSH3_AMB", 3, "JOSH", 5000, 1101004800);
		}
		else if (num == 30)
		{
			if (iLocal_263 == 0)
...
void func_23(char* sParam0, int iParam1, int iParam2) // Position - 0xE40
{
	if (Global_101392 != 10 && Global_101392 != 9)
	{
		...
		func_25(&Global_104933, sParam0, 0, "Start", iParam1, iParam2);
		func_24();
		Global_95550 = 0;
	}
...
void func_25(int iParam0, char* sParam1, int iParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x1B19
{
	...
	*iParam0 = _GET_CURRENT_PLAYER_CHARACTER_0();
	...
	for (j = CHAR_MICHAEL; j < CHAR_MULTIPLAYER; j = j + 1)
	{
		...
		{
			func_48(unk_0x4A8C381C258A124D(), &iParam0->f_616[j /*65*/], 1, -1);
		}
		else
		{
			for (i = 0; i < 12; i = i + 1)
		...
		if (unk_0xFC8BFE4B41177C22(Global_98703[i]))
			if (Global_98703[i] == iParam0)
				if (echParam1 == _CHAR_NULL || echParam1 == Global_98713[i])
					if (iParam2 == 0 || unk_0x4B423FAA24E8ABF0(iParam0) == func_34(echParam1, iParam2))
						return 1;
	}
...
void func_48(int iParam0, var uParam1, int iParam2, Hash hParam3) // Position - 0x3879
{
	...
	if (!unk_0x4FAFF4BCB7633475(iParam0))
	{
		...
		{
			if (func_53(161, hParam3))
				uParam1->f_59 = func_49(2053, hParam3);
			else
				uParam1->f_59 = func_49(753, hParam3);
		
			uParam1->f_60 = func_49(754, hParam3);
			uParam1->f_61 = func_49(755, hParam3);
		}
...
int func_49(int iParam0, Hash hParam1) // Position - 0x3A13
{
	var unk;
	int num;
...
Hash func_51(Hash hParam0) // Position - 0x3A57
{
	Hash hash;
	Hash hash2;
...
Hash func_52() // Position - 0x3A8B
{
	return Global_1574925;
}

BOOL func_53(int iParam0, Hash hParam1) // Position - 0x3A97
{
	var unk;
	BOOL num;

	unk = func_54(iParam0, hParam1);
...
var func_54(int iParam0, Hash hParam1) // Position - 0x3ABB
{
	return unk_0xD69CE161FE614531(2, iParam0, func_51(hParam1));
}
...
void func_60(int iParam0, BOOL bParam1) // Position - 0x4380
{
	...
	if (func_36(character) && !unk_0x4FAFF4BCB7633475(iParam0))
	{
		if (iParam0 == unk_0x4A8C381C258A124D())
		{
			func_61(iParam0, &Global_114370.f_2366.f_539.f_298[character /*477*/]);
...
BOOL func_69(var uParam0, var uParam1, var uParam2, char* sParam3, float fParam4, float fParam5, float fParam6) // Position - 0x5EE3
{
	var unk;
	var unk2;
...
BOOL func_71(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0x66A6
{
	if (bParam6)
...
BOOL func_72(var uParam0) // Position - 0x66ED
{
...
BOOL func_74(int iParam0, int iParam1, BOOL bParam2) // Position - 0x6758
{
	if (iParam0 == -1)
		return false;
...
BOOL func_77(int iParam0) // Position - 0x6B6B
{
	return func_74(iParam0, 5, true);
}

int func_78(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x6B7B
{
	int i;
	float num;
	float num2;
...
Vector3 func_83(float fParam0, float fParam1, float fParam2) // Position - 0x76BC
{
...
BOOL func_85(Player plParam0) // Position - 0x76E8
{
...
BOOL func_87(int iParam0, int iParam1, var uParam2, int iParam3, BOOL bParam4) // Position - 0x77EA
{
	var unk;
	var unk7;
	var unk13;
...
Vector3 func_88(float fParam0, var uParam1, var uParam2, float fParam3) // Position - 0x787F
{
	float num;
	float num2;
	float num3;
...
BOOL func_92(int iParam0, var uParam1) // Position - 0x8520
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_93(Player plParam0) // Position - 0x85A2
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
...
Player _INVALID_PLAYER_INDEX() // Position - 0x85FA
{
	return -1;
}
...
BOOL func_98(int iParam0) // Position - 0x889C
{
...
int func_106(int iParam0) // Position - 0x8DE5
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * IS_BIT_SET(iParam0, 31) ? -1 : 1) + 2011;
}

var func_107(BOOL bParam0, var uParam1, var uParam2) // Position - 0x8E07
{
	if (bParam0)
		return uParam1;
...
int func_108(int iParam0) // Position - 0x8E1E
{
	return iParam0 & 15;
}
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER_0() // Position - 0x8EDC
{
	func_58();
	return Global_114370.f_2366.f_539.f_4321;
}
...
void func_116(char* sParam0, var uParam1, int iParam2) // Position - 0x8F7A
{
...
BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0x8FBC
{
...
BOOL func_122(Any* panParam0) // Position - 0xAA4F
{
	int num;
...
void func_126(Vehicle veParam0) // Position - 0xABED
{
	int num;
	int num2;
	int num3;
...
int func_128(Vehicle veParam0) // Position - 0xACC9
{
	int i;
...
BOOL func_132(int iParam0, int iParam1, int iParam2) // Position - 0xADC2
{
...
int func_134(Vehicle veParam0) // Position - 0xAE29
{
	int i;
...
BOOL func_135(var uParam0) // Position - 0xAE72
{
...
BOOL func_136(int iParam0) // Position - 0xAE92
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_138(int iParam0) // Position - 0xAF62
{
	switch (iParam0)
	{
		case 5:
...
void func_139(Any* panParam0, int iParam1, BOOL bParam2) // Position - 0xAFB5
{
	int i;
...
BOOL func_140(int iParam0) // Position - 0xB0AA
{
	switch (iParam0)
	{
		case 5:
...
void func_142(BOOL bParam0, BOOL bParam1, BOOL bParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB154
{
	if (bParam0)
	{
...
Player func_145(Hash hParam0, BOOL bParam1) // Position - 0xB314
{
	Player player;
	Hash hash;
...
BOOL func_146(int iParam0) // Position - 0xB355
{
	int num;
...
BOOL func_147(int iParam0) // Position - 0xB377
{
...
int func_149(int iParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0xB3C4
{
	int num;
...
BOOL func_152(var uParam0) // Position - 0xB441
{
...
BOOL func_158(var uParam0, float fParam1, int iParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB574
{
...
void func_159(var uParam0) // Position - 0xB5CB
{
	if (!unk_0x1C2F771CDC87A3A5(uParam0, 0))
...
BOOL func_166(int iParam0) // Position - 0xB8D8
{
	if (iParam0 == 1)
...
BOOL func_168(int iParam0) // Position - 0xB93E
{
...
BOOL func_169(int iParam0) // Position - 0xB97F
{
	int num;
...
int func_171(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4) // Position - 0xB9F6
{
	int i;
...
void func_172(int iParam0, int iParam1) // Position - 0xBB2D
{
	int i;
...
BOOL func_174(int iParam0, int iParam1) // Position - 0xBB8D
{
	if (iParam1 == 15)
		return 1;
...
BOOL func_175(int iParam0) // Position - 0xBD6E
{
	if (Global_43922 == 15)
		return false;
...
void func_179(int iParam0, var uParam1) // Position - 0xBE0E
{
	switch (iParam0)
	{
		case 0:
...
var func_180(float fParam0, float fParam1, float fParam2, int iParam3) // Position - 0xC282
{
	var unk;
...
var func_181(BOOL bParam0, var uParam1, var uParam2) // Position - 0xC2AE
{
	if (bParam0)
		return uParam1;
...
BOOL func_182(int iParam0) // Position - 0xC2C5
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_183(var uParam0) // Position - 0xC354
{
	if (*uParam0 == 30)
	{
		if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_28[0]))
		{
			if (bLocal_261)
			{
				if (!unk_0x7F420695E3F776FB(unk_0x4A8C381C258A124D(), 0))
				{
					if (func_184(unk_0x4A8C381C258A124D(), uParam0->f_28[0], 1) <= 15f)
					{
						func_318("Special launching Josh 4 (not in vehicle)");
						return true;
					}
				}
				else if (func_184(unk_0x4A8C381C258A124D(), uParam0->f_28[0], 1) <= 10f)
				{
...
float func_184(var uParam0, var uParam1, int iParam2) // Position - 0xC3D3
{
	var unk;
	var unk4;
...
BOOL func_185(var uParam0) // Position - 0xC431
{
	if (*uParam0 == 29)
	{
		if (func_228(unk_0x4A8C381C258A124D(), 566.7472f, -1771.875f, 28.35786f, 1) < 6f)
		{
			if (!unk_0x7F420695E3F776FB(unk_0x4A8C381C258A124D(), 0))
			{
			...
			else if (!func_186(unk_0x4A8C381C258A124D(), joaat("SCRIPT_TASK_LEAVE_ANY_VEHICLE")) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(unk_0x6EF03BE64E058E2F(unk_0x4A8C381C258A124D(), 0)) && func_158(unk_0x6EF03BE64E058E2F(unk_0x4A8C381C258A124D(), 0), 1f, 1, 1056964608, 0, true, false))
			{
				unk_0x092B9247AF00F5CF(unk_0x4A8C381C258A124D(), 0, 0);
			}
		}
...
BOOL func_186(var uParam0, int iParam1) // Position - 0xC4C4
{
	if (func_135(uParam0))
...
int func_187(var uParam0) // Position - 0xC4F7
{
	if (*uParam0 == 28)
	{
		if (func_228(unk_0x4A8C381C258A124D(), 566.7472f, -1771.875f, 28.35786f, 1) < 9f)
		{
			if (!unk_0x7F420695E3F776FB(unk_0x4A8C381C258A124D(), 0))
			{
			...
			else if (!func_186(unk_0x4A8C381C258A124D(), joaat("SCRIPT_TASK_LEAVE_ANY_VEHICLE")) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(unk_0x6EF03BE64E058E2F(unk_0x4A8C381C258A124D(), 0)) && func_158(unk_0x6EF03BE64E058E2F(unk_0x4A8C381C258A124D(), 0), 4f, 1, 1056964608, 0, true, false))
			{
				unk_0x092B9247AF00F5CF(unk_0x4A8C381C258A124D(), 0, 0);
			}
		}
...
BOOL func_190(var uParam0) // Position - 0xCD8C
{
	float num;
...
void func_191(int iParam0, var uParam1) // Position - 0xCE1A
{
	if (iParam0 == 1)
	{
		if (!func_138(uParam1))
...
BOOL func_192(BOOL bParam0) // Position - 0xCE7E
{
	var unk;
...
BOOL func_193(var uParam0) // Position - 0xCF15
{
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0))
		if (unk_0xD9F5E1FEFD1329E4(uParam0, 0))
...
BOOL func_194(int iParam0) // Position - 0xCF3F
{
	eCharacter character;
		...
		if (unk_0xFC8BFE4B41177C22(unk_0x4A8C381C258A124D()))
		{
			if (!unk_0x4FAFF4BCB7633475(unk_0x4A8C381C258A124D()))
			{
				...
				switch (iParam0)
				{
					...
					case 3:
						if (unk_0x8BF5256C439DF778(unk_0x4A8C381C258A124D()) || unk_0x9857C978BD3CBEDA(unk_0x4A8C381C258A124D()) || unk_0x6652E84A43F51B8B(unk_0x259BE71D8A81D4FA(), 1) || unk_0x1B32E388988DD296(unk_0x4A8C381C258A124D(), 0) || func_202() || Global_113417 || Global_32831 || func_201() || func_200(8, -1) || func_100() || func_199() || func_197() || Global_114370.f_7691.f_919[character] == 5)
							return false;
						break;
				
					case 4:
						if (func_202() || unk_0xE7B45027762DEFE7(unk_0x259BE71D8A81D4FA()) > 0 || func_200(8, -1) || func_197() || func_196() || Global_114370.f_7691.f_919[character] == 5)
							return false;
						break;
...
BOOL func_195() // Position - 0xD65C
{
	return Global_101431.f_1;
}

BOOL func_196() // Position - 0xD66A
{
	if (Global_98294 != -1)
...
BOOL func_201() // Position - 0xD71A
{
	return Global_1575079;
}

BOOL func_202() // Position - 0xD726
{
	if (!unk_0x76CD105BCAC6EB9F())
...
void func_203() // Position - 0xD742
{
	switch (iLocal_94)
	{
		...
		case 1:
			if (func_228(unk_0x4A8C381C258A124D(), -1103.44f, 290.18f, 63.28f, 1) <= 20f)
		...
		case 2:
			...
			else if (func_228(unk_0x4A8C381C258A124D(), -1103.44f, 290.18f, 63.28f, 1) >= 25f)
			{
				func_153();
				bLocal_261 = true;
				iLocal_94 = 0;
...
BOOL _CONVERSATION_ADD_LINE(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0xD80E
{
...
BOOL func_205(char* sParam0, int iParam1, BOOL bParam2) // Position - 0xD85C
{
	Global_22167 = 0;
...
BOOL func_209(int iParam0, int iParam1) // Position - 0xDBD4
{
...
void _UPDATE_CURRENT_PLAYER_CHARACTER() // Position - 0xDD4C
{
	if (func_59(14))
	{
		if (!unk_0x1C2F771CDC87A3A5(unk_0x4A8C381C258A124D(), 0))
...
void func_215(var uParam0, eCharacter echParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xDE46
{
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(int iParam0) // Position - 0xDE9C
{
	if (unk_0xFC8BFE4B41177C22(iParam0))
...
int func_217(var uParam0, var uParam1, var uParam2, var uParam3, char* sParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, int iParam9) // Position - 0xDEBD
{
	var unk;

	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(unk_0x4A8C381C258A124D()) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_28[0]) && !_CONVERSATION_IS_DIALOGUE_IN_PROGRESS() && unk_0x1DD05E817C89C737() - uParam0->f_60 > iParam8 && func_228(unk_0x4A8C381C258A124D(), uParam1, 1) < iParam9)
	{
		unk = 16;
...
void _CONVERSATION_ADD_LINE_NO_SUBTITLE(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xDF45
{
...
void func_219(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) // Position - 0xDF80
{
	if (unk_0x75EAB09F5E974116(unk_0x259BE71D8A81D4FA()))
	{
		if (!unk_0xD6F9DEE4765092A9(uParam1))
		{
			...
			{
				if (func_228(unk_0x4A8C381C258A124D(), uParam2, 1) <= 100f)
					func_222(uParam0, 1);
			}
			else
			{
				...
				if (func_228(unk_0x4A8C381C258A124D(), uParam2, 1) > 120f)
					func_224(uParam0);
			}
		}
	}
...
int func_221(int iParam0) // Position - 0xE0AD
{
	if (Global_79244 == iParam0)
		if (Global_79245 == -1)
			if (Global_79243 < unk_0x8034325BF6D6E41F())
				return 1;
	else if (Global_79245 == iParam0)
		return 2;
...
void func_222(var uParam0, int iParam1) // Position - 0xE0E6
{
	BOOL flag;
	int i;
...
void func_224(var uParam0) // Position - 0xE190
{
	unk_0xB479965CBAA3EAE1(0);
	unk_0xDD291722ADDCBD60();
	func_225(uParam0);
...
void func_225(var uParam0) // Position - 0xE1A7
{
	BOOL flag;
	int num;
	int i;
	...
	Global_79241 = Global_79241 - 1;
	Global_79242 = 1;
	Global_79243 = unk_0x8034325BF6D6E41F();
	*uParam0 = -1;
	return;
}
...
void func_227(var uParam0) // Position - 0xE2B7
{
	int i;
...
float func_228(var uParam0, float fParam1, float fParam2, float fParam3, int iParam4) // Position - 0xE337
{
	var unk;
...
BOOL IS_RC_FINE_AND_IN_RANGE(Any* panParam0, BOOL bParam1) // Position - 0xE371
{
	var unk;
...
void func_230(int iParam0, var uParam1, int iParam2) // Position - 0xE5E1
{
	...
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(iParam0))
	{
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_232(uParam1) || !unk_0x13CCB1AD131C1082(iParam0, *uParam1, uParam1->f_2, 3))
				{
					if (func_231(iParam2) && !unk_0x3644984C9D7B57EF(iParam0, unk_0x4A8C381C258A124D(), 25f))
					{
						unk_0x0E95B96CFEFE7B61(iParam0, unk_0x4A8C381C258A124D(), 0);
						uParam1->f_3 = 5;
					}
					else if (func_232(uParam1) && uParam1->f_4 == 0 && unk_0xED977E2AE2CB16EE(unk_0xD1A6A821F5AC81DB(unk_0x4A8C381C258A124D(), 1), unk_0xD1A6A821F5AC81DB(iParam0, 1), 1) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
			...
			case 5:
				if (!func_231(iParam2) || unk_0x3644984C9D7B57EF(iParam0, unk_0x4A8C381C258A124D(), 10f))
				{
					if (func_71(uParam1->f_5, 0f, 0f, 0f, false))
						unk_0x10425721983AE158(iParam0, *uParam1, uParam1->f_1, 8f, -8f, -1, 262153, 0, 0, 0, 0);
					else
...
BOOL func_231(int iParam0) // Position - 0xE939
{
...
BOOL func_232(var uParam0) // Position - 0xE959
{
...
BOOL func_233(var uParam0) // Position - 0xE971
{
...
void func_235(var uParam0) // Position - 0xEC9A
{
...
BOOL CHECK_VEHICLES_OK(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0xECC5
{
	int i;
	int num;
	var unk;
			...
			if (unk_0xFC8BFE4B41177C22(uParam0->f_35[i]))
			{
				...
				if (bParam2)
				{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_237(unk_0x4A8C381C258A124D(), uParam0->f_35[i]))
							{
...
BOOL func_237(var uParam0, var uParam1) // Position - 0xEE83
{
	var unk;
...
BOOL func_238(var uParam0, BOOL bParam1, int iParam2) // Position - 0xEEB3
{
	int i;
	int num;
...
BOOL func_239(int iParam0) // Position - 0xF16F
{
...
BOOL func_240(var uParam0, int iParam1) // Position - 0xF1A3
{
	float num;

	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(unk_0x4A8C381C258A124D()) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0))
	{
		if (func_251(uParam0) || unk_0x41754DC6001F6313(unk_0x259BE71D8A81D4FA(), uParam0))
		{
...
BOOL func_241(var uParam0, int iParam1) // Position - 0xF219
{
	return func_242(uParam0, unk_0x4A8C381C258A124D(), iParam1, 1, 250, 7);
}

BOOL func_242(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xF231
{
	BOOL flag;
	var unk;
	int num;

	num = func_250(uParam0, uParam1);
	...
	flag = func_243(&iLocal_35[num /*4*/], unk, uParam1, &(iLocal_35[num /*4*/].f_3), uParam0, iParam5);
	return flag || unk_0x1DD05E817C89C737() - iLocal_35[num /*4*/].f_3 < iParam4;
}

BOOL func_243(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, int iParam7) // Position - 0xF2F2
{
	var unk;
	var unk2;
	var unk5;
...
Vector3 func_244(var uParam0, int iParam1) // Position - 0xF41E
{
	int num;
...
BOOL func_246(var uParam0, var uParam1, int iParam2, int iParam3) // Position - 0xF52D
{
	var unk;
	var unk4;
	float num;

	unk = { func_248(unk_0xD1A6A821F5AC81DB(uParam1, 1) - unk_0xD1A6A821F5AC81DB(uParam0, 1)) };
	...
	if (iParam3 == 0)
		...
		unk4 = { func_248(unk_0x83FDC027F0BEA202(uParam0, 31086, 0f, 5f, 0f) - unk_0x83FDC027F0BEA202(uParam0, 31086, 0f, 0f, 0f)) };

	num = func_247(unk4, unk);
...
float func_247(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0xF5BE
{
	return (fParam0 * uParam3) + (fParam0.f_1 * uParam3.f_1) + (fParam0.f_2 * uParam3.f_2);
}

Vector3 func_248(float fParam0, var uParam1, var uParam2) // Position - 0xF5DF
{
	float num;
	float num2;
...
int func_250(var uParam0, var uParam1) // Position - 0xF639
{
	int i;
...
int func_251(var uParam0) // Position - 0xF678
{
...
BOOL func_252(var uParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xF6A0
{
	float num;
	float num2;
	int num3;
	...
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(unk_0x4A8C381C258A124D()) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0))
	{
		...
		if (!bParam2)
		{
			if (func_256(uParam0, bParam1, num, num2))
				return true;
		
			if (func_253(uParam0, num2, bParam3, bParam4))
				return true;
		}
		else
		{
...
BOOL func_253(var uParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0xF79B
{
	float num;
	float num2;
...
BOOL func_254(var uParam0, float fParam1) // Position - 0xF8A7
{
	var unk;
	var unk2;
	...
	if (unk_0xF67924A428A734EC(uParam0, joaat("WEAPON_GRENADE"), fParam1, &unk2, &unk, 0) || unk_0xF67924A428A734EC(uParam0, joaat("WEAPON_SMOKEGRENADE"), fParam1, &unk2, &unk, 0) || unk_0xF67924A428A734EC(uParam0, joaat("WEAPON_BZGAS"), fParam1, &unk2, &unk, 0) || unk_0xF67924A428A734EC(uParam0, joaat("WEAPON_STICKYBOMB"), fParam1, &unk2, &unk, 0) || unk_0xF67924A428A734EC(uParam0, joaat("WEAPON_MOLOTOV"), fParam1, &unk2, &unk, 0))
		if (func_255(uParam0, unk2, 90f, 0))
			return true;

	return false;
}

BOOL func_255(var uParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xF93C
{
	var unk;
	var unk4;
	float num;

	unk = { func_248(uParam1 - unk_0xD1A6A821F5AC81DB(uParam0, 1)) };
...
BOOL func_256(var uParam0, BOOL bParam1, float fParam2, float fParam3) // Position - 0xF9CA
{
	if (bParam1)
		if (unk_0x65F146FF416F109F(unk_0x4A8C381C258A124D()))
...
BOOL func_257(int iParam0) // Position - 0xFA12
{
...
void func_258(var uParam0) // Position - 0xFA5C
{
	var unk;
...
BOOL func_259(int iParam0) // Position - 0xFAF9
{
	if (iParam0 == -1)
		iParam0 = func_176();
...
BOOL func_260(int iParam0) // Position - 0xFB8E
{
...
BOOL func_263(int iParam0) // Position - 0xFC0D
{
...
BOOL func_265(int iParam0) // Position - 0xFC7F
{
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, var uParam2, char* sParam3, int iParam4, int iParam5) // Position - 0xFCA7
{
...
BOOL func_267(var uParam0) // Position - 0xFD42
{
	switch (*uParam0)
	{
		case 27:
...
BOOL func_268(var uParam0) // Position - 0xFDB7
{
	int num;
	int i;
	float num2;
	...
	switch (iLocal_89)
	{
		...
		case 2:
			...
			{
				func_272(&uParam0->f_28[1], num[2], -1102.92f, 290.12f, 64.28f, 40.46f, 6);
			...
			{
				func_272(&uParam0->f_28[2], num[2], -1102.73f, 290.91f, 64.28f, 92.06f, 6);
...
void func_269(var uParam0, BOOL bParam1) // Position - 0x101AD
{
	var unk;
	float num;
	...
	func_270(uParam0, iLocal_91, unk, num);
...
void func_270(var uParam0, int iParam1, float fParam2, float fParam3, float fParam4, float fParam5) // Position - 0x10221
{
	func_271(uParam0);
...
void func_271(var uParam0) // Position - 0x10264
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
void func_272(var uParam0, var uParam1, float fParam2, float fParam3, float fParam4, float fParam5, int iParam6) // Position - 0x10300
{
	func_273(uParam0);
...
void func_273(var uParam0) // Position - 0x10321
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (!unk_0x1C2F771CDC87A3A5(*uParam0, 0))
...
BOOL func_274(var uParam0, eCharacter echParam1, float fParam2, float fParam3, float fParam4, float fParam5, char* sParam6, int iParam7) // Position - 0x10362
{
	if (func_275(uParam0, echParam1, fParam2, fParam5, true))
	{
		if (unk_0xFC8BFE4B41177C22(*uParam0))
		{
			if (!unk_0x1C2F771CDC87A3A5(*uParam0, 0))
...
BOOL func_275(var uParam0, eCharacter echParam1, var uParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0x103BE
{
	int num;

	if (!func_36(echParam1))
	{
		num = func_321(echParam1);
...
int func_276(int iParam0, eCharacter echParam1) // Position - 0x1044C
{
	int num;
...
BOOL func_277(BOOL bParam0, BOOL bParam1) // Position - 0x10492
{
	int num;
...
BOOL func_278(BOOL bParam0, BOOL bParam1) // Position - 0x10500
{
	int num;
...
BOOL func_279(var uParam0) // Position - 0x105A6
{
	if (func_233(uParam0))
	{
...
BOOL func_280(var uParam0) // Position - 0x105D0
{
	int i;
...
BOOL func_282(var uParam0) // Position - 0x1063D
{
	int num;
	int i;
	BOOL flag;
	...
	switch (iLocal_89)
	{
		...
		case 1:
			if (!func_280(&num) || !unk_0xE100DD4F82A51BDE("rcmjosh3"))
				return false;
...
void func_283(var uParam0) // Position - 0x10825
{
	func_270(uParam0, iLocal_91, 558.09f, -1765.39f, 28.86f, 335.3252f);
	unk_0x20DD46D27530FAC7(*uParam0, 4);
...
BOOL func_284(var uParam0) // Position - 0x1086B
{
	int num;
	int i;
	BOOL flag;
	...
	switch (iLocal_89)
	{
		...
		case 1:
			if (!func_280(&num) || !unk_0xE100DD4F82A51BDE("rcmjosh2"))
				return false;
...
BOOL func_285(var uParam0) // Position - 0x10A8E
{
	int num;
	int i;
	BOOL flag;
...
BOOL func_286(BOOL bParam0, BOOL bParam1) // Position - 0x10BFB
{
	int num;
...
BOOL func_287(int iParam0) // Position - 0x10C69
{
	var unk;
	eCharacter character;
...
BOOL func_288(int iParam0) // Position - 0x10CBA
{
	var unk;
	...
	if (Global_101392.f_11 == 6)
	{
		if (Global_101392 < 9)
		{
			...
			if (unk_0x1B79E937E91F40C3(&(Global_101392.f_3), unk))
			{
...
BOOL func_289(int iParam0) // Position - 0x10D73
{
	var unk;
...
BOOL func_290(int iParam0) // Position - 0x10E34
{
	int i;
	var unk;
	int num;
...
BOOL func_292(int iParam0) // Position - 0x10F9B
{
...
BOOL func_293(int iParam0) // Position - 0x10FC6
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_294(int iParam0) // Position - 0x10FF1
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_295(int iParam0) // Position - 0x1101C
{
	if (func_260(iParam0))
		return false;
	else if (!unk_0x4FAFF4BCB7633475(unk_0x4A8C381C258A124D()))
...
BOOL func_297(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, float fParam5) // Position - 0x1106B
{
	int i;
...
BOOL func_298(int iParam0, var uParam1, var uParam2, var uParam3, float fParam4, var uParam5) // Position - 0x110D0
{
	int num;
	char* str;
...
BOOL func_299(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7) // Position - 0x11148
{
	if (fParam6 < 0f)
		fParam6 = 0f;
...
void func_300(var uParam0, BOOL bParam1) // Position - 0x111C3
{
	char* str;
...
BOOL func_304(char* sParam0) // Position - 0x112C1
{
	var unk;
...
void func_310(var uParam0, BOOL bParam1) // Position - 0x113AB
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (unk_0x5B9219522937741D(*uParam0))
...
void func_313(var uParam0) // Position - 0x11435
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
void func_316(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x114C0
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (!unk_0x4FAFF4BCB7633475(*uParam0))
...
void func_317(int iParam0) // Position - 0x11510
{
	if (*iParam0 == -1)
		return;
...
int func_321(eCharacter echParam0) // Position - 0x115AC
{
	if (!func_36(echParam0))

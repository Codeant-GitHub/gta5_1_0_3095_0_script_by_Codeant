...
void main() // Position - 0x0
{
	...
	while (true)
	{
		...
		if (!unk_0x76CD105BCAC6EB9F() || _SHOULD_NETWORK_SCRIPT_TERMINATE() || Global_1579704 == 0 || func_28())
			func_25();
...
{
	return !Global_1579700 && unk_0x834C960822A4683F();
}
...
{
	while (!unk_0x0384E096E4BE6261(32, 0, Global_1579719))
	{
		SYSTEM::WAIT(0);
	}

				...
				case 3:
					...
					if (!_CAN_ENTER_FREEROAM_STATE(iLocal_99))
					{
						if (!func_184(iLocal_93, 8))
						{
							...
							if (unk_0x1B79E937E91F40C3(&(Global_101392.f_3), &uLocal_68))
							{
								uLocal_68 = { uLocal_52 };
								flag2 = false;
							}
					...
					else
					{
						...
						if (!func_169(3) && !Global_101426)
						{
							...
							{
								if (!func_184(iLocal_93, 1) || !unk_0xFC8BFE4B41177C22(func_168()) && !Global_101426)
								{
									func_177(10);
									break;
								}
				...
				case 6:
					...
					if (!unk_0xF40767E41852FB72(iLocal_51))
					{
						...
						if (iLocal_98 != -1)
						{
							if (func_184(Global_113020, 0))
							{
								unk_0x375B1B37EF136A49(func_21(iLocal_98), 0, Global_101429, 0);
...
void func_7(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4) // Position - 0xAD1
{
	...
	if (unk_0xDCE96FB47C1D0314(sParam0, &Global_98442, 0, -1) != 0)
		return;

	unk_0x1A6EB10909EB6840(sParam0, iParam1, iParam2, iParam3, iParam4, Global_95549);
...
void func_27(Vehicle veParam0) // Position - 0xF06
{
	int num;
	int num2;
	int num3;
...
int func_29(Vehicle veParam0) // Position - 0xFE2
{
	int i;
...
int func_35(Vehicle veParam0) // Position - 0x1142
{
	int i;
...
int func_63(int iParam0, Hash hParam1) // Position - 0x46FA
{
	var unk;
	int num;
...
var func_64(int iParam0, Hash hParam1) // Position - 0x4729
{
	return unk_0xD69CE161FE614531(0, iParam0, func_65(hParam1));
}

Hash func_65(Hash hParam0) // Position - 0x473E
{
	Hash hash;
	Hash hash2;
...
BOOL func_69(Player plParam0, int iParam1, BOOL bParam2, BOOL bParam3, Hash hParam4) // Position - 0x5A1C
{
	Hash hash;
	int num;
	int num2;
	...
	if (func_70(plParam0, iParam1, &num2, &num, bParam2, bParam3))
	{
		num3 = func_63(num2, hash);
...
BOOL func_70(Player plParam0, int iParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5) // Position - 0x5A5A
{
	int value;
...
void func_71(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x8549
{
	...
	if (iParam0 == 12)
	{
		...
		if (num4 >= 0)
		{
			...
			if (num5 > num4)
			{
				...
				Global_2883589 = num3;
				func_60(&Global_79031[0 /*14*/], iParam0, iParam1, &(num3.f_7), 0, 0, num3.f_2, false, -1, 2, true);
				return;
			}
		}
	}
	...
	else if (iParam0 == 14)
	{
		...
		if (num8 >= 0)
		{
			...
			if (num9 > num8)
			{
				...
				Global_2883589 = num6;
				func_60(&Global_79031[0 /*14*/], iParam0, iParam1, &(num6.f_9), num6.f_3, num6.f_4, num6.f_5, unk_0x304A39EB177D246B(num6.f_1, joaat("OUTFIT_ONLY"), 0), num7, 2, num6.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_79229)
		{
			...
			func_60(&Global_79031[0 /*14*/], iParam0, iParam1, &(num10.f_9), num10.f_3, num10.f_4, num10.f_5, unk_0x304A39EB177D246B(num10.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, num10.f_1 != 0);
			return;
		}
		...
		if (num11 >= 0)
		{
			num12 = unk_0x7B6C0A0D604E68FA(num2, 10, -1, 0, -1, func_53(iParam0));
...
void func_129(var uParam0, int iParam1, int iParam2, Player plParam3, Player plParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x1BA8E
{
	uParam0->[0] = iParam1;
	uParam0->[2] = iParam2;
	uParam0->[3] = plParam3;
...
eCharacter _GET_PLAYER_CHARACTER_FROM_PED(var uParam0) // Position - 0x1BB86
{
	eCharacter i;
	int num;
...
int _GET_CHARACTER_MODEL(eCharacter character) // Position - 0x1BBC3
{
...
int func_136(eCharacter echParam0) // Position - 0x1BBE8
{
...
void _CONTEXT_ADD_HELP_TEXT(var uParam0, int iParam1, char* sParam2, int iParam3, char* sParam4, int iParam5, int iParam6) // Position - 0x1BD4D
{
	int i;
		...
		if (unk_0xFC8BFE4B41177C22(unk_0x4A8C381C258A124D()))
		{
			if (!unk_0x4FAFF4BCB7633475(unk_0x4A8C381C258A124D()))
			{
				...
				switch (iParam0)
				{
					...
					case 1:
						if (unk_0x6652E84A43F51B8B(unk_0x259BE71D8A81D4FA(), 1) || func_164() || Global_32831 || func_163() || func_146(8, -1) || func_160() || func_162() || func_161() || func_148() || Global_114370.f_7691.f_919[character] == 5)
							return false;
						break;
					...
					case 4:
						if (func_164() || unk_0xE7B45027762DEFE7(unk_0x259BE71D8A81D4FA()) > 0 || func_146(8, -1) || func_148() || func_159() || Global_114370.f_7691.f_919[character] == 5)
							return false;
						break;

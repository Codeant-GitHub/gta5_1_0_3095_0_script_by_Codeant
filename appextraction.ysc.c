...
void func_7() // Position - 0x1FB
{
	...
	if (IS_BIT_SET(Global_4542983, 23))
	{
		...
		unk_0x330108B080A2132F(Global_4542984);
		unk_0x330108B080A2132F(SYSTEM::FLOOR(Global_4543264));
		unk_0x330108B080A2132F(Global_4542985);
		unk_0x330108B080A2132F(SYSTEM::FLOOR(Global_4543264.f_1));
		unk_0x330108B080A2132F(Global_4542986);
		unk_0x330108B080A2132F(SYSTEM::FLOOR(Global_4543264.f_2));
		func_8("CELL_BODYG" /*Guard*/);
		unk_0x330108B080A2132F(Global_4542987);
		unk_0x330108B080A2132F(SYSTEM::FLOOR(Global_4543267));
		unk_0x330108B080A2132F(Global_4542988);
		unk_0x330108B080A2132F(SYSTEM::FLOOR(Global_4543267.f_1));
		unk_0x330108B080A2132F(Global_4542989);
		unk_0x330108B080A2132F(SYSTEM::FLOOR(Global_4543267.f_2));
	}
	else
	{
		unk_0x557F1E2300EF1A3E(0);

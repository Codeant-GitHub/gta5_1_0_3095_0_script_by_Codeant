...
{
	if (!unk_0x4FAFF4BCB7633475(Global_101113))
	{
	}
	else
	{
...
BOOL func_4() // Position - 0x1B6
{
	...
	if (!func_3(&unk))
	{
		...
		else if (unk_0x5266F1D2AEF6F73A(Global_98702))
		{
			...
			if (!func_5(Global_101113, uLocal_73, 2))
				if (num >= 0.9f)
					unk_0x73CAFD2038E812B3(Global_101113, uLocal_73, 2);
...
void func_22() // Position - 0x6A5
{
	...
	while (!unk_0xFC8BFE4B41177C22(Global_101113) || !unk_0xFC8BFE4B41177C22(uLocal_73) || !unk_0x6252BC0DD8A320DB(iLocal_72) && num < 400)
	{
	...
	unk_0xEE0BCDB1B5E36BCB(Global_101113, 1, 1);

	if (unk_0xFC8BFE4B41177C22(Global_101113))
	{
		unk_0x3CEA1FD137ACE2D9(Global_101113, Global_96376);
		unk_0x397CF4F4C8B17365(Global_101113, "A_F_Y_BevHills_01_White_FULL_01");
	}
...
BOOL func_32(Player plParam0, BOOL bParam1, int iParam2) // Position - 0x7C97
{
	int i;
	var unk;
...
BOOL func_33(Player plParam0) // Position - 0x7E19
{
	int num;
	var unk;
	var unk2;
...
BOOL func_35(Player plParam0, int iParam1) // Position - 0x7EFC
{
	BOOL num;
	var unk;
...
Player func_36(BOOL bParam0) // Position - 0xD436
{
	if (bParam0)
		return -426933872;
...
BOOL func_39() // Position - 0xD47C
{
	return false;
}

BOOL func_40() // Position - 0xD485
{
	return true;
}

BOOL func_41() // Position - 0xD48E
{
	return true;
}

BOOL func_42() // Position - 0xD497
{
...
BOOL _IS_EXCLUSIVE_CONTENT_UNLOCKED() // Position - 0xD4B0
{
	var unk;
...
BOOL func_44(int iParam0) // Position - 0xD568
{
...
BOOL func_47(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0xDA9B
{
	if (bParam6)
...
BOOL func_48(int iParam0, var uParam1, char* sParam2) // Position - 0xDAE2
{
	var unk;
	int num;
	var unk4;
...
BOOL func_49(int iParam0, int iParam1, var uParam2, var uParam3) // Position - 0x100E9
{
	switch (iParam1)
	{
		case 0:
...
BOOL _GET_RANDOM_BOOL() // Position - 0x12036
{
...
BOOL func_51(int iParam0, var uParam1, var uParam2) // Position - 0x12054
{
	switch (iParam0)
	{
		case 11:

		...
		switch (iLocal_239[iParam1])
		{
			case 0:
				if (unk_0x13CCB1AD131C1082(uParam0, &uLocal_344, &uLocal_393[iParam1 /*16*/], 2))
				{
					...
					{
						num3 = unk_0xBD3B265153D3BA2D(Global_98702);
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, var uParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x15E4
{
...
BOOL func_28(var uParam0) // Position - 0x167F
{
	int i;
...
BOOL func_29(var uParam0) // Position - 0x171B
{
	int i;
	float num;
...
void func_30(var uParam0, int iParam1) // Position - 0x17C6
{
...
BOOL func_32(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0x17E6
{
	if (bParam6)
...
void func_33(var uParam0, char* sParam1, char* sParam2, int iParam3) // Position - 0x182D
{
	unk_0x4CAD907F190E6F10(uParam0, sParam1, sParam2, func_34(iParam3), 0);
	return;
}

char* func_34(int iParam0) // Position - 0x1846
{
	char* str;
...
int func_35(var uParam0, var uParam1, char* sParam2, var uParam3, var uParam4) // Position - 0x1A35
{
		...
		if (unk_0x5266F1D2AEF6F73A(Global_98702))
		{
			for (i = 0; i < iLocal_236; i = i + 1)
			{
				if (!unk_0x4FAFF4BCB7633475(iLocal_236[i]))
				{
					...
					unk_0x3DA436E63AB0F541(iLocal_236[i], Global_98702, &uLocal_344, &uLocal_393[i /*16*/], 1000f, num, num2, num3, num4, num5);
					iLocal_239[i] = 0;
				}
			}
			...
			for (i = 0; i < iLocal_252; i = i + 1)
			{
				if (unk_0xFC8BFE4B41177C22(iLocal_252[i]))
					if (!unk_0xD6F9DEE4765092A9(&uLocal_558[i /*16*/]))
						unk_0x381D671BCFC294D9(iLocal_252[i], Global_98702, &uLocal_558[i /*16*/], &uLocal_344, 8f, -1000f, 0, 1148846080);
			}
...
BOOL func_38() // Position - 0x1C63
{
	...
	if (unk_0x5266F1D2AEF6F73A(Global_98701))
	{
		...
		{
			if (!unk_0x4FAFF4BCB7633475(iLocal_236[i]))
				unk_0x3DA436E63AB0F541(iLocal_236[i], Global_98701, &uLocal_344, &uLocal_360[i /*16*/], 8f, -1000f, 0, 0, 1148846080, 0);
		}
		...
		for (i = 0; i < iLocal_252; i = i + 1)
		{
			if (unk_0xFC8BFE4B41177C22(iLocal_252[i]))
				if (!unk_0xD6F9DEE4765092A9(&uLocal_525[i /*16*/]))
					unk_0x381D671BCFC294D9(iLocal_252[i], Global_98701, &uLocal_525[i /*16*/], &uLocal_344, 8f, -1000f, 0, 1148846080);
		}
...
int func_40(int iParam0) // Position - 0x1E43
{
	return iParam0;
}

BOOL func_41(int iParam0, int iParam1) // Position - 0x1E4D
{
	return iParam0 && iParam1 != false;
}
...
BOOL func_53(int iParam0, var uParam1, char* sParam2) // Position - 0x4422
{
	var unk;
	int num;
	var unk4;
...
BOOL func_54(int iParam0, int iParam1, var uParam2, var uParam3) // Position - 0x682E
{
	switch (iParam1)
	{
		case 0:

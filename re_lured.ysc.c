...
void _STAT_SET_PACKED_BOOL(int iParam0, int iParam1, Player plParam2) // Position - 0xAD3
{
	if (plParam2 == -1)
		plParam2 = func_14();
...
void func_63(int iParam0) // Position - 0x2EE3
{
	...
	else if (IS_BIT_SET(Global_114370.f_20567.f_471, iParam0) || IS_BIT_SET(Global_2359296[func_65() /*5569*/].f_681.f_10, iParam0))
	{
		flag = true;
		unk_0x8744D2E3FC95740E(&(Global_114370.f_20567.f_471), iParam0);
		unk_0x8744D2E3FC95740E(&(Global_2359296[func_65() /*5569*/].f_681.f_10), iParam0);
	}
...
Player func_68(Player plParam0) // Position - 0x31A1
{
	Player player;
	Player player2;
...
BOOL func_72(int iParam0, Player plParam1) // Position - 0x33C4
{
	if (plParam1 == -1)
		plParam1 = func_14();
...
void func_105() // Position - 0x40BD
{
	if (!func_134())
	{
		if (!unk_0x1C2F771CDC87A3A5(uLocal_67, 0))
		{
			if (unk_0x65FFA94B82A71741(unk_0x4A8C381C258A124D(), uLocal_47, 65f, 60f, 60f, 0, 1, 0) || Global_114365)
			{
...
{
	switch (func_113(&Global_32888, 0, 5, false, unk_0x8F76B2250AC806FA()))
	{
		case 1:
			return true;
...
{
	if (Global_114359 == func_31() && unk_0x9FA91AA1AC724CD0() && Global_114360)
		return true;
		...
		if (unk_0xFC8BFE4B41177C22(unk_0x4A8C381C258A124D()))
		{
			if (!unk_0x4FAFF4BCB7633475(unk_0x4A8C381C258A124D()))
			{
				...
				switch (iParam0)
				{
					...
					case 3:
						if (unk_0x8BF5256C439DF778(unk_0x4A8C381C258A124D()) || unk_0x9857C978BD3CBEDA(unk_0x4A8C381C258A124D()) || unk_0x6652E84A43F51B8B(unk_0x259BE71D8A81D4FA(), 1) || unk_0x1B32E388988DD296(unk_0x4A8C381C258A124D(), 0) || func_172() || Global_113417 || Global_32831 || func_171() || func_51(8, -1) || func_170() || func_169() || func_167() || Global_114370.f_7691.f_919[character] == 5)
							return false;
						break;
				
					case 4:
						if (func_172() || unk_0xE7B45027762DEFE7(unk_0x259BE71D8A81D4FA()) > 0 || func_51(8, -1) || func_167() || func_166() || Global_114370.f_7691.f_919[character] == 5)
							return false;
						break;
...
void func_181(int iParam0) // Position - 0x7FFA
{
	...
	if (func_134())
	{
		...
		func_184(30000);
		TEXT_LABEL_ASSIGN_STRING(&unk, func_183(Global_114359, true), 64);
